...
function gn_Cal_Yymm(btnsrc){
	...
	return window.showModalDialog("/werp/erpw/comm_function/COM_Calendar_yymm.html","",strleft +  strtop +";dialogWidth:190px; dialogHeight:5px;scroll:no;status:no;titlebar:no;center:no;help:no;");
}	

function gn_Cal_Yyyymmdd(){
	strleft = "dialogleft:" + eval(window.screenLeft + window.event.clientX ) ;
	strtop = ";dialogtop:" + eval(window.screenTop + window.event.clientY ) ;
	return window.showModalDialog("/werp/erpw/comm_function/COM_Calendar.html","",strleft +  strtop +";dialogWidth:190px; dialogHeight:208px;scroll:no;status:no;titlebar:no;center:no;help:yes;");
}
