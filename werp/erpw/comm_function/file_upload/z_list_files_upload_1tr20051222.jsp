...
/*
	             try
				{
					...
					// 삭제시 : 등록된 이미지 삭제
						...
						multi = new MultipartRequest(request, file_path, sizeLimit, "euc-kr", new DefaultFileRenamePolicy());
						...
						String s_file = file_path + "\\" + file_name;
						File lrImageFile = new File(s_file);
						
						// 새로운 이미지 파일명으로 변경
						//////multi.getFile(rows.getString(idx_s_file)).renameTo(lrImageFile);
