...
try { 
     ...
     conn = DriverManager.getConnection("jdbc:microsoft:sqlserver://218.49.235.196:1433;databasename=hp_plus","midas","midasit");  // testdb정보(url,userid,passwor)를 이용하여 conn
