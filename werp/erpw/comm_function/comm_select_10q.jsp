...
include file="conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("select_6",GauceDataColumn.TB_STRING,100));
     dSet.addDataColumn(new GauceDataColumn("select_7",GauceDataColumn.TB_STRING,100));
     dSet.addDataColumn(new GauceDataColumn("select_8",GauceDataColumn.TB_STRING,100));
     dSet.addDataColumn(new GauceDataColumn("select_9",GauceDataColumn.TB_STRING,100));
     dSet.addDataColumn(new GauceDataColumn("select_10",GauceDataColumn.TB_STRING,100));
    String query = in_sql;
%><%@ 
