...
// Wait 프레임 객체
var frmWait = null;
var WAIT_PAGE = "../../../comm_function/t_common/common/Wait.html";
...
var COMM_PATH = "../../../comm_function/t_common/common/";
...
function C_CalendarHide(asCalendarID, asDate)
{
	...
	try
	{
		...
		if (asCalendarID != -1) CalendarResult(asCalendarID, asDate, asDate.substring(0, 4), asDate.substring(5, 7), asDate.substring(8));
	}
	catch (e)
	{
