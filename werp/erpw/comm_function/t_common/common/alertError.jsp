													...
													<tr>
														<td align="center" valign="middle">
															...
															<table width="330" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<td align="center">
																		<div id="divMessage" style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 116px">
																			<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td><TEXTAREA style="WIDTH: 350px; HEIGHT: 114px" id="txtMessage" readOnly></TEXTAREA></td>
																				</tr>
																			</table>
																		</div>
																	</td>
