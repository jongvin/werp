										...
										<tr> 
											<td align="right" bgcolor="ECECEC">
											    <table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td align="right">
															<input id="btnYes" type="button" class="img_btnOk3" value="예" title="예(Y)" onclick="btnYes_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															<input id="btnNo" type="button" class="img_btnClose3" value="아니오" title="아니오(N)" onclick="btnNo_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															<input id="btnCancel" type="button" class="img_btnCancel3" value="취소" title="취소(C)" onclick="btnCancel_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
														</td>
														<td width="12">&nbsp;</td>
													</tr>
												</table>
