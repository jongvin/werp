...
try { 
     ...
     conn = DriverManager.getConnection("jdbc:microsoft:sqlserver://192.168.1.5:1433;databasename=ezconn","sso_user","worldro");  // testdb정보(url,userid,passwor)를 이용하여 conn
