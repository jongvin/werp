...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RAcctRemainR.jsp(기간별일일잔액내역)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RAcctRemainR";
	String strPageName = "t_RAcctRemainR";
//저장 액션
											...
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="52">
															<input id="txtBUDG_YYYY_MM_FR" type="text" notNull DATATYPE="date" style="width:90px">
														</td>
														...
														<td width="52">
															<input id="txtBUDG_YYYY_MM_TO" type="text" notNull  DATATYPE="date" style="width:90px">
														</td>
