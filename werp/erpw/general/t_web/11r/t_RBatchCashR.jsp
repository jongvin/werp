...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RBatchCashR.jsp(현금대량이체확인서)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RBatchCashR";
	String strPageName = "t_RBatchCashR";
//저장 액션
								...
								<td height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<C> Name='출금은행' ID=OUT_ACCOUNT_NO Width=120
											</C>
											...
											<C> Name='이체파일명' ID=DESCRIPTION Width=200
											</C>
											">
