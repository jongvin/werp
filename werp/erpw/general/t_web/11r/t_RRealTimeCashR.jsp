...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RRealTimeCashR.jsp(현금건별이체확인서)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RRealTimeCashR";
	String strPageName = "t_RRealTimeCashR";
//저장 액션
								...
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 예금이체목록</td>
								...
								<td height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<C> Name='출금계좌' ID=OUT_ACCOUNT_NO Width=120
											</C>
											<C> Name='이체실행일' ID=PAY_YMD Width=90
											</C>
											<C> Name='등록자' ID=NAME Width=90
											</C>
											<C> Name='등록일시' ID=CREATION_DATE Width=160
											</C>
											<C> Name='이체금액' ID=PAY_AMT Width=90
											</C>
											<C> Name='상태' ID=PAY_STATUS_NAME Width=90
											</C>
											<C> Name='적요' ID=DESCRIPTION Width=200
											</C>
											">
