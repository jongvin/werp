...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RSlipReport0002";
	String strFileName01 = "t_RSlipReport0002";
	String strReportName = "r_t_010002";
										...
										<tr> 
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="80" class=font_green_bold>전표월</td>
														<td width="72">
															<input id="txtDT_F" type="text" notNull datatype="DATEYM" style="width:70px" value="<%=strDate%>">
														</td>
