...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RSlipReport0001";
	String strFileName01 = "t_RSlipReport0001";
	String strReportName = "r_t_010001";
											...
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="20"><input id="btnDT_F" type="button" datatype="DATE" class="img_btnCalendar_S" title="달력" onclick="btnDT_F_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"></td>
														<td width="5">
															~&nbsp;
														</td>
														<td width="72">
														...
														<td width="20"><input id="btnDT_T" type="button" datatype="DATE" class="img_btnCalendar_S" title="달력" onclick="btnDT_T_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"></td>
														<td width=*>&nbsp;</td>
													</tr>
												</table>
