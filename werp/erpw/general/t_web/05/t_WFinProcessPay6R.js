/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFinProcessPay6R.jsp(대금지급관리예수금)
...
function Initialize()
{
	G_addDataSet(dsMAIN, trans, gridMAIN, sSelectPageName+D_P1("ACT","MAIN"), "대금지급관리예수금");
...
function btnsave_onclick()
{
	...
	for(var i = 1 ; i <= dsMAIN.CountRow ; ++i)
	{
		...
		{
			lnSum += C_convSafeFloat(dsMAIN.NameString(i,"EXEC_AMT"));
		}
	}
	...
	lrObject.amt = lnSum;
	lrObject.work_slip_id = "";
	lrObject.work_slip_idseq = "";

	var		arrRtn2 = window.showModalDialog("./t_PMakeEmpPayTaxSlipR.jsp", lrObject, "center:yes; dialogWidth:410px; dialogHeight:600px; status:no; help:no; scroll:no");
	...
	dsMAKE_SLIP.NameString(dsMAKE_SLIP.RowPosition,"WORK_SLIP_ID") = arrRtn2.work_slip_id;
	dsMAKE_SLIP.NameString(dsMAKE_SLIP.RowPosition,"WORK_SLIP_IDSEQ") = arrRtn2.work_slip_idseq;
