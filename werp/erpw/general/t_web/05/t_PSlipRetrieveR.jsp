...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_PSlipRetrieveR";
//저장 액션
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="52">&nbsp;</td>
		<td width="15"><img src="../images/bullet3.gif"></td>
		<td width="70"  class="font_green_bold" >인사부문</td>
		<td width="112"> <input name="txtEMP_CLASS_CODE" 	type="text" datatype="han" style="width:110px" 	VALUE="" onblur="txtEMP_CLASS_CODE_onblur()"></td>
		<td width="162"> <input name="txtEMP_CLASS_NAME"	type="text" class="ro" readOnly style="width:160px"	VALUE=""></td>
		<td>
			<input id="btnEMP_CLASS_CODE" type="button" class="img_btnFind" onclick="btnEMP_CLASS_CODE_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"value="찾기" />
		</td>
		<td width="*">&nbsp;</td>
	</tr>
</table>
	...
	<tr>
		...
		<td width="70">
			<select  name="cboKEEP_CLS"  style="WIDTH: 70px">
				...
				<OPTION value="K" selected> 확&nbsp;&nbsp;정</OPTION>
			</select>
		</td>
		<td width="*">&nbsp;</td>
	</tr>
