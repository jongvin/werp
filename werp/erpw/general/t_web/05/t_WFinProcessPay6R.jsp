...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFinProcessPay6R";
//저장 액션
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											...
											<FC> Name=전표번호 ID=MAKE_SLIPNO Width=100
											</FC>
											<C> Name=전표일자 ID=MAKE_DT Width=100
											</C>
											<C> Name=계정코드 ID=ACC_CODE Width=100
											</C>
											<C> Name=계정명 ID=ACC_NAME Width=160
											</C>
											<C> Name=적요 ID=SUMMARY1 Width=260
											</C>
											<C> Name=채무잔액 ID=REMAIN_AMT Width=100
											</C>
											<C> Name=지급금액 ID=EXEC_AMT Width=100
											</C>
											">
