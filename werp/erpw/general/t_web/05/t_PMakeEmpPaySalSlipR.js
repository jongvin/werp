/**************************************************************************/
/* 1. 프 로 그 램 id : t_PMakeLoanRefundSlipR(차입상환전표)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
function Initialize()
{
	...
	dsWORK_SLIP_IDSEQ.NameString(dsWORK_SLIP_IDSEQ.RowPosition,"WORK_SEQ") = lrArgs.work_seq;
...
function	ConfirmSelected()
{
	...
	dsMAKE_SLIP.NameString(dsMAKE_SLIP.RowPosition,"WORK_SEQ") = lrArgs.work_seq;
	dsMAKE_SLIP.NameString(dsMAKE_SLIP.RowPosition,"WORK_DT") = lrArgs.work_dt;
