...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WEmpPaySumR";
	String strFileName01 = "t_WEmpPaySumR";
	String strReportName = "r_t_050001";
//저장 액션
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="15"><img src="../images/bullet3.gif"></td>
		<td width="80" class=font_green_bold>작성월</td>
		<td width="72">
		...
		<td width="15">&nbsp;</td>
		<td width="15"><img src="../images/bullet3.gif"></td>
		<td width="60" class="font_green_bold" >집계구분</td>
		<td width="100">
			<SELECT id="cboChulTag" style="WIDTH: 80px">
				<OPTION VALUE='1' selected>구분
				<OPTION VALUE='2'>구분-팀
				<OPTION VALUE='3'>구분-부서
			</SELECT>
		</td>
		<td width=*>&nbsp;</td>
	</tr>
...
-->
<input id="btnPrint_01" type="button" tabindex="-1" class="img_btn4_1" onClick="btnquery_prt_onclick();" 	value="인 쇄" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<C> Name=구분 		ID=EMP_CLASS_NAME		Align=Left	 Width=80   	Edit='none' 	Show='true' suppress=4
BgColor = {ROW_COLOR}
</C>
<C> Name=팀 		ID=TEAM_DEPT_NAME		Align=Left	 Width=120   	Edit='none' 	Show='true' SubSumText='' suppress=3
BgColor = {ROW_COLOR}
</C>
<C> Name=부서 		ID=DEPT_NAME			Align=Left	 Width=120   	Edit='none' 	Show='true' SubSumText='' suppress=2
BgColor = {ROW_COLOR}
</C>
<C> Name=항목 		ID=ITEM_NAME			Align=Left	 Width=120   	Edit='none' 	Show='true' SubSumText='' suppress=1
BgColor = {ROW_COLOR}
</C>
<C> Name=세목 		ID=ACC_SHRT_NAME		Align=Left	 Width=120   	Edit='none' 	Show='true'
BgColor = {ROW_COLOR}
</C>
<C> Name='당 월' 	ID=NOW_AMT				Align=Right	 Width=150   	Edit='none' 	SumText=@sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right
BgColor = {ROW_COLOR}
</C>
<C> Name='누 계' 	ID=TOT_AMT				Align=Right	 Width=150   	Edit='none'  	SumText=@sum	SumColor=Black	SumBgColor=#A8C9FF  SumTextAlign=right
BgColor = {ROW_COLOR}
</C>
										">
