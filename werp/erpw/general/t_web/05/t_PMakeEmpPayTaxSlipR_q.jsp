...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("WORK_SLIP_IDSEQ"))
		{
			...
			strSql  = " Select SQ_T_WORK_SLIP_ID.NEXTVAL WORK_SLIP_ID, SQ_T_WORK_SLIP_IDSEQ.NEXTVAL WORK_SLIP_IDSEQ,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' WORK_CODE,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' COMP_CODE, 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' DEPT_CODE,0 WORK_SEQ, 'XXXXXXXXXXXXXX' WORK_DT,0 AMT From DUAL ";
