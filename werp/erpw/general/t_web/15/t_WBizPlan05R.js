...
function Initialize()
{
	G_addDataSet(dsMAIN, null, gridMAIN, null, "자금수지",null,null,true);
...
function	processGridTitle()
{
	...
	s1 = 
"	<FC> Name='구분' id='LEVELED_NAME'	Width=95 BgColor ='#ECF5EB' Color ={Decode(LEVELED,'','black','blue')} </FC>	\n" +
"	<FC> Name="+BesClseAccId+"'년 실적' id='BF_EXEC_AMT' decao='4' Width=95  </FC>	\n" +
"	<G> Name="+sClseAccId+"'년' id='G1'   \n" +
"	<C> Name='1 ~ "+vMon+"월 실적' ID=NW_BM_EXEC_AMT	decao='4'	Width=95 </C> \n" +
...
"	</G> \n" +
"	<G> Name="+sClseAccId+"'년 년간' id='G2'   \n" +
"	<C> Name='계획' 		ID=NW_PLAN_AMT					decao='4' Width=95 </C>	\n" +
"	<C> Name='예상' 		ID=NW_FORE_AMT					decao='4' Width=95 </C>	\n" +
"	<C> Name='계획비' 	ID=NW_GAP_PLAN_AMT			decao='4' Width=95 </C>	\n" +
"	<C> Name='전년비' 	ID=NW_GAP_BYEAR_AMT			decao='4' Width=95 </C>	\n" +
"	</G> \n" +
"	<G> Name="+AfsClseAccId+"'년' id='G3'   \n" +
