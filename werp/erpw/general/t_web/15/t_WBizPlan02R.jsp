...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBizPlan02R(경비및영업외수지)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBizPlan02R";
//저장 액션
...
<html>
	<head>
		...
		<param name=SubsumExpr	value="total,1:PRN"></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__1); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="40">&nbsp;</td>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="40" class=font_green_bold>구분</td>
														<td width="152">
															<select  id="cboGUBUN"  style="WIDTH: 150px" >
																<OPTION value='1'> 관리판매비</OPTION>
																<OPTION value='2'> 영업외수지</OPTION>
																<OPTION value='3'> 관리판매비및영업외수지</OPTION>
															</select>
														</td>														
														<td>&nbsp; </td>
													</tr>
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 경비및영업외수지</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__2"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<FC> Name='분류' id='P_NAME'	Width=95 BgColor ='#ECF5EB'
														</FC>
														<FC> Name='항목' id='BIZ_PLAN_ITEM_NAME'	Width=95 BgColor ='#ECF5EB' 
														</FC>
														<FC> Name='2004년실적' id='BF_EXEC_AMT' Width=95	
														</FC>														
														<G> Name='2005년 1~9월' id='G1'
															<C> Name='전년' ID=BF_BM_EXEC_AMT			Width=95 
															</C>
															<C> Name='계획' ID=NW_BM_PLAN_AMT			Width=95 
															</C>
															<C> Name='실적' ID=NW_BM_EXEC_AMT			Width=95 
															</C>
															<C> Name='계획비' ID=NW_BM_GAP_PLAN		Width=95 
															</C>
															<C> Name='전년비' ID=NW_BM_GAP_BYEAR	Width=95 
															</C>
														</G>	
														<G> Name='2005년 해당분기' id='G2'
															<C> Name='1월 계획' ID=NW_MIN_PLAN_AMT		Width=95 
															</C>
															<C> Name='1월 예상' ID=NW_MIN_FORE_AMT		Width=95 
															</C>
															<C> Name='2월 계획' ID=NW_MID_PLAN_AMT		Width=95 
															</C>
															<C> Name='2월 예상' ID=NW_MID_FORE_AMT		Width=95 
															</C>
															<C> Name='3월 계획' ID=NW_MAX_PLAN_AMT		Width=95 
															</C>
															<C> Name='3월 예상' ID=NW_MAX_FORE_AMT		Width=95 
															</C>
														</G>
														<G> Name='2005년 년간' id='G3'
															<C> Name='년간계획' ID=NW_PLAN_AMT					Width=95
															</C>
															<C> Name='년간예상' ID=NW_FORE_AMT					Width=95 
															</C>
															<C> Name='계획비' 	ID=NW_GAP_PLAN_AMT			Width=95 
															</C>
															<C> Name='전년비'	 	ID=NW_GAP_BYEAR_AMT			Width=95 
															</C>															
														</G>
														<G> Name='2006년' id='G4'
															<C> Name='계획' 	ID=AF_PLAN_AMT					Width=95 
															</C>
															<C> Name='전년비' ID=AF_GAP_BYEAR_AMT			Width=95 
															</C>
														</G>
