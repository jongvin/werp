...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBizPlan04(자금수지)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBizPlan05R";
//저장 액션
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__2"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<FC> Name='구분' id='LEVELED_NAME'	Width=95  BgColor ='#ECF5EB'
														</FC>
														<FC> Name='2005년 실적' id='BF_EXEC_AMT' Width=95	
														</FC>														
														<G> Name='2006년' id='G1'
															<C> Name='1~9월 실적' ID=NW_BM_EXEC_AMT			Width=95 
															</C>
															<C> Name='10월 예상' ID=NW_MIN_FORE_AMT			Width=95 
															</C>
															<C> Name='11월 예상' ID=NW_MID_FORE_AMT			Width=95 
															</C>
															<C> Name='12월 예상' ID=NW_MAX_FORE_AMT			Width=95 
															</C>
														</G>	
														<G> Name='2006년 년간' id='G2'
															<C> Name='계획' 		ID=NW_PLAN_AMT					Width=95
															</C>
															<C> Name='예상' 		ID=NW_FORE_AMT					Width=95 
															</C>
