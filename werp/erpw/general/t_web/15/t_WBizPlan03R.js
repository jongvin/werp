...
function	processGridTitle()
{
	...
	s1 = 
"	<FC> Name='현장명' id='DEPT_NAME' Width=95 BgColor ='#ECF5EB' suppress=1 </FC>	\n" +
"	<FC> Name='항목' id='BIZ_PLAN_ITEM_NAME' Width=95 BgColor ='#ECF5EB' </FC>	\n" +
"	<FC> Name="+BesClseAccId+"'년실적' id='BF_EXEC_AMT' decao='4' Width=95  </FC>	\n" +
"	<G> Name="+sClseAccId+"'년 1 ~ '"+vMon+"월 id='G1'   \n" +
"	<C> Name='전년' ID=BF_BM_EXEC_AMT	decao='4' Width=95 </C>	\n" +
"	<C> Name='계획' ID=NW_BM_PLAN_AMT	decao='4' Width=95 </C>	\n" +
"	<C> Name='실적' ID=NW_BM_EXEC_AMT	decao='4' Width=95 </C>	\n" +
"	<C> Name='계획비' ID=NW_BM_GAP_PLAN	decao='4' Width=95 </C>	\n" +
"	<C> Name='전년비' ID=NW_BM_GAP_BYEAR	decao='4' Width=95 </C>	\n" +
"	</G> \n" +
"	<G> Name="+sClseAccId+"'년 해당분기' id='G2'   \n" +
"	<C> Name="+vMon1+"'월 계획' ID=NW_MIN_PLAN_AMT	 	decao='4' Width=95 </C>	\n" +
"	<C> Name="+vMon1+"'월 예상' ID=NW_MIN_FORE_AMT		decao='4'	Width=95 </C>	\n" +
"	<C> Name="+vMon2+"'월 계획' ID=NW_MID_PLAN_AMT	 	decao='4'	Width=95 </C>	\n" +
"	<C> Name="+vMon2+"'월 예상' ID=NW_MID_FORE_AMT		decao='4'	Width=95 </C>	\n" +
"	<C> Name="+vMon3+"'월 계획' ID=NW_MAX_PLAN_AMT	 	decao='4'	Width=95 </C>	\n" +
"	<C> Name="+vMon3+"'월 예상' ID=NW_MAX_FORE_AMT		decao='4'	Width=95 </C>	\n" +
"	</G> \n" +
"	<G> Name="+sClseAccId+"' 년간' id='G3'   \n" +
"	<C> Name='년간계획' ID=NW_PLAN_AMT	decao='4' Width=95 </C>	\n" +
"	<C> Name='년간예상' ID=NW_FORE_AMT		decao='4' Width=95 </C>	\n" +
"	<C> Name='계획비' 	ID=NW_GAP_PLAN_AMT			decao='4' Width=95 </C>	\n" +
"	<C> Name='전년비' 	ID=NW_GAP_BYEAR_AMT			decao='4' Width=95 </C>	\n" +
"	</G> \n" +
"	<G> Name="+AfsClseAccId+"'년' id='G4'   \n" +
"	<C> Name='계획' 	ID=AF_PLAN_AMT	decao='4' Width=95 </C>	\n" +
"	<C> Name='전년비' ID=AF_GAP_BYEAR_AMT	decao='4' Width=95 </C>	\n" +
"	</G> \n" ;	
	gridMAIN.Format = s1;
