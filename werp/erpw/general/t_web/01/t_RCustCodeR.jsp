...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RCustCodeR";
//저장 액션
					...
					<td width="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="150" class="font_green_bold">거래처목록</td>
...
<C> Name=우편번호 ID=ZIPCODE Width=90 Edit=none Show=false
</C>
<C> Name=업태 ID=BIZCOND Width=90 Edit=none Show=false
</C>
<C> Name=업종 ID=BIZKND Width=90 Edit=none Show=false
</C>
<C> Name=주소1 ID=ADDR1 Width=90 Edit=none Show=false
</C>
<C> Name=전화번호 ID=TELNO Width=90 Edit=none Show=false
</C>
											">
									</OBJECT><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__9); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
									&nbsp;
								</td>
								<td width="365" height="100%" onActivate="G_focusDataset(dsMAIN)">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="10">&nbsp;</td>
		...
		<!-- 가우스 Bind 객체정의 시작 //-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=ADE_Bind_1 classid=clsid:9C9AB433-EA85-11D2-A4F9-00608CEBEE49 VIEWASTEXT >
			<PARAM NAME="DataID" VALUE="dsMAIN">
