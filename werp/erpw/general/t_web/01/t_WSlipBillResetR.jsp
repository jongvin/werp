...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WSlipBillResetR(지급어음반제전표자동생성)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//파일명
	...
	String strFileName = "./t_WSlipBillResetR";
...
//저장 액션
	...
	String strWORK_CODE = "0000000002";
...
<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsAUTO_BILL_RESET_SEQ classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__8); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
						...
						<!-- 간격조정 테이블 종료 //-->
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="font_green_bold"> 지급어음 반제전표 생성</td>
										<td align="right">
...
Value = {Decode(CUST_NAME,'',EXPR_DT_GRP_GRP&' 계',CUST_NAME)}
BgColor = {Decode(CUST_NAME,'','#EFEEFF', '#FFFFFF')}
</C>
