								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="60">
												<select id="cboSLIP_KIND_TAG" style="WIDTH: 60px" tabindex="-1" class="input_listbox_default" onChange="cboSLIP_KIND_TAG_onChange()">
													<%=strSLIP_KIND_TAG%>
												</select>
          									</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="165" align="right">
												&nbsp;
												<!--
												<input id="btnSLIP_NO_CHG" type="button" tabindex="-1" class="img_btn6_1" onClick="btnSLIP_NO_CHG_onClick()" 	value="전표일자변경" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
												-->
											</td>
												...
												<td colspan="2" style="background:#F6F6F6">
													<table border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td width="134">
																<input id="txtVAT_NAME" type="text" readOnly adsreadonly tabindex="-1" class="ro" style="width:132px"/>
															</td>
															<td width="22">
