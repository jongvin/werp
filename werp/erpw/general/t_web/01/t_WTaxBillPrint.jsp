...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WTaxBillPrint";
	String strFileName01 = "t_WTaxBillPrint";
...
<html>
	<head>
		...
		<!--
			...
			var	vPAGE_ID = "[<%=strUserNo%>]"+"t_WTaxBillPrint";
		//-->
		</script>
		
		<!-- 가우스 Dataset 및 Tranaction 객체정의 시작 //-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__1"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsSUB01 classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__1); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__1_1"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsSUB02 classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__1_1); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
...
&nbsp;
<input name="btnAllSelect" type="button" class="img_btn9_1" onclick="btnquery_prt_onclick();" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" value="매출세금계산서출력" />
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
...
<FC> Name=선택	ID=CHK_CLS	Align=Center	Width=40   	Show='true' 	EditStyle=CheckBox
</FC>
<C> Name=확정   		ID=KEEP_CLS 		Align=Center	 Width=40 Sort=true Edit='none'
</C>
<C> Name=계산서구분 	ID=RCPTBILL_CLS		Align=Center	Width=70	Show='true'		Edit='None'		EditStyle='Combo' Data='<%=strRCPTBILL_CLS%>'
</C>
<C> Name=거래처코드 	ID=CUST_CODE 		Align=Left	 Width=100 Sort=true Edit='none'
</C>
<C> Name=거래처명 		ID=CUST_NAME 		Align=Left	 Width=140 Sort=true Edit='none' SumText=' 합 계 : '
</C>
<C> Name=공급가			ID=SUPAMT 			Align=Right	 SumBgColor=#FFCCCC BgColor=#FFECEC Width=95 Edit='none' SumText=@sum
</C>
<C> Name=부가세			ID=VATAMT 			Align=Right	 SumBgColor=#CEEEFF BgColor=#E0F4FF Width=95 Edit='none' SumText=@sum
</C>
<C> Name='적        요' ID=SUMMARY1 		Align=Left	 Width=170 Sort=true Edit='none'
</C>
<C> Name=권			ID=BOOK_NO 		Align=Right	 Width=50 Sort=true Edit=''
</C>
<C> Name=번			ID=BOOK_SEQ 	Align=Right	 Width=50 Sort=true Edit=''
</C>
<C> Name=일련번호	ID=SER_NO 		Align=Left	 Width=100 Sort=true Edit=''
</C>
<C> Name=증빙일자 		ID=VAT_DT			Align=Center	Width=80   	Show='true'		
</C>
<C> Name=전표번호	ID=MAKE_SLIPNOLINE		Align=Left	 Width=110 Sort=true BgColor=#ECF5EB Edit='none'
</C>
<C> Name=귀속부서 		ID=DEPT_NAME 		Align=Left	 Width=100 Sort=true Edit='none' Show=false
</C>
...
<C> Name=은행명 		ID=BANK_NAME 		Align=Left	 Width=100 Sort=true Edit='none' Show=false
</C>
<C> Name=사원번호 		ID=EMP_NO 			Align=Left	 Width=80 Sort=true Edit='none' Show=false
</C>
<C> Name=사원명    		ID=EMP_NAME 		Align=Left	 Width=80 Sort=true Edit='none' Show=false
</C>
											">
							...
							<tr>
								<td width="50%">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold"> 품목</td>
...
<C> Name=품목 ID=ITEM Align=Left HeadAlign=Center  Width=150
</C>
<C> Name=규격 ID=ITEM_SIZE Align=Left HeadAlign=Center  Width=80
</C>
<C> Name=수량 ID=CNT Align=Right HeadAlign=Center  Width=60
</C>
<C> Name=단가 ID=UCOST Align=Right HeadAlign=Center  Width=80
</C>
<C> Name=공급가액 ID=SUPAMT Align=Right HeadAlign=Center  Width=80
</C>
<C> Name=부가세 ID=VATAMT Align=Right HeadAlign=Center  Width=80
</C>
<C> Name=비고 ID=REMARK Align=Left HeadAlign=Center  Width=200
</C>
														">
