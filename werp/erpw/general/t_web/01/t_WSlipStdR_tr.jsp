...
/**************************************************************************/
	...
	try
	{
		...
		if (CITCommon.isNull(strAct))
		{
			...
			rows_SLIP_H = dsSLIP_H.getDataRows();

			try
			{
				for	(int i = 0;	i <	rows_SLIP_H.length; i++)
				{
					CITData lrArgData = new CITData();

					if (rows_SLIP_H[i].getJobType() == GauceDataRow.TB_JOB_INSERT)
					{
						strSql = "{call SP_T_ACC_SLIP_HEAD_I(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
						...
						lrArgData.addColumn("MAKE_SEQ", CITData.NUMBER);
						...
						lrArgData.addColumn("GROUPWARE_SLIPSTATUS", CITData.VARCHAR2);
						...
						lrArgData.addColumn("KEEP_SEQ", CITData.NUMBER);
						lrArgData.addColumn("KEEP_DEPT_CODE", CITData.VARCHAR2);
						...
						lrArgData.addColumn("TRANSFER_TAG", CITData.VARCHAR2);
						lrArgData.addColumn("IGNORE_SET_RESET_TAG", CITData.VARCHAR2);

						lrArgData.addRow();
						strSLIP_ID = rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("SLIP_ID"));
						lrArgData.setValue("SLIP_ID", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("SLIP_ID")));
						lrArgData.setValue("CRTUSERNO", strUserNo);
						lrArgData.setValue("MAKE_SLIPCLS", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("MAKE_SLIPCLS")));
						lrArgData.setValue("MAKE_SLIPNO", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("MAKE_SLIPNO")));
						lrArgData.setValue("MAKE_COMP_CODE", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("MAKE_COMP_CODE")));
						lrArgData.setValue("MAKE_DEPT_CODE", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("MAKE_DEPT_CODE")));
						lrArgData.setValue("MAKE_DT", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("MAKE_DT")));
						lrArgData.setValue("MAKE_DT_TRANS", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("MAKE_DT_TRANS")));
						lrArgData.setValue("MAKE_SEQ", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("MAKE_SEQ")));
						lrArgData.setValue("INOUT_DEPT_CODE", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("INOUT_DEPT_CODE")));
						lrArgData.setValue("MAKE_PERS", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("MAKE_PERS")));
						lrArgData.setValue("MAKE_NAME", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("MAKE_NAME")));
						lrArgData.setValue("GROUPWARE_SLIPSTATUS", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("GROUPWARE_SLIPSTATUS")));
						lrArgData.setValue("KEEP_SLIPNO", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("KEEP_SLIPNO")));
						lrArgData.setValue("KEEP_DT", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("KEEP_DT")));
						lrArgData.setValue("KEEP_DT_TRANS", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("KEEP_DT_TRANS")));
						lrArgData.setValue("KEEP_SEQ", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("KEEP_SEQ")));
						lrArgData.setValue("KEEP_DEPT_CODE", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("KEEP_DEPT_CODE")));
						lrArgData.setValue("KEEP_KEEPER", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("KEEP_KEEPER")));
						lrArgData.setValue("WORK_CODE", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("WORK_CODE")));
						lrArgData.setValue("CHARGE_PERS", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("CHARGE_PERS")));
						lrArgData.setValue("SLIP_KIND_TAG", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("SLIP_KIND_TAG")));
						lrArgData.setValue("TRANSFER_TAG", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("TRANSFER_TAG")));
						lrArgData.setValue("IGNORE_SET_RESET_TAG", rows_SLIP_H[i].getString(dsSLIP_H.indexOfColumn("IGNORE_SET_RESET_TAG")));
					}
					else if (rows_SLIP_H[i].getJobType() == GauceDataRow.TB_JOB_UPDATE)
					{
						strSql = "{call SP_T_ACC_SLIP_HEAD_U(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
					...
					else if (rows_SLIP_H[i].getJobType() == GauceDataRow.TB_JOB_DELETE)
					{
						strSql = "{call SP_T_ACC_SLIP_HEAD_D(?,?)}";
			...
			catch (Exception ex)
			{
				...
				GauceInfo.response.writeException("USER", "900001", "T_ACC_SLIP_HEAD 테이블 데이타 갱신 에러" + ex.getMessage());
			...
			try
			{
				for	(int i = 0;	i <	rows_SLIP_D.length; i++)
				{
					...
					{
						strSql = "{call Sp_T_Acc_Slip_Body_B_I("
															+"?,?,?,?,?,?,?,?,?,?,"
															+"?,?,?,?,?,?,?,?,?,?,"
															+"?,?,?,?,?,?,?,?,?,?,"
															+"?,?,?,?,?,?,?,?,?,?,"
						...
						lrArgData.addColumn("BRAIN_GRP_SEQ",CITData.NUMBER);
						...
						lrArgData.addColumn("BRAIN_ACC_POSITION",CITData.VARCHAR2);
						...
						lrArgData.addColumn("CHK_COLL_DT",CITData.VARCHAR2);
						...
						lrArgData.addColumn("BILL_COLL_DT_R",CITData.VARCHAR2);
						...
						lrArgData.setValue("BRAIN_GRP_SEQ", rows_SLIP_D[i].getString(dsSLIP_D.indexOfColumn("BRAIN_GRP_SEQ")));
						lrArgData.setValue("BRAIN_SLIP_SEQ1", rows_SLIP_D[i].getString(dsSLIP_D.indexOfColumn("BRAIN_SLIP_SEQ1")));
						lrArgData.setValue("BRAIN_SLIP_SEQ2", rows_SLIP_D[i].getString(dsSLIP_D.indexOfColumn("BRAIN_SLIP_SEQ2")));
						lrArgData.setValue("BRAIN_SLIP_LINE", rows_SLIP_D[i].getString(dsSLIP_D.indexOfColumn("BRAIN_SLIP_LINE")));
						lrArgData.setValue("BRAIN_SORT_SEQ", rows_SLIP_D[i].getString(dsSLIP_D.indexOfColumn("BRAIN_SORT_SEQ")));
						lrArgData.setValue("BRAIN_ACC_POSITION", rows_SLIP_D[i].getString(dsSLIP_D.indexOfColumn("BRAIN_ACC_POSITION")));
						...
						lrArgData.setValue("CHK_COLL_DT", rows_SLIP_D[i].getString(dsSLIP_D.indexOfColumn("CHK_COLL_DT")));
						...
						lrArgData.setValue("BILL_COLL_DT_R", rows_SLIP_D[i].getString(dsSLIP_D.indexOfColumn("BILL_COLL_DT_R")));
						...
						lrArgData.setValue("SECU_REAL_SECU_NO", rows_SLIP_D[i].getString(dsSLIP_D.indexOfColumn("SECU_REAL_SECU_NO")));
					...
					{
						strSql = "{call Sp_T_Acc_Slip_Body_B_U("
															+"?,?,?,?,?,?,?,?,?,?,"
															+"?,?,?,?,?,?,?,?,?,?,"
															+"?,?,?,?,?,?,?,?,?,?,"
															+"?,?,?,?,?,?,?,?,?,?,"
					...
					{
						strSql = "{call Sp_T_Acc_Slip_Body_B_D(?,?)}";
