...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSlipSelPrintR";
	String strFileName01 = "t_WSlipSelPrintR";
	String strReportName = "r_t_010005";
//저장 액션
						...
						<!-- 간격조정 테이블 종료 //-->
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="font_green_bold"> 조 회 건 수</td>
										<td align="right">
<input id="btnSLIP_CONFIRM"		type="button" tabindex="-1" class="img_btn6_1" onClick="btnSLIP_CONFIRM_onClick()" 	value="일 괄 출 력" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
										</td>
