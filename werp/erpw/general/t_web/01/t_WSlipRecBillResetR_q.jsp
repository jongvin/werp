...
/**************************************************************************/
	...
	try
	{
		...
		{			
			...
			strSql  = " SELECT \n";
			strSql += " 	'F' CHK_CLS ,  \n";
			strSql += " 	F_T_DateToString(NVL(A.EXPR_DT,sysdate)) EXPR_DT_GRP,   \n";
			strSql += " 	F_T_DateToString(NVL(A.EXPR_DT,sysdate)) EXPR_DT,   \n";
			strSql += " 	a.SLIP_ID ,   \n";
			strSql += " 	a.SLIP_IDSEQ ,  \n";
			strSql += " 	d.ACC_CODE ,   \n";
			strSql += " 	d.ACC_NAME ,   \n";
			...
			strSql += " 				--AND	      \n";
			strSql += " 				A.ACC_CODE In ('111050201','111050202','121050200','111050290')   \n";
			...
			strSql += " 		AND	A.ACC_CODE In ('111050201','111050202','121050200','111050290')   \n";
			strSql += " 		AND	C.CUST_CODE LIKE   ?    || '%'  \n";
			strSql += " 		AND	( E.EXPR_DT BETWEEN F_T_Stringtodate( ? ) AND F_T_Stringtodate( ? ) OR E.EXPR_DT IS NULL)  \n";
		...
		{			
			...
			strSql += " T_FIN_RECEIVE_CHK_BILL F \n";
			strSql += " WHERE   \n";
			...
			strSql += " 	AND	B.SLIP_ID = F.RESET_SLIP_ID  \n";
			strSql += " 	AND	B.SLIP_IDSEQ = F.RESET_SLIP_IDSEQ  \n";
			...
			strSql += " 	AND	b.ACC_CODE In ('111050201','111050202','121050200','111050290')   \n";
			strSql += " 	AND	b.CUST_CODE LIKE   ? ||'%'  \n";	
			strSql += " 	AND	( F.EXPR_DT BETWEEN F_T_Stringtodate( ? ) AND F_T_Stringtodate( ? ) OR F.EXPR_DT IS NULL )  \n";
			strSql += " 	AND D.Acc_REMAIN_MNG = 'T' \n";
			//strSql += " 	AND D.CHK_NO_MNG = 'F' \n";
			//strSql += " 	AND D.BILL_NO_MNG = 'F' \n";
			strSql += " 	AND D.REC_BILL_NO_MNG = 'T' \n";
		...
		else if (strAct.equals("AUTO_REC_BILL_RESET_SEQ"))
		{
			strSql  = " Select SQ_T_AUTO_REC_BILL_RESET.NEXTVAL AUTO_REC_BILL_RESET_SEQ From DUAL ";
