...
<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__14"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transMAIN"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	...
	<script language="javascript">
		function initT(){
  //         alert(strSLIP_TRANS_CLS);
           C_Initialize();
       }
    </script>
	</head>
	
	<body onload="initT()" tabindex="-1">
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="54" class="font_green_bold" >발의일자</td>
											<td width="58">
											...
											<td width="144"> <input id="txtWORK_NAME" type="text" readOnly adsreadonly tabindex="-1" class="ro" style="width:100px"/></td>
											<td width="15">&nbsp;</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="275">
												<input id="txtMAKE_SLIPNO" 		type="text" readOnly adsreadonly tabindex="-1" class="ro" Center style="width:100px"/>
											</td>
											<td width="15"><img src="../images/bullet3.gif"></td>
											...
											<td width="*">
												...
												<input id="txtMAKE_NAME" 		type="text" readOnly adsreadonly tabindex="-1" class="ro" style="width:60px"/>
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<div id="divSLIP_H"  style="display:none">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="*">
													<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__15"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSLIP_H WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
														...
														<PARAM NAME="Format" 		VALUE="
															...
															<C> Name=발의사업장 	ID=MAKE_COMP_CODE	Width=100
															</C>
															<C> Name=발의부서 		ID=MAKE_DEPT_CODE 	Width=100
															</C>
															<C> Name=발의일자 		ID=MAKE_DT			Width=100
															</C>
															<C> Name=발의일자 		ID=MAKE_DT_TRANS	Width=100
															</C>
...
<input id="btnDETAIL_INSERT"	type="button" tabindex="-1" class="img_btn4_1" onClick="btnDETAIL_INSERT_onClick()" value="라인추가" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
										...
										<table width="100%" height="100%" border="1" bordercolor="black" cellspacing="0" cellpadding="2">
												...
												<td colspan="2" style="background:#F6F6F6">
													...
													<table border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td width="202">
												   				<input id="txtSUMMARY1" type="text" datatype="han" tabindex="116" style="width:200px"/>
															</td>
															<td width="22">
											...
											<tr>
												<td width="690" height="100%">
													<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__16"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSLIP_D WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
...
<FC> Name=차변금액 		ID=DB_AMT			BgColor=#FFECEC SumBgColor=#FFCCCC width=90 SumText=@sum Edit='none'</FC>
<FC> Name=대변금액 		ID=CR_AMT			BgColor=#E0F4FF SumBgColor=#CEEEFF width=90 SumText=@sum Edit='none'</FC>
...
<div id="divRESET_SLIPNO" style="display:none">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<!-- 가우스 Bind 객체정의 시작 //-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__17"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=ADE_Bind_1 style="Z-INDEX: 107; LEFT: 335px; POSITION: absolute; TOP: 158px" classid=clsid:9C9AB433-EA85-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbbind.cab#version=1,1,0,13">
			<PARAM NAME="DataID" 		VALUE="dsSLIP_D">
