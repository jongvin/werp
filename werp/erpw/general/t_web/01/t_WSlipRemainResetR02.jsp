...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WSlipRemainResetR(잔액반제전표자동생성)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//파일명
	...
	String strFileName = "./t_WSlipRemainResetR02";
...
//저장 액션
	...
	String strWORK_CODE = "0000000005";
						...
						<!-- 간격조정 테이블 종료 //-->
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="font_green_bold"> 받을구매카드 반제전표 생성</td>
										<td align="right">
