...
function Initialize()
{
	...
	G_addDataSet(dsAUTO_BILL_RESET_SEQ, null, null, null, "잔액반제_자동전표_작업번호");
...
function OnLoadBefore(dataset)
{
	...
	else if(dataset == dsAUTO_BILL_RESET_SEQ)
	{
		dataset.DataID = sSelectPageName	+ D_P1("ACT","AUTO_BILL_RESET_SEQ");
	}
}
...
function	btnSlipCreate_onClick()
{
	...
	*/
	...
	G_Load(dsAUTO_BILL_RESET_SEQ, null);

	btnSLIP_MAKE_SLIPNO_onClick();
	
	trans.Parameters = "";
	trans.Parameters += "ACT=AUTO_BILL_RESET";
	trans.Parameters += ",AUTO_BILL_RESET_SEQ="+dsAUTO_BILL_RESET_SEQ.NameString(1,"AUTO_BILL_RESET_SEQ");
...
function	btnSlipDelete_onClick()
{
	...
	trans.Parameters = "";
	trans.Parameters += "ACT=DELETE_BILL_RESET";
