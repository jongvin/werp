...
/**************************************************************************/
	...
	String strSLIP_ID = "";
	String strAUTO_REC_BILL_RESET_SEQ = "";
	...
	try
	{
		...
		strAUTO_REC_BILL_RESET_SEQ = GauceInfo.request.getParameter("AUTO_REC_BILL_RESET_SEQ");
		...
		if(strAct.equals("AUTO_REC_BILL_RESET"))
		{
			...
			try
			{
				for	(int i = 0;	i <	rows.length; i++)
				{
					...
					{
						strSql = "{call SP_T_AUTO_REC_BILL_RESET_I(?,?,?,?,?)}";
						
						lrArgData.addColumn("AUTO_REC_BILL_RESET_SEQ", CITData.NUMBER);
						...
						lrArgData.addRow();
						lrArgData.setValue("AUTO_REC_BILL_RESET_SEQ", strAUTO_REC_BILL_RESET_SEQ);
					...
					{
						strSql = "{call SP_T_AUTO_REC_BILL_RESET_D(?,?,?)}";
			...
			{
				CITData lrArgData = new CITData();
				strSql = "{call SP_T_AUTO_REC_BILL_RESET_SLIP(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
		...
		else if(strAct.equals("DELETE_REC_BILL_RESET")) {
