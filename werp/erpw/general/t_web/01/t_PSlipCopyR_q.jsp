...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += "  	A1.ACC_CODE VAT_ACC_CODE ,  \n";
			strSql += "  	--예산관리  \n";
			strSql += "  	A1.BUDG_MNG ,  \n";
			strSql += "  	--예산통제  \n";
			...
			strSql += " 			-- 바디조건 추가  \n";
			strSql += " 			--거래처  \n";
			if(!"".equals(strCUST_CODE)) strSql += " 			AND A6.CUST_CODE =  ?  \n";
			strSql += " 			--금액  \n";
			...
			strSql += " 			--계정과목  \n";
			if(!"".equals(strACC_CODE)) strSql += " 			AND AA.ACC_CODE =  ?  \n";
			strSql += " 			--부가세코드  \n";
			if(!"".equals(strVAT_CODE)) strSql += " 			AND AA.VAT_CODE =  ?  \n";
			strSql += " 			--귀속부서  \n";
			if(!"".equals(strDEPT_CODE)) strSql += " 			AND AA.DEPT_CODE =  ?  \n";
			strSql += " 			--적요  \n";
			if(!"".equals(strSUMMARY1)) strSql += " 			AND AA.SUMMARY1 LIKE ? ||'%' \n";
			strSql += " 			--세무사업장  \n";
			if(!"".equals(strTAX_COMP_CODE)) strSql += " 			AND AA.TAX_COMP_CODE =  ?  \n";
