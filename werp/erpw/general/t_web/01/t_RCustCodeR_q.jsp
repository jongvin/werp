	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			try
			{
				...
				//lrReturnData.setNotNull("BOSS_NAME", true);
				//lrReturnData.setNotNull("BIZCOND", true);
				//lrReturnData.setNotNull("BIZKND", true);
				//lrReturnData.setNotNull("ADDR1", true);
				//lrReturnData.setNotNull("TELNO", true);
