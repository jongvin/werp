...
/**************************************************************************/
	...
	try
	{
		...
		if(strAct.equals("AUTO_BILL_RESET"))
		{
			strAUTO_BILL_RESET_SEQ = GauceInfo.request.getParameter("AUTO_BILL_RESET_SEQ");
			...
			try
			{
				for	(int i = 0;	i <	rows.length; i++)
				{
					...
					{
						strSql = "{call SP_T_AUTO_BILL_RESET_I(?,?,?,?,?)}";
						
						lrArgData.addColumn("AUTO_BILL_RESET_SEQ", CITData.NUMBER);
						...
						lrArgData.addRow();
						lrArgData.setValue("AUTO_BILL_RESET_SEQ", strAUTO_BILL_RESET_SEQ);
					...
					{
						strSql = "{call SP_T_AUTO_BILL_RESET_D(?,?,?)}";
			...
			{
				CITData lrArgData = new CITData();
				strSql = "{call SP_T_AUTO_BILL_RESET_SLIP(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
		...
		else if(strAct.equals("DELETE_BILL_RESET")) {
