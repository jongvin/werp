...
/**************************************************************************/
	...
	try
	{
		...
		{			
			...
			strSql  = " SELECT \n";
			strSql += " 	'F' CHK_CLS ,  \n";
			strSql += " 	F_T_DateToString(A.EXPR_DT) EXPR_DT_GRP,   \n";
			...
			strSql += " 				--AND	      \n";
			strSql += " 				A.ACC_CODE In ('210010201','210010290')   \n";
			...
			strSql += " 		AND	A.ACC_CODE In ('210010201','210010290')   \n";
		...
		{			
			...
			strSql += " 	AND	b.ACC_CODE In ('210010201','210010290')   \n";
		...
		else if (strAct.equals("AUTO_BILL_RESET_SEQ"))
		{
			strSql  = " Select SQ_T_AUTO_BILL_RESET.NEXTVAL AUTO_BILL_RESET_SEQ From DUAL ";
