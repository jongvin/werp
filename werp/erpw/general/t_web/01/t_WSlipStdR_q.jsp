...
/**************************************************************************/
	...
	try
	{
		...
		else if (strAct.equals("BRAIN_SLIP_SEQ1"))
		{
			...
			strSql += ") \n";
			strSql += "ORDER BY TO_NUMBER(BRAIN_SLIP_SEQ1) \n";
		...
		else if (strAct.equals("BRAIN_SLIP_SEQ2"))
		{
			...
			strSql += ") \n";
			strSql += "ORDER BY TO_NUMBER(BRAIN_SLIP_SEQ2) \n";
		...
		else if (strAct.equals("BRAIN_SLIP_BODY"))
		{
			...
			strSql += "   			A.BRAIN_SLIP_SEQ2,   \n";
			strSql += "   			A.BRAIN_SLIP_LINE,   \n";
			strSql += " 			A.BRAIN_SORT_SEQ BRAIN_SORT_SEQ_ORG, \n";
			strSql += " 		   	ROWNUM BRAIN_SORT_SEQ,  \n";
			strSql += "   			A.ACC_CODE,   \n";
			...
			strSql += "   			A.SUMMARY2,  \n";
			strSql += "  			A.BRAIN_CLS, \n";
			strSql += " 			A.BRAIN_REPEAT_CLS, \n";
			strSql += " 			A.BRAIN_DEL_CLS \n";
			strSql += " 		FROM								  \n";
			strSql += " 	  	( \n";
			strSql += " 	  		SELECT \n";
			strSql += " 				1 join_rn, \n";
			strSql += " 	  			BRAIN_SLIP_SEQ1,   \n";
			strSql += " 	  			BRAIN_SLIP_SEQ2,   \n";
			strSql += " 	  			BRAIN_SLIP_LINE,   \n";
			strSql += " 	  			BRAIN_SORT_SEQ, \n";
			strSql += " 				CASE \n";
			strSql += " 					WHEN A.ACC_CODE LIKE '5310%' THEN \n";
			strSql += " 						( \n";
			strSql += " 							SELECT  \n";
			strSql += " 								Bi.ACC_CODE \n";
			strSql += " 							FROM \n";
			strSql += " 								T_MAIN_ACC_CODE Ai, \n";
			strSql += " 								T_CODE_KIND_ACC_CODE Bi \n";
			strSql += " 							WHERE \n";
			strSql += " 								Ai.MAIN_ACC_CODE = Bi.MAIN_ACC_CODE \n";
			strSql += " 								AND Bi.COST_DEPT_KND_TAG IN ( \n";
			strSql += " 									SELECT \n";
			strSql += " 										COST_DEPT_KND_TAG \n";
			strSql += " 									FROM \n";
			strSql += " 										T_DEPT_CODE \n";
			strSql += " 									WHERE \n";
			strSql += " 										DEPT_CODE =  ?  \n";
			strSql += " 								) \n";
			strSql += " 								AND Ai.MAIN_ACC_CODE = A.ACC_CODE \n";
			strSql += " 						) \n";
			strSql += " 					ELSE \n";
			strSql += " 						A.ACC_CODE \n";
			strSql += " 				END ACC_CODE, \n";
			...
			strSql += " 	  			SUMMARY2,  \n";
			strSql += " 	 			BRAIN_CLS, \n";
			strSql += " 				BRAIN_REPEAT_CLS, \n";
			strSql += " 				BRAIN_DEL_CLS  \n";
			strSql += " 	  		FROM   \n";
			...
			strSql += " 	 						BRAIN_CLS   \n";
			strSql += " 	 					FROM   \n";
			strSql += " 	 						T_ACC_VAT_CODE   \n";
			strSql += " 	 					WHERE   \n";
			strSql += " 	 						VAT_CODE =   ?     \n";
			strSql += " 	 				)  \n";
			strSql += " 	 			)  \n";
			strSql += " 	  			AND A.BRAIN_SORT_SEQ < 100 \n";
			strSql += " 	  		UNION ALL   \n";
			strSql += " 	  		SELECT \n";
			strSql += " 				1 join_rn, \n";
			strSql += " 	  			BRAIN_SLIP_SEQ1,   \n";
			...
			strSql += " 				CASE \n";
			strSql += " 					WHEN \n";
			strSql += " 						( ACC_CODE = '111221700' ) -- 선급부가세 세금계산서 \n";
			strSql += " 						OR \n";
			strSql += " 						( ACC_CODE = '111221800' ) -- 선급부가세 계산서 \n";
			strSql += " 						OR \n";
			strSql += " 						( ACC_CODE = '111220900' ) -- 선급부가세 법인카드 \n";
			strSql += " 						THEN \n";
			strSql += " 							CASE \n";
			strSql += " 								WHEN  ?  = '10' THEN '111221700'-- 선급부가세 세금계산서 \n";
			strSql += " 								WHEN  ?  = '20' THEN '111221800'-- 선급부가세 계산서 \n";
			strSql += " 								WHEN  ?  = '30' THEN '111220900'-- 선급부가세 법인카드 \n";
			strSql += " 								WHEN  ?  = '40' THEN NULL \n";
			strSql += " 								WHEN  ?  = '50' THEN NULL \n";
			strSql += " 							END \n";
			strSql += " 					WHEN \n";
			strSql += " 						( ACC_CODE = '210130100' ) -- 예수부가세 공사세금계산서 \n";
			strSql += " 						OR \n";
			strSql += " 						( ACC_CODE = '210130200' ) -- 예수부가세 공사계산서 \n";
			strSql += " 						THEN \n";
			strSql += " 							CASE \n";
			strSql += " 								WHEN  ?  = '10' THEN '210130100' \n";
			strSql += " 								WHEN  ?  = '20' THEN '210130200' \n";
			strSql += " 								WHEN  ?  = '30' THEN NULL \n";
			strSql += " 								WHEN  ?  = '40' THEN NULL \n";
			strSql += " 								WHEN  ?  = '50' THEN NULL \n";
			strSql += " 							END \n";
			strSql += " 					ELSE \n";
			...
			strSql += " WHERE   \n";
			strSql += " 	A.ACC_CODE = B.ACC_CODE(+) \n";
			strSql += " 	AND A.join_rn = C.RN(+)  \n";
			strSql += " ORDER BY \n";
			strSql += " 	A.BRAIN_SORT_SEQ ";
			
			lrArgData.addColumn("1DEPT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("2BRAIN_SLIP_SEQ1", CITData.VARCHAR2);
			lrArgData.addColumn("3BRAIN_SLIP_SEQ2", CITData.VARCHAR2);
			lrArgData.addColumn("4VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("5VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("6VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("7VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("8VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("9VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("10VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("11VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("12VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("13VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("14VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("15BRAIN_SLIP_SEQ1", CITData.VARCHAR2);
			lrArgData.addColumn("16BRAIN_SLIP_SEQ2", CITData.VARCHAR2);
			lrArgData.addColumn("17VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("18BRAIN_SLIP_SEQ1", CITData.VARCHAR2);
			lrArgData.addColumn("19BRAIN_SLIP_SEQ2", CITData.VARCHAR2);
			lrArgData.addColumn("20VAT_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("21VAT_CODE", CITData.VARCHAR2);
			lrArgData.addRow();
			lrArgData.setValue("1DEPT_CODE", strDEPT_CODE);
			lrArgData.setValue("2BRAIN_SLIP_SEQ1", strBRAIN_SLIP_SEQ1);
			lrArgData.setValue("3BRAIN_SLIP_SEQ2", strBRAIN_SLIP_SEQ2);
			lrArgData.setValue("4VAT_CODE", strVAT_CODE);
			lrArgData.setValue("5VAT_CODE", strVAT_CODE);
			lrArgData.setValue("6VAT_CODE", strVAT_CODE);
			lrArgData.setValue("7VAT_CODE", strVAT_CODE);
			lrArgData.setValue("8VAT_CODE", strVAT_CODE);
			lrArgData.setValue("9VAT_CODE", strVAT_CODE);
			lrArgData.setValue("10VAT_CODE", strVAT_CODE);
			lrArgData.setValue("11VAT_CODE", strVAT_CODE);
			lrArgData.setValue("12VAT_CODE", strVAT_CODE);
			lrArgData.setValue("13VAT_CODE", strVAT_CODE);
			lrArgData.setValue("14VAT_CODE", strVAT_CODE);
			lrArgData.setValue("15BRAIN_SLIP_SEQ1", strBRAIN_SLIP_SEQ1);
			lrArgData.setValue("16BRAIN_SLIP_SEQ2", strBRAIN_SLIP_SEQ2);
			lrArgData.setValue("17VAT_CODE", strVAT_CODE);
			lrArgData.setValue("18BRAIN_SLIP_SEQ1", strBRAIN_SLIP_SEQ1);
			lrArgData.setValue("19BRAIN_SLIP_SEQ2", strBRAIN_SLIP_SEQ2);
			lrArgData.setValue("20VAT_CODE", strVAT_CODE);
			lrArgData.setValue("21VAT_CODE", strVAT_CODE);
		...
		else if (strAct.equals("COST_DEPT_KND_ACC"))
		{
			String strDEPT_CODE = CITCommon.toKOR(request.getParameter("DEPT_CODE"));
			String strACC_CODE = CITCommon.toKOR(request.getParameter("ACC_CODE"));
			...
			strSql += " 		WHERE  \n";
			strSql += " 			AI.MAIN_ACC_CODE = BI.MAIN_ACC_CODE  \n";
			strSql += " 			AND BI.COST_DEPT_KND_TAG = ( \n";
			strSql += " 				-- 변경된 귀속부서의 원가현장구분을 구함 \n";
			strSql += " 				SELECT  \n";
			strSql += " 					COST_DEPT_KND_TAG  \n";
			strSql += " 				FROM  \n";
			strSql += " 					T_DEPT_CODE  \n";
			...
			strSql += " 					DEPT_CODE =  ?  \n";
			strSql += " 			)  \n";
			strSql += " 			AND AI.MAIN_ACC_CODE IN ( \n";
			strSql += " 				-- 귀속부서 변경전 세팅된 계정코드의 대표계정코드 구함 \n";
			strSql += " 				SELECT   \n";
			strSql += " 					DISTINCT MAIN_ACC_CODE \n";
			strSql += " 				FROM  \n";
			strSql += " 					T_CODE_KIND_ACC_CODE \n";
			strSql += " 				WHERE  \n";
			strSql += " 					ACC_CODE =  ?  \n";
			strSql += " 			) \n";
			strSql += " 	) A,    \n";
			...
			{
				if (GauceInfo == null) GauceInfo = new CITGauceInfo(request, response);
				GauceInfo.response.writeException("USER", "900001","COST_DEPT_KND_ACC Select 오류-> "+ ex.getMessage());
			}
		}
