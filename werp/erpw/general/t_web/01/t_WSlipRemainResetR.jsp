...
//파일명
	...
	String strFileName = "./t_WSlipRemainResetR";
...
//저장 액션
	...
	String strWORK_CODE = "0000000001";
...
<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsAUTO_REMAIN_RESET_SEQ classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__8); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
						...
						<!-- 간격조정 테이블 종료 //-->
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="font_green_bold"> 반제전표 생성 (※수표, 어음, CP, 차입, 유가증권 등은 대상에 포함되지 않습니다.)</td>
										<td align="right">
...
<FC> Name=작성전표번호 ID=MAKE_SLIPNOLINE Align=Left HeadAlign=Center  Width=110 Show='true' 	Edit='none'
</FC>
<FC> Name=계정명 ID=ACC_NAME Align=Left HeadAlign=Center  Width=100	BgColor='#FFFCE0' 	Edit='none'
</FC>
<C> Name=잔액 ID=ACC_REMAIN_POSITION_NAME Align=Left HeadAlign=Center  Width=35 Show='true' 	Edit='none' 	SumTextAlign=Center 	SumText='합        계 :'
</C>
