...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RBudgAssignByDeptByAccForYearR.jsp(부서별계정별월별현황(년))
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RBudgAssignByDeptByAccForYearR";
	String strPageName = "t_RBudgAssignByDeptByAccForYearR";
//저장 액션
							...
							<tr> 
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="60" class=font_green_bold>회기</td>
											<td width="52">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="60" class="font_green_bold" >상하반기</td>
											<td width="102">
												<select id="selDiv" style="width:100">
