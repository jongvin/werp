...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RBudgResultAmtR";
	String strPageName = "t_RBudgResultAmtR";
//저장 액션
										...
										<tr> 
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="80" class=font_green_bold>회기</td>
														<td width="52">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="80" class="font_green_bold" >조회월</td>
														<td width="272">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="80" class="font_green_bold" >출력구분</td>
														<td width="102">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="102">
															<select id="selAccFlag" style="width:100">
