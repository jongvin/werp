...
function Initialize()
{
	...
	cboSALEBUY_CLS.value = "2";
	cboRCPTBILL_CLS.value = "01";
	cboSUBTR_CLS.value = "1";
...
function OnExit(dataset, grid, row, colid, olddata)
{
	...
	else if(dataset == dsSUB01)
	{
		if(colid == "ACC_CODE" || colid == "ACC_NAME")
		{
			...
			{
				lrRet = C_AutoLov(dsLOV,"T_ACC_CODE19", lrArgs,"F");
			}
			else
			{
				lrRet = C_AutoLov(dsLOV,"T_ACC_CODE19", lrArgs,"T");
			}
...
function OnPopup(dataset, grid, row, colid, olddata)
{
	...
	else if(dataset == dsSUB01)
	{
		if(colid == "ACC_CODE" || colid == "ACC_NAME")
		{
			...
			lrRet = C_LOV("T_ACC_CODE19", lrArgs,"T");
