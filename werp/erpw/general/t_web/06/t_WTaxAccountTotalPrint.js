...
function Initialize()
{
	...
	G_addDataSet(dsLIST02_4, null, gridLIST02_4, null, "세금계산서 합계표 매입");
	G_addDataSet(dsLIST02_5, null, gridLIST02_5, null, "세금계산서 합계표 매입합계");

	G_addDataSet(dsLIST03_1, null, gridLIST03_1, null, "계산서 합계표(제출자)");
	//G_addDataSet(dsLIST03_2, null, gridLIST03_2, null, "계산서 합계표");
	G_addDataSet(dsLIST03_3, null, gridLIST03_3, null, "계산서 합계표 매출합계");
	G_addDataSet(dsLIST03_4, null, gridLIST03_4, null, "계산서 합계표 매출");
	G_addDataSet(dsLIST03_5, null, gridLIST03_5, null, "계산서 합계표 매입합계");
	G_addDataSet(dsLIST03_6, null, gridLIST03_6, null, "계산서 합계표 매입");
...
function OnLoadBefore(dataset)
{
	...
	else if (dataset == dsLIST02_4) {
		dataset.DataID = sSelectPageName + D_P1("ACT","LIST02_4")
										 + D_P2("COMP_CODE",txtCOMP_CODE.value)
										 + D_P2("TAX_YEAR",cboTAX_YEAR.value)
										 + D_P2("TAX_GI",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_GI"))
										 + D_P2("TAX_CONF",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_CONF"))
	...
	else if (dataset == dsLIST02_5) {
		dataset.DataID = sSelectPageName + D_P1("ACT","LIST02_5")
										 + D_P2("COMP_CODE",txtCOMP_CODE.value)
										 + D_P2("TAX_YEAR",cboTAX_YEAR.value)
										 + D_P2("TAX_GI",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_GI"))
										 + D_P2("TAX_CONF",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_CONF"))
	...
	else if (dataset == dsLIST03_1) {
		dataset.DataID = sSelectPageName + D_P1("ACT","LIST03_1")
										 + D_P2("COMP_CODE",txtCOMP_CODE.value)
										 + D_P2("TAX_YEAR",cboTAX_YEAR.value)
										 + D_P2("TAX_GI",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_GI"))
										 + D_P2("TAX_CONF",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_CONF"))
	...
	else if (dataset == dsLIST03_2) {
		dataset.DataID = sSelectPageName + D_P1("ACT","LIST03_2")
										 + D_P2("COMP_CODE",txtCOMP_CODE.value)
										 + D_P2("TAX_YEAR",cboTAX_YEAR.value)
										 + D_P2("TAX_GI",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_GI"))
										 + D_P2("TAX_CONF",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_CONF"))
	...
	else if (dataset == dsLIST03_3) {
		dataset.DataID = sSelectPageName + D_P1("ACT","LIST03_3")
										 + D_P2("COMP_CODE",txtCOMP_CODE.value)
										 + D_P2("TAX_YEAR",cboTAX_YEAR.value)
										 + D_P2("TAX_GI",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_GI"))
										 + D_P2("TAX_CONF",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_CONF"))
	...
	else if (dataset == dsLIST03_4) {
		dataset.DataID = sSelectPageName + D_P1("ACT","LIST03_4")
										 + D_P2("COMP_CODE",txtCOMP_CODE.value)
										 + D_P2("TAX_YEAR",cboTAX_YEAR.value)
										 + D_P2("TAX_GI",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_GI"))
										 + D_P2("TAX_CONF",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_CONF"))
	...
	else if (dataset == dsLIST03_5) {
		dataset.DataID = sSelectPageName + D_P1("ACT","LIST03_5")
										 + D_P2("COMP_CODE",txtCOMP_CODE.value)
										 + D_P2("TAX_YEAR",cboTAX_YEAR.value)
										 + D_P2("TAX_GI",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_GI"))
										 + D_P2("TAX_CONF",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_CONF"))
	...
	else if (dataset == dsLIST03_6) {
		dataset.DataID = sSelectPageName + D_P1("ACT","LIST03_6")
										 + D_P2("COMP_CODE",txtCOMP_CODE.value)
										 + D_P2("TAX_YEAR",cboTAX_YEAR.value)
										 + D_P2("TAX_GI",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_GI"))
										 + D_P2("TAX_CONF",dsMAIN.NameString(dsMAIN.RowPosition,"TAX_CONF"))
...
function selectTab(index, totcount)
{
	...
	{
	case 1:
			document.all.gridLIST02_2.style.display = '';
			document.all.gridLIST02_3.style.display = '';
			document.all.gridLIST02_4.style.display = 'none';
			document.all.gridLIST02_5.style.display = 'none';
			break;
	case 2:
			document.all.gridLIST02_2.style.display = 'none';
			document.all.gridLIST02_3.style.display = 'none';
			document.all.gridLIST02_4.style.display = '';
			document.all.gridLIST02_5.style.display = '';
			break;
	case 3:
			document.all.gridLIST03_3.style.display = '';
			document.all.gridLIST03_4.style.display = '';
			document.all.gridLIST03_5.style.display = 'none';
			document.all.gridLIST03_6.style.display = 'none';
			break;
	case 4:
			document.all.gridLIST03_3.style.display = 'none';
			document.all.gridLIST03_4.style.display = 'none';
			document.all.gridLIST03_5.style.display = '';
			document.all.gridLIST03_6.style.display = '';
			break;
	}
}
...
function btnquery_onclick()
{
	...
	if(cboRCPTBILL_CLS.value=="01"){
		G_Load(dsLIST02_1, null);
		G_Load(dsLIST02_2, null);
		G_Load(dsLIST02_3, null);
		G_Load(dsLIST02_4, null);
		G_Load(dsLIST02_5, null);
		divMain01.style.display = "";
		divMain02.style.display = "none";
		selectTab(1, 4);
	} else if(cboRCPTBILL_CLS.value=="02"){
		G_Load(dsLIST03_1, null);
		G_Load(dsLIST03_2, null);
		G_Load(dsLIST03_3, null);
		G_Load(dsLIST03_4, null);
		G_Load(dsLIST03_5, null);
		G_Load(dsLIST03_6, null);
		divMain01.style.display = "none";
		divMain02.style.display = "";
		selectTab(3, 4);
	}
}
...
function OnDblClick(dataset, grid, row, colid) {
	...
	var lsURL = "./t_WTaxAccountTotalDetailR.jsp";
	lrArgs.opener		= window;

	if(dataset == dsLIST02_2) // 세금계산서 합계표 매출
	{
		lrArgs.SALEBUY_CLS	= "1";
		lrArgs.CUST_CODE	= dataset.NameString(dataset.RowPosition,"e4");
	}
	else if(dataset == dsLIST02_4) // 세금계산서 합계표 매입
	{
		lrArgs.SALEBUY_CLS	= "2";
		lrArgs.CUST_CODE	= dataset.NameString(dataset.RowPosition,"e4");
	}
	else if(dataset == dsLIST03_4) // 세금계산서 합계표 매출
	{
		lrArgs.SALEBUY_CLS	= "1";
		lrArgs.CUST_CODE	= dataset.NameString(dataset.RowPosition,"e8");
	}
	else if(dataset == dsLIST03_6) // 세금계산서 합계표 매입
	{
		lrArgs.SALEBUY_CLS	= "2";
		lrArgs.CUST_CODE	= dataset.NameString(dataset.RowPosition,"e8");
	}

	if(lrArgs.CUST_CODE!=null) {
		var lrRet = null;
