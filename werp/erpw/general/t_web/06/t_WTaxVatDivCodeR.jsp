...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WTaxVatDivCodeR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 안분분류코드</td>
...
<C> Name=사업장 		ID=DIV_COMP_CODE	Align=Left	 Width=250   	Show='false'
</C>
<C> Name=안분분류코드 	ID=DIV_CODE			Align=Left	 Width=100   	Show='true'
</C>
<C> Name=안분분류명칭 	ID=DIV_NAME			Align=Left	 Width=200   	Show='true'
</C>
<C> Name=안분비율 		ID=DIV_RATIO		Align=Center  Width=100	Show='false' edit='none' BgColor='#E0F4FF'
</C>
<C> Name='비    고' 	ID=REMARKS		Align=Left	 Width=400   	 	Show='true'
</C>
<C> Name=본사구분		ID=MAIN_TAG		Align=Center	 Width=60		EditStyle=CheckBox	Show='true'
</C>
<C> Name=선택 			ID=USE_TAG		Align=Center	 Width=60		EditStyle=CheckBox	Show='true'
</C>
											">
							...
							<tr>
								<td width="50%">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold"> 부서/현장</td>
											<td align="right" width="*">
												&nbsp;
											</td>
										</tr>
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE=" 
<C> Name=사업장 ID=COMPANY_NAME Align=Left HeadAlign=Center  Width=120 Show=False
</C>
<C> Name='부가세안분코드' ID=DIV_CODE Align=Center HeadAlign=Center  Width=120 Sort=true edit=none Show=False
</C>
<FC> Name='부서/현장코드' ID=DIV_DEPT_CODE Align=Left HeadAlign=Center  Width=120 Sort=true edit=none BgColor='#E0F4FF'
</FC>
<FC> Name='부서/현장명' ID=DIV_DEPT_NAME Align=Left HeadAlign=Center  Width=250 edit=none	BgColor='#E0F4FF'
</FC>
														">
