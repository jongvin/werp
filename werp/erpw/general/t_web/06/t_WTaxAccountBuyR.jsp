...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WTaxAccountBuyR";
	String strFileName01 = "t_WTaxAccountBuyR";
...
//저장 액션
	...
	try
	{
		...
		try
		{
			...
			strSql += "	A.DIV_NAME \n";
			strSql += "FROM  \n";
			strSql += "	T_ACC_VAT_DIV_CODE A \n";
			strSql += "WHERE  \n";
			strSql += "	NVL(A.MAIN_TAG, ' ') = 'T' \n";
			...
			if(lrReturnData.getRowsCount() >= 1)
			{
				strDIV_CODE = lrReturnData.toString(0,"DIV_CODE");
				strDIV_NAME = lrReturnData.toString(0,"DIV_NAME");
			}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="112"><input id="txtDIV_CODE" 	type="text" value="<%=strDIV_CODE%>" style="width:110px" onblur="txtDIV_CODE_onblur()"></td>
		<td width="161">
			<input id="txtDIV_NAME" type="text" value="<%=strDIV_NAME%>" readOnly left class="ro" style="width:159px">
		</td>
		<td width="40">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="60">
			<select id="cboSALEBUY_CLS" disabled style="WIDTH: 60px" tabindex="-1" class="input_listbox_default" onchange="gridSUB01.focus();btnquery_onclick();">
			<option value='%'>전  체</option>
			<%=cboSALEBUY_CLS%>
			</select>
		</td>
		...
		<td width="130">
			<select id="cboRCPTBILL_CLS" disabled style="WIDTH: 130px" tabindex="-1" class="input_listbox_default">\
			<option value='%'>전  체</option>
			<%=cboRCPTBILL_CLS%>
			</select>
		</td>
		...
		<td width="60">
			<select id="cboSUBTR_CLS" disabled style="WIDTH: 60px" tabindex="-1" class="input_listbox_default">
			<option value='%'>전  체</option>
			<%=cboSUBTR_CLS%>
			</select>
		</td>
...
<C> Name=계산서구분 		ID=RCPTBILL_CLS		Align=Center	Width=80	Show='false'	Edit='None'		EditStyle='Combo' Data='<%=strRCPTBILL_CLS%>'
</C>
<C> Name='매입/매출' 		ID=SALEBUY_CLS		Align=Center	Width=80   	Show='false'	Edit='None'		EditStyle='Combo' Data='<%=strSALEBUY_CLS%>'
</C>
