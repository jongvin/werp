...
txtTAX_YEAR.value		= lrArgs.opener.cboTAX_YEAR.value;
txtTAX_GI.value			= lrArgs.opener.dsMAIN.NameString(dsMAIN.RowPosition,"TAX_GI");
txtTAX_CONF.value		= lrArgs.opener.dsMAIN.NameString(dsMAIN.RowPosition,"TAX_CONF");
txtRCPTBILL_CLS.value	= lrArgs.opener.cboRCPTBILL_CLS.value;
txtSALEBUY_CLS.value	= lrArgs.SALEBUY_CLS;
txtCUST_CODE.value		= lrArgs.CUST_CODE;
...
function OnLoadBefore(dataset)
{
	if (dataset == dsMAIN)	//시스템명 가져오기
	{
		dataset.DataID = sSelectPageName	+ D_P1("ACT","MAIN")
											...
											+ D_P2("TAX_YEAR",txtTAX_YEAR.value)
											+ D_P2("TAX_GI",txtTAX_GI.value)
											+ D_P2("TAX_CONF",txtTAX_CONF.value)
											+ D_P2("RCPTBILL_CLS",txtRCPTBILL_CLS.value)
											+ D_P2("SALEBUY_CLS",txtSALEBUY_CLS.value)
