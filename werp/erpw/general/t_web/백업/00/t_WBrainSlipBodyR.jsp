...
<html>
	<head>
		...
		<object id=dsSEQ classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object>
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="170">
												<object id=cboBRAIN_SLIP_SEQ1 width=160 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
											...
											<td width="*">
												<object id=cboBRAIN_SLIP_SEQ2 width=160 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
													<PARAM NAME="ComboStyle" VALUE="5">
