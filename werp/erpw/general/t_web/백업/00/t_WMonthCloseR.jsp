...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WMonthCloseR.jsp(월마감등록)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WMonthCloseR";
//저장 액션
...
<html>
	<head>
		...
		<object id=dsCLSE_ACC_ID classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object>
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="55" class="font_green_bold" >회기년도</td>
											<td width="*">
												<object id=cboCLSE_ACC_ID width=100 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
							...
							<tr>
								<td width="440">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 월마감</td>
								...
								<td width="*">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold"> 일마감</td>
											<td align="right" width="*">
												&nbsp;
											</td>
										</tr>
							...
							<tr>
								<td width="440" height="100%">
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<FC> Name=마감월 ID=CLSE_MONTH Align=Center Width=80 Mask='XXXX-XX'
												Edit='Numeric' EditLimit=8
												Edit='none' 
											</FC> 
											<FC> Name=마감구분 ID=CLSE_CLS EditStyle=checkbox Align=Center Width=80
											</FC> 
											<C> Name=마감일 ID=CLSE_DT Width=100
												Edit='none'
											</C>
								...
								<td width="*">
									<OBJECT id=gridLIST WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="ColSizing" VALUE="-1">
										<PARAM NAME="Format" VALUE=" 
											<FC> Name=마감일 ID=CLSE_DAY  
												Edit='none' Align=Center Width=100 
											</FC> 
											<FC> Name=마감구분 ID=CLSE_CLS EditStyle=checkbox Width=80 
											</FC>
