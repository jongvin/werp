...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WAccCodeAccnoR";
//저장 액션
...
<html>
	<head>
		...
		<object id="dsVAT_GRP" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object>
		<object id="dsSUBTR_CLS" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object>
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="*" class="font_green_bold"> 계정별기본계좌등록</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr class="head_line">
...
<C> Name='계  정  명'	ID='ACC_NAME'	Width=195		Edit='none'	BgColor='#ECF5EB'
</C>
<C> Name=계좌번호		ID=ACCNO Width=135				EditStyle=popup
</C> 
<C> Name=계좌명			ID=ACCT_NAME Width=150			Edit='none'	BgColor='#ECF5EB'
</C> 
<C> Name=은행명			ID=BANK_NAME Width=200			Edit=none	BgColor='#ECF5EB'
</C> 
											">
									</OBJECT>
								</td>
