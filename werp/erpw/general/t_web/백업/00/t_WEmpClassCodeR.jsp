...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WEmpClassCodeR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 인사부문코드목록</td>
								...
								<td width="100%" height="100%">
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=인사부문코드 ID=EMP_CLASS_CODE Align=Center Width=120 
											</FC> 
											<C> Name=인사부문코드명 ID=EMP_CLASS_NAME Width=240
											</C> 
