...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBrainSlipR.jsp(전표_표준적요_대분류등록)
/* 2. 유형(시나리오) : shared window 조회 및 입력
/* 3. 기  능  정  의 : 프로그램 설명
/* 4. 변  경  이  력 : 한재원 작성(2003-12-06)
							...
							<tr>
								<td width="440">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 표준적요대분류</td>
								...
								<td width="*">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold"> 표준적요중분류</td>
							...
							<tr>
								<td width="440" height="100%">
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=대분류코드 ID=BRAIN_SLIP_SEQ1 Width=120 show=false
											</C>
											<C> Name=대분류명   ID=BRAIN_SLIP_NAME1 Width=400
											</C>
											">
									</OBJECT>
								</td>
								...
								<td width="*">
									<OBJECT id=gridLIST WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="ColSizing" VALUE="-1">
										<PARAM NAME="Format" VALUE="
											<C> Name=대분류코드 ID=BRAIN_SLIP_SEQ1 Width=115 show=false
											</C>
											<C> Name=중분류코드 ID=BRAIN_SLIP_SEQ2 Width=120 show=false
											</C>
											<C> Name=중분류명 ID=BRAIN_SLIP_NAME2 Width=420
											</C>
											<C> Name=사용여부 ID=USE_CLS Width=80 EditStyle=Checkbox
											</C>
											">
									</OBJECT>
								</td>
