								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="*" class="font_green_bold"> 부가세코드목록</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr class="head_line">
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<FC> Name='부가세코드'		ID='VAT_CODE'		Align=Center	Width=95
											</FC>
											<FC> Name='부가세명칭'		ID='VAT_NAME'		Width=220
											</FC>
											<C> Name='계산서종류'		ID='RCPTBILL_CLS'	Editlimit=4 EditStyle=Combo	Data='<%=strRCPTBILL_CLS%>' Width=110 Show='false'
											</C>
											<C> Name='공제구분'			ID='SUBTR_CLS'		EditStyle=Combo	Data='<%=strSUBTR_CLS%>' Width=70 Show='false'
											</C>
											<C> Name='매출입구분'		ID='SALEBUY_CLS'	EditStyle=Combo	Data='<%=strSALEBUY_CLS%>' Width=70 Show='false'
											</C>
											<C> Name='부가세발생여부'	ID='VATOCCUR_CLS'	Align=Center	EditStyle=CheckBox	Width=100 Show='false'
											</C>
											<C> Name='부가세계정'		ID='ACC_CODE'		Align=Center	EditStyle=popup	Width=90 Show='true'
											</C>
											<C> Name='계  정  명'		ID='ACC_NAME'		Width=195	Edit='none' Show='true'
											</C>
