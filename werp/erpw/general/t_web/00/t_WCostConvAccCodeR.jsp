											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 원가대체 계정구분</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE=" 
														<C> Name=구분코드 ID=COST_CONV_CODE Align=Center Width=120 
														</C> 
														<C> Name=구분명 ID=COST_CONV_NAME Width=300
														</C> 
														<C> Name=매출액계정코드 ID=SALE_ACC_CODE Align=Center Width=120
														</C> 
														<C> Name=매출액계정명 ID=ACC_NAME Width=300
														</C> 
										...
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 원가대체 계정정의목록</td>
														<td align="right" width="*">
															&nbsp;
														</td>
													</tr>
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE=" 
														<FG> Name='원가계정' ID=G1
															<C> Name=계정코드 ID=ACC_CODE Align=Center Width=100 
															</C> 
															<C> Name=계정명 ID=ACC_NAME_COST Width=200
															</C> 
														</FG>
														<G> Name='대체(매출원가)계정' ID=G2
															<C> Name=계정코드 ID=R_ACC_CODE Align=Center Width=100
															</C> 
															<C> Name=계정명 ID=ACC_NAME_CONV Width=200
															</C> 
														</G>
														<G> Name='대체(미완성)계정' ID=G3
															<C> Name=건물계정코드 ID=R_ACC_CODE2 Align=Center Width=100
															</C> 
															<C> Name=건물계정명 ID=ACC_NAME_CONV2 Width=200
															</C> 
															<C> Name=토지계정코드 ID=R_ACC_CODE3 Align=Center Width=100
															</C> 
															<C> Name=토지계정명 ID=ACC_NAME_CONV3 Width=200
															</C> 
														</G>
														<G> Name='대체(완성)계정' ID=G4
															<C> Name=건물계정코드 ID=R_ACC_CODE4 Align=Center Width=100
															</C> 
															<C> Name=건물계정명 ID=ACC_NAME_CONV4 Width=200
															</C> 
															<C> Name=토지계정코드 ID=R_ACC_CODE5 Align=Center Width=100
															</C> 
															<C> Name=토지계정명 ID=ACC_NAME_CONV5 Width=200
															</C> 
														</G>
														">
