...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__2"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsINFO classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
													...
													<tr>
														...
														<td width="100">
															<SELECT id="cboTAG" style="WIDTH: 80px">
																...
																<OPTION VALUE='2'>진행현장 </OPTION>
																<OPTION VALUE='3'>마감현장 </OPTION>
															</SELECT>
														</td>
														<td>&nbsp; </td>
													</tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td align="right" width="*">
												<input id="btnSetInfo3" type="button" tabindex="-1" class="img_btn16_1" onClick="btnSetInfo3_onClick()" 	value="선택 현장 최초 도급/실행반영" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
												<input id="btnSetInfo4" type="button" tabindex="-1" class="img_btn14_1" onClick="btnSetInfo4_onClick()" 	value="전 현장 최초 도급/실행반영" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
											</td>
										</tr>
										<tr>
											<td width="15" height="20">&nbsp;</td>
											<td class="font_green_bold"> &nbsp;</td>
											<td align="right" width="*">
												<input id="btnSetInfo" type="button" tabindex="-1" class="img_btn14_1" onClick="btnSetInfo_onClick()" 	value="선택 현장 도급/실행반영" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
												<input id="btnSetInfo2" type="button" tabindex="-1" class="img_btn12_1" onClick="btnSetInfo2_onClick()" 	value="전 현장 도급/실행반영" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
										...
										<tr>
											...
											<td align="right" width="*">
												<input id="btnSetInfoCost1" type="button" tabindex="-1" class="img_btn12_1" onClick="btnSetInfoCost1_onClick()" 	value="선택 현장 추정원가반영" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
												<input id="btnSetInfoCost2" type="button" tabindex="-1" class="img_btn10_1" onClick="btnSetInfoCost2_onClick()" 	value="전 현장 추정원가반영" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
												<input id="btnSetInfoHist2" type="button" tabindex="-1" class="img_btn8_1" onClick="btnSetInfoHist2_onClick()" 	value="추정원가변경이력" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<C> Name=최초도급금액 ID=F_CONS_AMT  Width=100 </C>
<C> Name=최초실행금액 ID=F_BUDG_AMT  Width=100 </C>
...
<C> Name=추정원가 ID=COST_GUESS_AMT  Width=100 </C>
