...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WEmpAccNoR.jsp(사원별계좌)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WEmpAccNoR";
//저장 액션
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="80" class=font_green_bold>사번/성명</td>
														<td width="200">
															<input id="txtNAME" type="text" style="width:150px" >
														</td>
														<td>&nbsp; </td>
													</tr>
												</table>
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 사원계좌목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__3"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=사번 ID=ERMP_NO Align=Center   Width=70
											</C>
											<C> Name=성명 ID=NAME Align=Center   Width=100
											</C>
											<G> Name='경비입금' ID=G2
												<C> Name=은행 ID=IN_BANK_MAIN_CODE_2 Align=Center   Width=180  EditStyle=Combo Data='<%=strBANK_MAIN_G%>'
												</C>
												<C> Name=계좌 ID=IN_ACC_NO_2 Align=Center   Width=160
												</C>
											</G>
											<G> Name='급여계좌' ID=G3
												<C> Name=은행 ID=BANKCD Align=Center   Width=180  EditStyle=Combo Data='<%=strBANK_MAIN_G%>' 
												</C>
												<C> Name=계좌 ID=BANKNO Align=Center   Width=160
												</C>
											</G>
											<C> Name=주민번호 ID=RESNO_DISP Align=Center   Width=100
											</C>
											">
