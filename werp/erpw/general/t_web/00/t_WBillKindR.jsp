...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBillKindR.jsp(어음종류등록)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBillKindR";
//저장 액션
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 어음종류목록(지급/기업)</td>
														<td align="right" width="*">
															※기업어음처럼 어음 및 차입으로 동시 관리되는 것은 관련 차입을 선택하여 주십시오.
														</td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<C> Name=현장구분 ID=BILL_KIND Align=Center Width=60
														</C>
														<C> Name=어음종류명 ID=BILL_NAME Align=Left  Width=260
														</C>
														<C> Name='관련차입(기업어음)' ID=REL_LOAN_KIND_CODE	 EditStyle=Combo Data='<%=strCombo%>' Align=Left Width=240
														</C>
														">
										...
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 현장구분별계정코드</td>
														<td align="right" width="*">
															&nbsp;
														</td>
													</tr>
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="ColSizing" VALUE="-1">
													<PARAM NAME="Format" VALUE="
														<C> Name='부서/현장구분' ID=COST_DEPT_KND_TAG	 EditStyle=Combo Data='<%=strCombo2%>' Align=Left Width=240
														</C>
														<C> Name=차입계정코드 ID=ACC_CODE Align=Center Width=100
														</C>
														<C> Name=차입계정명 ID=ACC_NAME Align=Left  Width=260
														</C>
														">
