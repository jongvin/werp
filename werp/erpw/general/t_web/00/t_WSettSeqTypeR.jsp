...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WSettSeqTypeR.jsp(재무제표순번형식)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSettSeqTypeR";
//저장 액션
											...
											<td>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 재무제표순번형식</td>
											...
											<td height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT >
													...
													<PARAM NAME="Format" VALUE="
														<C> Name=코드 ID=SEQ_TYPE Align=Center  Width=50
														</C>
														<C> Name=순번형식명 ID='SEQ_TYPE_NAME' Align=Left  Width=300
														</C>
														">
									...
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 재무제표순번목록</td>
														<td align="right" width="*">
															&nbsp;
														</td>
													</tr>
										...
										<tr>
											<td height="100%" width="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT >
													<PARAM NAME="Editable" VALUE="-1">
													<PARAM NAME="ColSelect" VALUE="-1">
													<PARAM NAME="ColSizing" VALUE="-1">
													<PARAM NAME="Format" VALUE="
														<C> Name=순번 ID=SEQ_SEQ Align=Center  Width=50
														</C>
														<C> Name=출력순번 ID='SEQ_TYPE_NAME' Align=Left  Width=160
														</C>
														">
