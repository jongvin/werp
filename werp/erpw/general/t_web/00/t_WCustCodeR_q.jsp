...
/**************************************************************************/
	...
	try
	{
		...
		else if (strAct.equals("ACCT"))
		{
			...
			{
				if (GauceInfo == null) GauceInfo = new CITGauceInfo(request, response);
				GauceInfo.response.writeException("USER", "900001","f_retrive_acct_holder_name Select 오류-> "+ ex.getMessage());
			}
		}
		else if (strAct.equals("BILL_VENDOR"))
		{
			...
			{
				if (GauceInfo == null) GauceInfo = new CITGauceInfo(request, response);
				GauceInfo.response.writeException("USER", "900001","BILL_VENDOR Select 오류-> "+ ex.getMessage());
			}
		}
	}
	catch (Exception ex)
