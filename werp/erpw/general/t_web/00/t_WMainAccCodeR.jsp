...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WMainAccCodeR.jsp(부서현장구분별계정설정)
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__1"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsCOST_DEPT_KIND" classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
					...
					<td width="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="font_green_bold">대표계정 목록</td>
								<td align="right">
								</td>
							</tr>
						</table>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=대표계정코드 ID=MAIN_ACC_CODE Width=120
											</C>
							...
							<tr>
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold"> 부서현장구분별 계정</td>
											<td align="right" width="*">
												<input name="btnAddAll" type="button" class="img_btn8_1" onclick="btnAddAll_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"value="대표계정일괄등록" />
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="ColSizing" VALUE="-1">
										<PARAM NAME="Format" VALUE=" 
											<C> Name=부서현장구분 ID='COST_DEPT_KND_TAG' EditStyle=Lookup Data='dsCOST_DEPT_KIND:COST_DEPT_KND_TAG:COST_DEPT_KND_NAME' Width=160
											</C>
											<C> Name=부서현장구분별계정코드 ID=ACC_CODE Width=160
											</C>
											<C> Name=부서현장별계정명 ID='ACC_NAME' Width=300
											</C>
											">
