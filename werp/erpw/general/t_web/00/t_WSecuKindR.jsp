...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WSecuKindR.jsp(유가증권종류등록)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSecuKindR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 유가증권종류목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<FC> Name='코드' ID=SEC_KIND_CODE Align=Center Width=50
											</FC>
											<FC> Name=유가증권종류명 ID=SEC_KIND_NAME Align=Left  Width=160
											</FC>
											<C> Name='유가증권계정' ID=SEC_ACC_CODE	Align=Center Width=90
											</C>
											<C> Name='유가증권계정명' ID=SEC_ACC_CODE_NAME	Align=Left Width=160
											</C>
											<C> Name='이자수익계정' ID=ITRP_ACC_CODE	Align=Center Width=90
											</C>
											<C> Name='이자수익계정명' ID=ITRP_ACC_CODE_NAME	Align=Left Width=160
											</C>
											<C> Name='미수이자계정' ID=ITRB_ACC_CODE	Align=Center Width=90
											</C>
											<C> Name='미수이자계정명' ID=ITRB_ACC_CODE_NAME	Align=Left Width=160
											</C>
											">
