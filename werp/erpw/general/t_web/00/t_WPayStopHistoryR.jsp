...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WPayStopHistoryR_q.jsp(지불거래정지HISTORY)
/* 2. 유형(시나리오) : shared window 조회 및 입력
/* 3. 기  능  정  의 : 지불거래정지HISTORY를 등록,조회 
/* 4. 변  경  이  력 : 한재원 작성(2003-11-24)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPayStopHistoryR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 지불거래정지HISTORY</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<FC> Name=거래처코드 ID=CUST_CODE Align=Center Width=80 show=true EditStyle=Popup
											</FC>
											<FC> Name=거래처명   ID=CUST_NAME Align=left Width=250 show=true  EditStyle=Popup
											</FC>
											<C> Name=순번 ID=PAY_STOP_SEQ Align=Center Width=150 show=false 
											</C> 
											<C> Name=구분 ID=PAY_STOP_CLS Width=65 EditStyle=Combo Data='<%=strPAY_STOP_CLS%>' 
											</C> 
											<C> Name=지불정지시작일  ID=PAY_STOPSTR_DT  EditStyle=Popup Width=95 align=center
											</C> 
											<C> Name=지불정지종료일  ID=PAY_STOPEND_DT EditStyle=Popup Width=95 align=center
											</C>
											<C> Name=정지금액 ID=PAY_STOP_AMT Width=120 
											</C> 
											<C> Name=지불정지현장 ID=DEPT_NAME EditStyle=Popup Width=200
											</C> 
											<C> Name=지불정지사유 ID=PAY_STOPSTR_MEMO Width=250
											</C>
											<C> Name=지불정지해제사유 ID=PAY_STOPEND_MEMO Width=250 
											</C> 
