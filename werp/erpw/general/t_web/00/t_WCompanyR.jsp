	...
	<body onload="C_Initialize()">
										...
										<tr>
											...
											<td width="400" height="100%" valign="top" onActivate="G_focusDataset(dsMAIN)">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="100">부가세환급금계좌</td>
														<td width="150"><input id="txtVAT_RETURN_ACCNO" type="text" readOnly class="ro" style="width:148px"></td>
														<td width="*"><input id="btntxtVAT_RETURN_ACCNO" type="button" class="img_btnFind_S" title="계좌찾기" onclick="btntxtVAT_RETURN_ACCNO_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"></td>
													</tr>
												</table>
											</td>
										</tr>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=ADE_Bind_1 style="Z-INDEX: 107; LEFT: 335px; POSITION: absolute; TOP: 158px" classid=clsid:9C9AB433-EA85-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbbind.cab#version=1,1,0,13">
			...
			<PARAM NAME="BindInfo" VALUE="
				...
				<C> Col=VAT_RETURN_ACCNO 		Ctrl=txtVAT_RETURN_ACCNO 			Param=value</C>
			">
