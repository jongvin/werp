								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 공제계정목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<FC> Name=공제코드 ID=SUDANGCD Align=Center Width=70
											</FC> 
											<FC> Name=공제명 ID=HNAME Width=160
											</FC> 
											<C> Name='전표발행대상?' ID=INCLUDE_TAG Width=90 EditStyle=CheckBox
											</C> 
											<G> Name='일반계정' ID=G1
												<C> Name=계정코드 ID=ACC_CODE Width=90
												</C> 
												<C> Name=계정명 ID=ACC_NAME_1 Width=220
												</C> 
											</G>
											<G> Name='안전관리계정' ID=G2
												<C> Name=계정코드 ID=ACC_CODE2 Width=90
												</C> 
												<C> Name=계정명 ID=ACC_NAME_2 Width=220
												</C> 
											</G>
											">
