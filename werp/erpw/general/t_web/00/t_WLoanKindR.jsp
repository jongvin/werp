...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WLoanKindR.jsp(차입종류등록)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WLoanKindR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 차입종류목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<FC> Name=코드 ID=LOAN_KIND_CODE Align=Center Width=60
											</FC>
											<FC> Name=차입종류명 ID=LOAN_KIND_NAME Align=Left  Width=160
											</FC>
											<C> Name='구분' ID=LOAN_TAG	Align=Center Width=60 EditStyle=Combo Data='1:단기,2:장기'
											</C>
											<C> Name='차입계정코드' ID=LOAN_ACC_CODE	Align=Center Width=90
											</C>
											<C> Name='차입계정명' ID=LOAN_ACC_CODE_NAME	Align=Left Width=160
											</C>
											<C> Name='이자계정코드' ID=ITR_ACC_CODE	Align=Center Width=90
											</C>
											<C> Name='이자계정명' ID=ITR_ACC_CODE_NAME	Align=Left Width=160
											</C>
											<C> Name='선급이자계정코드' ID=PE_ITR_ACC_CODE	Align=Center Width=110
											</C>
											<C> Name='선급이자계정명' ID=PE_ITR_ACC_CODE_NAME	Align=Left Width=160
											</C>
											<C> Name='미지급이자계정코드' ID=AE_ITR_ACC_CODE	Align=Center Width=120
											</C>
											<C> Name='미지급이자계정명' ID=AE_ITR_ACC_CODE_NAME	Align=Left Width=160
											</C>
											">
