...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WPlanDeptR(경영계획회기별현장관리)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPlanDeptR";
//저장 액션
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="120" class=font_green_bold>부서/현장구분</td>
														<td width="52">
															<select  id="cboDEPT_PROJ_TAG"  style="WIDTH: 70px" >
																<OPTION value='%'> 전체</OPTION>
																<OPTION value='P'> 현장</OPTION>
																<OPTION value='H'> 부서</OPTION>
															</select>
														</td>
														<td>&nbsp; </td>
													</tr>
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 당 회기에 관리되는 현장</td>
										...
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 현장 및 미확정 현장 목록</td>
														<td align="right" width="*">
															&nbsp;
														</td>
													</tr>
