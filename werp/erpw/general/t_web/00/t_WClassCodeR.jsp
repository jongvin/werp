...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WClassCodeR.jsp(부문코드 등록)
/* 2. 유형(시나리오) : shared window 조회 및 입력
/* 3. 기  능  정  의 : 부문코드 등록 조회
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WClassCodeR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 부문코드목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__3"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=부문코드 ID=CLASS_CODE Align=Center Width=120 
											</FC> 
											<C> Name=부문코드명 ID=CLASS_CODE_NAME Width=240
											</C> 
											<C> Name=사용구분 ID=USE_CLS Width=80 EditStyle=Checkbox
											</C> 
