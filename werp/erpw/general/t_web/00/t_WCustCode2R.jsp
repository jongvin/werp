...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WCustCode2R";
	String strPageName = "t_WCustCode2R";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsCUST_PAYSTOP_SEQ classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
	...
	<body onload="C_Initialize()">
					...
					<td width="100%" height="100%">
						...
						<table width="100%"  height="530" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="515" height="100%" onActivate="G_focusDataset(dsMAIN)" valign=top>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="10">&nbsp;</td>
		...
		<!-- 가우스 Bind 객체정의 시작 //-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=ADE_Bind_1 classid=clsid:9C9AB433-EA85-11D2-A4F9-00608CEBEE49 VIEWASTEXT >
			<PARAM NAME="DataID" VALUE="dsMAIN">
