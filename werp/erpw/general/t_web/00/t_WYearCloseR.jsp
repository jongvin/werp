...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WYearCloseR.jsp(회기등록)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WYearCloseR";
//저장 액션
					...
					<td width="100%" height="100%">
						<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="*">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold">사업장별 회기</td>
											<td align="right" width="*">
												&nbsp;
											</td>
										</tr>
							...
							<tr>
								<td width="320" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<C> Name=사업장명 ID=COMPANY_NAME Width=180
											</C> 
											">
								...
								<td width="10"></td>
								<td width="*">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridLIST WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										<PARAM NAME="DataID" VALUE="dsLIST">
										<PARAM NAME="Editable" VALUE="-1">
										<PARAM NAME="ColSelect" VALUE="true">
										<PARAM NAME="ColSizing" VALUE="-1">
										<PARAM NAME="Format" VALUE=" 
											<C> Name=회기년도 ID=CLSE_ACC_ID EditLimit=4 Align=Center Width=80 
											</C> 
											<C> Name=회기  ID=ACC_ID Align=Center Width=60 
											</C>
											<C> Name=회기시작일 ID=ACCOUNT_FDT Align=Center Width=90 EditStyle=Popup
											</C> 
											<C> Name=회기종료일 ID=ACCOUNT_EDT Align=Center Width=90 EditStyle=Popup
											</C> 
											<C> Name=마감구분 ID=CLSE_CLS Align=Center Width=70 EditStyle=Checkbox
											</C> 
											<C> Name=마감일 ID=CLSE_DT Align=Center Width=90 
											</C>  
											">
