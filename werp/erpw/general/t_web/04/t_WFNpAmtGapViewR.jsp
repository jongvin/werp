...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFNpAmtGapViewR";
//저장 액션
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 세금계산서미발행현황</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<G> Name='전전월' ID=G1
															<C> Name=진행율 ID=REMAIN_AMT_01_01 Width=100
															</C>
															<C> Name=계산서 ID=REMAIN_AMT_02_01 Width=100
															</C>
															<C> Name=차 ID=GAP_AMT_01 Width=100
															</C>
														</G>
														<G> Name='전월' ID=G2
															<C> Name=진행율 ID=REMAIN_AMT_01_02 Width=100
															</C>
															<C> Name=계산서 ID=REMAIN_AMT_02_02 Width=100
															</C>
															<C> Name=차 ID=GAP_AMT_02 Width=100
															</C>
														</G>
														<G> Name='당월' ID=G3
															<C> Name=진행율 ID=REMAIN_AMT_01_03 Width=100
															</C>
															<C> Name=계산서 ID=REMAIN_AMT_02_03 Width=100
															</C>
															<C> Name=차 ID=GAP_AMT_03 Width=100
															</C>
														</G>
														<G> Name='증감' ID=G4
															<C> Name=전월대비 ID=RAT_01 Width=100
															</C>
															<C> Name=전전월대비 ID=RAT_02 Width=100
															</C>
														</G>
														">
