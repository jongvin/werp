...
function Initialize()
{
	G_addDataSet(dsMAIN, trans, null, sSelectPageName+D_P1("ACT","MAIN"), "현장자금수지코드");
	G_addDataSet(dsMAIN_D, trans, null, sSelectPageName+D_P1("ACT","MAIN_D"), "현장자금수지코드삭제");
	...
	G_addDataSet(dsFLOW_CODE, null, null, sSelectPageName+D_P1("ACT","FLOW_CODE"), "현장자금수지코드번호");
	...
	F_setCellValue(fg,0,fgManager.getColumnIndex("DEPT_PLN_FUNC_NO"),"계획집계방법");
	F_setCellValue(fg,0,fgManager.getColumnIndex("DEPT_EXE_FUNC_NO"),"실적집계방법");
	F_setCellValue(fg,0,fgManager.getColumnIndex("DEPT_FOR_FUNC_NO"),"전망집계방법");
