...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFLItrInfoR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 이율목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=이율적용시작일 ID=ITR_DATE_F Align=Center Width=100 	EditStyle=Popup
											</C>
											<C> Name=수입금이율 ID=ITR_RATIO_IN Width=90
											</C>
											<C> Name=투입비이율 ID=ITR_RATIO_OUT Width=90
											</C>
											<C> Name=비고 ID=REMARKS Width=680
											</C>
											">
