/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFNpAmtDurView2R.jsp(연령별공사미수금현황)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
function Initialize()
{
	G_addDataSet(dsMAIN, trans, gridMAIN, sSelectPageName+D_P1("ACT","MAIN"), "연령별공사미수금현황");
...
function OnLoadBefore(dataset)
{
	if(dataset == dsMAIN)
	{
		var			strYm01 = txtYM_T.value.replace(/-/g,"");
		var			strYm02 = addMonthsToYm(txtYM_T.value,-1).replace(/-/g,"");
		var			strYm03 = addMonthsToYm(txtYM_T.value,-2).replace(/-/g,"");
		var			strYm04 = addMonthsToYm(txtYM_T.value,-5).replace(/-/g,"");
		var			strYm05 = addMonthsToYm(txtYM_T.value,-11).replace(/-/g,"");
		dataset.DataID = sSelectPageName + D_P1("ACT","MAIN")
										+ D_P2("WORK_YM_TO",txtYM_T.value.replace(/-/g,""))
										+ D_P2("WORK_YM_01",strYm01)
										+ D_P2("WORK_YM_02",strYm02)
										+ D_P2("WORK_YM_03",strYm03)
										+ D_P2("WORK_YM_04",strYm04)
										+ D_P2("WORK_YM_05",strYm05)
...
function btnquery_prt_onclick()
{
	...
	strTemp += "&&WORK_YM_03__" + strYm03;
	strTemp += "&&WORK_YM_04__" + strYm04;
	strTemp += "&&WORK_YM_05__" + strYm05;
