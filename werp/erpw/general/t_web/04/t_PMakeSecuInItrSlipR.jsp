...
<%
	...
	String strOut = "";
	String strWORK_CODE = "FS000200";		//유가증권 선취이자전표
	String strFileName = "./t_PMakeSecuInItrSlipR";
...
<html>
	<head>
		<title>유가증권 매입시 선취이자 전표 생성</title>
								...
								<td align="left" background="../images/pop_tit_bg.gif">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="title_default">유가증권 매입시 선취이자 전표 생성</td>
										</tr>
									</table>
								</td>
							</tr>
