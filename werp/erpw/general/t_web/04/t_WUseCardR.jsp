...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WUseCardR";
//저장 액션
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="83">
			<select  name="cboDT_CLS"  style="WIDTH: 82px">
				<OPTION value="B"> 작성일자</OPTION>
				<OPTION value="C" Selected> 사용일자</OPTION>
			</select>
		</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="30">&nbsp;</td>		
		<td width="15"><img src="../images/bullet3.gif"></td>
		<td width="70" class="font_green_bold" >카드구분</td>
		<td width="100">
			<select  id="cboCARD_CLS"  style="WIDTH: 82px">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="142"> <input id="txtCARD_NO" type="text" datatype="han" style="width:140px" VALUE="" onblur="txtCARD_NO_onblur()"></td>
		<input id="txtCARDSEQ" type="hidden" class="ro" readOnly style="width:159px" VALUE="">
		<td width="40">
			<input id="btnCARDNO" type="button" class="img_btnFind" onclick="btnCARDNO_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"value="찾기" />
		</td>
		<td width="*">&nbsp;</td>
	</tr>
</table>
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 사용내역</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" 		VALUE="
											<C> Name=소유자 		ID=OWNER		Align=Left	 Width=77   	Edit='none'  suppress=1
											</C>
											<C> Name='신용카드사' 		ID=BANK_NAME		Align=Left	 Width=90   	Edit='none' suppress=1
											</C>
											<C> Name='신용카드번호' 		ID=CARDNO		Align=Left	 Width=130   	Edit='none' suppress=1
											</C>
											<C> Name=구분 			ID=CARD_CLS		Align=Left	 Width=40   	Edit='none' VALUE = {decode(CARD_CLS,1,'법인','2','개인')} suppress=1
											</C>
											<C> Name='사용자사번' 		ID=EMP_NO		Align=Left	 Width=130   	Edit='none' Show='false'
											</C>
											<C> Name='사용자' 		ID=NAME		Align=Left	 Width=80   	Edit='none'
											</C>
											<C> Name=사용일 		ID=USE_DT		Align=Left	 Width=80   	Edit='none'
											</C>
											<C> Name=전표번호 	ID=MAKE_SLIPNO		Align=Left	 Width=120   	Edit='none'  BgColor='#FFFCE0'	SubSumText='카드  소계 :'   SumText='총     계 : '
											</C>
											<C> Name=사용금액 		ID=TRADE_AMT		Align=Right	 Width=100   	Edit='none'		 BgColor='#FFECEC'  SumText=@Sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right
											</C>
											<C> Name=거래처코드 	ID=CUST_CODE		Align=Left	 Width=165   	Edit='none' Show='false'
											</C>
											<C> Name=거래처명 		ID=CUST_NAME		Align=Left	 Width=160   	Edit='none'
											</C>
											<C> Name=적요 			ID=SUMMARY1		Align=Left	 Width=203   	Edit='none'
											</C>
											...
											<C> Name=계정명 		ID=ACC_NAME		Align=Left	 Width=165   	Edit='none'
											</C>
										">
