...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFNpAmtDurView2R";
//저장 액션
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 연령별공사미수금현황(계산서)</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<C> Name=공사미수금 ID=REMAIN_AMT Width=100
														</C>
														<C> Name='~1개월' ID=AMT_01 Width=100
														</C>
														<C> Name='1~2개월' ID=AMT_02 Width=100
														</C>
														<C> Name='2~3개월' ID=AMT_03 Width=100
														</C>
														<C> Name='3~6개월' ID=AMT_04 Width=100
														</C>
														<C> Name='6~12개월' ID=AMT_05 Width=100
														</C>
														<C> Name='12개월~' ID=AMT_06 Width=100
														</C>
														">
