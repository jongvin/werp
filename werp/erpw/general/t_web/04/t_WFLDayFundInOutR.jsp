...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFLDayFundInOutR.jsp.jsp(입출금내역등록)
/* 2. 유형(시나리오) : 입출금내역 조회 및 입력
/* 3. 기  능  정  의 : 입출금내역등록 
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 일별입출금내역</td>
								...
								<td width="100%" height="100%">
									...
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=구분 ID=ITEM_NAME Width=150
											</C>
											<C> Name=금액 ID=AMT Width=200
											</C>
											<C> Name=당월누계 ID=MONTH_AMT Width=200 Value={AMT_B + AMT}
											</C>
