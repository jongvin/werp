...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFLCompDeptMonthPlanExecSum04";
	String strPageName = "t_WFLCompDeptMonthPlanExecSum04";
//저장 액션
								...
								<td width="100%" height="100%">
									...
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<G>name='당월' ID=C1 
												<C> Name=계획 ID=c_m_plan_amt Width=75 
												</C> 
												<C> Name=실적  ID=c_m_exec_amt Width=75
												</C>
											</G>
											<G>name='누계' ID=C2 
												<C> Name=계획 ID=c_y_plan_amt Width=75 
												</C> 
												<C> Name=실적  ID=c_y_exec_amt Width=75
												</C>
											</G>
											<G>name='누적' ID=C3
												<C> Name=계획 ID=b_c_y_plan_amt Width=75 
												</C> 
												<C> Name=실적  ID=b_c_y_exec_amt Width=75
												</C>
											</G>
											">
									</OBJECT>
