...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 	f.IN_BANK_MAIN_CODE_2 IN_BANK_MAIN_CODE, \n";
			strSql += " 	f.IN_ACC_NO_2 IN_ACC_NO, \n";
			strSql += " 	a.NAME ACCNO_OWNER, \n";
			...
			strSql += " 	) a, \n";
			strSql += " 	T_FIN_EMP_IN_ACC_NO f \n";
			strSql += " Where	a.EMP_NO = f.ERMP_NO (+) ";
