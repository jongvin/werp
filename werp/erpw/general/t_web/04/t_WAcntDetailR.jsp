...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WAcntDetailR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__1"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsMAIN classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
				<param name=SubsumExpr	value="3:ACC_CODE,2:BANK_CODE,1:MNG_ITEM">
				<param name=SortExpr	value="+ACC_CODE+BANK_CODE+MNG_ITEM">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="160"> <input name="txtACCNO" type="text" datatype="han" style="width:160px" VALUE="" onblur="txtACCNO_onblur()"></td>
		<td width="40">
			<input name="btnACCNO" type="button" class="img_btnFind" onclick="btnACCNO_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"value="찾기" />
		</td>
		<td width="*">&nbsp;</td>
	</tr>
</table>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" 		VALUE="
											<C> Name=계정명 		ID=ACC_NAME		Align=Left	 Width=140   	Edit='none' 	Show='true'  BgColor='#F0F8FF' suppress=1
											</C>
											<C> Name=은행명 		ID=BANK_NAME			Align=Left	 Width=140   	Edit='none' 	Show='true' suppress=2	SubSumText={Decode(curlevel,1,'              계좌소계 :',2,'              은행소계 :',3,'              계정소계 :')} SubColor={Decode(curlevel,1,'BLUE',2,'#8B0000',3,'RED')}  BgColor='#F0F8FF'
											</C>
											<C> Name=계좌번호 		ID=MNG_ITEM		Align=Left	 Width=140   	Edit='none' 	Show='true' 	suppress=3 	SubSumText={Decode(curlevel,1,'',2,'')}  BgColor='#F0F8FF'
											</C>
											<C> Name=전표번호 		ID=MAKE_SLIPNO			Align=Center	 Width=120   	Edit='none' 	Show='true'  BgColor='#F0F8FF'
											</C>
											<C> Name='적   요' 		ID=SUMMARY1			Align=Left	 Width=200   	Edit='none' 	Show='true' 	  SumText='총         계 : '		 SumColor=BLUE  BgColor='#F0F8FF'
											</C>
											<C> Name='차  변' 		ID=DB_AMT				Align=Right	 Width=95   	Edit='none'		BgColor='#FFECEC' 	SumText=@sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right   SubColor={Decode(curlevel,1,'BLUE',2,'#8B0000',3,'RED')}
											</C>
											<C> Name='대  변' 		ID=CR_AMT			Align=Right	 Width=95   	Edit='none'     BgColor='#E0F4FF'  	SumText=@sum	SumColor=Black	SumBgColor=#A8C9FF  SumTextAlign=right  SubColor={Decode(curlevel,1,'BLUE',2,'#8B0000',3,'RED')}
											</C>
