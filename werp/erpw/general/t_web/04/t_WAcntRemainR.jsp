...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WAcntRemainR(계정별은행별잔액현황)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WAcntRemainR";
//저장 액션
	String strUpdateKeyValue = "Service1(I:dsCASH=dsCASH)";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="30">&nbsp;</td>		
		<td width="15"><img src="../images/bullet3.gif"></td>
		<td width="70" class="font_green_bold" >조회일자</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" 		VALUE="
														<C> Name=계정명 		ID=ACC_NAME		Align=Left	 Width=200   	Edit='none' 	Show='true'	suppress=1 BgColor='#F0F8FF' Color={Decode(BANK_MAIN_SHORT_NAME,'','red','black')}
														</C>
														<C> Name=은행명 		ID=BANK_MAIN_SHORT_NAME		Align=Left	 Width=200   	Edit='none' 	Show='true'	BgColor='#F0F8FF' Color={Decode(BANK_MAIN_SHORT_NAME,'','red','black')}
														</C>
														<C> Name=잔액 		ID=REMAIN_AMT	Align=Right	 Width=120   	Edit='none'     BgColor='#FFFCE0'  	SumText=@sum	SumColor=Black	SumBgColor=#FFF270  SumTextAlign=right  Color={Decode(BANK_MAIN_SHORT_NAME,'','red','black')}
														</C>
													">
