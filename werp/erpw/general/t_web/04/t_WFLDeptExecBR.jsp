...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFLDeptExecBR(본사자금수지 현장별실적집계)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFLDeptExecBR";
//저장 액션
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 본사자금수지 현장별실적집계내역</td>
														<td align="right" width="*">
															...
															<input id="btnRemoveAll" type="button" class="img_btn12_1" value="자금수지실적삭제(월)"  onclick="btnRemoveAll()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															&nbsp;&nbsp;
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<FG> Name='기본사항' id='G1'
															<C> Name=항목명 ID=LEVELED_FLOW_ITEM_NAME Width=120 suppress=1
															</C>
														</FG>
														<G> Name='실적'  id='G2'
															<C> Name='전월누계' ID=PRE_EXEC_AMT	Width=95 
															</C>
															<C> Name='당월집계실적' ID=SUM_EXEC_AMT	Width=95
															</C>
															<C> Name='당월조정실적' ID=MOD_EXEC_AMT	Width=95  BgColor={decode(IS_LEAF_TAG,'T','white','F','#EFEFEF')}
															</C>
															<C> Name='누계실적' ID=TOT_EXEC_AMT	Width=95 Value={PRE_EXEC_AMT + SUM_EXEC_AMT + MOD_EXEC_AMT}
															</C>
														</G>
														<G> Name='계획'  id='G3'
															<C> Name='전월계획' ID=PRE_PLAN_AMT	Width=95 Value={TOT_PLAN_AMT - PLAN_AMT}
															</C>
															<C> Name='당월계획' ID=PLAN_AMT	Width=95 
															</C>
															<C> Name='누계계획' ID=TOT_PLAN_AMT	Width=95 
															</C>
														</G>
														<G> Name='전망'  id='G4'
															<C> Name='당월전망' ID=FORECAST_AMT	Width=95
															</C>
														</G>
														<G> Name='계획대비'  id='G5'
															<C> Name='전월' ID=PRE_RATIO	Dec=2 	Width=60 Value={PRE_EXEC_AMT * 100 / (TOT_PLAN_AMT - PLAN_AMT) + SCALE_AMT}
															</C>
															<C> Name='당월' ID=CUR_RATIO	Dec=2	Width=60  Value={(SUM_EXEC_AMT + MOD_EXEC_AMT) * 100 / PLAN_AMT + SCALE_AMT}
															</C>
															<C> Name='누계' ID=SUM_RATIO	Dec=2	Width=60  Value={(PRE_EXEC_AMT + SUM_EXEC_AMT + MOD_EXEC_AMT)*100 / TOT_PLAN_AMT + SCALE_AMT}
															</C>
														</G>
														">
