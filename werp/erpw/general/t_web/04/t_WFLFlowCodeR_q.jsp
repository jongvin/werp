...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 	a.LEVEL_SEQ , \n";
			strSql += " 	a.MNG_CODE , \n";
			strSql += " 	to_char(a.DEPT_PLN_FUNC_NO) DEPT_PLN_FUNC_NO , \n";
			strSql += " 	to_char(a.DEPT_EXE_FUNC_NO) DEPT_EXE_FUNC_NO , \n";
			strSql += " 	to_char(a.DEPT_FOR_FUNC_NO) DEPT_FOR_FUNC_NO , \n";
		...
		else if (strAct.equals("FLOW_CODE"))
		{
			...
			strSql  = " Select SQ_T_FLOW_CODE.NextVal FLOW_CODE From Dual  \n";
		...
		else if (strAct.equals("SUB01"))
		{
			...
			strSql += " From	T_FL_FLOW_ACC_CODE a, \n";
			strSql += " 		T_ACC_CODE b, \n";
			strSql += " 		T_ACC_CODE c \n";
			strSql += " Where	a.FLOW_CODE =  ?  \n";
