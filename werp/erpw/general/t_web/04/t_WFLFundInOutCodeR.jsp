...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFLFundInOutCodeR.jsp(프로그램 한글명)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFLFundInOutCodeR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--><comment id="__NSID__1"><!--CONVPAGE_HEAD 지우지마세요//-->
					...
					<td width="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="font_green_bold">입출금내역코드</td>
								<td align="right">
									&nbsp;
								</td>
							</tr>
						...
						<table width="100%" height="250" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--><comment id="__NSID__4"><!--CONVPAGE_HEAD 지우지마세요//-->
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=내역코드 ID=ITEM_CODE Width=80 Sort=true align=center
											</C> 
											<C> Name=입출금구분  ID=IO_TAG Width=80 Sort=true EditStyle=Combo Data='1:입금,0:출금' align=center
											</C>
											<C> Name=내역명  ID=ITEM_NAME Width=150 Sort=true
											</C> 
											">
									</OBJECT>
									<!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__4); </script><!--CONVPAGE_HEAD 지우지마세요//-->
								</td>
							</tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold">관련본사수지내역</td>
							...
							<tr>
								<td width="100%" height="100%">
									<OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="ColSizing" VALUE="-1">
										<PARAM NAME="Format" VALUE=" 
											<C> Name=분사자금수지분류코드  ID=FLOW_CODE_B Width=150 show=false
											</C> 
											<C> Name=분사자금수지분류코드명 ID=FLOW_ITEM_NAME Width=250
											</C> 
											">
									</OBJECT>
								</td>
