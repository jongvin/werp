...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFinProcessPay1R.jsp(대금지급관리거래처지급구매)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFinProcessPay1R";
//저장 액션
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="96" class=font_green_bold>입금은행</td>
														<td width="52">
															<select  name="cboBANK"  >
																<OPTION VALUE='03' selected>기업 </OPTION>
