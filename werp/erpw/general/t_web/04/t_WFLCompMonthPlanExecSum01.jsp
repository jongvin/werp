...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFLCompMonthPlanExecSum01";
	String strPageName = "t_WFLCompMonthPlanExecSum01";
//저장 액션
								...
								<td width="100%" height="100%">
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<X>name={'당년예상'} ID=MON
												<C> Name='1~9월' ID=c_y_exec_amt19 Width=75 
												</C> 
												<C> Name='10월'  ID=forecast_amt10 Width=75
												</C> 
												<C> Name='11월'  ID=forecast_amt11 Width=75
												</C> 
												<C> Name='12월' ID=forecast_amt12 Width=75
												</C>
												<G>name='연간' ID=YEAR
											...
											<X>name='내년'  ID=NEXT_YEAR
												<C> Name='계획' ID=n_y_forecast_amt Width=75
												</C>
