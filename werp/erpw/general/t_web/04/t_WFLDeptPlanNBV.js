/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFLDeptPlanBV(본사자금수지 미확정현장별계획대비실적)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
function Initialize()
{
	...
	G_addDataSet(dsSUB01, trans, gridSUB01, null, "실현장별실적금액",null,null,true);
	...
	G_addRelCol(dsSUB01,"FLOW_CODE_B","FLOW_CODE_B");	
...
function OnLoadBefore(dataset)
{
	...
	else if(dataset == dsSUB01)
	{
		dataset.DataID = sSelectPageName	+ D_P1("ACT","SUB01")
											...
											+ D_P2("CLSE_ACC_ID",txtCLSE_ACC_ID.value)
											+ D_P2("DEPT_CODE",txtDEPT_CODE.value)
											+ D_P2("FLOW_CODE_B",dsMAIN.NameString(dsMAIN.RowPosition,"FLOW_CODE_B"));
	}
}
