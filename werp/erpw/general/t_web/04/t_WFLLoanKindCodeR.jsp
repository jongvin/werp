...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFLLoanKindCodeR.jsp(차입금구분코드등록)
/* 2. 유형(시나리오) : 차입금구분코드 조회 및 입력
/* 3. 기  능  정  의 : 차입금구분코드등록 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFLLoanKindCodeR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 차입금구분코드</td>
								...
								<td width="100%" height="100%">
									...
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=차입금구분코드 ID=FL_LOAN_KIND_CODE Width=120  align=center
											</C>
											<C> Name=차입금구분 ID=FL_LOAN_KIND_TAG Width=100  align=center EditStyle=Combo Data='1:단기,0:장기'
											</C>
											<C> Name=차입금구분명 ID=FL_LOAN_KIND_NAME Width=160
											</C>
