...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFinProcessPay5R.jsp(대금지급관리법인카드)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFinProcessPay5R";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__1"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsMAIN classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
			<param NAME=SubSumExpr          value="1:EMP_NO:NAME ">
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="55"  >구분 : </td>
														<td width="180" class="font_green_bold" >
															<select  name="cboSUM_ACC_GROUP"  style="WIDTH: 180px" >
																<%=strCombo%>
															</select>
														</td>
														<td>&nbsp; </td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											...
											<FC> Name='사번' ID=EMP_NO Align=Center Width=60 Color={Decode(MAKE_SLIPNO,'','red','black')}	suppress=1
											</FC> 
											<FC> Name=성명 ID=NAME Width=80 Color={Decode(MAKE_SLIPNO,'','red','black')}	suppress=1
											</FC> 
											...
											<C> Name=카드번호 ID=CARDNO Width=120 Color={Decode(MAKE_SLIPNO,'','red','black')}
											</C>
