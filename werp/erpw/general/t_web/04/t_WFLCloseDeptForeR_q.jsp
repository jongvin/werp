...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 	a.QUARTER_YEAR, \n";
			strSql += " 	a.CRTUSERNO ,  \n";
			strSql += " 	a.CRTDATE ,  \n";
			strSql += " 	a.MODUSERNO ,  \n";
			strSql += " 	a.MODDATE ,  \n";
			strSql += " 	a.FORE_CONFIRM_TAG PLAN_CONFIRM_TAG ,  \n";
			strSql += " 	a.REMARKS,  \n";
			strSql += " 	c.DEPT_NAME, \n";
			strSql += " 	Decode(  \n";
			strSql += " 	(  \n";
			...
			strSql += " 		And		b.WORK_YM Between a.CLSE_ACC_ID || to_char((a.QUARTER_YEAR-1) * 3 + 1,'fm00')  \n";
			strSql += " 							And a.CLSE_ACC_ID || to_char((a.QUARTER_YEAR-1) * 3 + 3,'fm00')  \n";
			strSql += " 		And		Nvl(b.FORECAST_AMT,0) <> 0 \n";
			strSql += " 	) +   \n";
			strSql += " 	(  \n";
			strSql += " 		Select  \n";
			strSql += " 			Count(*)  \n";
		...
		else if (strAct.equals("SUB01"))
		{
			...
			strSql += " 	Select \n";
			strSql += " 		b.DEPT_CODE \n";
			strSql += " 	From	T_FL_DEPT_FORECAST_CLOSE b \n";
			strSql += " 	Where	b.COMP_CODE =  ?  \n";
			strSql += " 	And		b.CLSE_ACC_ID =  ?  \n";
			strSql += " 	And		b.QUARTER_YEAR =  ?  \n";
			strSql += " ) \n";
			strSql += " Order By \n";
			strSql += " 	a.DEPT_CODE \n";
			strSql += "  ";
		...
		else if (strAct.equals("MASTER"))
		{
			...
			strSql += " 	a.MODDATE , \n";
			strSql += " 	a.FORE_CONFIRM_TAG PLAN_CONFIRM_TAG , \n";
			strSql += " 	SubStrb(Decode(a.FORE_CONFIRM_TAG,'T','마감됨','마감안됨'),1,50) PLAN_CONFIRM_TAG_NM, \n";
			strSql += " 	a.REMARKS \n";
			strSql += " From	T_FL_COMP_FORECAST_CLOSE a \n";
			strSql += " Where	a.COMP_CODE =  ?  \n";
			strSql += " And		a.CLSE_ACC_ID =  ?  \n";
			strSql += " And		a.QUARTER_YEAR =  ?  \n";
			strSql += "   \n";
