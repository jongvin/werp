...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFLCompDeptMonthPlanExecSum03";
	String strPageName = "t_WFLCompDeptMonthPlanExecSum03";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 현장별 자금수지</td>
								...
								<td width="100%" height="100%">
									...
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name='구분' ID=flow_item_name Align=Center Width=100 
											</C> 
											<C> Name='전년누계' ID=b_y_exec_amt Width=75
											</C>
											<G>name='당년' ID=C2
												...
												<C> Name='누계' ID=c_y_exec_amt Width=75
												</C>
											</G>
											<C> Name='누적' ID=b_c_y_amt Width=75
											</C>
											">
									</OBJECT>
