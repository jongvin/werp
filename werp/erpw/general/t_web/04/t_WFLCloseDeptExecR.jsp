...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFLCloseDeptExecR(자금수지실적현장별마감)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFLCloseDeptExecR";
//저장 액션
	String strUpdateKeyValue = "Service1(I:dsMAIN=dsMAIN,I:dsSUB01=dsSUB01,I:dsMASTER=dsMASTER)";
	...
	try
	{
		...
		try
		{
			...
			lrReturnData = CITDatabase.selectQuery(strSql, lrArgData);
			strWORK_YM = lrReturnData.toString(0,"Q");
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__3"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsMASTER classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
	...
	<body onload="C_Initialize()">
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="40" class=font_green_bold>월</td>
														<td width="52">
															<select  id="cboWORK_YM"  style="WIDTH: 50px" onchange="cboWORK_YM_onChange()">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr> 
								<td >
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td width="50" style="background:#87CEEB">
												&nbsp;
											</td>
											<td width="250">
												&nbsp;: 작업한 자료가 있는 현장&nbsp;&nbsp;&nbsp;
											</td>
											<td width="50" style="background:#EFEFEF">
												&nbsp;
											</td>
											<td width="250">
												&nbsp;: 아직 작업한 자료가 없는 현장
								...
								<td >
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="600">
												<input id="txtPLAN_CONFIRM_TAG_NM" type="text" readOnly class="ro" style="width:90px">
												<input id="btnCloseB" type="button" class="img_btn4_1" value="본사마감" onclick="btnCloseB_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
												<input id="btnOpenB" type="button" class="img_btn6_1" value="본사마감해제" onclick="btnOpenB_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
											<td >
												&nbsp;
											</td>
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 자금수지실적 편성 대상 현장</td>
														<td align="right" width="*">
															<input id="btnSelectAll" type="button" class="img_btn6_1" value="전체선택마감" onclick="btnSelectAll_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															<input id="btnDeSelectAll" type="button" class="img_btn6_1" value="전체마감해제" onclick="btnDeSelectAll_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
														</td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<C> Name=부서코드 ID=DEPT_CODE Align=Center Width=100 Edit=None  BgColor={decode(IS_DATA_EXISTS,'T','#87CEEB','#EFEFEF')} </C>
														<C> Name=부서명 ID=DEPT_NAME Width=280 Edit=None BgColor={decode(IS_DATA_EXISTS,'T','#87CEEB','#EFEFEF')} </C>
														<C> Name='마감?' ID=PLAN_CONFIRM_TAG Width=50 EditStyle=CheckBox</C>
														">
										...
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 부서 현장 목록</td>
														<td align="right" width="*">
															&nbsp;
														</td>
													</tr>
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="MultiRowSelect" VALUE="true">
													<PARAM NAME="Format" VALUE="
														<C> Name=부서코드 ID=DEPT_CODE Align=Center Width=100 </C>
														<C> Name=부서명 ID=DEPT_NAME Width=300 </C>
														">
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=ADE_Bind_1 style="Z-INDEX: 107; LEFT: 335px; POSITION: absolute; TOP: 158px" classid=clsid:9C9AB433-EA85-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbbind.cab#version=1,1,0,13">
			...
			<PARAM NAME="BindInfo" VALUE="
				<C> Col=PLAN_CONFIRM_TAG_NM 				Ctrl=txtPLAN_CONFIRM_TAG_NM 				Param=value</C>
			">
