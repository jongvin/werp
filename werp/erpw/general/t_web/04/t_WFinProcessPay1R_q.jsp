...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			String strBANK = CITCommon.toKOR(request.getParameter("BANK"));
			...
			strSql += " 				And		x.BANK_MAIN_CODE = ?  \n";
			strSql += " 				And		x.ACCNO_CLS = '3' \n";
			...
			strSql += " 	) a ) where  IN_BANK_MAIN_CODE = ? \n";
			strSql += "  ";
			
			lrArgData.addColumn("1OUT_ACC_NO", CITData.VARCHAR2);
			lrArgData.addColumn("BANK_01", CITData.VARCHAR2);
			...
			lrArgData.addColumn("BANK_02", CITData.VARCHAR2);
			lrArgData.addRow();
			lrArgData.setValue("1OUT_ACC_NO", strOUT_ACC_NO);
			lrArgData.setValue("BANK_01", strBANK);
			...
			lrArgData.setValue("BANK_02", strBANK);
			try
			{
