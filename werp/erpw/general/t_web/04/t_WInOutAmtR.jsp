...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WInOutAmtR";
//저장 액션
	...
	try
	{
		...
		try
		{
			strSql = 
				...
				"Where	a.CODE_GROUP_ID = 'IN_KIND_TG'"+"\n"+
				"And		a.USE_TAG = 'T'"+"\n"+
				"Order By"+"\n"+
				"	a.SEQ";
			lrReturnData = CITDatabase.selectQuery(strSql, lrArgData);
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 입금표목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=입고일 ID=IN_DT Align=Center Width=80 </C>
											<C> Name=입금표번호 ID=NO Align=Left Width=80 </C>
											<C> Name=입고구분 ID=IN_KIND_TG Align=Center EditStyle=Combo Data='<%=strCombo%>' Width=80</C>
											<C> Name=입고내역 ID=IN_DESCRIPTION Align=Left Width=200 </C>
											<C> Name=출고구분 ID=OUT_KIND_TG Align=Center EditStyle=Combo Data='<%=strCombo2%>' Width=80</C>
											<C> Name=출고일 ID=OUT_DT Align=Center Width=80 </C>
											<C> Name=출고내역 ID=OUT_DESCRIPTION Align=Left Width=200 </C>
											<C> Name=수령자사번 ID=GET_PERSON Align=Center Width=80 </C>
											<C> Name=수령자명 ID=NAME Align=Center Width=90 </C>
											">
