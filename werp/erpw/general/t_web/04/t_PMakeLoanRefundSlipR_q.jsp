...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("WORK_SLIP_IDSEQ"))
		{
			...
			strSql  = " Select SQ_T_WORK_SLIP_ID.NEXTVAL WORK_SLIP_ID, SQ_T_WORK_SLIP_IDSEQ.NEXTVAL WORK_SLIP_IDSEQ,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' WORK_CODE,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' DEPT_CODE,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' LOAN_NO,0 LOAN_REFUND_SEQ From DUAL ";
		...
		{
			strSql  = " Select 0 WORK_SLIP_ID, 0 WORK_SLIP_IDSEQ,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' COMP_CODE, 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' WORK_CODE,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' DEPT_CODE,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' LOAN_NO,0 LOAN_REFUND_SEQ From DUAL ";
