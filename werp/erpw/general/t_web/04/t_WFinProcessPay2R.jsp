...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFinProcessPay2R.jsp(대금지급관리거래처실물어음)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFinProcessPay2R";
//저장 액션
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											...
											<C> Name=만기일수 ID=PAY_CON_BILL_DAYS align=right Width=70 Color={Decode(MAKE_SLIPNO,'','red','black')}
											</C>
											<C> Name=만기일 ID=EXPR_DT Width=90 Color={Decode(MAKE_SLIPNO,'','red','black')}
											</C>
											<C> Name=채무잔액 ID=REMAIN_AMT Width=100 Color={Decode(MAKE_SLIPNO,'','red','black')}
											</C>
											<C> Name=어음비율 ID=B_RATIO Width=60 align=right Color={Decode(MAKE_SLIPNO,'','red','black')}
											</C>
											<C> Name=현금비율 ID=C_RATIO Width=60 align=right Color={Decode(MAKE_SLIPNO,'','red','black')}
											</C>
											...
											<C> Name=어음번호 ID=CHK_BILL_NO Width=140 Color={Decode(MAKE_SLIPNO,'','red','black')}
											</C>
											">
