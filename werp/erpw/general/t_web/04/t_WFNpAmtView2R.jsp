...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFNpAmtView2R.jsp(월별미수금현황)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFNpAmtView2R";
//저장 액션
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 월별미수금현황(계산서)</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<G> Name='도급금액' ID=G1
															<C> Name=구분 ID=GB3 Align=Center Width=40 Suppress=3
															</C>
															<C> Name=금액 ID=CONS_AMT Width=100
															</C>
														</G>
														<C> Name=전년누적 ID=AMT_00 Width=100
														</C>
														<C> Name='구분' ID=GB1	 Align=Center Width=40 Suppress=4
														</C>
														<C> Name='구분' ID=GB1_1	 Align=Center Width=40 Suppress=5
														</C>
														<C> Name='구분' ID=GB2	 Align=Center Width=40
														</C>
														<G> Name='1월' ID=G101
															<C> Name='7월' ID=AMT_01 Width=100
															</C>
														</G>
														<G> Name='2월' ID=G102
															<C> Name='8월' ID=AMT_02 Width=100
															</C>
														</G>
														<G> Name='3월' ID=G103
															<C> Name='9월' ID=AMT_03 Width=100
															</C>
														</G>
														<G> Name='4월' ID=G104
															<C> Name='10월' ID=AMT_04 Width=100
															</C>
														</G>
														<G> Name='5월' ID=G105
															<C> Name='11월' ID=AMT_05 Width=100
															</C>
														</G>
														<G> Name='6월' ID=G106
															<C> Name='12월' ID=AMT_06 Width=100
															</C>
														</G>
														<C> Name=누계 ID=AMT_13 Width=100
														</C>
														<C> Name=누적 ID=AMT_14 Width=100
														</C>
														">
