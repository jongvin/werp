...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBankTotalR";
//저장 액션
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" 		VALUE="
											<C> Name=계정명 		ID=ACC_NAME		Align=Left	 Width=200   	Edit='none' 	Show='true'	suppress=1		SubSumText='          계정  소계 :' SubColor='RED' BgColor='#F0F8FF'
											</C>
											<C> Name=은행명 		ID=BANK_NAME			Align=Left	 Width=240   	Edit='none' 	Show='true'	 SumText='총         계 : ' SumColor=BLUE BgColor='#F0F8FF'
											</C>
											<C> Name=전일잔액 		ID=PRE_REMAIN_AMT	Align=Right	 Width=100   	Edit='none'     BgColor='#FFFCE0'  	SumText=@sum	SumColor=Black	SumBgColor=#FFF270  SumTextAlign=right
											</C>
											<C> Name=설정금액 		ID=SET_AMT				Align=Right	 Width=100   	Edit='none'		BgColor='#FFECEC' 	SumText=@sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right
											</C>
											<C> Name=반제금액 		ID=RESET_AMT			Align=Right	 Width=100   	Edit='none'     BgColor='#E0F4FF'  	SumText=@sum	SumColor=Black	SumBgColor=#A8C9FF  SumTextAlign=right
											</C>
											<C> Name='잔   액' 		ID=REMAIN_AMT	Align=Right	 Width=100   	Edit='none'     BgColor='#F2F9E8'  	SumText=@sum	SumColor=Black	SumBgColor=#C4E693  SumTextAlign=right
											</C>
