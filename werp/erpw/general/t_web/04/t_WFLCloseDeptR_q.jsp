...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " From	T_FL_DEPT_FLOW_MA a, \n";
		...
		else 		if (strAct.equals("SUB01"))
		{
			...
			strSql += " 	Select \n";
			strSql += " 		b.DEPT_CODE \n";
			strSql += " 	From	T_FL_DEPT_FLOW_MA b \n";
		...
		else if (strAct.equals("MASTER"))
		{
			...
			strSql += " 	a.MODDATE , \n";
			strSql += " 	a.PLAN_CONFIRM_TAG , \n";
			strSql += " 	SubStrb(Decode(a.PLAN_CONFIRM_TAG,'T','마감됨','마감안됨'),1,50) PLAN_CONFIRM_TAG_NM, \n";
			strSql += " 	a.REMARKS \n";
			strSql += " From	T_FL_COMP_FLOW_MA_B a \n";
			strSql += " Where	a.COMP_CODE =  ?  \n";
			strSql += " And		a.CLSE_ACC_ID =  ?  \n";
			strSql += "  ";
