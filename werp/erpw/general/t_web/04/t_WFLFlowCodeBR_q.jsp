	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			try
			{
				...
				lrReturnData.setKey("FLOW_CODE", true);
		...
		else if (strAct.equals("FLOW_CODE"))
		{

			
			strSql  = " Select SQ_T_FLOW_CODE_B.NextVal FLOW_CODE From Dual  \n";
		...
		else if (strAct.equals("APPLY_SEQ"))
		{
			...
			strSql  = " Select SQ_T_APPLY_SEQ_B.NextVal APPLY_SEQ From Dual  \n";
		...
		if (strAct.equals("SUB01"))
		{
			...
			strSql += " From	T_FL_FLOW_ACC_CODE_B a, \n";
			strSql += " 		T_ACC_CODE b, \n";
			strSql += " 		T_ACC_CODE c \n";
			strSql += " Where	a.FLOW_CODE_B =  ?  \n";
			strSql += " And		a.ACC_CODE = b.ACC_CODE (+) \n";
			strSql += " And		a.SETOFF_ACC_CODE = c.ACC_CODE (+) \n";
			strSql += " Order By \n";
			strSql += " 	a.ACC_CODE ";
			
			lrArgData.addColumn("FLOW_CODE", CITData.VARCHAR2);
			lrArgData.addRow();
			lrArgData.setValue("FLOW_CODE", strFLOW_CODE);
			try
			{
				lrReturnData = CITDatabase.selectQuery(strSql, lrArgData);
		...
		{
			String strFLOW_CODE_B = CITCommon.toKOR(request.getParameter("FLOW_CODE"));
			...
			strSql += " From	T_FL_FLOW_COMP_B a, \n";
			strSql += " 		T_COMPANY b \n";
			strSql += " Where	a.FLOW_CODE_B =  ?  \n";
			...
			lrArgData.addColumn("1FLOW_CODE_B", CITData.VARCHAR2);
			lrArgData.addRow();
			lrArgData.setValue("1FLOW_CODE_B", strFLOW_CODE_B);
			try
			{
				lrReturnData = CITDatabase.selectQuery(strSql, lrArgData);
