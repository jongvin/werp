/**************************************************************************/
/* 1. 프 로 그 램 id : t_PMakeSecuInSlipR(유가증권매입)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
function Initialize()
{
	...
	dsWORK_SLIP_IDSEQ.NameString(dsWORK_SLIP_IDSEQ.RowPosition,"SECU_NO") = lrArgs.SECU_NO;
...
function	ConfirmSelected()
{
	...
	dsMAKE_SLIP.NameString(dsMAKE_SLIP.RowPosition,"SECU_NO") = lrArgs.SECU_NO;
