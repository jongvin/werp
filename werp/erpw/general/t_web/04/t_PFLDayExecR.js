/**************************************************************************/
/* 1. 프 로 그 램 id : t_PFLDayExecR.jsp(자금수지실적집계내역)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
function Initialize()
{
	...
	G_addRelCol(dsSUB01, "TRACE_SLIP_ID", "SLIP_ID");
	G_addRelCol(dsSUB01, "TRACE_SLIP_IDSEQ", "SLIP_IDSEQ");
...
function OnLoadBefore(dataset)
{
	if(dataset == dsMAIN)
	{
		dataset.DataID = sSelectPageName	+ D_P1("ACT","MAIN")
											+ D_P2("FLOW_CODE",opnrArgs.get("FLOW_CODE"))
											+ D_P2("COMP_CODE",opnrArgs.get("COMP_CODE"))
											+ D_P2("CLSE_ACC_ID",opnrArgs.get("CLSE_ACC_ID"))
											+ D_P2("WORK_DT",opnrArgs.get("WORK_DT"));
	}
	else if(dataset == dsSUB01)
	{
		dataset.DataID = sSelectPageName	+ D_P1("ACT","SUB01")
											+ D_P2("WORK_DT",dsMAIN.NameString(dsMAIN.RowPosition,"WORK_DT"))
											+ D_P2("TRACE_SLIP_ID",dsMAIN.NameString(dsMAIN.RowPosition,"TRACE_SLIP_ID"))
											+ D_P2("TRACE_SLIP_IDSEQ",dsMAIN.NameString(dsMAIN.RowPosition,"TRACE_SLIP_IDSEQ"));
	}
