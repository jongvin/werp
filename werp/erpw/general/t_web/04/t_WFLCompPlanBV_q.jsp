...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 					b.PLAN_AMT, \n";
			strSql += " 					b.EXEC_AMT, \n";
			strSql += " 					Sum(b.PLAN_AMT) Over(Partition By b.COMP_CODE,b.FLOW_CODE_B Order By b.COMP_CODE,b.FLOW_CODE_B,b.WORK_YM) A_PLAN_AMT, \n";
			strSql += " 					Sum(b.EXEC_AMT) Over(Partition By b.COMP_CODE,b.FLOW_CODE_B Order By b.COMP_CODE,b.FLOW_CODE_B,b.WORK_YM) A_EXEC_AMT \n";
