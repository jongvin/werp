...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WNpDeptProjR";
//저장 액션
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="90" class=font_green_bold >부서/현장 명</td>
														<td width="160"> <input name="txtSEARCH_CONDITION" type="text" Left class="box_ma5_white" VALUE="" style="width:155px"></td>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="60" class="font_green_bold" >본사/현장</td>
														<td width="100">
															<SELECT id="cboDEPT_PROJ_TAG" style="WIDTH: 80px">
																<OPTION VALUE='%' selected>전체 </OPTION>
																<OPTION VALUE='H'>본사부서 </OPTION>
																<OPTION VALUE='P'>현장 </OPTION>
															</SELECT>
														</td>
														<td width="15"><img src="../images/bullet3.gif"></td>
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 부서/현장목록</td>
...
<FC> Name='부서/현장코드' ID=DEPT_CODE Align=Center Width=120 </FC>
<FC> Name=현장명 ID=DEPT_NAME Align=Left Width=250 </FC>
<C> Name=축소명 ID=DEPT_SHORT_NAME Align=Left Width=250 </C>
<C> Name=현장마감일 ID=ACC_CLOSE_DT Align=Center Width=100 </C>
<C> Name='미수금현황대상여부' ID=NP_PRT_TAG Width=120 EditStyle=CheckBox</C>
											">
