	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql = 
				...
				"			2,Max(Decode(b.YM,'01',b.MOD_PLAN_AMT))	,"+"\n"+
				"			3,Max(Decode(b.YM,'01',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'01',b.PLAN_AMT)))			PLAN_AMT_01,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'02',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'02',b.MOD_PLAN_AMT))	,"+"\n"+
				"			3,Max(Decode(b.YM,'02',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'02',b.PLAN_AMT)))			PLAN_AMT_02,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'03',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'03',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'03',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'03',b.PLAN_AMT)))			PLAN_AMT_03,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'04',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'04',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'04',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'04',b.PLAN_AMT)))			PLAN_AMT_04,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'05',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'05',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'05',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'05',b.PLAN_AMT)))			PLAN_AMT_05,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'06',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'06',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'06',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'06',b.PLAN_AMT)))			PLAN_AMT_06,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'07',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'07',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'07',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'07',b.PLAN_AMT)))			PLAN_AMT_07,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'08',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'08',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'08',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'08',b.PLAN_AMT)))			PLAN_AMT_08,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'09',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'09',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'09',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'09',b.PLAN_AMT)))			PLAN_AMT_09,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'10',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'10',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'10',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'10',b.PLAN_AMT)))			PLAN_AMT_10,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'11',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'11',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'11',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'11',b.PLAN_AMT)))			PLAN_AMT_11,"+"\n"+
				"	Decode(a.LV,1, Max(Decode(b.YM,'12',b.SUM_PLAN_AMT)),"+"\n"+
				"			2,Max(Decode(b.YM,'12',b.MOD_PLAN_AMT)),"+"\n"+
				"			3,Max(Decode(b.YM,'12',b.B_MOD_PLAN_AMT))	,"+"\n"+
				"			4,Max(Decode(b.YM,'12',b.PLAN_AMT)))			PLAN_AMT_12"+"\n"+
				"From"+"\n"+
				"	("+"\n"+
				"		Select"+"\n"+
				"			a.COMP_CODE,"+"\n"+
				...
				"			a.RN,"+"\n"+
				"			x.LV,"+"\n"+
				"			Decode(x.LV,1,'집계',2,'현장조정',3,'본사조정',4,'계') SUBTITLE_NAME"+"\n"+
				"		From"+"\n"+
				"			("+"\n"+
				"				Select"+"\n"+
				"					?  COMP_CODE,"+"\n"+
