...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WCashAcntTotalR(계좌별집계조회)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WCashAcntTotalR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__2"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsCASH classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
							...
							<tr>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" 		VALUE="
														<C> Name=계정명 		ID=ACC_NAME		Align=Left	 Width=140   	Edit='none' 	Show='true'	suppress=1 BgColor='#F0F8FF' Color={Decode(MAKE_COMP_CODE,'','red','black')}
														</C>
														<C> Name=계좌명 		ID=ACCT_NAME		Align=Left	 Width=140   	Edit='none' 	Show='true'	BgColor='#F0F8FF' Color={Decode(MAKE_COMP_CODE,'','red','black')}
														</C>
														<C> Name=전일잔고 		ID=PRE_REMAIN_AMT	Align=Right	 Width=95   	Edit='none'     BgColor='#FFFCE0'  	SumText=@sum	SumColor=Black	SumBgColor=#FFF270  SumTextAlign=right  Color={Decode(MAKE_COMP_CODE,'','red','black')}
														</C>
														<C> Name=금일입금 		ID=SET_AMT				Align=Right	 Width=95   	Edit='none'		BgColor='#FFECEC' 	SumText=@sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right Color={Decode(MAKE_COMP_CODE,'','red','black')}
														</C>
														<C> Name=금일출금 		ID=RESET_AMT			Align=Right	 Width=95   	Edit='none'     BgColor='#E0F4FF'  	SumText=@sum	SumColor=Black	SumBgColor=#A8C9FF  SumTextAlign=right Color={Decode(MAKE_COMP_CODE,'','red','black')}
														</C>
														<C> Name='금일잔고' 		ID=REMAIN_AMT	Align=Right	 Width=95   	Edit='none'     BgColor='#F2F9E8'  	SumText=@sum	SumColor=Black	SumBgColor=#C4E693  SumTextAlign=right Color={Decode(MAKE_COMP_CODE,'','red','black')}
														</C>
													">
								...
								<td width="300" height="100%">
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 현금보유고</td>
														<td align="right" width="*">
															&nbsp;
														</td>
													</tr>
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridCASH WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													<PARAM NAME="DataID" VALUE="dsCASH">
													<PARAM NAME="Editable" VALUE="-1">
													<PARAM NAME="ColSelect" VALUE="-1">
													<PARAM NAME="ColSizing" VALUE="-1">
													<param name="ViewSummary"	value=1>
													<PARAM NAME="SuppressOption" 	VALUE=1>
													<PARAM NAME="Format" 		VALUE="
														<C> Name=구분 		ID=CASH_NAME		Align=Left	 Width=100   	Edit='none' 	
														</C>
														<C> Name=수량 		ID=QTY	Align=Right	 Width=80 BgColor={decode(UNIT_COST,0,'#DCDCDC','white')}
														</C>
														<C> Name=금액 		ID=AMT	Align=Right	 Width=95   BgColor={decode(UNIT_COST,0,'white','#DCDCDC')} 	SumText=@sum	
														</C>
													">
