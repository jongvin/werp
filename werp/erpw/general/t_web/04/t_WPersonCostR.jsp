...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsSUM classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__8); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__100"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsREMOVE classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__100); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transSUM"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__101"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transREMOVE"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	      <param name="KeyValue" value="Service1(I:dsREMOVE=dsREMOVE)">
		  <param name="Action"    value="<%=strFileName%>_tr.jsp">
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__101); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 작업 목록</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<FC> Name=작업일 		ID=WORK_DT	Width=90 EditStyle=Popup
														</FC>
														<C> Name=작업내용 		ID=CONTENTS		Width=200
														</C>
														<C> Name='당사인출계좌' 		ID='ACCNO'			Align=Center	 Width=300  EditStyle=Combo Data='<%=strACCNO_G%>'
														</C>
														">
										...
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 전표목록</td>
														<td align="right" width="*">
															<input id="btnMakeInSlip" type="button" class="img_btn6_1" value="자료집계" title="" onclick="btnMakeInSlip_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<C> Name=좌수 		ID=MAKE_SLIPLINE			Align=Center	 Width=40 
														</C>
														<C> Name=계정 		ID=ACC_NAME			 Width=160
														</C>
														<C> Name=적요 		ID=SUMMARY1			 Width=160
														</C>
														<C> Name=금액 		ID=EXEC_AMT			 Width=100
														</C>
														<G> Name=대상설정 ID=G1
														<C> Name=대상구분 		ID=IN_TARGET_TAG		Width=70 EditStyle=Combo Data='1:거래처,2:사원,0:제외'
														</C>
														</G>
														<G> Name=사원 ID=G3
															<C> Name=사번 		ID=ERMP_NO			 Width=90
															</C>
															<C> Name=성명 		ID=NAME			 Width=160
															</C>
														</G>
														<G> Name=거래처 ID=G2
														...
														<C> Name=입금은행 		ID=IN_BANK_MAIN_CODE		Width=100  EditStyle=LookUp Data='dsBANK_MAIN:BANK_MAIN_CODE:BANK_MAIN_NAME' 
														</C>
														<C> Name=계좌번호 		ID=IN_ACC_NO		Width=200
														</C>
														<C> Name=예금주 		ID=IN_ACC_NO_OWNER		Width=160
														</C>
														">
