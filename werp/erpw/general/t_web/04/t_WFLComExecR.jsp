...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFLComExecR(본사자금수지실적집계)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFLComExecR";
//저장 액션
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td align="right" width="*">
															...
															<input id="btnRemoveAll" type="button" class="img_btn12_1" value="자금수지실적삭제(전체)"  onclick="btnRemoveAll()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
														</td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
												...
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<G> Name='실적' id='G2'
															...
															<C> Name='당월실적' ID=EXEC_AMT	Width=95
															</C>
															<C> Name='누계실적' ID=SUM_EXEC_AMT	Width=95
															</C>
														</G>
														<G> Name='계획' id='G3'
															<C> Name='전월계획' ID=PRE_PLAN_AMT	Width=95 Value={SUM_PLAN_AMT - PLAN_AMT}
															</C>
															<C> Name='당월계획' ID=PLAN_AMT	Width=95 
															</C>
															<C> Name='누계계획' ID=SUM_PLAN_AMT	Width=95 
															</C>
														</G>
														<G> Name='실적' id='G4'
															<C> Name='당월실적' ID=FORECAST_AMT	Width=95
															</C>
														</G>
														<G> Name='계획대비' id='G5'
															<C> Name='전월' ID=PRE_RATIO	Width=60 Value={PRE_EXEC_AMT * 100 / (SUM_PLAN_AMT - PLAN_AMT)}
															</C>
															<C> Name='당월' ID=CUR_RATIO	Width=60  Value={EXEC_AMT * 100 / PLAN_AMT}
															</C>
															<C> Name='누계' ID=SUM_RATIO	Width=60  Value={SUM_EXEC_AMT*100 / SUM_PLAN_AMT}
															</C>
														</G>
														">
