...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 				From	T_CARD_MEMBER_HISTORY x \n";
			strSql += " 				Where	x.CARD_SEQ = a.CARD_SEQ \n";
			strSql += " 				And		x.USESTARTDATE =  \n";
			strSql += " 				( \n";
			strSql += " 					Select \n";
			strSql += " 						Max(y.USESTARTDATE) \n";
			strSql += " 					From	T_CARD_MEMBER_HISTORY y \n";
			strSql += " 					Where	x.CARD_SEQ = y.CARD_SEQ \n";
			strSql += " 				) \n";
			strSql += " 			) IN_ACC_INFO, \n";
			strSql += " 			RowNum Rn \n";
			strSql += " 		From \n";
			...
			strSql += " 			T_ACC_CODE e \n";
			strSql += " 		Where	a.EMP_NO = c.EMPNO (+) \n";
			strSql += " 		And		a.TARGET_SLIP_ID = d.SLIP_ID \n";
			strSql += " 		And		a.ACC_CODE = e.ACC_CODE \n";
			strSql += " 	) a, \n";
			strSql += " 	T_ACC_CREDCARD g \n";
			strSql += " Where	a.CARD_SEQ = g.CARD_SEQ (+) \n";
			strSql += "  ";
