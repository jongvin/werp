								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="45" class="font_green_bold" >LOV명</td>
					...
					<td width="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="font_green_bold">LOV명</td>
								<td align="right">
								...
								<td width="100%" height="100%">
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<FC> Name=LOV명 ID=NAME Width=150 Sort=true
											</FC> 
											<C> Name=타이틀 ID=TITLE Width=180 Sort=true
											</C> 
											">
									</OBJECT>
								</td>
								<td width="560" height="100%">
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="40">SQL</td>
											<td width="*" height="100%"><textarea id="txtSql" style="width:480; height:216" wrap="off"></textarea></td>
										</tr>
									</table>
								</td>
							</tr>
