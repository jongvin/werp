Create Or Replace Package PKG_T_Make_Remain_Keep
Is
	Type	R_Detail Is Record
	(
		r_Slip_Id				T_ACC_SLIP_BODY1.SLIP_ID%Type,
		r_Slip_IdSeq			T_ACC_SLIP_BODY1.SLIP_IDSEQ%Type,
		r_MAKE_SLIPLINE			T_ACC_SLIP_BODY1.MAKE_SLIPLINE%Type,
		r_ACC_CODE				T_ACC_SLIP_BODY1.ACC_CODE%Type,
		r_DB_AMT				T_ACC_SLIP_BODY1.DB_AMT%Type,
		r_CR_AMT				T_ACC_SLIP_BODY1.CR_AMT%Type,
		r_REMAIN_AMT			T_ACC_SLIP_REMAIN_KEEP.RESET_AMT%Type
	);
	Type	T_Detail Is Table Of R_Detail
		Index By Binary_Integer;
	Type	T_SlipDetail Is Table Of T_ACC_SLIP_BODY1%RowType
		Index By Binary_Integer;
...
Create Or Replace Package Body PKG_T_Make_Remain_Keep
Is
	Function	CreateDetail
	(
		lr_Slip_Elem			T_ACC_SLIP_BODY1%RowType
	)
	Return R_Detail
	Is
		lrTemp					R_Detail;
	...
	Is
	Begin
		Insert Into T_ACC_SLIP_REMAIN_KEEP
		(
			SLIP_ID,
			SLIP_IDSEQ,
			RESET_SLIP_IDSEQ,
...
Declare
Begin
	For lrA In (Select slip_id from t_acc_slip_head) Loop
		PKG_T_Make_Remain_Keep.Make_Remain_Keep(lrA.Slip_Id);
	End Loop;
End;
/
