Create Or Replace Package PKG_FL_DEPT_FORE_B
Is
...
End;
/
Create Or Replace Package Body PKG_FL_DEPT_FORE_B
Is
	Type	T_FUNCTTIONS	Is Table Of T_FL_COMP_FORE_FUNCTIONS.FUNC_NAME%Type
	...
	Begin
		G_FUNCTIONS.Delete;
		For lrA In (Select COMP_FOR_FUNC_NO,FUNC_NAME From T_FL_COMP_FORE_FUNCTIONS) Loop
	...
	Is
		...
		liFirst						Number;
		liLast						Number;
		lsFuncName					T_FL_COMP_FORE_FUNCTIONS.FUNC_NAME%Type;
		lnFuncNo					Number;
	Begin
		LoadFunctions;
		...
		From
			(
				...
				(
					Select
						b.COMP_FOR_FUNC_NO
					From	T_FL_COMP_FORE_FUNCTIONS b
	...
	Begin
		...
		Insert
		(COMP_CODE,CLSE_ACC_ID,DEPT_CODE,WORK_YM,FLOW_CODE_B,SUM_FORECAST_AMT,FORECAST_AMT,CRTDATE,CRTUSERNO)
		Values
		(s.COMP_CODE,s.CLSE_ACC_ID,s.DEPT_CODE,s.WORK_YM,s.FLOW_CODE_B,s.SUM_FORECAST_AMT,s.FORECAST_AMT,s.CRTDATE,s.CRTUSERNO);
	End;
	Procedure	CalcCurrentInOut
	Is
		lsBegin						Varchar2(6);
	...
	Begin
		...
		When Not Matched Then
		Insert 
		(COMP_CODE,CLSE_ACC_ID,DEPT_CODE,WORK_YM,FLOW_CODE_B,CRTUSERNO,CRTDATE,SUM_FORECAST_AMT,MOD_FORECAST_AMT,FORECAST_AMT)
		Values
		(s.COMP_CODE,s.CLSE_ACC_ID,s.DEPT_CODE,s.WORK_YM,s.FLOW_CODE_B,s.CRTUSERNO,s.CRTDATE,s.SUM_FORECAST_AMT,s.MOD_FORECAST_AMT,s.FORECAST_AMT);
	End;
	Procedure	CalcSpecialInOut
	Is
		lsBegin						Varchar2(6);
