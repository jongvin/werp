CREATE OR REPLACE Procedure SP_DELETE_CASH_EDI_FILE
(
...
Is
    /*************************************************************************/
    /*                                                                       */
    /*  1. 모듈ID    : SP_DELETE_CASH_EDI_FILE                               */
    /*  2. 모듈이름  : 이체파일삭제                                          */
    /*  3. 시스템    : 회계시스템                                            */
    /*  4. 서브시스템: FBS                                                   */
    /*  5. 모듈유형  :                                                       */
	...
	ELSE
      ...
      BEGIN
          ...
          END LOOP;
      		...
      		DELETE FROM T_FB_CASH_PAY_HISTORY
          WHERE  EDI_HISTORY_SEQ = p_edi_seq
      ...
      BEGIN
          v_dummy_return := fbs_util_pkg.exec_os_command(	'del ' || v_cash_send_dir || v_sned_file_name );
      EXCEPTION
          WHEN OTHERS THEN
