Create Or Replace Procedure SP_T_MAKE_DFLT_AEITR_SLIP
(
...
Begin
	...
	End If;
	If lrRec.ITR_TAG = '4' Or lrRec.ITR_TAG = '7' Then
		lnAmt := Nvl(lrRec.INTR_AMT,0);
	Else
		Raise_Application_Error(-20009,'후취이자 지급 또는 선취이자 지급을 선잭하여 주십시오.');
	End If;
	If lnAmt <= 0 Then
