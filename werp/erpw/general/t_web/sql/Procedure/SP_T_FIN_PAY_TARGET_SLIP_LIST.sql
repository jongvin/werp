Create Or Replace Procedure SP_T_FIN_PAY_TARGET_SLIP_LIST_I
(
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIN_PAY_TARGET_SLIP_LIST_I
/* 2. 유형(시나리오) : Procedure
...
End;
/
Create Or Replace Procedure SP_T_FIN_PAY_TARGET_SLIP_LIST_U
(
	AR_COMP_CODE                               VARCHAR2,
	AR_WORK_DT                                 VARCHAR2,
	AR_SEQ                                     NUMBER,
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIN_PAY_TARGET_SLIP_LIST_U
/* 2. 유형(시나리오) : Procedure
...
End;
/
Create Or Replace Procedure SP_T_FIN_PAY_TARGET_SLIP_LIST_D
(
	AR_COMP_CODE                               VARCHAR2,
	AR_WORK_DT                                 VARCHAR2,
	AR_SEQ                                     NUMBER
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIN_PAY_TARGET_SLIP_LIST_D
/* 2. 유형(시나리오) : Procedure
