Create Or Replace Procedure SP_T_FL_MONTH_COM_FORE_SUMUP
(
...
Begin
	...
	Insert
	(COMP_CODE,CLSE_ACC_ID,WORK_YM,FLOW_CODE_B,SUM_FORECAST_AMT,MOD_FORECAST_AMT,B_MOD_FORECAST_AMT,FORECAST_AMT)
	Values
	(s.COMP_CODE,s.CLSE_ACC_ID,s.WORK_YM,s.FLOW_CODE_B,s.SUM_FORECAST_AMT,s.MOD_FORECAST_AMT,s.B_MOD_FORECAST_AMT,s.FORECAST_AMT);
End;
/
