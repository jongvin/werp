...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FL_COMP_PLN_FUNCTIONS_I
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FL_COMP_PLN_FUNCTIONS 테이블 Insert
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FL_COMP_PLN_FUNCTIONS_U
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FL_COMP_PLN_FUNCTIONS 테이블 Update
/* 4. 변  경  이  력 : 김흥수 작성(2006-01-10)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FL_COMP_PLN_FUNCTIONS_D
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FL_COMP_PLN_FUNCTIONS 테이블 Delete
/* 4. 변  경  이  력 : 김흥수 작성(2006-01-10)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
