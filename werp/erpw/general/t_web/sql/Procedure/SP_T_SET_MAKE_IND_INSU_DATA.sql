Create Or Replace Procedure SP_T_SET_MAKE_IND_INSU_DATA
(
...
Begin
	...
	End If;
	Delete	T_SET_IND_INSUR_TARGET_SLIP a
	...
	(
		Select
			Null
		From	T_SET_IND_INSUR_TARGET_SLIP aa
