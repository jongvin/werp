Create Or Replace Procedure SP_T_FIX_SUM_I
(
	AR_WORK_SEQ                                NUMBER,
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIX_SUM_I
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FIX_SUM 테이블 Insert
/* 4. 변  경  이  력 : 홍길동 작성(2006-03-07)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
Begin
	Insert Into T_FIX_SUM
	(
		WORK_SEQ,
		FIX_ASSET_SEQ,
		CRTUSERNO,
...
End;
/
Create Or Replace Procedure SP_T_FIX_SUM_U
(
	AR_WORK_SEQ                                NUMBER,
	AR_FIX_ASSET_SEQ                           NUMBER,
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIX_SUM_U
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FIX_SUM 테이블 Update
/* 4. 변  경  이  력 : 홍길동 작성(2006-03-07)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
...
End;
/
Create Or Replace Procedure SP_T_FIX_SUM_D
(
	AR_WORK_SEQ                                NUMBER,
	AR_FIX_ASSET_SEQ                           NUMBER
)
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIX_SUM_D
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FIX_SUM 테이블 Delete
/* 4. 변  경  이  력 : 홍길동 작성(2006-03-07)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
Begin
	Delete T_FIX_FURNI_SUM
	Where	WORK_SEQ = AR_WORK_SEQ
	And	      FIX_ASSET_SEQ = AR_FIX_ASSET_SEQ;
