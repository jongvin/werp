Create Or Replace Procedure SP_T_FIN_PAY_EXEC_LIST_I
(
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIN_PAY_EXEC_LIST_I
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FIN_PAY_EXEC_LIST 테이블 Insert
...
End;
/
Create Or Replace Procedure SP_T_FIN_PAY_EXEC_LIST_U
(
	AR_COMP_CODE                               VARCHAR2,
	AR_WORK_DT                                 VARCHAR2,
	AR_SEQ                                     NUMBER,
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIN_PAY_EXEC_LIST_U
/* 2. 유형(시나리오) : Procedure
...
End;
/
Create Or Replace Procedure SP_T_FIN_PAY_EXEC_LIST_D
(
	AR_COMP_CODE                               VARCHAR2,
	AR_WORK_DT                                 VARCHAR2,
	AR_SEQ                                     NUMBER
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIN_PAY_EXEC_LIST_D
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FIN_PAY_EXEC_LIST 테이블 Delete
/* 4. 변  경  이  력 : 김흥수 작성(2006-02-13)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
Begin
	Delete T_FIN_PAY_EXEC_LIST
	Where	COMP_CODE = AR_COMP_CODE
	And	WORK_DT = F_T_StringToDate(AR_WORK_DT)
	And	SEQ = AR_SEQ;
End;
