Create Or Replace Procedure SP_T_SET_MAKE_EMP_INS_SLIP
(
...
Is
	...
	ls_Work_Code					T_WORK_CODE.WORK_CODE%Type := 'SETEMPINS';
...
Begin
	...
	Begin
		...
		Where	a.CODE_GROUP_ID = 'NPAY_EMP_INSU'
		And		RowNum < 2;	
	Exception When No_Data_Found Then
		Raise_Application_Error(-20009,'공통코드에 NPAY_EMP_INSU에 의한 계정이 설정되어 있지 않습니다.');
	End;
	...
	For lrA In ( 
					Select
						...
						Else
							b.DB_AMT
						End) L_AMT
					From	T_SET_EMP_INSUR_TARGET_SLIP a,
							T_ACC_SLIP_BODY1 b,
							T_SET_EMP_INSUR_ACC_CODE c
