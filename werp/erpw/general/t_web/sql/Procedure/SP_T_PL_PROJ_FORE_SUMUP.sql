Create Or Replace Procedure SP_T_PL_PROJ_FORE_SUMUP
(
...
Begin
	...
	(
		...
		From
				...
				From
					(
						Select
							...
							RowNum RN,
							Level LV,
							First_Value(a.BIZ_PLAN_ITEM_NO) Over(Order By  rn Range Lv - 1 Preceding ) LEAF_BIZ_PLAN_ITEM_NO
						From
							(
								Select
									a.BIZ_PLAN_ITEM_NO,
			...
			(
				Select
					...
					b.MOD_FORECAST_AMT ,
					b.FORECAST_AMT
				From	T_PL_COMP_DEPT_PLAN_EXEC b
		...
		And		a.LEAF_BIZ_PLAN_ITEM_NO = b.BIZ_PLAN_ITEM_NO (+)
		Group By
			a.COMP_CODE,
			a.CLSE_ACC_ID,
			a.CHG_SEQ,
	...
	Insert
	(COMP_CODE,CLSE_ACC_ID,CHG_SEQ,DEPT_CODE,WORK_YM,BIZ_PLAN_ITEM_NO,SUM_FORECAST_AMT,MOD_FORECAST_AMT,FORECAST_AMT)
	Values
	(s.COMP_CODE,s.CLSE_ACC_ID,s.CHG_SEQ,s.DEPT_CODE,s.WORK_YM,s.BIZ_PLAN_ITEM_NO,s.SUM_FORECAST_AMT,s.MOD_FORECAST_AMT,s.FORECAST_AMT);
End;
/
