Create Or Replace Procedure SP_T_SET_IND_INSUR_WORK_I
(
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_SET_IND_INSUR_WORK_I
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_SET_IND_INSUR_WORK 테이블 Insert
/* 4. 변  경  이  력 : 김흥수 작성(2006-03-23)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
Begin
	Insert Into T_SET_IND_INSUR_WORK
	(
		COMP_CODE,
		INSUR_WORK_NO,
		CRTUSERNO,
...
End;
/
Create Or Replace Procedure SP_T_SET_IND_INSUR_WORK_U
(
	AR_COMP_CODE                               VARCHAR2,
	AR_INSUR_WORK_NO                           NUMBER,
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_SET_IND_INSUR_WORK_U
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_SET_IND_INSUR_WORK 테이블 Update
/* 4. 변  경  이  력 : 김흥수 작성(2006-03-23)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
...
End;
/
Create Or Replace Procedure SP_T_SET_IND_INSUR_WORK_D
(
	AR_COMP_CODE                               VARCHAR2,
	AR_INSUR_WORK_NO                           NUMBER
)
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_SET_IND_INSUR_WORK_D
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_SET_IND_INSUR_WORK 테이블 Delete
/* 4. 변  경  이  력 : 김흥수 작성(2006-03-23)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
