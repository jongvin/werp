Create Or Replace Procedure SP_T_FIX_DEPREC_CAL_I
(
	AR_WORK_SEQ                                NUMBER,
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIX_DEPREC_CAL_I
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FIX_DEPREC_CAL 테이블 Insert
/* 4. 변  경  이  력 : 한재원 작성(2006-01-19)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
Begin
	Insert Into T_FIX_DEPREC_CAL
	(
		WORK_SEQ,
		CRTUSERNO,
		CRTDATE,
...
End;
/
Create Or Replace Procedure SP_T_FIX_DEPREC_CAL_U
(
	AR_WORK_SEQ                                NUMBER,
...
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIX_DEPREC_CAL_U
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FIX_DEPREC_CAL 테이블 Update
/* 4. 변  경  이  력 : 한재원 작성(2006-01-19)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
Begin
	Update T_FIX_DEPREC_CAL
	Set
...
End;
/
Create Or Replace Procedure SP_T_FIX_DEPREC_CAL_D
(
	AR_WORK_SEQ                                NUMBER
)
Is
/**************************************************************************/
/* 1. 프 로 그 램 id : SP_T_FIX_DEPREC_CAL_D
/* 2. 유형(시나리오) : Procedure
/* 3. 기  능  정  의 : T_FIX_DEPREC_CAL 테이블 Delete
/* 4. 변  경  이  력 : 한재원 작성(2006-01-19)
/* 5. 관련  프로그램 : 
/* 6. 특  기  사  항 : 
/**************************************************************************/
Begin
	Delete T_FIX_DEPREC_CAL
	Where	WORK_SEQ = AR_WORK_SEQ;
End;
/
