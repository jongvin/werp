Create Or Replace Procedure SP_T_FL_GET_EXEC_CONS_INFO_B
(
...
Begin
	...
	End If;
	PKG_FL_DEPT_EXEC_B.ProcessBatch(Ar_COMP_CODE,Ar_CLSE_ACC_ID,Ar_DEPT_CODE,Ar_WORK_YM,Ar_CRTUSERNO);
