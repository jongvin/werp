Create Or Replace Procedure SP_T_FL_GET_FORE_CONS_INFO
(
...
Begin
	...
	End If;
	PKG_FL_DEPT_FORE.ProcessBatch(Ar_COMP_CODE,Ar_CLSE_ACC_ID,Ar_DEPT_CODE,Ar_QUARTER_YEAR,Ar_CRTUSERNO);
	SP_T_FL_MONTH_FORE_SUMUP(Ar_COMP_CODE,Ar_CLSE_ACC_ID,Ar_DEPT_CODE,Ar_QUARTER_YEAR);
End;
/
