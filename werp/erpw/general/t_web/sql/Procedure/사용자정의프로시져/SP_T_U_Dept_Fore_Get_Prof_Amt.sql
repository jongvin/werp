Create Or Replace Procedure SP_T_U_Dept_Fore_Get_Prof_Amt
Is
	...
	(
		...
		From
			(
				...
				And		a.CASH_DATE Between To_Date(lsBegin ||'01','YYYYMMDD')
				...
				From	R_CONTRACT_COLLECTION_PLAN a
				Where	a.DEPT_CODE = lsDeptCode
				And		a.BILL_DATE Between To_Date(lsBegin ||'01','YYYYMMDD')
						And Last_Day(To_Date(lsEnd ||'01','YYYYMMDD'))
				Group By
					a.DEPT_CODE,
