Create Or Replace Procedure SP_T_U_Dept_Plan_Get_Est_Amt
Is
...
Begin
	...
	(
		Select
			...
			SysDate CRTDATE,
			Nvl(Sum(a.CASH_AMT),0) + Nvl(Sum(a.BILL_AMT),0) SUM_PLAN_AMT
		From	R_CONTRACT_COLLECTION_PLAN a
		Where	a.DEPT_CODE = lsDeptCode
		And		a.PLAN_DATE Between To_Date(lsClseAccId ||'0101','YYYYMMDD')
