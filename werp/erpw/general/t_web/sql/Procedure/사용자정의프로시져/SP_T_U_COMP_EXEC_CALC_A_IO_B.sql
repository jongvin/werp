Create Or Replace Procedure SP_T_U_COMP_EXEC_CALC_A_IO_B
(
	...
	If PKG_FL_DAY_EXEC.Is_DayExec Then
		...
		(
			Select
				...
				SysDate CRTDATE,
				Sum(Case a.MNG_CODE
					When Ar_In_Mng_Code Then b.SUM_EXEC_AMT
					When Ar_Out_Mng_Code Then - b.SUM_EXEC_AMT
					Else 0
				End) SUM_EXEC_AMT,
				Sum(Case a.MNG_CODE
					When Ar_In_Mng_Code Then b.MOD_EXEC_AMT
					When Ar_Out_Mng_Code Then - b.MOD_EXEC_AMT
					Else 0
				End) MOD_EXEC_AMT,
				Sum(Case a.MNG_CODE
					When Ar_In_Mng_Code Then b.EXEC_AMT
					When Ar_Out_Mng_Code Then - b.EXEC_AMT
					Else 0
				End) EXEC_AMT
	...
	Else
		...
		(
			Select
				...
				End) MOD_EXEC_AMT,
				Sum(Case a.MNG_CODE
					When Ar_In_Mng_Code Then b.B_MOD_EXEC_AMT
					When Ar_Out_Mng_Code Then - b.B_MOD_EXEC_AMT
					Else 0
				End) B_MOD_EXEC_AMT,
				Sum(Case a.MNG_CODE
					When Ar_In_Mng_Code Then b.EXEC_AMT
