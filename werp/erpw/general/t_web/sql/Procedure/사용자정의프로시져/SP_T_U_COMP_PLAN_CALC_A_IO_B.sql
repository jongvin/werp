Create Or Replace Procedure SP_T_U_COMP_PLAN_CALC_A_IO_B
(
...
Begin
	...
	(
		Select
			...
			SysDate CRTDATE,
			Sum(Case a.MNG_CODE
				When Ar_In_Mng_Code Then b.SUM_PLAN_AMT
				When Ar_Out_Mng_Code Then - b.SUM_PLAN_AMT
				Else 0
			End) SUM_PLAN_AMT,
			Sum(Case a.MNG_CODE
				When Ar_In_Mng_Code Then b.MOD_PLAN_AMT
				When Ar_Out_Mng_Code Then - b.MOD_PLAN_AMT
				Else 0
			End) MOD_PLAN_AMT,
			Sum(Case a.MNG_CODE
				When Ar_In_Mng_Code Then b.B_MOD_PLAN_AMT
				When Ar_Out_Mng_Code Then - b.B_MOD_PLAN_AMT
				Else 0
			End) B_MOD_PLAN_AMT,
			Sum(Case a.MNG_CODE
				When Ar_In_Mng_Code Then b.PLAN_AMT
				When Ar_Out_Mng_Code Then - b.PLAN_AMT
				Else 0
			End) PLAN_AMT
