Create Or Replace Procedure SP_T_U_COMP_FORE_CALC_HL_B
Is
...
Begin
	...
	(
		Select
			...
			SysDate CRTDATE,
			Sum(Case a.MNG_CODE
				When ls_FI_Mng_Code Then b.SUM_FORECAST_AMT
				When ls_IO_Mng_Code Then b.SUM_FORECAST_AMT
				When ls_Out_Mng_Code Then - b.SUM_FORECAST_AMT
				Else 0
			End) SUM_FORECAST_AMT,
			Sum(Case a.MNG_CODE
				When ls_FI_Mng_Code Then b.MOD_FORECAST_AMT
				When ls_IO_Mng_Code Then b.MOD_FORECAST_AMT
				When ls_Out_Mng_Code Then - b.MOD_FORECAST_AMT
				Else 0
			End) MOD_FORECAST_AMT,
			Sum(Case a.MNG_CODE
				When ls_FI_Mng_Code Then b.B_MOD_FORECAST_AMT
				When ls_IO_Mng_Code Then b.B_MOD_FORECAST_AMT
				When ls_Out_Mng_Code Then - b.B_MOD_FORECAST_AMT
				Else 0
			End) B_MOD_FORECAST_AMT,
			Sum(Case a.MNG_CODE
				When ls_FI_Mng_Code Then b.FORECAST_AMT
				When ls_IO_Mng_Code Then b.FORECAST_AMT
				When ls_Out_Mng_Code Then - b.FORECAST_AMT
				Else 0
			End) FORECAST_AMT
