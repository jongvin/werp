CREATE OR REPLACE Procedure SP_T_CALCPROCESS
(
	AR_WORK_SEQ                             NUMBER,
	Ar_MODUSERNO							NUMBER
)
...
/* 3. 감가상각을 계산한다.
/* 4. T_FIX_SUM 에 계산한 값을 저장한다.
/***************************************************/
	lr_T_FIX_DEPREC_CAL				T_FIX_DEPREC_CAL%RowType;
Begin
	Select
		*
	Into
	...
	If lr_T_FIX_DEPREC_CAL.CAL_CLS = 'A' Then		--월상각
		Merge Into T_FIX_SUM t
		Using
		(
			Select
				y.FIX_ASSET_SEQ ,
