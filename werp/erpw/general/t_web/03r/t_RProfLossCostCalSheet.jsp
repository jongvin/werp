...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RProfLossCostCalSheet.jsp(손이계산서)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RProfLossCostCalSheet";
	String strPageName = "t_RProfLossCostCalSheet";
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsCOPY classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__8); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__22"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transCopy"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
											...
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="100" class="font_green_bold" >손익계산서구분</td>
														<td width="112">
															<select id="cboPROF_LOSS_TAG" style="width:110">
																<option value="1">일반손익계산서</option>
																<option value="2">누적손익계산서</option>
															</select>
														</td>
														<td width=*>&nbsp;</td>
													</tr>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="100" class=font_green_bold>기준년월</td>
														<td width="52">
															<input id="txtYEAR_MONTH" type="text"  datatype=dateym style="width:60px" >
														</td>
														<td width="70">
															<input id="btnYEAR_MONTH" type="button" class="img_btnCalendar_S"  title="달력"  onclick="btnYEAR_MONTH_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
														</td>
														<td width=*>&nbsp;</td>
													</tr>
												</table>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="100" class=font_green_bold>현장</td>
														<td width="52">
