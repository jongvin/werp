		...
		if(!CITCommon.isNull(strAct) && strAct.equals("COPY"))
		{
			...
			try
			{
				for	(int i = 0;	i <	rows.length; i++)
				{
					...
					lrArgData.setValue("YEAR", rows[i].getString(dsCOPY.indexOfColumn("YEAR")));
					lrArgData.setValue("MONTH", rows[i].getString(dsCOPY.indexOfColumn("MONTH")));
