		...
		else
		{
			...
			for (int i = 0; i < lrFilters.getRowsCount(); i++)
			{
				...
				else if (lsType.equals("D"))
				{
					...
					{
						strFilterHtml += "<INPUT type='text' id='" + lsFilterName + "' datatype='DATE' center style='Width:78px'>";
						strFilterHtml += "<INPUT type='text' id='space' tabindex='-1' readOnly style='Width:2px;border:none;background:none'>";
					...
					{
						strFilterHtml += "<INPUT type='text' id='" + lsFilterName + "' datatype='DATEYM' center style='Width:58px'>";
						strFilterHtml += "<INPUT type='text' id='space' tabindex='-1' readOnly style='Width:2px;border:none;background:none'>";
				...
				else if (lsType.equals("C"))
				{
					...
					strFilterHtml += "<!--CONVPAGE_HEAD 지우지마세요//--> <comment id='__NSID__"+i+"'> <!--CONVPAGE_TAIL 지우지마세요//--> \n";
					strFilterHtml += "<object id=" + lsFilterName + " style='width:" + lsWidth + "px' classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69> \n";
					...
					strFilterHtml += "<!--CONVPAGE_HEAD 지우지마세요//--> </comment> <script> __WS__(__NSID__"+i+"); </script> <!--CONVPAGE_TAIL 지우지마세요//--> \n";
...
%>
	...
	<body id='bbody' onload="C_Initialize()">
				...
				<tr> 
					<td height="100%" width="100%">
						<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="100%" height="*">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id='__NSID___0'> <!--CONVPAGE_TAIL 지우지마세요//-->
									<OBJECT id=gridMain style="HEIGHT: 100% ; WIDTH: 100%"  classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
									...
									<!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID___0); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
								</td>
							</tr>
							<tr>
