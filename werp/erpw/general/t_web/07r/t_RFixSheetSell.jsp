...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RFixSheetSell.jsp(고정자산대장출력(매각))
/* 2. 유형(시나리오) : shared window 조회 및 입력
/* 3. 기  능  정  의 : 고정자산대장출력(매각)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String 	strFileName = "./t_RFixSheetSell";
//저장 액션
								...
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="186">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id="cboASSET_CLS_CODE" style="width:100" classid=clsid:60109D65-70C0-425c-B3A4-4CB001513C69 VIEWASTEXT codebase="../../../cabfiles/LuxeCombo.cab#version=1,1,0,16">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="80" class="font_green_bold" >품목구분</td>
											<td width="72">
												<input id="txtITEM_CODE" type="text" style="width:70px" onblur="txtITEM_CODE_onblur()">
											</td>
											<td width="150">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="80" class="font_green_bold" >품명구분</td>
											<td width="72">
												<input id="txtITEM_NM_CODE" type="text" style="width:70px" onblur="txtITEM_NM_CODE_onblur()">
											</td>
											<td width="150">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="72">
												<input id="txtDEPT_CODE" type="text" style="width:70px" onblur="txtDEPT_CODE_onblur()">
											</td>
											<td width="150">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="70"> <input name="txtINCREDU_DT_FROM" type="text" datatype="date" style="width:70px" VALUE="" ></td>
											<td width="20"><input id="btnINCREDU_DT_FROM" type="button" class="img_btnCalendar_S" title="달력" onclick="btnINCREDU_DT_FROM_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"></td>
											<td width="12">~</td>
											<td width="70"><input name="txtINCREDU_DT_TO" type="text" datatype="date" align="Center" style="width:70px" VALUE=""></td>
											<td width="20"><input id="btnINCREDU_DT_TO" type="button" class="img_btnCalendar_S" title="달력" onclick="btnINCREDU_DT_TO_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"></td>
											<td width="2">&nbsp;</td>
											<td width="40">
												&nbsp;
											</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="80" class="font_green_bold" >고정자산구분</td>
											<td width="186">
												<select id=cboFIXED_CLS>
													<%= strFIXED_CLS %>
												</select>
											</td>
