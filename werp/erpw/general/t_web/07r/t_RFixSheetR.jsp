...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFixSheetR.jsp(고정자산대장출력)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String 	strFileName = "./t_RFixSheetR";
//저장 액션
								...
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="62">
												<input id="txtGET_DT" type="text" datatype=date style="width:70px">
											</td>
											
											<td width="30">
												<input id="btnGET_DT" type="button" class="img_btnCalendar_S" onClick="btnGET_DT_onClick()" title="달력" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"/>
											</td>
