...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RFixDeprecSumByAcc.jsp(감가상각비 자산종류별 명세서)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RFixDeprecList";
//저장 액션
	...
	try
	{
		...
		try
		{
			...
			strSql  = "Select \n";
			strSql += "		a.ASSET_CLS_CODE AS CODE, \n";
			strSql += "		a.ASSET_CLS_NAME AS NAME \n";
			strSql += "From	T_FIX_ASSET_CLS_CODE a \n";
			strSql += "Order by	ASSET_CLS_CODE \n";

			lrReturnData = CITDatabase.selectQuery(strSql, lrArgData);

			strASSET_CLS_CODE = CITCommon.toHtmlComboString(lrReturnData, "CODE", "NAME");
		}
		catch (Exception ex)
		{
							...
							<tr> 
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="85" class="font_green_bold" >자산구분</td>
											<td width="102">
												<select id="cboASSET_CLS_CODE" style="WIDTH: 100px" class="input_listbox_default"><%=strASSET_CLS_CODE%></select>
											</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="85" class="font_green_bold">품목코드</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="85" class="font_green_bold">작업일자</td>
