...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 		nvl(a.GET_COST_AMT,0) GET_COST_AMT , 		--취득원가 \n";
			strSql += " 		nvl(a.OLD_DEPREC_AMT, 0) DEPREC_AMT, 	--감가상각누계액 \n";
			strSql += " 		nvl(g.INCSUB_AMT,0) INCSUB_AMT, 		--매각금액 \n";
			strSql += " 		abs(nvl(a.GET_COST_AMT,0) - (nvl(a.OLD_DEPREC_AMT,0) + nvl(g.INCSUB_AMT,0))) add_loss_amt, 		--순손익 \n";
			strSql += " 		nvl(a.GET_COST_AMT,0) - (nvl(a.OLD_DEPREC_AMT,0) + nvl(g.INCSUB_AMT,0)) add_loss_amt1, 		--순손익 \n";
			...
			strSql += " where		g.slip_id = f.slip_id(+) \n";
			strSql += " and		a.fix_asset_seq = g.fix_asset_seq \n";
			strSql += " and		g.incredu_cls = 4 \n";
			if(strDIV.equals("D"))
			{
