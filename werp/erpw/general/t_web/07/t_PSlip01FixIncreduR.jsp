...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_PSlip01FixIncreduR(자본적지출전표자동생성)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//파일명
	...
	String strFileName = "./t_PSlip01FixIncreduR";
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsAUTO_BILL_FIX_INCSUB_SEQ classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__7); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
								...
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="77">&nbsp;</td>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="60" class="font_green_bold">증감년도</td>
											<td width="62">
						...
						<!-- 간격조정 테이블 종료 //-->
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="font_green_bold"> 자본적지출전표 자동생성</td>
										<td align="right">
										<input id="btnSlipCreate" type="button" class="img_btn9_1" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" value="자본적지출전표생성" onclick="btnSlipCreate_onClick()"/>
										<!--<input id="btnSlipDelete" type="button" class="img_btn9_1" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" value="자본적지출전표삭제" onclick="btnSlipDelete_onClick()"/>-->
										</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<FC> Name=seq ID=INCREDU_SEQ Align=Left HeadAlign=Center  Width=120	BgColor='#FFFCE0' 	Edit='none' show=false
											</FC>
											 <FC> Name=기본 ID=CHK_CLS Width=30 EditStyle=Checkbox show=true
											</FC>
											<FC> Name=계정코드 ID=ACC_CODE Align=Left HeadAlign=Center  Width=120	BgColor='#FFFCE0' 	Edit='none' show=false
											</FC>
											...
											<C> Name=자본적지출 		ID=INCSUB_AMT		Align=Right	 Edit='none' Width=120   	Show='true'  Sort='true'
											</C>
											<C> Name=부가세 			ID=VAT_AMT		Align=Right	 Edit='none' Width=120   	Show='false'  Sort='true'
											</C>
											<C> Name=전표발의번호 	ID=SLIP_ID		Align=Center	 Edit='none' Width=100   	Show='true'  Sort='true'
											</C>
