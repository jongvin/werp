...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 		T_DEPT_CODE_ORG d1, \n";
			strSql += " 		T_DEPT_CODE_ORG d2, \n";
			...
			strSql += "Order	By	a.ASSET_MNG_NO desc ";
		...
		if (strAct.equals("MAIN2"))
		{
			...
			strSql += " 	  a.incredu_seq, \n";
			strSql += " 	  F_T_DATETOSTRING(incredu_dt) incredu_dt, \n";
			strSql += " 	  a.incredu_cls, \n";
			strSql += " 	  a.incsub_cnt, \n";
			strSql += " 	  a.incsub_amt, \n";
			strSql += " 	  a.incredu_remark, \n";
			strSql += " 	  a.approp_subamt, \n";
			strSql += " 	  a.vatamt, \n";
			strSql += " 	  to_char(a.SLIP_ID) SLIP_ID,				--전표ID  	    \n";
			strSql += " 	  to_char(a.SLIP_IDSEQ) SLIP_IDSEQ,		--전표ID순번 \n";
			strSql += " 	  a.st_cust_seq, \n";
			strSql += " 	  b.cust_name, \n";
			strSql += " 	  a.st_emp_no, \n";
			strSql += " 	  c.name emp_name, \n";
			...
			strSql += " from  t_fix_incredu a, \n";
			strSql += " 	   t_cust_code b, \n";
			strSql += " 	   z_authority_user c, \n";
			strSql += " 	   T_ACC_SLIP_HEAD aa \n";
			strSql += " where a.st_cust_seq = b.cust_seq(+) \n";
			strSql += " and     a.st_emp_no = c.empno(+) \n";
			strSql += " and     a.SLIP_ID = aa.SLIP_ID (+) \n";
			strSql += " and     a.fix_asset_seq = ? \n";
			strSql += " order by a.INCREDU_DT , INCREDU_CLS ";
			...
			try
			{
				...
				lrReturnData.setKey("FIX_ASSET_SEQ", true);
				lrReturnData.setKey("INCREDU_SEQ", true);
				lrReturnData.setNotNull("INCREDU_DT", true);
				lrReturnData.setNotNull("INCREDU_CLS", true);
				lrReturnData.setNotNull("INCSUB_CNT", true);
				lrReturnData.setNotNull("INCSUB_AMT", true);
		...
		//증감순번
		else	if (strAct.equals("INCREDU_SEQ"))
		{
			strSql  =  "SELECT SQ_T_FIX_INCREDU.NEXTVAL INCREDU_SEQ 		\n";
			strSql  += "FROM   DUAL ";
		...
		{
			strSql  =  "SELECT to_char(sysdate,'YYYY-MM-DD') INCREDU_DT 		\n";
			strSql  += "FROM   DUAL ";
		...
		else if (strAct.equals("REMOVE"))
		{
			...
			strSql  = " Select 0 FIX_ASSET_SEQ, 0  INCREDU_SEQ From Dual ";
