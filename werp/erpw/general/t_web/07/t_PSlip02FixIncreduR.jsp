...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_PSlip01FixIncreduR(매각전표자동생성)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
/* 4. 변  경  이  력 : 한재원 작성(2006-02-08)
...
//파일명
	...
	String strFileName = "./t_PSlip02FixIncreduR";
...
*/
	 	...
	 	try
		{
			...
			strINCSUB_YEAR = CITCommon.toHtmlComboString(lrReturnData, "CODE", "NAME");
		}
		catch (Exception ex)
		{
			throw new Exception("USER-900001:공통코드의 증감년도 Select 오류 -> " + ex.getMessage());
		}
	}
	catch (Exception ex)
	{
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsAUTO_BILL_FIX_SELL_SEQ classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__7); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsASSETCLS classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__8); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsDEPREC_FINISH classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="82">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id="cboDEPREC_FINISH" style="width:80" classid=clsid:60109D65-70C0-425c-B3A4-4CB001513C69 VIEWASTEXT codebase="../../../cabfiles/LuxeCombo.cab#version=1,1,0,16">
													<PARAM NAME="ComboStyle" VALUE="5">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="77">&nbsp;</td>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="60" class="font_green_bold">매각년도</td>
											<td width="62">
												 <select id=cboINCSUB_YEAR style="WIDTH: 60px" class="input_listbox_default">
												 	<%= strINCSUB_YEAR %>
												 </select>
											</td>
											<td width=*>&nbsp;</td>
						...
						<!-- 간격조정 테이블 종료 //-->
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="font_green_bold"> 매각전표 자동생성</td>
										<td align="right">
										<input id="btnSlipCreate" type="button" class="img_btn6_1" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" value="매각전표생성" onclick="btnSlipCreate_onClick()"/>
										<!--<input id="btnSlipDelete" type="button" class="img_btn6_1" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" value="매각전표삭제" onclick="btnSlipDelete_onClick()"/>--> 
										</td>
													...
													<!-- 프로그래머 디자인 시작 //-->
														...
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
																...
																<td width="5">&nbsp;</td>
																<td width="15"><img src="../images/bullet3.gif"></td>
																<td width="60">부가세등록</td>
																<td width="37">
																	<select id="cboVAT_TAG">
																		<option value=Y>예
																		<option value=N>아니오
																	</select>
																</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<FC> Name=기본 ID=CHK_CLS Width=30 EditStyle=Checkbox
											</FC>
											<C> Name=자산명칭 		ID=ASSET_NAME		Align=Left	 Edit='none' Width=200   	Show='true'  Sort='true'
											</C>
											<C> Name=취득금액 		ID=GET_COST_AMT			Align=Right	 Edit='none' Width=130   	Show='true'  Sort='true'
											</C>
											<C> Name=감가상각누계액 	ID=DEPREC_AMT	Align=Right	 Edit='none' Width=130   	Show='true'  Sort='true'
											</C>
											<C> Name=매각금액 		ID=INCSUB_AMT			Align=Right	 Edit='none' Width=130   	Show='true'  Sort='true'
											</C>
											<C> Name=처분손익             ID=ADD_LOSS_AMT	Align=Right	 Edit='none' Width=130   	Show='true'  Sort='true'
											</C>
											<C> Name=전표발의번호 	ID=SLIP_ID			Align=Center	 Edit='none' Width=80   	Show='false'  Sort='true' 
											</C>
