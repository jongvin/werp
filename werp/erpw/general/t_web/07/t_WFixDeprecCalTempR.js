...
function btnadd_onclick()
{
	...
	if ( G_FocusDataset.id =="dsMAIN2")
	{
		...
		window.showModalDialog("t_PFixDeprecCalTemp.jsp", arrRec, "center:yes; dialogWidth:800px; dialogHeight:400px; status:no; help:no; scroll:no");
...
function btnAutoSlipMake_onClick()
{
	...
	arrRtn2 = window.showModalDialog("t_PSlipFixDeprecR.jsp", arrRtn, "center:yes; dialogWidth:1024px; dialogHeight:768px; status:no; help:no; scroll:no");
