...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFixIncreduTempR";
//저장 액션
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="186">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id="cboASSET_CLS_CODE" style="width:100" classid=clsid:60109D65-70C0-425c-B3A4-4CB001513C69 VIEWASTEXT codebase="../../../cabfiles/LuxeCombo.cab#version=1,1,0,16">
											...
											<td width="102">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id="cboDEPREC_FINISH" style="width:100" classid=clsid:60109D65-70C0-425c-B3A4-4CB001513C69 VIEWASTEXT codebase="../../../cabfiles/LuxeCombo.cab#version=1,1,0,16">
													<PARAM NAME="ComboStyle" VALUE="5">
					...
					<td width="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="right">
									<input id="btnAutoSlipMake" type="button" class="img_btn12_1" value="자본적지출 자동전표발행" onclick="btnAutoSlipMake_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
									<input id="btnAutoSlipMake2" type="button" class="img_btn9_1" value="매각 자동전표발행" onclick="btnAutoSlipMake2_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
									<input id="btnAutoSlipMake3" type="button" class="img_btn9_1" value="폐기 자동전표발행" onclick="btnAutoSlipMake3_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
								</td>
							</tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr valign="top"> 
					<td width="100%" height="100%">
						<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN2 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbgrid.cab#version=1,1,0,125">
										<PARAM NAME="Editable"  	VALUE="-1">
										<PARAM NAME="ColSelect" 	VALUE="-1">
										<PARAM NAME="ColSizing" 	VALUE="-1">
										<PARAM NAME="SortView"    VALUE="Right">
										<PARAM NAME="Format" 	VALUE="
											<C> Name=증감구분 		ID=INCREDU_CLS		Align=Center	 Width=100   EditStyle='Combo' Data='<%= strINCREDU_CLS %>' 	Show='true'
											</C>
											<C> Name=증감일자 		ID=INCREDU_DT		Align=Center	 Width=100   	 	Show='true' EditStyle=popup
											</C>
											<C> Name=수량 		       ID=INCSUB_CNT		Align=Right	 Width=80   	 	Show='true'
											</C>
											<C> Name=증감금액 		ID=INCSUB_AMT		Align=Right	 Width=150   	 	Show='true'
											</C>
											<C> Name='충당금 감소액'	ID=APPROP_SUBAMT	Align=Right	 Width=150   	 	Show='true'
											</C>
											<C> Name=거래처 			ID=CUST_NAME	      Align=Right	 Width=150   	 	Show='true' EditStyle=popup
											</C>
											<C> Name=담당자 			ID=EMP_NAME			Align=Right	 Width=100   	 	Show='true'  EditStyle=popup
											</C>
											<C> Name=부가세 			ID=VATAMT			Align=Right	 Width=150   	 	Show='false'
											</C>
