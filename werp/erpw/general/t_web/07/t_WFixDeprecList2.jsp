...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFixDeprecList2";
//저장 액션
							...
							<tr> 
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="65" class="font_green_bold" >자산구분</td>
											<td width="62">
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=월 		    ID=MM			Align=CENTER	 Width=30   	Edit='none' Suppress=1 BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=품목 			ID=ITEM_NAME			Align=CENTER	 Width=100   	Edit='none' Suppress=1  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=자산번호 		ID=ASSET_MNG_NO			Align=CENTER	 Width=100   	Edit='none'  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=자산명 		ID=ASSET_NAME		Align=CENTER	 Width=160   	Edit='none' 	Show='true'	SumText=' 합  계 :' SubColor='RED'  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=기초자산가액 	ID=START_ASSET_AMT		Align=Right	 Width=100   	Edit='none' 	SumText=@sum	SumColor=Black	SumBgColor=#FFF270  SumTextAlign=right  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=당기자산증가 	ID=CURR_ASSET_INC_AMT	Align=Right	 Width=100   	Edit='none' 	SumText=@sum	SumColor=Black	SumBgColor=#C4E693  SumTextAlign=right  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=당기자산감소 	ID=CURR_ASSET_SUB_AMT	Align=Right	 Width=100   	Edit='none'     SumText=@sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=기말자산가액 	ID=LAST_AMT				Align=Right	 Width=100   	Edit='none'		SumText=@sum	SumColor=Black	SumBgColor=#BFB448  SumTextAlign=right  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name='기초충당금'		ID=BEFORE_OLD_DEPREC_AMT		Align=Right	 Width=100   	Edit='none'     SumText=@sum	SumColor=Black	SumBgColor=#FFF270  SumTextAlign=right  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=충당금감소액  	 ID=CURR_APPROP_SUB_AMT	Align=Right	 Width=100   	Edit='none'     SumText=@sum	SumColor=Black	SumBgColor=#C4E693  SumTextAlign=right  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=당기상각액 		ID=CURR_DEPREC_AMT		Align=Right	 Width=100   	Edit='none'		SumText=@sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=충당금누계액 	ID=OLD_DEPREC_AMT		Align=Right	 Width=100   	Edit='none'		SumText=@sum	SumColor=Black	SumBgColor=#BFB448  SumTextAlign=right  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
											<C> Name=장부가액 		ID=BASE_AMT				Align=Right	 Width=100   	Edit='none'		SumText=@sum	SumColor=Black	SumBgColor=#A8C9FF  SumTextAlign=right  BgColor={Decode(div,'12','yellow', '13','gray','14','blue')} 
											</C>
