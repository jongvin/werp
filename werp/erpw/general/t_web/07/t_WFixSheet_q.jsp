...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 		to_char(NVL(a.INC_SUM_AMT,0)-NVL(a.SUB_SUM_AMT,0)-NVL(a.OLD_DEPREC_AMT,0), '99,999,999,999')   INC_SUB_SUM_AMT,		--증감누계 \n";
			strSql += " 		to_char(nvl(a.GET_COST_AMT,0) + NVL(a.INC_SUM_AMT,0)- NVL(a.SUB_SUM_AMT,0) - NVL(a.OLD_DEPREC_AMT,0), '99,999,999,999')   JAN_AMT,		--잔존가액 \n";
			...
			strSql += " 		a.ESTIMATE_AMT1,	--견적가 \n";
			strSql += " 		a.ESTIMATE_AMT2,	 --복수견적가 \n";
			strSql += " 		a.FOREIGN_AMT,		 	--외환가격 \n";
