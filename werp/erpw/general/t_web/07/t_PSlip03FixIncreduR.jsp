...
//파일명
	...
	String strFileName = "./t_PSlip03FixIncreduR";
								...
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="77">&nbsp;</td>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="60" class="font_green_bold">폐기년도</td>
											<td width="62">
						...
						<!-- 간격조정 테이블 종료 //-->
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="font_green_bold"> 폐기전표 자동생성</td>
										<td align="right">
										<input id="btnSlipCreate" type="button" class="img_btn6_1" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" value="폐기전표생성" onclick="btnSlipCreate_onClick()"/>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											...
											<C> Name=전표발의번호 	ID=SLIP_ID			Align=Center	 Edit='none' Width=80   	Show='true'  Sort='true'
											</C>
