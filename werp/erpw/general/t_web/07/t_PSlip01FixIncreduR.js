...
function Initialize()
{
	...
	G_addDataSet(dsAUTO_BILL_FIX_INCSUB_SEQ, null, null, null, "자본적지출_자동전표_작업번호");
...
function OnLoadBefore(dataset)
{
	...
	else if(dataset == dsAUTO_BILL_FIX_INCSUB_SEQ)
	{
		dataset.DataID = sSelectPageName	+ D_P1("ACT","AUTO_BILL_FIX_INCSUB_SEQ");
	}
}
...
function SetIfrmOtherAccPageAmt()
{
	...
	ifrmOtherAccPage.dsSLIP_D.NameString(1,"DB_AMT") 	  = 0; 
	ifrmOtherAccPage.dsSLIP_D.NameString(1,"DB_AMT_D") = 0;
	ifrmOtherAccPage.dsSLIP_D.NameString(1,"CR_AMT") 	  =parseInt(dsMAIN.NameValue(dsMAIN.RowPosition, "INCSUB_AMT")) +  parseInt(txtVAT_AMT.value);
	ifrmOtherAccPage.dsSLIP_D.NameString(1,"CR_AMT_D") = C_toNumberFormatString(parseInt(dsMAIN.NameValue(dsMAIN.RowPosition, "INCSUB_AMT")) +  parseInt(txtVAT_AMT.value));
...
function	btnSlipCreate_onClick()
{
	...
	*/
	...
	G_Load(dsAUTO_BILL_FIX_INCSUB_SEQ, null); 
	
	btnSLIP_MAKE_SLIPNO_onClick();
	
	trans.Parameters = "";
	trans.Parameters += "ACT=AUTO_BILL_FIX_INCSUB";
	trans.Parameters += ",AUTO_BILL_FIX_INCSUB_SEQ="+dsAUTO_BILL_FIX_INCSUB_SEQ.NameString(1,"AUTO_BILL_FIX_INCSUB_SEQ");
