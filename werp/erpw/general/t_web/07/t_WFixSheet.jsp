...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFixSheetR.jsp(고정자산대장조회)
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="102">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id="cboDEPREC_FINISH" style="width:100" classid=clsid:60109D65-70C0-425c-B3A4-4CB001513C69 VIEWASTEXT codebase="../../../cabfiles/LuxeCombo.cab#version=1,1,0,16">
													<PARAM NAME="ComboStyle" VALUE="5">
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<FC> Name=자산명칭 		ID=ASSET_NAME		Align=Left	 Width=150   		Show='true'  		Sort='true'
											</FC>
											<C> Name=취득일자 		ID=GET_DT			Align=Center	 Width=70   	  	Show='true'
											</C>
											<C> Name=내용년수 		ID=SRVLIFE			Align=Center	 Width=70   	  	Show='true'
											</C>
											<C> Name=취득금액 		ID=GET_COST_AMT		Align=Right	 Width=100     	Show='true'
											</C>
											<C> Name=감가누계금액 	ID=INC_SUB_SUM_AMT	Align=Right	 Width=100     	Show='true'
											</C>
											<C> Name=잔존가액금액 	ID=BASE_AMT			Align=Right	 Width=100   	  	Show='true'
											</C>
											<C> Name=잔존가액금액 	ID=JAN_AMT			Align=Right	 Width=100     	Show='false'
											</C>
											<C> Name=관리부서 		ID=MNG_DEPT_NAME	Align=Left	 Width=120   	  	Show='true'
											</C>
											<C> Name=배치부서 		ID=DEPT_NAME		Align=Left	 Width=120   	  	Show='true'
											</C>
											<C> Name=완료구분 		ID=DEPREC_FINISH	EditStyle='Combo' Data='<%=strDEPREC_FINISH_NAME%>'	Align=Center	 Width=100 Show='true'
											</FC>
											<C> Name=규격 			ID=ASSET_SIZE		Align=Left	 Width=180   	  	Show='true'
											</FC>
											<C> Name=견적금액 		ID=ESTIMATE_AMT1	Align=Right	 Width=100     	Show='true'
											</C>
											<C> Name=복수견적금액 	ID=ESTIMATE_AMT2	Align=Right	 Width=100     	Show='true'
											</C>
											<C> Name=외환가격  		ID=FOREIGN_AMT    	Align=Right	 Width=100     	Show='true'
											</C>
