...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFixDeprecRatR.jsp(고정자산내용년수등록)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFixDeprecRatR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 고정자산내용년수</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<C> Name=내용년수 ID=SRVLIFE Width=80   Align=Center
											</C> 
											<C> Name=정율법 ID=DEPREC_RAT5 Width=80
											</C> 
											<C> Name=정율법10 ID=DEPREC_RAT10 Width=80 show=false
											</C>  
											<C> Name=정액법 ID=DEPREC_AMT Width=80
											</C>
