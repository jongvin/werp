...
function Initialize()
{
	...
	G_addDataSet(dsMAIN2, trans, gridMAIN2, sSelectPageName+D_P1("ACT","MAIN2"), "고정자산배치현황");
	...
	G_addDataSet(dsMOVE_SEQ, null, null, sSelectPageName+D_P1("ACT","MOVE_SEQ"), "배치순번");
...
function OnRowInserted(dataset, row)
{
	...
	if (dataset == dsMAIN2)
	{
		...
		dataset.NameString(dataset.RowPosition,"MOVE_DT_FROM") 	= dsCUR_DATE.NameValue(dsCUR_DATE.RowPosition,"CUR_DATE");//디폴트오늘날짜입력
