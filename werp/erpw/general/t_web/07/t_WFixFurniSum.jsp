...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFixFurniSum.jsp(부서별 상각액)
								...
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="97">&nbsp;</td>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="65" class="font_green_bold">작 업 명</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="65"  class="font_green_bold" >귀속부서</td>
											...
											<td width="25">&nbsp;</td>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="65" class="font_green_bold">귀속일자</td>
				...
				<tr valign="top"> 
					<td width="100%" height="100%">
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=계정명 		ID=ACC_NAME				Align=Left	 Width=160   	Edit='none' 	Show='true'		SumText=' 합  계 :' SubColor='RED'
											</C>
											...
											<C> Name=감가상각액 	ID=CURR_DEPREC_AMT		Align=Right	 Width=100   	Edit='none'		SumText=@sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right
											</C>
											...
											<C> Name=취득원가 		ID=GET_COST_AMT			Align=Right	 Width=100   	Edit='none'     Show='false'	SumText=@sum	SumColor=Black	SumBgColor=#C4E693  SumTextAlign=right
											</C>
											<C> Name='증액누계' 	ID=INC_SUM_AMT			Align=Right	 Width=100   	Edit='none'     Show='false'	SumText=@sum	SumColor=Black	SumBgColor=#C4E693  SumTextAlign=right
											</C>
						...
						<table width="100%" height="50%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold"> 회기별 상각액</td>
											<td align="right" width="*">
												&nbsp;
											</td>
										</tr>
							...
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN2 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										<PARAM NAME="DataID" VALUE="dsMAIN2">
										<PARAM NAME="Editable" VALUE="-1">
										<PARAM NAME="ColSelect" VALUE="-1">
										<PARAM NAME="ColSizing" VALUE="-1">
										<PARAM NAME="Format" VALUE=" 
											<C> Name=배치부서 		ID=DEPT_NAME	Align=Left	 Width=160   	Edit='none' 	Show='true'		 
											</C>
											<C> Name=귀속시작일자 	ID=SUM_DT_FROM	Align=Center	 Width=100   	Edit='none' 	Show='true' 
											</C>
											<C> Name=귀속종료일자 	ID=SUM_DT_TO	Align=center	 Width=100   	Edit='none' 	Show='true'
											</C>
											<C> Name=상각액 			ID=DEPREC_AMT	Align=Left	 Width=160   	Edit='none' 	Show='true'
											</C>
