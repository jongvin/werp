...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFixDeprecSum";
//저장 액션
								...
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="97">&nbsp;</td>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="85" class="font_green_bold">작 업 명</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=자산종류 		ID=ASSET_CLS_NAME				Align=CENTER		 Width=160   	Edit='none' 	Show='true'		SumText=' 합  계 :' SubColor='RED'
											</C>
