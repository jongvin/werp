...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WETaxSale6R(세금계산서건별등록)
/* 2. 유형(시나리오) : 화면디자인
/* 3. 기  능  정  의 : 프로그램 설명 
...
//파일명
	...
	String strFileName = "./t_WETaxSale6R";
	String strFileName01 = "t_WETaxSale6R";
...
<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsBEFORE classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__6); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
...
<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transMAIN"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="152">
												<input id="txtDOC_NUMBER"	type="text" center datatype="n"  readOnly adsreadonly maxlength=32 style="width:150px" tabindex="2" />
											</td>
											<td width="21">
												<input id="btnDOCU_NO" type="hidden" class="img_btnFind" value="검색" onclick="btnDOCU_NO_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
											<td>&nbsp;</td>
										</tr>
									</table>
...
<input id="btnRESAVE"	type="button" tabindex="-1" class="img_btn4_1" onClick="btnRESAVE_onclick();"	value="저장"	onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
...
<input id="btnCANCEL"		type="hidden" tabindex="-1" class="img_btn4_1" onClick="btnCANCEL_onclick();"		value="발행취소"		onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
										...
										<table width="100%" height="59%" border="1" bordercolor="black" cellspacing="0" cellpadding="2">										
											<tr>
												<td width="690" height="100%">
													<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
...
<C>  Name=규격 			ID=ITEM_UNIT 		Width=50 </C>
...
<C>  Name=비고			ID=ITEM_BIGO 		width=200 </C>
		...
		<!-- 가우스 Bind 객체정의 시작 //-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=ADE_Bind_1 style="Z-INDEX: 107; LEFT: 335px; POSITION: absolute; TOP: 158px" classid=clsid:9C9AB433-EA85-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbbind.cab#version=1,1,0,13">
			<PARAM NAME="DataID" 		VALUE="dsSLIP_H">
