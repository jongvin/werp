...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WETaxDeptR(부서 등록)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명
	String strFileName = "./t_WETaxDeptR";
//저장 액션
	...
	<body onload="C_Initialize()">
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="80" class=font_green_bold>부서코드</td>
											<td width="120">
											<input name="txtHDEPT_CODE" type="text" class="han" style="width:120px" VALUE="" ></td>
											<td>&nbsp; </td>
											</table>
											</td>
											<td width="245">
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="50" class=font_green_bold>부서명</td>
											<td width="150">
											<input name="txtHDEPT_NAME" type="text" class="han" style="width:150px" VALUE="" ></td>
											<td>&nbsp; </td>
											</table>
											</td>
											<td>&nbsp; </td>
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 부서 목록</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr class="head_line">
											...
											<td id="kkk" width="*" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<FC> Name=부서코드 ID=SECT_CODE Width=100 Edit=none
														</FC>
														<C> Name=부서명 ID=SECT_NAME  Width=250 Edit=none
														</C>
														<C> Name=사업장코드 ID=SAUP_CODE Align=Center Width=100 Edit=none
														</C>
														">
											...
											<td width="400" height="100%" valign="top" onActivate="G_focusDataset(dsMAIN)">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="*"><input id="txtSECT_CODE" type="text" notnull style="width:212px" ></td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="100">부서명</td>
														<td width="*"><input id="txtSECT_NAME" type="text" notnull style="width:212px"></td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="*"><input id="txtSAUP_CODE" type="text" style="width:100" ></td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="100">조직코드</td>
														<td width="*"><input id="txtORGAN_CODE" type="text" style="width:100px" ></td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=ADE_Bind_1 style="Z-INDEX: 107; LEFT: 335px; POSITION: absolute; TOP: 158px" classid=clsid:9C9AB433-EA85-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbbind.cab#version=1,1,0,13">
			...
			<PARAM NAME="BindInfo" VALUE="
				...
				<C> Col=ORGAN_CODE			Ctrl=txtORGAN_CODE		Param=value</C>
