...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WETaxItemR(제품코드등록)
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="80" class=font_green_bold>제품코드</td>
											<td width="120">
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="50" class=font_green_bold>제품명</td>
											<td width="150">
								...
								<td width="100%">
									...
									<form name="fileUploadForm" method="post" target="hidden" enctype="multipart/form-data">
										<tr>
											...
											<td class="font_green_bold"> 제품 목록</td>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="150" class="font_green_bold">제품정보 UPLOAD</td>
														<td width="230"><input type="file" name="fileCMS" length='8' value=""></td>
														<td width="5" class=font_green_bold >&nbsp;</td>
														<td width="77"><input id="btnFileLoad" type="button" class="img_btn8_1" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" value="파일불러오기" onclick="btnFileLoad_onClick();" /></td>
														<td>&nbsp;</td>
									</form>				
										</tr>
									</table>
											...
											<td id="kkk" width="*" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<FC> Name=제품코드 ID=ITEM_CODE Width=100 Edit=none
														</FC>
														<C> Name=제품명 ID=ITEM_NAME  Width=250 Edit=none
														</C>
														<C> Name=제품크기 ID=ITEM_SIZE Align=Center Width=100 Edit=none
														</C>
														">
