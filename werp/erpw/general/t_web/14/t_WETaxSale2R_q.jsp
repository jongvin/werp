...
/**************************************************************************/
	...
	try
	{
		...
		else if (strAct.equals("REGNUM"))
		{
			...
			{
				if (GauceInfo == null) GauceInfo = new CITGauceInfo(request, response);
				GauceInfo.response.writeException("USER", "900001","REGNUM Select 오류-> "+ ex.getMessage());
			}
		}		
		else if (strAct.equals("USER"))
		{
			...
			{
				if (GauceInfo == null) GauceInfo = new CITGauceInfo(request, response);
				GauceInfo.response.writeException("USER", "900001","USER Select 오류-> "+ ex.getMessage());
			}
		}				
	}
	catch (Exception ex)
