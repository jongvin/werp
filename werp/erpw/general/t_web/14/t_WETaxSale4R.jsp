...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명
	String strFileName = "./t_WETaxSale4R";
	String strFileName01 = "t_WETaxSale4R";
//저장 액션
										...
										<tr>
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="70" class="font_green_bold" >세무구분</td>
														<td width="239">
														...
														<td width="162" align="right">세금계산서 양식조회  -> </td>
									...
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="100%">
												...
												<td class="font_green_bold"> 세금계산서발행현황</td>												
												</tr>
												</table>
...
<%
String  strBgColor = "BgColor ={Decode(LINE_FLAG,'type1','#FFFCE0','type3','#ECF5EB','type4','#E0F4FF','white')}";
String  strColor=    "Color   ={Decode(LINE_FLAG,'type1','blue','type3','red','type4','green',  'black')}";
String  strColorh=   "Color   ={Decode(LINE_FLAG,'type1','#FFFCE0','type3','red','type4','green',  'black')}";
%>													
														<PARAM NAME="Format" VALUE="
														<C> Name=처리상태 ID=status						Align=center 	Edit='none' Width=80		<%=strBgColor%>	
														</C>
														<C> Name=문서번호 ID=DOC_NUMBER  			Align=left  	Edit='none' Width=145 	<%=strBgColor%>	<%=strColor%>
														</C>
														<C> Name=작성일자 ID=GEN_TM  					Align=Left  	Edit='none' Width=70		<%=strBgColor%>
														</C>														
														<C> Name=받는자사업번호 ID=BUY_REGNUM Align=Left  	Width=120								<%=strBgColor%>	<%=strColor%>
														</C>
														<C> Name=받는자상호 ID=BUY_COMPANY 		Align=Left  	SumText='      총계  : ' Edit='none' Width=150	<%=strBgColor%>	<%=strColor%>
														</C>
														<C> Name=세무구분 ID=TAX_NAME  				Align=Center  Width=80 								<%=strBgColor%>
														</C>
														<C> Name=공급가액 ID=TAX_SUPPRICE  		Align=right  	SumText=@sum Edit='none' Width=100	<%=strBgColor%>	<%=strColorh%>
														</C>														
														<C> Name=세액 ID=TAX_TAXPRICE  				Align=right  	SumText=@sum Edit='none' Width=100	<%=strBgColor%>	<%=strColorh%>
														</C>
														<C> Name=총금액 ID=PAY_TOTALPRICE  		Align=right  	SumText=@sum Edit='none' Width=100	<%=strBgColor%>	<%=strColorh%>
														</C>
														">
