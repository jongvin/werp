...
function OnDblClick(dataset, grid, row, colid)
{
	...
	lrArgs.set("DOC_NUMBER", dataset.NameString(row,"DOC_NUMBER"));

	var	lrRet = window.showModalDialog(
		"../14/t_WETaxSale6R.jsp",
		lrArgs,
		"center:yes; dialogWidth:1400px;	dialogHeight:900px;	status:no; help:no;	scroll:no"
	);
}
...
function	btnDOCU_NO_onClick()
{
	...
	txtDOC_NUMBER.value	= C_Trim(lrRet.get("DOC_NUMBER"));
