...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WETaxSale3R.jsp(세금계산서발행등록)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명
	String strFileName = "./t_WETaxSale3R";
	String strFileName01 = "t_WETaxSale3R";
//저장 액션
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														...
														<td width="239" align="left" >
															<input id="txtDOC_NUMBER"	type="text" center datatype="n"  maxlength=32 style="width:154px" tabindex="2" />
...
<input id="btnRDY"	type="button" tabindex="-1" class="img_btn10_1" onClick="btnRDY_onclick();"	value="전자세금계산서 발행"	onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
<input id="btnPRINT"	type="button" tabindex="-1" class="img_btn4_1" onClick="btnPRINT_onclick();"	value="출력"	onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
													</td>
												</tr>
												</table>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<C> Name=선택 ID=PRT_CHK  Align=center  EditStyle=CheckBox  Width=35
														</C>
														<C> Name=작성일자 ID=GEN_TM  Align=Left  Edit='none' Width=70
														</C>
														<C> Name=문서번호 ID=DOC_NUMBER  Align=left  Edit='none' Width=145 
														</C>
														<C> Name=세무구분 ID=TAX_NAME  Align=Center   Width=60 
														</C>
														<C> Name=공급자사업NO ID=SUP_REGNUM Align=Left   Width=80 
														</C>
														<C> Name=공급자상호 ID=SUP_COMPANY Align=Left   Width=105 
														</C>
														<C> Name=받는자사업NO ID=BUY_REGNUM Align=Left   Width=80 
														</C>
														<C> Name=받는자상호 ID=BUY_COMPANY Align=Left  Edit='none' Width=105
														</C>
														<C> Name=공급가액 ID=TAX_SUPPRICE  Align=right  Edit='none' Width=90
														</C>														
														<C> Name=세액 ID=TAX_TAXPRICE  Align=right  Edit='none' Width=90
														</C>
														<C> Name=총금액 ID=PAY_TOTALPRICE  Align=right  Edit='none' Width=90
														</C>
														">
