/**************************************************************************/
/* 1. 프 로 그 램 id : t_WETaxSale3R(세금계산서발행등록)
...
function OnLoadBefore(dataset)
{
	if(dataset == dsMAIN)
	{
		dataset.DataID = sSelectPageName	+ D_P1("ACT","MAIN")
											...
											+ D_P2("TAX_TYPE",C_Trim(cboTAX_TYPE.value))
...
function OnDblClick(dataset, grid, row, colid)
{
	...
	if ( dataset.NameString(row ,"LINE_FLAG" ) == "type1" || dataset.NameString(row ,"LINE_FLAG" ) == "type3" || dataset.NameString(row ,"LINE_FLAG" ) == "type4") return;
	// 프로그래머 유효성검사 추가
	// 보고서 디렉토리
