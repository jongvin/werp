...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WETaxSale5R.jsp(반려세금계산서관리)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명
	String strFileName = "./t_WETaxSale5R";
	String strFileName01 = "t_WETaxSale5R";
//저장 액션
									...
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="100%">
												...
												<td class="font_green_bold"> 반려세금계산서현황</td>												
												</tr>
												</table>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__3"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<C> Name=세무구분 ID=TAX_NAME  				Align=Center  Edit='none'	Width=80
														</C>
														<C> Name=공급자사업NO ID=SUP_REGNUM 	Align=Left   	Edit='none'	Width=80 
														</C>
														<C> Name=공급자상호 ID=SUP_COMPANY 		Align=Left   	Edit='none'	Width=105 
														</C>
														<C> Name=받는자사업NO ID=BUY_REGNUM 	Align=Left   	Edit='none'	Width=80 
														</C>
														<C> Name=받는자상호 ID=BUY_COMPANY 		Align=Left  	Edit='none' Width=105
														</C>
														<C> Name=공급가액 ID=TAX_SUPPRICE  		Align=right  	Edit='none' Width=95
														</C>														
														<C> Name=세액 ID=TAX_TAXPRICE  				Align=right  	Edit='none' Width=95	
														</C>
														<C> Name=총금액 ID=PAY_TOTALPRICE  		Align=right  	Edit='none' Width=95	
														</C>
														">
