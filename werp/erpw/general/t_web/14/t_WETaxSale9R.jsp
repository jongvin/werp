...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WETaxSale4R.jsp(매입계산서수신현황)
/* 2. 유형(시나리오) : shared window 조회 및 입력
/* 3. 기  능  정  의 : 프로그램 설명 
/* 4. 변  경  이  력 : 배민정 작성(2006-06-09) 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명
	String strFileName = "./t_WETaxSale9R";
	String strFileName01 = "t_WETaxSale9R";
//저장 액션
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="50">작성기준</td>
														<td width="30">
															<input id="chkINS" type="CheckBox" class="check"	checked onclick="chkINS_onChange()" >
														</td>
														...
														<td width="132">
														<input id="txtSUP_REGNUM" type="text" class="han" onblur="btnSUP_REGNUM_onblur()" style="width:130px" ></td>
														<td width="162">
													...
													<tr>
														...
														<td width="50">배달기준</td>
														<td width="30">
															<input id="chkACK" type="CheckBox" class="check" onclick="chkACK_onChange()">
														</td>
														...
														<td width="132">
														<input id="txtBUY_REGNUM" type="text" class="han" onblur="btnBUY_REGNUM_onblur()" style="width:130px" ></td>
														<td width="162">
													...
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="150" class="font_green_bold" >처리상태</td>
														<td width="132">
														<select  id="cboSTATUS"  onchange="cboSTATUS_onChange()"  style="WIDTH: 100px">
															<%=strCombo2%>
														</select></td>
														<td align="right">세금계산서 양식조회 -></td>
									...
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="100%">
												...
												<td class="font_green_bold">매입계산서수신현황</td>												
												</tr>
												</table>
...
<%
String  strColor 	= "SubColor ={Decode(GEN_TM,'','green','blue')}";
String  strBgColor = "BgColor ={Decode(GEN_TM,'','#FFFCE0','white')}";
%>													
														<PARAM NAME="Format" VALUE="
														<FC> Name=처리상태 ID=STATUS  					Align=Center 	Edit='none' Width=50	<%=strBgColor%>
														</FC>
														<FC> Name=작성일자 ID=GEN_TM  					Align=Left  	Edit='none' Width=70	<%=strBgColor%>
														</FC>
														<FC> Name=문서번호 ID=DOC_NUMBER  			Align=left  	Edit='none' Width=145	<%=strBgColor%>
														</FC>
														<FC> Name=공급자사업번호 ID=SUP_REGNUM 	Align=Left  	Edit='none'	Width=100	<%=strBgColor%>
														</FC>
														<FC> Name=공급자상호 ID=SUP_COMPANY 		Align=Left  	Edit='none' Width=150	<%=strBgColor%>	
														</FC>
														<C> Name=받는자사업번호 ID=BUY_REGNUM 	Align=Left  	Edit='none'	Width=100	<%=strBgColor%>
														</C>
														<C> Name=배달일 ID=DLV_TM 							Align=Left  	Edit='none' Width=130	<%=strBgColor%>
														</C>	
														<C> Name=수신일 ID=RCV_TM  							Align=Center  Edit='none'	Width=70 	<%=strBgColor%>	
														</C>
														<C> Name=공급가액 ID=TAX_SUPPRICE  			Align=right  	Edit='none' Width=100	<%=strBgColor%>
														</C>
														<C> Name=세액 ID=TAX_TAXPRICE  					Align=right  	Edit='none' Width=100	<%=strBgColor%>
														</C>
														<C> Name=총액 ID=PAY_TOTALPRICE  				Align=right  	Edit='none' Width=100	<%=strBgColor%>
														</C>
														<C> Name=답당자NO ID=BUY_EMPID  				Align=Left  	Edit='none' Width=70	<%=strBgColor%>
														</C>														
														<C> Name=담당자명 ID=BUY_EMPLOYEE  			Align=Left  	Edit='none' Width=70	<%=strBgColor%>
														</C>
														">
