...
<html>
		...
		<!--
			...
			function OnRowInserted(dataset, row)
			{
				if (dataset == dsLov)
				{
					...
					dsLov.NameValue(row, "LOCATION_X") = 100;
					dsLov.NameValue(row, "LOCATION_Y") = 100;
					dsLov.NameValue(row, "AUTO_LOAD") = "F";
				}
				else if (dataset == dsLovArgs)
				{
					G_Load(dsLovArgsSeq, null);
					dsLovArgs.NameValue(row, "SEQ") = dsLovArgsSeq.NameString(dsLovArgsSeq.RowPosition,"SEQ");
					dsLovArgs.NameValue(row, "DIS_SEQ") = dsLovArgs.NameMax("DIS_SEQ", 0, 0) + 1;
					dsLovArgs.NameValue(row, "TYPE") = "S";
					dsLovArgs.NameValue(row, "SEARCH") = "F";
				}
				else if (dataset == dsLovCols)
				{
				}
			...
			{
				if (dataset == dsLovArgs && colid == "SEARCH")
				{
					if (dataset.NameString(row, colid) == "T")
					{
						...
						dataset.NameString(row, "DEFAULT_VALUE") = "";
					}
				}
			}
			...
			{
				alert("G_FocusDataset : " + G_FocusDataset.id);
			}
	...
	<body onload="C_Initialize()">
					...
					<td width="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="right">
									<input id="btnFind" type="button" class="img_btnFind_S" onClick="btnFind_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridLov WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<C> Name=타이틀 ID=TITLE Width=220 Sort=true
											</C> 
											">
									</OBJECT><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__7); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
								</td>
								<td width="560" height="100%" onActivate="G_focusDataset(dsLov)">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="40">팝업명</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="40">비고</td>
											<td width="110">
												<input id="txtRemark" type="password" style="width:80px" value="123" MaxLength="3">
												<input id="btnFindTest" type="button" class="img_btnFind_S" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
											<td width="90">
												<SELECT ID="oSelect" NAME="Cars" style="Width:70px;">
													<OPTION VALUE="1" SELECTED>BMW
													<OPTION VALUE="2">Porsche
													<OPTION VALUE="3">Mercedes
												</SELECT>
											</td>
											<td width="80"><input name="rdoTest" type="radio" class="radio" Checked>1&nbsp;&nbsp;<input name="rdoTest" type="radio" class="radio">2</td>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="55">자동읽기</td>
											<td width="*">
												<input id="chkTest" type="checkbox" class="check" onclick="javascript:dsLov.NameValue(dsLov.RowPosition, 'AUTO_LOAD') = this.checked ? 'T' : 'F'">
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="40">비고</td>
											<td width="330"><input id="txtRemark" type="text" style="width:305px"></td>
											<td width="80">
												<SELECT ID="oSelect" NAME="Cars" style="Width:70px;">
													<OPTION VALUE="1" SELECTED>BMW
													<OPTION VALUE="2">Porsche
						...
						<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="440" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridArgs WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<C> Name=검색 ID=SEARCH Width=30 EditStyle=CheckBox
											</C> 
								...
								<td width="10"></td>
								<td width="*">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridCols WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
		...
		<!-- 가우스 Bind 객체정의 시작 //-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=binLov classid=CLSID:9C9AB433-EA85-11D2-A4F9-00608CEBEE49>
			<param name="DataID" value="dsLov">
