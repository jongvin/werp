...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WPLProjPlanFunctionR(경영계획현장별계획집계함수등록)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 
/* 4. 변  경  이  력 : 김흥수 작성(2006-03-09)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLProjPlanFunctionR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__2"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsSEQ" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="*" class="font_green_bold"> 경영계획 현장별 계획 집계함수 목록</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr class="head_line">
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name='프로시져제목'		ID='FUNC_TITLE'		Width=200
											</C>
											<C> Name='프로시져명'		ID='FUNC_NAME'		EditStyle=popup	Width=400
											</C>
											<C> Name='상위집계시자동재계산'		ID='AUTO_RECALCC_TAG'		EditStyle=Checkbox	Width=160
											</C>
											">
