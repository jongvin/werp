...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql  = " Select \n";
			strSql += " 	a.COMP_EXE_FUNC_NO_B DEPT_PLN_FUNC_NO , \n";
			strSql += " 	a.CRTUSERNO , \n";
			strSql += " 	a.CRTDATE , \n";
			strSql += " 	a.MODUSERNO , \n";
			strSql += " 	a.MODDATE , \n";
		...
		else if (strAct.equals("SEQ"))
		{
			...
			strSql  = " Select SQ_T_COMP_EXE_FUNC_NO_B_B.NextVal SEQ From Dual \n";
