...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transCopy"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="70" class=font_green_bold>처리상태</td>
														<td width="150">
													...
													<tr>													
													<td width="15"><img src="../images/bullet3.gif"></td>
													<td width="70" class="font_green_bold" >발행일자</td>													
													<td width="219">
													<table width="219" border="0" cellspacing="0" cellpadding="0">
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 전자어음승인내역</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											...
											<C> Name=만기일 ID=FUTURE_YMD  Align=Center   Width=70
											</C>
											<C> Name=지급처사업자번호 ID=REGIST_NUM  Align=Center   Width=100
											</C>
											<C> Name=지급처명 ID=CUST_NAME  Align=Left  Edit='none' Width=70
											</C>
											<C> Name=카드or수표번호 ID=CHECK_NO  Align=Left  Edit='none' Width=100
											</C>
