...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFBCashTrxR";
//저장 액션
	...
	try
	{
		...
		{	//거래구분
			strSql  = 
				...
				"where lookup_type = upper('DEPOSIT_TRX_GUBUN')"+"\n"+
				"and   use_yn      = 'Y'"+"\n"+
				"Union All"+"\n"+
				"Select"+"\n"+
				"	1,"+"\n"+
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="150">
															<table width="150" border="0" cellspacing="0" cellpadding="0">
																<td width="150">
																	<select id="txtBANK_CD" style="WIDTH: 148px " onchange="btnquery_onclick();">
																		<%=strBANK_CODE%>
																	</select>
																</td>
															</table>	
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold">예금거래내역</td>
										</tr>
									</table>									
									<!-- SUM 테이블 시작 //-->
									<!-- 간격조정 테이블 시작 //-->
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=전문번호 ID=DOCU_NUMC  Align=Center   Edit='none' Width=70  
											</C>
											<C> Name=은행 ID=BANK_NAME  Align=Left   Width=100  Edit='none'
											</C>
											<C> Name=계좌번호 ID=ACCOUNT_NO Align=Left  Edit='none' Width=100
											</C>
											<C> Name=거래일시 ID=TRADE_YMD Align=Center  Edit='none' Width=110 
											</C>
											<C> Name=거래구분 ID=TRX_GUBUN Align=Center  Edit='none' Width=70
											</C>
											<C> Name=성명 ID=IN_OUT_NAME  Align=Left  Edit='none' Width=100
											</C>
											<C> Name=금액 ID=RECV_AMT  Align=Right Edit='none'  Width=100
											</C>
											<C> Name=거래후잔액 ID=REMAIN_AMT  Align=Right  Edit='none' Width=100
											</C>
											<C> Name=CMS코드 ID=CMS_CODE  Align=Left  Edit='none' Width=100 
											</C>
											<C> Name=어음번호 ID=BILL_NO  Align=Left  Edit='none' Width=100 
											</C>											
											">
