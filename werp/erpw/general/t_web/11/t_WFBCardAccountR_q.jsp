...
/**************************************************************************/
	...
	try
	{
		...
		else if (strAct.equals("ACCT_CHK"))
		{
			...
			strSql += " 	AND  ( a.ACC_NAME Like  '%'|| Replace('차량유지비',' ','%') || '%' 	\n";
			strSql += " 	or a.ACC_NAME Like  '%'|| Replace('접대비',' ','%') 								\n";
			strSql += " 	or a.ACC_NAME Like  '%'|| Replace('여비교통비',' ','%') 						\n";
			strSql += " 	or a.ACC_NAME Like  '%'|| Replace('회의비',' ','%') 								\n";
			strSql += " 	or a.ACC_NAME Like  '%'|| Replace('자료조사',' ','%') || '%' ) 		\n";
