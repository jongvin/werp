...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFBCommonCodeR(은행거래정보관리)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFBCommonCodeR";
//저장 액션
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="100" class="font_green_bold" >코드분류</td>
														<td width="300">
															<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=cboMASTER width=200 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
																<PARAM NAME="ComboStyle" VALUE="5">
																<param name=ComboDataID		value=dsMASTER>
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 기타코드목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=코드 ID=LOOKUP_CODE Width=120
											</C>
											<C> Name=값 ID=LOOKUP_VALUE Width=180
											</C>
											<C> Name='사용여부' ID=USE_YN Width=90 EditStyle=CheckBox
											</C>
											<C> Name='설명' ID=DESCRIPTION Width=400
											</C>
											">
