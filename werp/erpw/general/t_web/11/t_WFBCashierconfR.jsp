...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFBCashierconfR";
	String strPageName = "t_WFBCashierconfR";
//저장 액션
	...
	try
	{
		...
		{	//지급구분
			...
			strSql  = 
				...
				"	a.LOOKUP_VALUE NAME  "+"\n"+
				"from	T_FB_LOOKUP_VALUES a "+"\n"+
				"where lookup_type = upper('cash_pay_status')"+"\n"+
				"and   use_yn      = 'Y'"+"\n"+
				"order by"+"\n"+
				"	1,2"+"\n";
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__S1"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsSUB classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsBANK classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__5); </script> <!--CONVPAGE_TAIL 지우지마세요//-->		
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsACCOUNT classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__6); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsPASS" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="178">
														<input name="txtCOMP_NAME" type="text" class="ro" readOnly style="width:178px" VALUE="<%=strCOMP_NAME%>" ></td>
														<input name="txtEMP_NO" type="hidden" class="ro" style="width:30px" VALUE="<%=strUserNo%>" >
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="60" class=font_green_bold>처리상태</td>
														<td width="150">
													...
													<tr>													
													<td width="15"><img src="../images/bullet3.gif"></td>
													<td width="90" class="font_green_bold" >지급일자</td>													
													<td width="219">
													<table width="219" border="0" cellspacing="0" cellpadding="0">
													...
													<td width="15"><img src="../images/bullet3.gif"></td>
													<td width="60" class="font_green_bold" >지급처</td>
													<td width="320">
													<table width="320" border="0" cellspacing="0" cellpadding="0">
													...
													<td width="15"><img src="../images/bullet3.gif"></td>
													<td width="60" class="font_green_bold" >지급방식</td>
													<td width="150">
													<table width="150" border="0" cellspacing="0" cellpadding="0">
													<td width="150">
															<select id="txtMETHOD_CODE" style="WIDTH: 150px " ;">
													...
													<tr>													
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="90" class="font_green_bold" >출금은행</td>
														<td width="219">
															<table width="219" border="0" cellspacing="0" cellpadding="0">
																<td width="219">
																	<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=cboBANK_CODE width=188 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
														...
														<td width="320">
															<table width="219" border="0" cellspacing="0" cellpadding="0">
																<td width="219">
																	<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=cboACCOUNT_NO width=202 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
																		<PARAM NAME="ComboStyle" VALUE="5">
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 현금출납내역</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<C> Name=지급처 ID=CUST_NAME  Align=Left  Edit='none' Width=70
														</C>
														<C> Name=지급금액 ID=PAY_AMT Align=Right  Edit='none' Width=70
														</C>
														<C> Name=처리상태 ID=PAY_STATUS_NAME  Align=Left  Edit='none' Width=70 show=false
														</C>
														<C> Name=처리상태 ID=PAY_STATUS  Align=Left  Edit='none' Width=70 show=false
														</C>
														<C> Name=지급일 ID=PAY_DUE_YMD Align=Center  Edit='none' Width=70
														</C>
														<C> Name=지급일 ID=PAY_YMD  Align=Center   Width=70 show=false
														</C>
														<C> Name=입금은행 ID=IN_BANK_CODE_NAME  Align=Left  Edit='none' Width=70
														</C>
														<C> Name=입금계좌번호 ID=IN_ACCOUNT_NO  Align=Left  Edit='none' Width=100
														</C>
														<C> Name=출금은행 ID=OUT_BANK_CODE_NAME  Align=Left  Edit='none' Width=70
														</C>
														...
														<C> Name=EDI생성일시 ID=LAST_TRX_SEND_DATE Align=Center  Edit='none' Width=120
														</C>
														<C> Name=처리결과메세지 ID=RESULT_TEXT  Align=Left  Edit='none' Width=100
														</C>
														<C> Name=처리결과일시 ID=LAST_TRX_RECV_DATE Align=Center Edit='none'  Width=120
														</C>																																	
														">
							...
							<tr>
								<td height="70%">
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 관련전표목록</td>
														<td align="right" width="*">
															<input id="btnSHOWSLIP"		type="button" tabindex="-1" class="img_btn4_1" onClick="btnSHOWSLIP_onClick()" 	value="전표보기" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
														</td>
													</tr>
												</table>									
												<!-- 간격조정 테이블 시작 //-->
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__S13"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													<PARAM NAME="DataID" VALUE="dsSUB">
													<PARAM NAME="Editable" VALUE="true">
													<PARAM NAME="ColSelect" VALUE="true">
													<PARAM NAME="ColSizing" VALUE="true">
													<PARAM NAME="Format" VALUE="
														<C> Name=전표번호 ID=MAKE_SLIPNO Align=Center  Edit='none' Width=120
														</C>
														<C> Name=적요 ID=SUMMARY1  Align=Left  Edit='none' Width=300
														</C>
														<C> Name=차변 ID=DB_AMT Align=Right  Edit='none' Width=120
														</C>
														<C> Name=대변 ID=CR_AMT Align=Right  Edit='none' Width=120
														</C>
														">
												</OBJECT><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__S13); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
											</td>
										</tr>
										<tr>
											<td width="100%">
