...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFBChangeAccountPwR(계좌암호설정)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFBChangeAccountPwR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 계좌목록</td>
											<td align="right" width="*">
												<input id="btnChangePw" type="button" class="img_btn4_1" value="암호변경"  onclick="btnChangePw_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=은행명 ID=BANK_NAME Width=160 suppress=1
											</C>
											<C> Name=계좌번호 ID=ACCNO Width=120
											</C>
											<C> Name=암호변경일 ID=CHANGE_YMD Width=100
											</C>
											<C> Name='이전암호' ID=OLD_PASSWORD Width=160 password=true
											</C>
											<C> Name='신규암호' ID=NEW_PASSWORD Width=160 password=true
											</C>
											">
