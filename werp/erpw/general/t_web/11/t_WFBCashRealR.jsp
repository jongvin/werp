...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFBCashRealR";
//저장 액션
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="90" class="font_green_bold" >지급예정일자</td>													
														<td width="200">
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 현금Real지급송신</td>
											...
											<input id="btnRealTime_Send"	type="button" tabindex="-1" class="img_btn6_1" onClick="btnRealTime_Send_onClick()"value="이체송신" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
											</td>
										</tr>
									</table>									
									<!-- SUM 테이블 시작 //-->
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											...
											<C> Name=지급예정일 ID=PAY_DUE_YMD Align=Center  Edit='none' Width=70
											</C>
											...
											<C> Name=지급처리상태 ID=PAY_STATUS  Align=Left  Edit='none' Width=100 show=false
											</C>
											<C> Name=처리결과메세지 ID=RESULT_TEXT  Align=Left   Width=100 Edit='none'
											</C>
											<C> Name=성공금액 ID=PAY_SUCCESS_AMT Align=Right  Edit='none' Width=100
											</C>
											<C> Name=실패금액 ID=PAY_FAIL_AMT Align=Right  Edit='none' Width=100
											</C>											
