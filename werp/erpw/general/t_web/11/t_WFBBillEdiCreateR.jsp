...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명
	String strFileName = "./t_WFBBillEdiCreateR";
//저장 액션
											...
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="90" class=font_green_bold>지급구분</td>
														<td width="240">
															<table width="219" border="0" cellspacing="0" cellpadding="0">
																<td width="219">
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 전자어음생성자료</td>
														...
														<input id="btnEDI_CREATE"	  type="button" tabindex="-1" class="img_btn6_1" onClick="btnEDI_CREATE_onClick()"value="발행파일생성" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
														</td>														
													</tr>
												</table>
									<!-- SUM 테이블 시작 //-->
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE=" 
														...
														<C> Name=발행예정일 ID=PAY_DUE_YMD Align=Center  Edit='none' Width=100
														</C>
														<C> Name=수표번호 ID=CHECK_NO Align=Center  Edit='none' Width=100
														</C>
														<C> Name=만기일 ID=FUTURE_YMD Align=Center  Edit='none' Width=100
														</C>
														<C> Name=지급처 ID=CUST_NAME  Align=Left  Edit='none' Width=200
														</C>
														<C> Name=사업장 ID=COMPANY_NAME Align=Center  Edit='none' Width=100
														</C>
														<C> Name=계좌번호 ID=OUT_ACCOUNT_NO Align=Center  Edit='none' Width=100 show=false
														</C>														
														">
										...
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 전자어음발행파일생성이력</td>
														<td align="right" width="*">
															<input id="btnEDI_DELETE" type="button" class="img_btn8_1" value="발행파일삭제" title="" onclick="btnEDIDELETE_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															<input id="btnEDI_SEND" type="button" class="img_btn8_1" value="발행파일송신" title="" onclick="btnEDISEND_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
														...
														<PARAM NAME="Format" VALUE=" 
															...
															<C> Name=출금계좌번호 ID=OUT_ACCOUNT_NO  Align=Left  Edit='none' Width=200 show=false
															</C>															
