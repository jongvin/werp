...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFBCardDeptQR.jsp(법인카드정산관리)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명
	String strFileName = "./t_WFBCardDeptQR";
//저장 액션
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="72">
												...
												<input name="txtCOMP_CODE" type="hidden" class="ro" readOnly style="width:60px" VALUE="<%=strCOMP_CODE%>" >
												<input name="txtCOMP_NAME" type="hidden" class="ro" readOnly style="width:150px" VALUE="<%=strCOMPANY_NAME%>" >
											</td>
											<td width=40>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<FC> Name=카드번호 		ID='CARDNUMBER'				Align=Center	Width=150 									  </FC>
														<FC> Name=정산년월 		ID='ADJUSTYEARMONTH'	Align=Center	Width=160  show=false   </FC>
														<C> Name='소지자' 	  ID='EMPNAME'					SumText='      총계  : ' Align=Center	 Width=70		  </C>
														<C> Name='총금액' 		ID=TOTALSUM						SumText=@sum	Width=95 														</C>
														<C> Name='청구금액' 	ID=COMPANYSUM					SumText=@sum	Width=95 </C>
														<C> Name='개인금액' 	ID=PERSONSUM					SumText=@sum	Width=95 </C>
														<C> Name='입금일자' 	ID=CHARGEDATE					Align=Center	Width=70	</C>														
														<C> Name='결제계좌' 	ID=AccNo							Width=100   </C>
														<C> Name='결제은행' 	ID=Bank_Main_Name			Width=100         </C>
														<C> Name='전표번호' 	ID=SLIP								Width=100 	</C>
														...
														<C> Name='전표일자' 	ID=ADJUSTFinishDateTime		Align=Center Width=70	</C>
														">
