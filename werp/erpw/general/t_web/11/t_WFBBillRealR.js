...
{
  if ( (txtPAY_STATUS.value == "2")|| (txtPAY_STATUS.value == "5"))
  {
  ...
  //암호확인
	...
	for (i=1;i<=dsMAIN.CountRow;i++) {
		  if (dsMAIN.NameString(i,"SELECT_YN") == "T" )
		  {
				...
				dsCOPY.NameString(cnt,"OUT_BANK_CODE") = dsMAIN.NameString(i,"OUT_BANK_CODE");
				dsCOPY.NameString(cnt,"OUT_ACCOUNT_NO") = dsMAIN.NameString(i,"NAIVE_OUT_ACCOUNT_NO");
				...
				dsCOPY.NameString(cnt,"REGIST_NUM") = dsMAIN.NameString(i,"REGIST_NUM");
				dsCOPY.NameString(cnt,"CHECK_NO") = dsMAIN.NameString(i,"CHECK_NO");
				dsCOPY.NameString(cnt,"FUTURE_YMD") = dsMAIN.NameString(i,"FUTURE_YMD");
				dsCOPY.NameString(cnt,"PAY_AMT") = dsMAIN.NameString(i,"PAY_AMT");
				dsCOPY.NameString(cnt,"FRANCHISE_NO") = dsMAIN.NameString(i,"FRANCHISE_NO");
