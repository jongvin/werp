...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFBManagerconfR.jsp(현금지급승인)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFBManagerconfR";
	String strPageName = "t_WFBManagerconfR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsPASS" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
										...
										<tr>
											<td class=td_green>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>													
													<td width="15"><img src="../images/bullet3.gif"></td>
													<td width="70" class="font_green_bold" >지급일자</td>													
													<td width="219">
													<table width="219" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>													
														...
														<td width="219">
															<table width="219" border="0" cellspacing="0" cellpadding="0">
																<td width="219">
																	<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=cboBANK_CODE width=188 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
														...
														<td width="320">
															<table width="219" border="0" cellspacing="0" cellpadding="0">
																<td width="219">
																	<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=cboACCOUNT_NO width=202 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
																		<PARAM NAME="ComboStyle" VALUE="5">
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 현금지급승인내역</td>
											...
											<input id="btnCASH_CONFIRM"	type="button" tabindex="-1" class="img_btn6_1" onClick="btnCASH_CONFIRM_onClick()"value="승인등록" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" />
											<input id="btnCASH_CANCEL" 	type="button" tabindex="-1" class="img_btn7_1" onClick="btnCASH_CANCEL_onClick()" value="승인등록취소" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"/>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											...
											<C> Name=지급처 ID=CUST_NAME  Align=Left  Edit='none' Width=100
											</C>											
											<C> Name=지급금액 ID=PAY_AMT Align=Right  Edit='none' Width=100
											</C>
											...
											<C> Name=지급일자 ID=PAY_DUE_YMD Align=Center  Edit='none' Width=70
											</C>
											<C> Name=승인일자 ID=MANAGER_CONFIRM_DATE  Align=Center   Edit='none'	Width=70
											</C>
											...
											<C> Name=적요사항 ID=DESCRIPTION  Align=Left Edit='none'  Width=120
											</C>
											<C> Name=사업장 ID=COMPANY_NAME Align=Left Edit='none'  Width=100 show=false
											</C>
											">
