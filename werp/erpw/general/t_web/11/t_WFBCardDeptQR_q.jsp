...
strSql +="And		f.DEPT_CODE 			like  substr(? ,1,4) ||'%'                                \n";
if(!"".equals(strCARDNUMBER))  strSql +="And   Replace(a.CARDNUMBER,'-','') = Replace( ? ,'-','') 				\n";
strSql +="group by a.CARDNUMBER ,a.ADJUSTYEARMONTH,f.NAME ,e.AccNo ,a.CHARGEDATE ,e.Bank_Main_Code ,g.Bank_Main_Name    \n";
			...
			if(!"".equals(strCARDNUMBER)) lrArgData.addColumn("4CARDNUMBER", CITData.VARCHAR2);
			lrArgData.addRow();
			...
			if(!"".equals(strCARDNUMBER)) lrArgData.setValue("4CARDNUMBER", strCARDNUMBER);
