...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WFBBankCodeR(은행거래정보관리)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WFBBankCodeR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 거래은행목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=은행명 ID=BANK_MAIN_CODE EditStyle=Combo Data='<%=strCombo%>'  Width=160
											</C>
											<C> Name=거래코드 ID=TRAN_CODE Width=120
											</C>
											<C> Name=업체코드 ID=ENTE_CODE Width=120
											</C>
											<C> Name=뱃치업체코드 ID=BILL_ENTE_CODE Width=120
											</C>
											<C> Name='은행EDI접속ID' ID=BANK_EDI_LOGIN_ID Width=120
											</C>
											<C> Name='거래처수신 Subject명' ID=VENDOR_SUBJECT_NAME Width=130
											</C>
											<C> Name='현금송신 Subject명' ID=CASH_SEND_SUBJECT_NAME Width=120
											</C>
											<C> Name='현금수신 Subject명' ID=CASH_RECV_SUBJECT_NAME Width=120
											</C>
											<C> Name='어음송신 Subject명' ID=BILL_SEND_SUBJECT_NAME Width=120
											</C>
											<C> Name='어음수신 Subject명' ID=BILL_RECV_SUBJECT_NAME Width=120
											</C>
											">
