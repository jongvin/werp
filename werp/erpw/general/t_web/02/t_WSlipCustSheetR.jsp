...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSlipCustSheetR";
//저장 액션
...
<C> Name=계정코드 	ID=ACC_CODE_P			Align=Left	 Width=65   	Edit='none' 	Show='true'
suppress=3
BgColor = {ROW_COLOR}
</C>
<C> Name=계정명 	ID=ACC_NAME_P			Align=Left	 Width=140   	Edit='none' 	Show='true' SubSumText='계정그룹소계' SumText='총         계 : ' SumColor=BLUE
suppress=2
BgColor = {ROW_COLOR}
</C>
<C> Name='거 래 처' ID=CUST_NAME Align=Left  Width=150 Sort=true		Edit='none'
suppress=1
BgColor = {ROW_COLOR}
</C>
...
<C> Name='적    요' ID=SUMMARY Align=Left  Width=200 	Show='true'		Edit='none'
BgColor = {ROW_COLOR}
</C>
<C> Name='은    행' ID=BANK_NAME Align=Left  Width=150 	Show='true'		Edit='none'
BgColor = {ROW_COLOR}
</C>
