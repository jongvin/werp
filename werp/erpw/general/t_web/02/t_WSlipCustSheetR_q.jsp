...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += "  		END ROW_TYPE,  \n";
			strSql += "  		CASE  \n";
			strSql += "  			WHEN B.CUST_CODE  IS NOT NULL THEN '#FFFFFF'  \n";
			strSql += "  			WHEN A.ACC_CODE6  IS NOT NULL THEN '#FFEEFF'  \n";
			strSql += "  			WHEN A.ACC_CODE5  IS NOT NULL THEN '#EFEEFF'  \n";
			strSql += "  			WHEN A.ACC_CODE4  IS NOT NULL THEN '#E3EEFF'  \n";
			...
			strSql += " 			d.ACC_CODE, \n";
			strSql += " 		 	d.ACC_NAME, \n";
			strSql += " 			NVL(c.CUST_CODE,'미지정') CUST_CODE, \n";
			strSql += " 			NVL(c.CUST_NAME,'미지정') CUST_NAME, \n";
			strSql += " 			A.MAKE_DT, \n";
			strSql += " 			A.SLIP_ID, \n";
			strSql += " 			A.SLIP_IDSEQ, \n";
