...
function txtDEPT_CODE_onblur()
{
	...
	lrRet = C_AutoLov(dsLOV,"T_DEPT_CODE12", lrArgs,"T");
...
function btnDEPT_CODE_onClick()
{
	...
	lrRet = C_LOV("T_DEPT_CODE12", lrArgs,"T");
...
function txtACC_CODE_onblur()
{
	...
	lrRet = C_AutoLov(dsLOV,"T_ACC_CODE_REMAIN", lrArgs,"T");
...
function btnACC_CODE_onClick()
{
	...
	if (C_isNull(txtACC_CODE.value))
	{
		lrRet = C_LOV("T_ACC_CODE_REMAIN", lrArgs,"F");
	}
	else
	{
		lrRet = C_LOV("T_ACC_CODE_REMAIN", lrArgs,"T");
	}
