...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			if(!"".equals(strACC_CODE)) lrArgData.addColumn("5ACC_CODE", CITData.VARCHAR2);
			...
			if(!"".equals(strACC_CODE)) lrArgData.addColumn("7ACC_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("8DT_T", CITData.VARCHAR2);
			if(!"".equals(strACC_CODE)) lrArgData.addColumn("9ACC_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("10DT_T", CITData.VARCHAR2);
			lrArgData.addRow();
			...
			if(!"".equals(strACC_CODE)) lrArgData.setValue("5ACC_CODE", strACC_CODE);
			...
			if(!"".equals(strACC_CODE)) lrArgData.setValue("7ACC_CODE", strACC_CODE);
			lrArgData.setValue("8DT_T", strDT_T);
			if(!"".equals(strACC_CODE)) lrArgData.setValue("9ACC_CODE", strACC_CODE);
			lrArgData.setValue("10DT_T", strDT_T);
