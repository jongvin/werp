...
txtDEPT_CODE.value		= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"DEPT_CODE");
txtCUST_CODE.value		= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"CUST_CODE");
txtACC_CODE.value		= lrArgs.opener.txtACC_CODE.value;
txtBANK_CODE.value		= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"BANK_CODE");
txtMNG_ITEM_CHAR1.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_CHAR1");
txtMNG_ITEM_CHAR2.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_CHAR2");
txtMNG_ITEM_CHAR3.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_CHAR3");
txtMNG_ITEM_CHAR4.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_CHAR4");
txtMNG_ITEM_NUM1.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_NUM1");
txtMNG_ITEM_NUM2.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_NUM2");
txtMNG_ITEM_NUM3.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_NUM3");
txtMNG_ITEM_NUM4.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_NUM4");
txtMNG_ITEM_DT1.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_DT1");
txtMNG_ITEM_DT2.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_DT2");
txtMNG_ITEM_DT3.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_DT3");
txtMNG_ITEM_DT4.value	= lrArgs.opener.dsMAIN.NameString(lrArgs.opener.dsMAIN.RowPosition,"MNG_ITEM_DT4");
...
function OnLoadBefore(dataset)
{
	if (dataset == dsMAIN)	//시스템명 가져오기
	{
		dataset.DataID = sSelectPageName	+ D_P1("ACT","MAIN")
											...
											+ D_P2("MNG_ITEM_CHAR1", txtMNG_ITEM_CHAR1.value)
											+ D_P2("MNG_ITEM_CHAR2", txtMNG_ITEM_CHAR2.value)
											+ D_P2("MNG_ITEM_CHAR3", txtMNG_ITEM_CHAR3.value)
											+ D_P2("MNG_ITEM_CHAR4", txtMNG_ITEM_CHAR4.value)
											+ D_P2("MNG_ITEM_NUM1", txtMNG_ITEM_NUM1.value)
											+ D_P2("MNG_ITEM_NUM2", txtMNG_ITEM_NUM2.value)
											+ D_P2("MNG_ITEM_NUM3", txtMNG_ITEM_NUM3.value)
											+ D_P2("MNG_ITEM_NUM4", txtMNG_ITEM_NUM4.value)
											+ D_P2("MNG_ITEM_DT1", txtMNG_ITEM_DT1.value)
											+ D_P2("MNG_ITEM_DT2", txtMNG_ITEM_DT2.value)
											+ D_P2("MNG_ITEM_DT3", txtMNG_ITEM_DT3.value)
											+ D_P2("MNG_ITEM_DT4", txtMNG_ITEM_DT4.value);
	}
}
