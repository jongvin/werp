...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSlipAccRemain01R";
//저장 액션
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="30">&nbsp;</td>
		<td width="15"><img src="../images/bullet3.gif"></td>
		<td width="70" class="font_green_bold" >반제구분</td>
		<td width="112">
			<select id="cboResetGbn" style="WIDTH: 80px" tabindex="-1" class="input_listbox_default">
				<OPTION value="1">전체</OPTION>
				<OPTION value="2" selected>미반제</OPTION>
				<OPTION value="3">반제완료</OPTION>
			</select>
		</td>
		<td width="*">&nbsp;</td>
	</tr>
...
<C> Name=계정코드 	ID=ACC_CODE			Align=Left	 Width=70   	Edit='none' 	Show='true'
suppress=2
BgColor = {ROW_COLOR}
</C>
<C> Name=계정명 	ID=ACC_NAME			Align=Left	 Width=140   	Edit='none' 	Show='true' SubSumText='계정그룹소계' SumText='총         계 : ' SumColor=BLUE
suppress=1
BgColor = {ROW_COLOR}
</C>
<C> Name='귀속부서' ID=DEPT_NAME Align=Left  Width=110 Sort=true		Edit='none'
BgColor = {ROW_COLOR}
</C>
<C> Name='거 래 처' ID=CUST_NAME Align=Left  Width=135 Sort=true		Edit='none'
BgColor = {ROW_COLOR}
</C>
<C> Name=전표일자 	ID=MAKE_DT_P			Align=Center Width=70   	Edit='none' 	Show='true' SubSumText='계정그룹소계' SumText='총         계 : ' SumColor=BLUE
BgColor = {ROW_COLOR}
<C> Name='설   정' 	ID=SET_AMT				Align=Right	 Width=105   	Edit='none' 	SumText=@sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right
BgColor = {Decode(ROW_COLOR,'#FFFFFF','#FFECEC', ROW_COLOR)}
</C>
<C> Name='반   제' 	ID=RESET_AMT			Align=Right	 Width=105   	Edit='none'  	SumText=@sum	SumColor=Black	SumBgColor=#A8C9FF  SumTextAlign=right
BgColor = {Decode(ROW_COLOR,'#FFFFFF','#E0F4FF', ROW_COLOR)}
</C>
<C> Name='잔   액' 	ID=REMAIN_AMT			Align=Right	 Width=105   	Edit='none'  	SumText=@sum	SumColor=Black	SumBgColor=#F2A6A6  SumTextAlign=right
BgColor = {Decode(ROW_COLOR,'#FFFFFF','#FFECEC', ROW_COLOR)}
</C>
<C> Name='미확정반제' 	ID=NOT_RESET_AMT	Align=Right	 Width=105   	Edit='none'  	SumText=@sum	SumColor=Black	SumBgColor=#A8C9FF  SumTextAlign=right
BgColor = {Decode(ROW_COLOR,'#FFFFFF','#E0F4FF', ROW_COLOR)}
</C>
<C> Name='적    요1' ID=SUMMARY1 Align=Left  Width=200 	Show='true'		Edit='none'
BgColor = {ROW_COLOR}
</C>
<C> Name='적    요2' ID=SUMMARY2 Align=Left  Width=200 	Show='true'		Edit='none'
BgColor = {ROW_COLOR}
</C>
<C> Name=잔액 	ID=ACC_REMAIN_POSITION_NAME	Align=Left	 Width=40   	Edit='none' 	Show='true' SubSumText=''
BgColor = {ROW_COLOR}
</C>
<C> Name='귀속사업장' ID=COMP_NAME Align=Left  Width=80 Sort=true		Edit='none' 	Show='true' 
BgColor = {ROW_COLOR}
</C>
<C> Name=전표번호	ID=MAKE_SLIPNOLINE		Align=Left	Width=120 Sort=true BgColor=#ECF5EB Edit='none'
BgColor = {ROW_COLOR}
</C>
										">
							...
							<tr>
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold"> 반제전표내역</td>
											<td align="right" width="*">
<!--
<input name="btnAllSelect" type="button" class="img_btn6_1" onclick="btnAllSelect_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" value="전 체 선 택" />
<input name="btnAllSelCancle" type="button" class="img_btn6_1" onclick="btnAllSelCancle_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;" value="전체선택취소" />
...
<C> Name=부서명 ID=DEPT_NAME Align=Left HeadAlign=Center  Width=120 Show='true' 	Edit='none' 	SumTextAlign=Center
</C>
<C> Name=거래처명 ID=CUST_NAME Align=Left HeadAlign=Center  Width=120 Show='true' 	Edit='none' 	SumTextAlign=Center 	SumText='합        계 :'
</C>
<C> Name=반제금액 ID=RESET_AMT Align=Right HeadAlign=Center  Width=120 Show='true'	SumText=@sum	Edit='none'  BgColor='#E0F4FF'	SumBgColor='#A8C9FF'
</C>
<C> Name=적요 ID=SUMMARY1 Align=Left HeadAlign=Center  Width=240 Show='true' 	Edit='none'
</C>
										">
