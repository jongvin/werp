...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 				a.ITEM_CODE, \n";
			strSql += " 				Sum( \n";
			strSql += " 						Case When a.WORK_YM = To_Char(To_Number(SubStrb( ? ,1,4)) - 1) || SubStrb( ? ,-2,2) Then \n";
			...
			strSql += " 				) P_NM_AMT, \n";
			strSql += " 				Sum( \n";
			strSql += " 						Case When a.WORK_YM Between To_Char(To_Number(SubStrb( ? ,1,4)) - 1) || '00' And To_Char(To_Number(SubStrb( ? ,1,4)) - 1) || SubStrb( ? ,-2,2) Then \n";
			strSql += " 							Nvl(a.CURR_LEFT,0) + Nvl(a.CURR_RIGHT,0) \n";
			strSql += " 						Else \n";
			strSql += " 							0 \n";
			strSql += " 						End \n";
			strSql += " 				) P_SUM_AMT, \n";
			strSql += " 				Sum( \n";
			strSql += " 						Case When a.WORK_YM =  ?  Then \n";
			strSql += " 							Nvl(a.CURR_LEFT,0) + Nvl(a.CURR_RIGHT,0) \n";
			strSql += " 						Else \n";
			strSql += " 							0 \n";
			strSql += " 						End \n";
			...
			strSql += " And		(b.ITEM_LVL = 1 Or  \n";
			strSql += " 	Abs(a.P_NM_AMT) + \n";
			strSql += " 	Abs(a.P_SUM_AMT) + \n";
			strSql += " 	Abs(a.N_NM_AMT) + \n";
			strSql += " 	Abs(a.N_SUM_AMT) <> 0) \n";
			strSql += " Order By \n";
			strSql += " 	b.SHEET_CODE, \n";
			strSql += " 	b.ITEM_CODE \n";
			strSql += "  ";
			...
			lrArgData.addColumn("7WORK_YM_N_T", CITData.VARCHAR2);
			lrArgData.addColumn("8WORK_YM_N_T", CITData.VARCHAR2);
			lrArgData.addColumn("9COMP_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("10SHEET_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("11WORK_YM_N_T", CITData.VARCHAR2);
			lrArgData.addColumn("12WORK_YM_N_T", CITData.VARCHAR2);
			lrArgData.addColumn("13SHEET_CODE", CITData.VARCHAR2);
			lrArgData.addRow();
			...
			lrArgData.setValue("7WORK_YM_N_T", strWORK_YM_N_T);
			lrArgData.setValue("8WORK_YM_N_T", strWORK_YM_N_T);
			lrArgData.setValue("9COMP_CODE", strCOMP_CODE);
			lrArgData.setValue("10SHEET_CODE", strSHEET_CODE);
			lrArgData.setValue("11WORK_YM_N_T", strWORK_YM_N_T);
			lrArgData.setValue("12WORK_YM_N_T", strWORK_YM_N_T);
			lrArgData.setValue("13SHEET_CODE", strSHEET_CODE);
			try
			{
