...
/**************************************************************************/
	...
	String strOut = "";
	String strWORK_CODE = "SETCONSINS";			//공사보험료 납입 자동 전표
	String strFileName = "./t_PSettMakeConsInsurSlipR";
								...
								<td align="left" background="../images/pop_tit_bg.gif">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="title_default">공사보험료 납입 전표 생성</td>
										</tr>
									</table>
								</td>
							</tr>
