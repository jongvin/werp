...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsSLIP_CHECK classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
							...
							<tr valign="middle"> 
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="60" class="font_green_bold" >회기년도</td>
														<td width="*">
															<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=cboCLSE_ACC_ID width=202 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
										...
										<tr> 
											<td width="100%" align="Center">
												<input id="btnSum" type="button" class="img_btn4_1" value="이월처리" onclick="btnSum_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
										</tr>
									</table>
									<!-- 조건 테이블 종료 //-->
