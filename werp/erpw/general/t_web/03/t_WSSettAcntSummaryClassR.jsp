...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WSSettAcntSummaryClassR(재무제표집계및조회(사업장별부문))
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSSettAcntSummaryClassR";
	String strPageName = "t_WSSettAcntSummaryClassR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsCLASS_CODE" classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsCFULL_PROJ" classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transMake"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F">
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<TD width="185">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__14"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id="cboSHEET_CODE"  style="width:180px" classid=clsid:60109D65-70C0-425c-B3A4-4CB001513C69 VIEWASTEXT>
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="70" class="font_green_bold" >부문</td>
											<TD width="52">
												<input id="txtCLASS_CODE" type="text" datatype="AN" UpperCase ColName="부문코드"  style="width : 50px" >
											</TD>
											<TD width="202">
												<input id="txtCLASS_CODE_NAME" type="text" datatype="HAN" UpperCase readOnly class="ro" ColName="부문명" style="width : 200px" >
											</TD>
											<TD width="40">
											...
											<td width="5">&nbsp;</td>
											<td width="20"><input id="chkCLASS_CODE" type="checkbox" class="check" onfocus="this.blur()" onClick="chkCLASS_CODE_onclick()"></td>
											<td>전부문</td>
											<td>&nbsp;</td>
										</tr>
									</table>
														...
														<td bgcolor="#FFFFFF"  height="100%">
				   										...
				   										<div id="divgridMAIN1" style="OVERFLOW: hidden; WIDTH: 100%; HEIGHT: 100%">
				   											<table width="100%"  height="100%" border="0" cellspacing="0" cellpadding="0">
				   											   <tr>
				   											      <td HEIGHT="100%">
				                                          	<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__16"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=gridMAIN1 classid=CLSID:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49	height="100%" width="100%">
