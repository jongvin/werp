/**************************************************************************/
/* 1. 프 로 그 램 id : t_PSettMakeConsInsurSlipR(공사보험료납입전표)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
function Initialize()
{
	...
	dsWORK_SLIP_IDSEQ.NameString(dsWORK_SLIP_IDSEQ.RowPosition,"WORK_DEPT_CODE") = lrArgs.work_dept_code;
	dsWORK_SLIP_IDSEQ.NameString(dsWORK_SLIP_IDSEQ.RowPosition,"INSUR_NO") = lrArgs.insur_no;
...
function	ConfirmSelected()
{
	...
	dsMAKE_SLIP.NameString(dsMAKE_SLIP.RowPosition,"WORK_DEPT_CODE") = lrArgs.work_dept_code;
	dsMAKE_SLIP.NameString(dsMAKE_SLIP.RowPosition,"INSUR_NO") = lrArgs.insur_no;
