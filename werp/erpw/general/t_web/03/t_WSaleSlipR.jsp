...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명
	String strFileName = "./t_WSaleSlipR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsREMOVE classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__5); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsMAKE_DATA classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49></object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__7); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="trans"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		  ...
		  <param name="TimeOut"    value="1200000000000">
		  <param name="Action"    value="<%=strFileName%>_tr.jsp">
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__8); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transREMOVE"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transMAKE"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transMAKE_DATA"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	      <param name="KeyValue" value="Service1(I:dsMAKE_DATA=dsMAKE_DATA)">
		  <param name="TimeOut"    value="1200000000000">
		  <param name="Action"    value="<%=strFileName%>_tr.jsp">
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 매출액전표 발행작업 목록</td>
														<td align="right" width="*">
															<input id="btnMakeInData" type="button" class="img_btn6_1" value="자료집계" title="" onclick="btnMakeInData_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															&nbsp;&nbsp;
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<C> Name=대상월 		ID=WORK_DT	Width=90 EditStyle=Popup
														</C>
														<C> Name=작업내용 		ID=REMARKS		Width=300
														</C>
										...
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 공사매출구성내역</td>
														<td align="right" width="*">
															&nbsp;
														</td>
													</tr>
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="ColSizing" VALUE="-1">
													<PARAM NAME="Format" VALUE="
														<FC> Name=현장코드 		ID=DEPT_CODE	Width=90 
														</FC>
														<FC> Name=현장명 		ID=DEPT_NAME		Width=160
														</FC>
														<C> Name='최초도급금액' 		ID='F_CONS_AMT'			Width=100
														</C>
														<C> Name='최초실행금액' 		ID='F_BUDG_AMT'			Width=100
														</C>
														<C> Name='도급금액' 		ID='CONS_AMT'			Width=100
														</C>
														<G> Name='총공사예정비' ID=G1
															<C> Name='실행예산' 		ID='BUDG_AMT'			Width=100
															</C>
															<C> Name='하자보수비' 		ID='AS_AMT'			Width=100
															</C>
															<C> Name='소계' 		ID='BUDG_TOT' Value={BUDG_AMT+AS_AMT}			Width=100
															</C>
														</G>
														<C> Name='이익율' 		ID='PROF_RATIO'	Value={(BUDG_AMT+AS_AMT) / CONS_AMT * 100 } Dec=2		Width=60
														</C>
														<G> Name='누적원가' ID=G2
															<C> Name='전년누적액' 		ID='PY_COST_SUM'			Width=100
															</C>
															<C> Name='당월발생액' 		ID='NM_COST_AMT'			Width=100
															</C>
															<C> Name='당년발생액' 		ID='NY_COST_SUM'			Width=100
															</C>
															<C> Name='누적원가' 		ID='COST_SUM'			Width=100
															</C>
														</G>
														<C> Name='진행율' 		ID='PROGRESS_RATIO'	Value={COST_SUM / (BUDG_AMT+AS_AMT)  * 100 } Dec=2		Width=60
														</C>
														<G> Name='매출현황' ID=G3
															<C> Name='전년누계' 		ID='PY_SALE_SUM'			Width=100
															</C>
															<C> Name='당월계산서' 		ID='NM_REQ_SALE_AMT'			Width=100
															</C>
															<C> Name='당월계상액' 		ID='NM_SALE_AMT'			Width=100
															</C>
															<C> Name='당년매출액' 		ID='NY_SALE_AMT'			Width=100
															</C>
															<C> Name='누계매출액' 		ID='SALE_SUM'			Width=100
															</C>
														</G>
														<G> Name='매출이익율' ID=G4
															<C> Name='당월' 		ID='SALE_RATIO_NM'	Dec=2	Value={(NM_SALE_AMT-NM_COST_AMT)/NM_SALE_AMT*100}	Width=60
															</C>
															<C> Name='당년' 		ID='SALE_RATIO_NY'	Dec=2	Value={(NY_SALE_AMT-NY_COST_SUM)/NY_SALE_AMT*100}	Width=60
															</C>
															<C> Name='누적' 		ID='SALE_RATIO'	Dec=2	Value={(SALE_SUM-COST_SUM)/SALE_SUM*100}	Width=60
															</C>
														</G>
														<G> Name='추정원가기준' ID=G5
															<C> Name='추정원가' 		ID='PR_COST_AMT'			Width=100
															</C>
															<C> Name='추정원가(하자포함)' 		ID='PR_COST_AMT_SUM' Value={AS_AMT+PR_COST_AMT}			Width=120
															</C>
															<C> Name='추정이익율' 		ID='PR_PROF_RATIO'	Value={(AS_AMT+PR_COST_AMT)/CONS_AMT*100}	Dec=2	Width=70
															</C>
															<C> Name='추정진행율' 		ID='PR_PROG_RATIO'	Value={COST_SUM/(AS_AMT+PR_COST_AMT)*100}	Dec=2	Width=70
															</C>
															<C> Name='추정누적매출액' 		ID='PR_SALE_SUM'			Width=100
															</C>
														</G>
														<G> Name='미수/선수금진행율' ID=G6
															<C> Name='미수금계산서잔액' 		ID='NP_REMAIN_AMT'			Width=100
															</C>
															<C> Name='미수금진행율잔액' 		ID='NP_R_REMAIN_AMT' 		Width=100
															</C>
															<C> Name='선수금진행율잔액' 		ID='PP_R_REMAIN_AMT' 		Width=100
															</C>
															<C> Name='미수금계상액' 		ID='NP_AMT' 		Width=100
															</C>
															<C> Name='선수금계상액' 		ID='PP_AMT' 		Width=100
															</C>
														</G>
														">
