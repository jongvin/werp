...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("WORK_SLIP_IDSEQ"))
		{
			...
			strSql  = " Select SQ_T_WORK_SLIP_ID.NEXTVAL WORK_SLIP_ID, SQ_T_WORK_SLIP_IDSEQ.NEXTVAL WORK_SLIP_IDSEQ,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' WORK_CODE,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' COMP_CODE, 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' DEPT_CODE,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' WORK_DEPT_CODE, 0 INSUR_NO From DUAL ";
		...
		{
			strSql  = " Select 0 WORK_SLIP_ID, 0 WORK_SLIP_IDSEQ,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' WORK_CODE,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' COMP_CODE, 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' DEPT_CODE,'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' WORK_DEPT_CODE, 0 INSUR_NO From DUAL ";
