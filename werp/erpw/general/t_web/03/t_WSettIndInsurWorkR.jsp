...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WSettIndInsurWorkR(산재보험료전표발행)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSettIndInsurWorkR";
//저장 액션
	...
	try
	{
		...
		strMAKE_DEPT_CODE = strDEPT_CODE;
		...
		try
		{
			strSql = " select F_T_DATETOSTRING(Trunc(SysDate,'YYYY')) DTF,F_T_DATETOSTRING(Last_Day(SysDate)) DTT From Dual ";
...
<html>
	<head>
		...
		<!--
			...
			var			sMakeDeptCode = "<%=strMAKE_DEPT_CODE%>";
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsWORK_NO" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__4); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsREMOVE_SLIP" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__5); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsMAKE_DATA" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__6); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsMAKE_SLIP" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transMAKE_DATA"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
			<param name="KeyValue" value="Service1(I:dsMAKE_DATA=dsMAKE_DATA)">
			<param name="Action"   value="<%=strFileName%>_tr.jsp">
			<param name=Parameter  value="ACT=MAKE_DATA">
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__10); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transMAKE_SLIP"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 산재보험료작업목록</td>
														<td align="right" width="*">
															<input id="btnCalcMonthDecAmt" type="button" class="img_btn10_1" value="기본자료생성"  onclick="btnCalcMonthDecAmt_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															<input id="btnMakeSlip" type="button" class="img_btn4_1" value="전표발행"  onclick="btnMakeSlip_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															<input id="btnShowSlip" type="button" class="img_btn4_1" value="전표보기"  onclick="btnShowLoanSlip_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<C> Name=작업기준일 ID=WORK_DT Width=90 EditStyle=Popup
														</C>
														<G> Name='대상기간' ID=G1
															<C> Name=시작일 ID=TARGET_DT_F Width=90 EditStyle=Popup
															</C>
															<C> Name=종료일 ID=TARGET_DT_T Width=90 EditStyle=Popup
															</C>
														</G>
														<C> Name='작업내용' ID=CONTENTS	Width=400
														</C>
										...
										<tr>
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td class="font_green_bold"> 산재보험료대상전표목록</td>
														<td align="right" width="*">
															&nbsp;
														</td>
													</tr>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<C> Name='현장명' ID=DEPT_NAME	Width=160 suppress=1
														</C>
														<C> Name=계정 ID=ACC_NAME Width=200 
														</C>
														<C> Name=전표번호 ID=MAKE_SLIPNO Width=160 
														</C>
														<C> Name='발생금액' ID=DB_AMT	Width=90 
														</C>
														<C> Name=적요 ID=SUMMARY1 Width=240 
														</C>
														">
