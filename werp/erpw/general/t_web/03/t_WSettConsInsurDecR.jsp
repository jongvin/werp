...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSettConsInsurDecR";
//저장 액션
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 공사보험료공제작업목록</td>
														<td align="right" width="*">
															<input id="btnCalcMonthDecAmt" type="button" class="img_btn10_1" value="월 공제 대상 집계"  onclick="btnCalcMonthDecAmt_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<C> Name='작업내용(적요)' ID=CONTENTS	Width=400
														</C>
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<C> Name=현장코드 ID=DEPT_CODE Width=90 
														</C>
														<C> Name='현장명' ID=DEPT_NAME	Width=200
														</C>
														<G> Name='기간' ID=G1
															<C> Name='시작일' ID=INSUR_DT_F	Width=90 
															</C>
															<C> Name='종료일' ID=INSUR_DT_T	Width=90 
															</C>
														</G>
														<C> Name='보험금액' ID=INSUR_AMT	Width=90 Sumtext=@Sum
														</C>
														<C> Name='전월누계' ID=PRE_SUM_DEC_AMT	Width=90  Sumtext=@Sum
														</C>
														<C> Name='당월공제' ID=DEC_AMT	Width=90  Sumtext=@Sum
														</C>
														<C> Name='공제누계' ID=DEC_TOT	Width=90 value={PRE_SUM_DEC_AMT + DEC_AMT}  Sumtext={Sum(PRE_SUM_DEC_AMT) + Sum(DEC_AMT)}
														</C>
														<C> Name='잔액' ID=REMAIN_AMT	Width=90 value={INSUR_AMT - PRE_SUM_DEC_AMT - DEC_AMT}
															 Sumtext={Sum(INSUR_AMT)-Sum(PRE_SUM_DEC_AMT) - Sum(DEC_AMT)}
														</C>
														">
