...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WSettIndInsurInfoR.jsp(년도별산재요율등록)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSettIndInsurInfoR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 년도별 산재보험 요율</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=년도 ID=WORK_YM Align=Center Width=60 </C>
											<C> Name=본사보험료 ID=HO_IND_DISASTER_AMT Width=100 </C>
											<C> Name='외주비노무비율%' ID=S_L_AMT_RATIO Width=100 </C>
											<C> Name='보험료율%' ID=INSUR_RATIO Width=100 </C>
											<G> Name='납입처' ID=G1
											...
											<C> Name='적요' ID=PROJ_SUMMARY Width=340 </C>
											">
