...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WLastYearBudgResultCompR.jsp(부서별계정별월별현황(년))
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명
	String strFileName = "./t_WLastYearBudgResultCompR";
	String strPageName = "t_WLastYearBudgResultCompR";
//저장 액션                       
								...
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="52">
												<input id="txtCLSE_ACC_ID" type="text" style="width:50px">
											</td>
											<td width="60">
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 전년실적대비현황</td>
							...
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridLIST02 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbgrid.cab#version=1,1,0,125">
										...
										<G>name={'1월'} ID=MON1                                                           
											<C> Name=전년  ID=b_cb1 Align=Right HeadAlign=Center  Width=120 SumText=@sum</C>
											<C> Name=당년 ID=cb1 Align=Right HeadAlign=Center  Width=120 SumText=@sum</C>   
											<C> Name=차    ID=sub_cb1 Align=Right HeadAlign=Center  Width=120</C>           
											<C> Name=%    ID=r_cb1 Align=Right HeadAlign=Center  Width=40</C>               
										</G>         																		
