...
//파일명	
	...
	String strPageName = "t_WBudgAssignByDeptByAccForYearR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 부서별계정별월별현황(년)</td>
											<td align="right" width="*">
												<input id="btnPreView" type="button" class="img_btn5_1" value="상반기출력" onclick="btnPreView_onClick(1)" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
												<input id="btnPreView" type="button" class="img_btn5_1" value="하반기출력" onclick="btnPreView_onClick(2)" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
