/**************************************************************************/
/* 1. 프 로 그 램 id : t_WAddBudgAmtByMonthR.js(월별추가현황)
/* 2. 유형(시나리오) : 스크립트소스
/* 3. 기  능  정  의 : 월별추가현황
...
function makeGridTitle(grid)
{
	...
	gridTitle += "</FC>                                                                                                                               ";
	gridTitle += "	<C> Name=본예산    ID=FIRST_BUDG_AMT Align=Right HeadAlign=Center  Width=150</C>                ";
	gridTitle += "	<C> Name=추가예산 ID=ADD_BUDG_AMT Align=Right HeadAlign=Center  Width=150</C>     ";
	gridTitle += "	<C> Name=예산합계 ID=BUDG_AMT Align=Right HeadAlign=Center  Width=150 show=false</C>    ";                                                               
...
//------------------------------------------------------------------------
{
	...
	var vCompName  = txtCOMPANY_NAME.value;
   	...
   	reportFile ="r_t_080040";  //전체
   	
   	frmList.EXPORT_TAG.value ="P";
	frmList.RUN_TAG.value = "1";
	frmList.REQUEST_NAME.value = "월별추가현황";
