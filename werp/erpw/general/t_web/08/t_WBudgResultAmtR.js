...
function makeGridTitle(grid)
{
	...
	if(vDeptFlag !="ALL"){
		gridTitle += "<FC> Name=팀  ID=chk_dept_name Sort=true Align=Left HeadAlign=Center     Width=100 suppress=3";
		gridTitle += "</FC>                                                                                                                               ";
	}
	if(vDeptFlag !="ALL" && vDeptFlag !="CHK_DEPT" ){
		gridTitle += "<FC> Name=부서  ID=DEPT_NAME Sort=true Align=Left HeadAlign=Center     Width=100 suppress=2";
		gridTitle += "</FC>                                                                                                                               ";
	}
	...
	gridTitle += "	<C> Name=예산  ID=budg_assign_amt Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "	<C> Name=추가배정액 ID=chg_amt Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "	<C> Name=확정실적액    ID=sil_amt Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "	<C> Name=미확정실적액    ID=no_sil_amt Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "	<C> Name=잔액    ID=jan Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "</G>                                                                                                                               ";
	gridTitle += "<G>name={'누계'} ID=SUM                                                                                                                               ";
	gridTitle += "	<C> Name=예산 ID=budg_assign_amt_sum Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "	<C> Name=추가배정액 ID=chg_amt_sum Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "	<C> Name=확정실적액    ID=sil_amt_sum Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "	<C> Name=미확정실적액    ID=no_sil_amt_sum Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "	<C> Name=잔액    ID=jan_sum Align=Right HeadAlign=Center  Width=120</C>                                                                   ";
	gridTitle += "</G>                                                                                                                               ";
...
function btnquery_prt_onclick()
{
	...
	frmList.REQUEST_NAME.value = "예산실적보고서";
