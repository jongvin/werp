...
function txtDEPT_CODE_onblur()
{
	...
	lrRet = C_AutoLov(dsLOV,"T_DEPT_CODE14", lrArgs,"T");	//조원갑님 요청에 의한 수정 ==>내용은 자신이 소속한 파트 내의 다른 파트 및 소속 팀과 자신이 권한이 있는 부서는 모두 볼 수 있다.
...
{     
	...
	lrRet = C_LOV("T_DEPT_CODE14", lrArgs,"F");		//조원갑님 요청에 의한 수정 ==>내용은 자신이 소속한 파트 내의 다른 파트 및 소속 팀과 자신이 권한이 있는 부서는 모두 볼 수 있다.
