...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBudgDeptR.jsp(예산신청부서 등록)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBudgDeptR";
//저장 액션
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=현장코드 ID=DEPT_CODE  Align=Center Width=80 EditStyle=Popup 
											</C> 
											<C> Name=현장명 ID=DEPT_NAME  Width=250 Edit=none
											</C> 
											<C> Name=최종변경차수  ID=LAST_CONFIRMED_SEQ Width=100 Align=Center Edit=none
											</C> 
											<C> Name=최종작업변경차수 ID=LAST_WORK_SEQ Width=110  Align=Center Edit=none
											</C> 
											<C> Name=최초편성차수  ID=FIRST_SEQ Width=100 Align=Center Edit=none
											</C> 
											">
