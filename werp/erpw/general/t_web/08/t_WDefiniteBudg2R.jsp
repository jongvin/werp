...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WDefiniteBudg2R(확정예산) - 재무팀용
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WDefiniteBudg2R";
//저장 액션
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 확정예산</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<C> Name=예산신청금액 ID=BUDG_ITEM_REQ_AMT	Width=200 SumText=@Sum show=false
														</C>
														<C> Name=확정예산금액  ID=BUDG_ITEM_ASSIGN_AMT	Width=200 SumText=@Sum show=true
														</C>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<C> Name=예산신청금액 ID=BUDG_MONTH_REQ_AMT	Width=190 SumText=@Sum show=false
														</C>
														<C> Name=확정예산  ID=BUDG_MONTH_ASSIGN_AMT	Width=190 SumText=@Sum  Edit=none
														</C>
														">
