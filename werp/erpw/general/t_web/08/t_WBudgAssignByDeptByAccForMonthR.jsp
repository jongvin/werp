...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBudgAssignByDeptByAccForMonthR..jsp(부서별계정별월별현황)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBudgAssignByDeptByAccForMonthR";
	String strPageName = "t_WBudgAssignByDeptByAccForMonthR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 부서별계정별월별현황(월)</td>
							...
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridLIST02 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbgrid.cab#version=1,1,0,125">
										...
										<G>name={'당월'} ID=MON                                                                                                             
											<C> Name=계획  ID=budg_assign_amt Align=Right HeadAlign=Center  Width=120 SumText=@sum</C>                                      
											<C> Name=실적    ID=sil_amt Align=Right HeadAlign=Center  Width=120</C>                                                          
											<C> Name=잔액    ID=jan Align=Right HeadAlign=Center  Width=120</C>                         
										</G>                                                                                               
										<G>name={'누계'} ID=SUM                                                                            
											<C> Name=계획 ID=budg_assign_amt_sum Align=Right HeadAlign=Center  Width=120 SumText=@sum</C>  
