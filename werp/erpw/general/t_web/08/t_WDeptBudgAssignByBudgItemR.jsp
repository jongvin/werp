...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WDeptBudgAssignByBudgItemR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsDEPT_ALL" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__10); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsBUDG_ITEM_ALL" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__11); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsITEM_COST" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__12); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transItemCost"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__16"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transDvd"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__17"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transConfirm"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__18"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transConfirmAll"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__19"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transDeptAll"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__20"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transBudgItemAll"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
							...
							<tr>
								<td width="550">
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 예산항목</td>
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__21"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMASTER WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="											
														...
														<FC> Name=예산항목명 ID=BUDG_CODE_NAME Align=Left Width=80 Edit=none BgColor={Decode(ITEM_NO, 0 , '#FFFCE0', '#E0F4FF') }
														</FC>
														<C> Name=항목전체명 ID=FULL_PATH	Width=250  Edit=none
														</C>
										...
										<tr>
											<td height="50%">
												<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="100%">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<td width="15" height="20"><img src="../images/bullet1.gif"></td>
																	<td class="font_green_bold"> 예산신청대상부서</td>
																	<td align="right" width="*">
																		<!--<input id="chkNumber" type="checkbox" value=""  >금액불일치검증-->
																		 <!--<input id="btnDvdAllMonth" type="button" class="img_btn7_1" value="전항목월별분할"  onclick="btnDvdAllMonth_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">-->
																		<input id="btnAddBudgItemAll" type="button" class="img_btn10_1" value="예산부서일괄등록"  onclick="btnAddBudgItemAll()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
																		<input id="btnGetFromItemCost" type="button" class="img_btn4_1" value="단가적용"  onclick="btnGetFromItemCost()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
													...
													<tr>
														<td width="100%" height="100%">
															<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__22"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
																...
																<PARAM NAME="Format" VALUE="
																	...
																	<C> Name=예산배정금액 ID=BUDG_ITEM_ASSIGN_AMT	Width=120 SumText=@Sum  Edit=none show=false
																	</C>
																	<C> Name=차액 ID=DIFF_AMT value={BUDG_ITEM_REQ_AMT-BUDG_ITEM_ASSIGN_AMT} Width=120 SumText=@Sum show=false
																	</C>
																	">
										...
										<tr>
											<td height="50%">
												<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														<td width="100%" height="100%">
															<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__23"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
																...
																<PARAM NAME="Format" VALUE="
																	...
																	<C> Name=예산배정금액 ID=BUDG_MONTH_ASSIGN_AMT	Width=120 SumText=@Sum  Edit=none show=false
																	</C>
																	<C> Name=비고 ID=REMARKS	Width=120 
																	</C>
																	">
