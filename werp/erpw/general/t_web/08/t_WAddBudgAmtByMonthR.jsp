...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WAddBudgAmtByMonthR.jsp(월별추가현황)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WAddBudgAmtByMonthR";
	String strPageName = "t_WAddBudgAmtByMonthR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsDATE classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
								...
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="*"><input id="btnBUDG_YYYY_MM_FR" type="button" class="img_btnCalendar_S" title="달력" onclick="btnBUDG_YYYY_MM_FR_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"></td>
											<td width="5">
												~&nbsp;
											</td>
											<td width="60">
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 월별추가현황</td>
							...
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridLIST02 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbgrid.cab#version=1,1,0,125">
										...
										<C> Name=본예산 ID=FIRST_BUDG_AMT Align=Right HeadAlign=Center  Width=150</C>
										<C> Name=추가예산 ID=ADD_BUDG_AMT Align=Right HeadAlign=Center  Width=150</C>
