...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBudgItemCostR.jsp(예산코드항목등록)
...
//저장 액션
	...
	try
	{
		...
		{
			throw new Exception("USER-900001:공통코드의 일자계산기준 Select 오류 -> " + ex.getMessage());
		}
		...
		{
			throw new Exception("USER-900001:공통코드의 단가기준 Select 오류 -> " + ex.getMessage());
		}
		...
		{
			throw new Exception("USER-900001:공통코드의 직급 Select 오류 -> " + ex.getMessage());
		}
	}
	catch (Exception ex)
	{
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsCHILD_BUDG_CODE_NO classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsITEM_NO classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__6); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsGRADE_COPY classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transGradeCopy"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
							...
							<tr> 
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="70" class="font_green_bold" >대분류코드</td>
											<td width="272">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=cboBUDG_CODE_NO width=160 classid=clsid:60109D65-70C0-425C-B3A4-4CB001513C69 >
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="60" class=font_green_bold>예산코드</td>
											<td width="54">
											...
											<td width="70">
												<input id="btnBUDG_CODE_NO" type="button" class="img_btnFind" value="검색" onclick="btnBUDG_CODE_NO_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
							...
							<tr>
								<td width="700">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 예산코드별단가</td>
											<td align="right" width="*">
												<input id="btnPreView" type="button" class="img_btn2_1" value="복사" onclick="btnCopy_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<td width="*">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold"> 직급별단가</td>
											<td align="right" width="*">
												<input id="btnPreView" type="button" class="img_btn4_1" value="직급복사" onclick="btnGradeCopy_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<td width="750" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=예산코드명 ID=budg_code_name Width=160 suppress=1 Edit=none
											</C> 
											<C> Name=항목명 ID=ITEM_NAME Width=120
											</C>
											<C> Name=예산코드번호 ID=BUDG_CODE_NO Width=75 show=false
											</C> 
											<C> Name=항목번호 ID=ITEM_NO Width=30 show=false
											</C> 											
											<C> Name=일자계산기준 ID=DAY_CALC_TAG  Width=80 align=center EditStyle=Combo Data='<%=strDAY_CALC_TAG%>'
											</C>
											<C> Name=단가기준  ID=UNIT_TAG Width=60 align=center EditStyle=Combo Data='<%=strUNIT_TAG%>'
											</C>
											<C> Name=직급별단가여부 ID=GRADE_UNIT_TAG Width=90 EditStyle=Checkbox
											</C>
											<C> Name=단가 ID=UNIT_COST Width=110
											</C>
											<C> Name=일괄변경적용여부 ID=ALL_CHG_TAG Width=100 EditStyle=Checkbox
											</C> 
											">
								...
								<td width="*">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<C> Name=직급 ID=GRADE_CODE Width=70 align=center EditStyle=Combo Data='<%=strGRADE_CODE%>'
											</C> 
											<C> Name=단가 ID=UNIT_COST Width=130 
											</C>
