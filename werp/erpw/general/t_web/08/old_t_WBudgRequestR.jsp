...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBudgRequestR(예산신청)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBudgRequestR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsBUDG_ITEM" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__4); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsCOPY" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__5); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsDVD_MONTHS" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td align="right" width="*">
															...
															<input id="btnCopyPrev" type="button" class="img_btn7_1" value="전년도예산복사"  onclick="btnCopyPrev_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__10"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														...
														<C> Name=예산항목명 ID=BUDG_CODE_NAME Align=Left Width=160 SumText='합계'
														</C>
														<C> Name=예산신청금액 ID=BUDG_ITEM_REQ_AMT	Width=200 SumText=@Sum
														</C>
														<C> Name=예산배정금액 ID=BUDG_ITEM_ASSIGN_AMT	Width=90 SumText=@Sum show=false
														</C>
														<C> Name=항목전체명 ID=FULL_PATH	Width=290
														</C>
														<C> Name=통제계정 ID=BUDG_EXEC_CLS	Width=60 EditStyle=Checkbox show=false
														</C>
														<C> Name=편성부서  ID=MAKE_DEPT_CLS	Width=60 EditStyle=Checkbox show=false
														</C>
														">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td align="right" width="*">
															...
															<!--<input id="btnDvdMonths" type="button" class="img_btn4_1" value="전월복사"  onclick="btnPrevCopy_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">-->
														</td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="ViewSummary" VALUE="1">
													<PARAM NAME="Format" VALUE="
														<C> Name=예산월 ID=BUDG_YM Align=center Width=90 SumText='합계' Edit=none
														</C>
														<C> Name=예산신청금액 ID=BUDG_MONTH_REQ_AMT	Width=190 SumText=@Sum
														</C>
														<C> Name=예산배정금액 ID=BUDG_MONTH_ASSIGN_AMT	Width=100 SumText=@Sum show=false
														</C>
														">
