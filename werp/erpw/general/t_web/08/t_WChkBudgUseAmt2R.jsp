...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WChkBudgUseAmtR.jsp(통제예산실적조회) - 재무팀용
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WChkBudgUseAmt2R";
	String strPageName = "t_WChkBudgUseAmt2R";
//저장 액션
							...
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridLIST02 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbgrid.cab#version=1,1,0,125">
										...
										<FC> Name=팀명  ID=chk_dept_name Sort=true Align=Left HeadAlign=Center     Width=100 Suppress=2
										</FC>
										<FC> Name=예산코드명 ID=budg_code_name Sort=true Align=Left HeadAlign=Center     Width=100
										</FC>
										
										<G>name={'당월'} ID=MON                                                                                                             
											<C> Name=계획  ID=budg_plan_amt Align=Right HeadAlign=Center  Width=120</C>                                      
											<C> Name=추가 ID=budg_add_amt Align=Right HeadAlign=Center  Width=120</C>                                               
											<C> Name=실적    ID=sil_amt Align=Right HeadAlign=Center  Width=120</C>                                                          
											<C> Name=잔액    ID=jan1 Align=Right HeadAlign=Center  Width=120</C>                         
										</G>                                                                                               
										<G>name={'누계'} ID=SUM                                                                            
											<C> Name=계획 ID=s_budg_plan_amt Align=Right HeadAlign=Center  Width=120</C>  
											<C> Name=추가 ID=s_budg_add_amt Align=Right HeadAlign=Center  Width=120</C>          
											<C> Name=실적    ID=s_sil_amt Align=Right HeadAlign=Center  Width=120</C>                     
											<C> Name=잔액    ID=s_jan1 Align=Right HeadAlign=Center  Width=120</C>                         
										</G>                                                                                               
