...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBudgYearR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 예산회기정보설정</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=회기년도 ID=CLSE_ACC_ID Align=Center Width=120
											</C>
											<C> Name=회기기수 ID=ACC_ID Align=Center Width=120
											</C>
											<C> Name='예산편성시작일' ID=MAKE_DT_F	Align=Center Width=150
											</C>
											<C> Name='예산편성종료일' ID=MAKE_DT_T	Align=Center Width=150
											</C>
											<C> Name='비고' ID=REMARKS	Align=Left Width=400
											</C>
											">
