...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBudgDeptMapR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 예산귀속부서편성부서목록</td>
											<td align="right" width="*">
												<input id="btnApplyDefault" type="button" class="img_btn4_1" value="기본설정" title="Alt-F1" onclick="btnApplyDefault_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__4"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=귀속부서코드 ID=DEPT_CODE Align=Center Width=100
											</C>
											<C> Name=귀속부서명 ID=DEPT_NAME Align=Left Width=200
											</C>
											<C> Name='통제부서코드' ID=CHK_DEPT_CODE	Align=Center Width=100
											</C>
											<C> Name='통제부서명' ID=CHK_DEPT_NAME	Align=Left Width=200
											</C>
											">
