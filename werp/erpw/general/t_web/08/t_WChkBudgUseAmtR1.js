...
function makeGridTitle(grid)
{
	...
	gridTitle += "<FC> Name=상위계정 ID=p_acc_name Sort=true Align=left HeadAlign=Center    Width=150    suppress=1           ";
	gridTitle += "</FC>                                                                                                                               ";
	gridTitle += "<FC> Name=계정 ID=ACC_NAME Sort=true Align=Left HeadAlign=Center    Width=200               ";
	gridTitle += "</FC>                                                                                                                               ";
	gridTitle += "<G>name={'당월'} ID=MON                                                                                                                             ";
	gridTitle += "	<C> Name=계획  ID=budg_amt Align=Right HeadAlign=Center  Width=120 SumText=@sum</C>                                                                   ";
	gridTitle += "	<C> Name=추가 ID=add_amt Align=Right HeadAlign=Center  Width=120 SumText=@sum</C>                                                                   ";
	...
	gridTitle += "	<C> Name=계획 ID=budg_amt_sum Align=Right HeadAlign=Center  Width=120 SumText=@sum</C>                                                                   ";
	gridTitle += "	<C> Name=추가 ID=add_amt_sum Align=Right HeadAlign=Center  Width=120 SumText=@sum</C>                                                                   ";
