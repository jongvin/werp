...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBudgAssignR(예산배정)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
/* 4. 변  경  이  력 : 김흥수 작성(2005-12-01)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBudgAssignR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsDVD_MONTHS" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__7); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__8"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsCONFIRM" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		</object><!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__8); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="dsCONFIRM_ALL" classid="clsid:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__11"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transCopy"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transDvd"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__13"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transConfirm"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__14"> <!--CONVPAGE_TAIL 지우지마세요//--><object id="transConfirmAll"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
							...
							<tr>
								<td width="300">
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 예산신청부서</td>
														<td align="right" width="*">
															<input id="btnConfirmAll" type="button" class="img_btn5_1" value="전부서확정"  onclick="btnConfirmAll_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															<input id="btnCancelAll" type="button" class="img_btn7_1" value="전부서확정취소"  onclick="btnCancelAll_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
														</td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__15"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMASTER WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													<PARAM NAME="DataID" VALUE="dsMASTER">
													<PARAM NAME="Editable" VALUE="false">
													<PARAM NAME="ColSelect" VALUE="true">
													<PARAM NAME="ColSizing" VALUE="true">
													<PARAM NAME="Format" VALUE="
														<C> Name=부서코드 ID=DEPT_CODE Align=Left Width=60 align=center
														</C>
														<C> Name=부서명 ID=DEPT_NAME Align=Left Width=160 
														</C>
														<C> Name='확정' ID=CONFIRM_TAG	Width=60 EditStyle='checkbox'
														</C>
														">
														...
														<td width="100%">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	...
																	<td align="right" width="*">
																		<!--<input id="chkNumber" type="checkbox" value=""  >금액불일치검증-->
																		<input id="btnAssignAll" type="button" class="img_btn7_1" value="전항목일괄배정"  onclick="btnAssignAll_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
																		<input id="btnConfirmDept" type="button" class="img_btn8_1" value="해당부서예산확정"  onclick="btnConfirmDept_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
																		<input id="btnCancelDept" type="button" class="img_btn10_1" value="해당부서예산확정취소"  onclick="btnCancelDept_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
																	</td>
																</tr>
															</table>
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														<td width="100%" height="100%">
															<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__16"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
																...
																<PARAM NAME="Format" VALUE="
																	<C> Name=예산코드 ID=BUDG_ITEM_CODE Align=Left Width=70 show=false
																	</C>
																	<C> Name=예산항목명 ID=BUDG_CODE_NAME Align=Left Width=120 SumText='합계'
																	</C>
																	<C> Name=예산신청금액 ID=BUDG_ITEM_REQ_AMT	Width=180 SumText=@Sum
																	</C>
																	<C> Name=예산배정금액 ID=BUDG_ITEM_ASSIGN_AMT	Width=180 SumText=@Sum
																	</C>
																	<C> Name=차액 ID=DIFF_AMT value={BUDG_ITEM_REQ_AMT-BUDG_ITEM_ASSIGN_AMT}	Width=180 SumText=@Sum
																	</C>
																	<C> Name=항목전체명 ID=FULL_PATH	Width=300
																	</C>
																	">
										...
										<tr>
											<td height="50%">
												<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<td width="100%">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	...
																	<td align="right" width="*">
																		<input id="btnAssignMonths" type="button" class="img_btn4_1" value="일괄배정"  onclick="btnAssignMonths_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
																		<!--<input id="btnDvdMonths" type="button" class="img_btn4_1" value="월별분할"  onclick="btnDvdMonths_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">-->																	</td>
																</tr>
															</table>
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr class="head_line">
													...
													<tr>
														<td width="100%" height="100%">
															<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__17"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
																...
																<PARAM NAME="Format" VALUE="
																	...
																	<C> Name=예산신청금액 ID=BUDG_MONTH_REQ_AMT	Width=180 SumText=@Sum
																	</C>
																	<C> Name=예산배정금액 ID=BUDG_MONTH_ASSIGN_AMT	Width=180 SumText=@Sum
																	</C>
																	<C> Name=비고 ID=REMARKS	Width=180 
																	</C>
																	">
