...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBudgResultAmtR.jsp(예산실적조회)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBudgResultAmtR";
	String strPageName = "t_WBudgResultAmtR";
//저장 액션
...
<html>
	<head>
		...
		<!--사업장목록 Dataset-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__3"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsLIST02 classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>     
								...
								<td width="100%" class="td_green">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="110">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id="cboDeptCode" style="width:100" classid=clsid:60109D65-70C0-425c-B3A4-4CB001513C69 VIEWASTEXT codebase="../../../cabfiles/LuxeCombo.cab#version=1,1,0,16">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="45" class="font_green_bold" >조회월</td>
											<td width="272">
												<select id="selMonth" style="width:50">
				...
				<tr valign="top"> 
					<td width="100%" height="100%">
						<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 예산실적조회</td>
											<td align="right" width="*">
												<input id="btnPreView" type="button" class="img_btn2_1" value="출력" onclick="btnPreView_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__7"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridLIST02 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT codebase="../../../cabfiles/toinbgrid.cab#version=1,1,0,125">
										...
										<FC> Name=계정 ID=ACC_NAME Sort=true Align=Left HeadAlign=Center     Width=250
										</FC>
										
										<G>name={'당월'} ID=MON                                                                                                             
											<C> Name=예산  ID=budg_assign_amt Align=Right HeadAlign=Center  Width=120</C>                                      
											<C> Name=추가배정액 ID=chg_amt Align=Right HeadAlign=Center  Width=120</C>                                               
											<C> Name=확정실적액    ID=sil_amt Align=Right HeadAlign=Center  Width=120</C>
											<C> Name=미확정실적액    ID=no_sil_amt Align=Right HeadAlign=Center  Width=120</C>                                                          
											<C> Name=잔액    ID=jan Align=Right HeadAlign=Center  Width=120</C>                         
										</G>                                                                                               
										<G>name={'누계'} ID=SUM                                                                            
											<C> Name=예산 ID=budg_assign_amt_sum Align=Right HeadAlign=Center  Width=120</C>  
											<C> Name=추가배정액 ID=chg_amt_sum Align=Right HeadAlign=Center  Width=120</C>          
											<C> Name=확정실적액    ID=sil_amt_sum Align=Right HeadAlign=Center  Width=120</C>
											<C> Name=미확정실적액    ID=no_sil_amt_sum Align=Right HeadAlign=Center  Width=120</C>                        
											<C> Name=잔액    ID=jan_sum Align=Right HeadAlign=Center  Width=120</C>                         
										</G>                                                                                               
