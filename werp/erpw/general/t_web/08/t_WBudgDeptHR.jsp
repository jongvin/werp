...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WBudgDeptHR.jsp(예산변경차수등록)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBudgDeptHR";
//저장 액션
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__3"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=예산변경차수 ID=CHG_SEQ Align=Center Width=80 Edit=none
											</C> 
											<C> Name=확정여부 ID=CONFIRM_TAG Width=105 EditStyle=Checkbox
											</C> 
											<C> Name=예산변경적용시작월 ID=BUDG_APPLY_YM Width=100 EditStyle=Popup 
											</C> 
