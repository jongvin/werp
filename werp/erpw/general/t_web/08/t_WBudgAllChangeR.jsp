...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WBudgAllChangeR";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__2"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsALL_CHG_SEQ classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 일괄변경차수</td>
											<td align="right" width="*">
												<input id="btnAllBudgAllChg" type="button" class="img_btn6_1" value="일괄예산변경" onclick="btnAllBudgAllChg_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
												<input id="btnAllBudgAllChgCancel" type="button" class="img_btn8_1" value="일괄예산변경취소" onclick="btnAllBudgAllChgCancel_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=일괄변경차수  ID=ALL_CHG_SEQ Width=80 align=center
											</C> 
											<C> Name=예산변경적용시작월 ID=BUDG_APPLY_YM Width=125  align=center
											</C> 
											<C> Name=적용여부  ID=CHG_DIV Width=80 align=center
											</C>
											">
