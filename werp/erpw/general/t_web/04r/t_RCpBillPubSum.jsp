...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RBillPubSum.jsp(수표/어음폐기대장)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RCpBillPubSum";
	String strPageName = "t_RCpBillPubSum";
//저장 액션
	...
	try
	{
		...
		try
		{
			...
			strSql = " select substr(F_T_DateToString(Trunc(Sysdate,'MM')), 1, 7) DT_M  From Dual ";

			lrReturnData = CITDatabase.selectQuery(strSql, lrArgData);
			strDT_M = lrReturnData.toString(0,"DT_M");
										...
										<tr> 
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="*" align=center>
															...
															<input name="chkTYPE" id="chkTYPE1" type="radio" class="radio" value="0" onclick="clearPayBank(this);" checked>&nbsp;어음
															<input name="chkTYPE" id="chkTYPE2" type="radio" class="radio" value="1" onclick="clearPayBank(this);">&nbsp;수표
														</td>
														<td width="">&nbsp</td>
													</tr>
												</table>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="70" class="font_green_bold" >기준월</td>
														<td width="72"><input id="txtDT_M" type="text" datatype="dateym" style="width:70px" value = "<%=strDT_M%>"/></td>
														<td width="30">
															<input id="btnDT_M" type="button" class="img_btnCalendar_S" onClick="btnDT_M_onClick()" title="달력" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"/>
														</td>
