...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RCustBillListR.jsp(어음/수표수불집계표)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RCustBillListR";
	String strPageName = "t_RCustBillListR";
//저장 액션
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="*" align=center>
												<input id="chkTYPEOld" type="hidden" value="B">
												<input name="chkTYPE" id="chkTYPE1" type="radio" class="radio" value="0" onclick="clearPayBank(this);" checked>&nbsp;지급어음
												<input name="chkTYPE" id="chkTYPE2" type="radio" class="radio" value="1" onclick="clearPayBank(this);">&nbsp;받을어음
											</td>
											<td width="">&nbsp</td>
										</tr>
									</table>
											...
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="112"> <input id="txtCUST_CODE" type="text" datatype="han" style="width:110px" VALUE="" onblur="txtCUST_CODE_onblur()"></td>
														<td width="161"> <input id="txtCUST_NAME" type="text" class="ro" readOnly style="width:159px" VALUE="">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="70" class="font_green_bold" >발행일</td>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="72"><input id="txtDT_F2" type="text" datatype="date" style="width:70px" value = "<%=strDT_F%>"/></td>
														<td width="30">
															<input id="btnDT_F2" type="button" class="img_btnCalendar_S" onClick="btnDT_F2_onClick()" title="달력" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"/>
														</td>
														<td width="15">~</td>
														<td width="72"><input id="txtDT_T2" type="text" datatype="date" style="width:70px" value = "<%=strDT_T%>"/></td>
														<td width="30">
															<input id="btnDT_T2" type="button" class="img_btnCalendar_S" onClick="btnDT_T2_onClick()" title="달력" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;"/>
														</td>
														<td width="*">&nbsp;</td>
													</tr>
												</table>
