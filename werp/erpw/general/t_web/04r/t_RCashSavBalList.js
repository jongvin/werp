...
function btnquery_prt_onclick()
{
	...
	strTemp += "pCOMP_CODE__" + (C_isNull(txtCOMP_CODE.value)?"%":txtCOMP_CODE.value);
	strTemp += "&&pCOMP_CODE2__" + txtCOMP_CODE.value;
	strTemp += "&&pCOMPANY_NAME__" + (C_isNull(txtCOMP_CODE.value)?"전사업장":txtCOMPANY_NAME.value);
	strTemp += "&&pDT_F__" + txtDT_F.value;
	strTemp += "&&pDT_T__" + txtDT_T.value;
	strTemp += "&&pDT_T2__" + txtDT_T.value;
