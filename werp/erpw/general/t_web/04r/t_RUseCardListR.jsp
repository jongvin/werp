...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RUseCardListR";
	String strPageName = "t_RUseCardListR";
//저장 액션
										...
										<tr> 
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="70" class="font_green_bold" >카드결제일</td>
														<td width="72"><input id="txtPAY_DAY" type="text" datatype="N" style="width:40px" maxlength=2/></td>
														<td width="*">카드결제일을 입력함(ex:25)</td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
