/**************************************************************************/
/* 1. 프 로 그 램 id : t_RLoanList2R.jsp(차입금명세)
/* 2. 유형(시나리오) : shared window 조회 및 입력
/* 3. 기  능  정  의 : 
/* 4. 변  경  이  력 : 김흥수 작성(2006-03-17)
...
function btnquery_prt_onclick()
{
	...
	if(!print_condition_check()) return;
   	...
   	var reportFile ="r_t_040015_2.rpt";
	...
	strTemp += "&&CompanyName__" + txtCOMPANY_NAME.value;
	strTemp += "&&DateDtTo__" + txtDT_T.value;
