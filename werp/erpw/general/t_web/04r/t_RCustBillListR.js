...
function btnquery_prt_onclick()
{
	...
	strTemp += "GB_CD__" + strCHK_BILL_CLS;
	...
	strTemp += "&&EXPR_DT_F__" + txtDT_F2.value.replace(/-/g, "");
	strTemp += "&&EXPR_DT_T__" + txtDT_T2.value.replace(/-/g, "");
	...
	{
		strTemp += "&&CUST_CODE__" + txtCUST_CODE.value.replace(/-/g, "");
	}
