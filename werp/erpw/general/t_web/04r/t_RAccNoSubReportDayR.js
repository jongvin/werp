...
function btnquery_prt_onclick()
{
	...
	strTemp += "&&AccNo__" + (C_isNull(txtACCNO.value)?"%":txtACCNO.value);
	strTemp += "&&BankCode__" + (C_isNull(txtBANK_CODE.value)?"%":txtBANK_CODE.value);
	strTemp += "&&MakeCompany__" + txtCOMP_CODE.value;
	strTemp += "&&KeepDtFrom__" + txtDT_F.value;
	strTemp += "&&KeepDtTo__" + txtDT_T.value;
