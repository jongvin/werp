/**************************************************************************/
/* 1. 프 로 그 램 id : t_RNPaySumR.jsp(미불집계장부)
/* 2. 유형(시나리오) : shared window 출력
/* 3. 기  능  정  의 : 미불집계장부 
/* 4. 변  경  이  력 : 김흥수 작성(2006-06-19)
...
function btnquery_prt_onclick()
{
	...
	sDEPT_CODE = txtDEPT_CODE.value;
	if(C_isNull(sDEPT_CODE))
	{
		sDEPT_CODE = "%";
	}
   
   
   	var reportFile ="r_t_041030.rpt";
	...
	strTemp += "&&DEPT_CODE__" + sDEPT_CODE;
	strTemp += "&&DT_F__" + txtDT_F.value.replace(/-/g,'');
	strTemp += "&&DT_T__" + txtDT_T.value.replace(/-/g,'');
