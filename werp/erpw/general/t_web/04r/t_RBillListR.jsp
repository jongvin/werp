...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RBillListR";
	String strPageName = "t_RBillListR";
//저장 액션
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="460">
												...
												<input name="chkTYPE" id="chkTYPE1" type="radio" class="radio" value="0" onclick="clearPayBank(this);" checked>&nbsp;어음발행대장
												<input name="chkTYPE" id="chkTYPE2" type="radio" class="radio" value="1" onclick="clearPayBank(this);">&nbsp;견질어음대장
												<input name="chkTYPE" id="chkTYPE3" type="radio" class="radio" value="2" onclick="clearPayBank(this);">&nbsp;수표발행대장
												<input name="chkTYPE" id="chkTYPE4" type="radio" class="radio" value="3" onclick="clearPayBank(this);">&nbsp;견질수표대장
											</td>
											<td width="">&nbsp</td>
										</tr>
									</table>
