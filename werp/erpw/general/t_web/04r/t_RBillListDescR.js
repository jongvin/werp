...
function btnquery_prt_onclick()
{
	...
	strTemp += "&&PublDtFr__" + txtDT_F.value.replace(/-/g, "");
	strTemp += "&&PublDtTo__" + txtDT_T.value.replace(/-/g, "");
...
{
	C_Calendar("DT_F2", "D", txtDT_F2.value);
	S_nextFocus(btnDT_F2);
}

function btnDT_T2_onClick()
{
	C_Calendar("DT_T2", "D", txtDT_T2.value);
