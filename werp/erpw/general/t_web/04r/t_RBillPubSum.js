...
{
	if (asCalendarID == "DT_M")
	{
		txtDT_M.value = asDate;
	}
...
{
	if (C_isNull(txtDT_M.value))
	{
		C_msgOk("기준월을 입력하세요.", "확인");
		return false;
	}
...
function btnDT_M_onClick()
{
	C_Calendar("DT_M", "M", txtDT_M.value);
	S_nextFocus(btnDT_M);
}
