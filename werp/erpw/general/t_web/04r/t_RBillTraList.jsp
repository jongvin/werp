...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RLoanIncDecListR.jsp(수표/어음폐기대장)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RBillTraList";
	String strPageName = "t_RBillTraList";
//저장 액션
										...
										<tr> 
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="70" class="font_green_bold" >폐기일</td>
