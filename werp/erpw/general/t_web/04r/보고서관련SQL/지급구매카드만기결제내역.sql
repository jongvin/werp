Select
	...
	a.ACCNO,			--계좌번호
	a.MAKE_SLIPLINE,	--좌수
	aa.MNG_ITEM_DT1,	--발행일(세금계산서일자)
	aa.PAY_CON_BILL_DT,	--만기일
	Nvl(a.DB_AMT,0) - Nvl(a.CR_AMT,0) AMT,			--입금금액
	a.SUMMARY1			--적요
...
And		(a.SLIP_IDSEQ <> a.RESET_SLIP_IDSEQ Or a.SLIP_ID <> a.RESET_SLIP_ID)
And		a.SLIP_ID = b.SLIP_ID
And		a.BANK_CODE = c.BANK_CODE (+)
And		a.CUST_SEQ = d.CUST_SEQ (+)
And		a.RESET_SLIP_ID = aa.SLIP_ID
And		a.RESET_SLIP_IDSEQ = aa.RESET_SLIP_IDSEQ
