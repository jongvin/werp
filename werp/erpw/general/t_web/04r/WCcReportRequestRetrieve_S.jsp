	...
	try
	{
		...
		if (strAct.equals("REQUEST_LIST"))
		{
			try
			{
				...
				lrArgData.setValue("SYS_ID", strSysID);
				...
				strSql += "        SF_DateToString(a.DELETE_EXPECT_DATE) as DELETE_EXPECT_DATE, ";
				strSql += "        a.STATE, ";
				strSql += "        c.CODE_LIST_NAME as STATE_NAME, ";
				strSql += "        a.REMARK ";
				strSql += " From   TCC_USER_REPORT_REQUEST a, ";
				strSql += "        TCC_REPORT b, ";
				strSql += "        VCC_CODE_LIST c ";
			...
			{
				if (GauceInfo != null) GauceInfo.response.writeException("USER", "900001", "TCC_USER_REPORT_REQUEST 테이블 Select 오류 -> " + ex.getMessage());
				throw new Exception("USER-900001:TCC_USER_REPORT_REQUEST 테이블 Select 오류 -> " + ex.getMessage());
			}
		}
	}
	catch (Exception ex)
