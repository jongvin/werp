...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RDayFundBrief";
	String strPageName = "t_RDayFundBrief";
//저장 액션
	String strDate = CITDate.getNow();
										...
										<tr> 
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="100" class=font_green_bold>기준작업일</td>
														<td width="52">
															<input id="txtYMD" type="text" datatype=date  style="width:70px" >
														</td>
														<td width="70">
															<input id="btnYMD" type="button" class="img_btnCalendar_S"  title="달력"  onclick="btnYMD_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
														</td>
														<td width=*>&nbsp;</td>
													</tr>
												</table>
