...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RFinSecDescR.jsp(투자유가증권명세서(취득일))
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RFinSecDescR";
	String strPageName = "t_RFinSecDescR";
//저장 액션
										...
										<tr> 
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15"><img src="../images/bullet3.gif"></td>
														<td width="70" class="font_green_bold" >취득일</td>
