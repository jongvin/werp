...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_RBankSheet.jsp(은행원장)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_RBankSheet";
	String strPageName = "t_RBankSheet";
//저장 액션
	...
	try
	{
		...
		try
		{
			...
			strSql = " select To_Char(Trunc(Sysdate,'MM'),'YYYY-MM') DT_F,F_T_DateToString(SysDate) DT_T From Dual ";
											...
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="72"><input id="txtDT_F" type="text" datatype="DATEYM" style="width:70px" value = "<%=strDT_F%>"/></td>
														<td width="30">
