...
(
	Select
		...
		a.PLAN_AMT_12,
		a.PLAN_AMT_TOT,
		100* a.EXEC_AMT_TOT / NullIf(a.PLAN_AMT_TOT,0) PROGRESS_TOT,
		Sum(a.BASE_EXEC_AMT_01) Over () BASE_EXEC_AMT_01,
		Sum(a.BASE_EXEC_AMT_02) Over () BASE_EXEC_AMT_02,
		Sum(a.BASE_EXEC_AMT_03) Over () BASE_EXEC_AMT_03,
		Sum(a.BASE_EXEC_AMT_04) Over () BASE_EXEC_AMT_04,
		Sum(a.BASE_EXEC_AMT_05) Over () BASE_EXEC_AMT_05,
		Sum(a.BASE_EXEC_AMT_06) Over () BASE_EXEC_AMT_06,
		Sum(a.BASE_EXEC_AMT_07) Over () BASE_EXEC_AMT_07,
		Sum(a.BASE_EXEC_AMT_08) Over () BASE_EXEC_AMT_08,
		Sum(a.BASE_EXEC_AMT_09) Over () BASE_EXEC_AMT_09,
		Sum(a.BASE_EXEC_AMT_10) Over () BASE_EXEC_AMT_10,
		Sum(a.BASE_EXEC_AMT_11) Over () BASE_EXEC_AMT_11,
		Sum(a.BASE_EXEC_AMT_12) Over () BASE_EXEC_AMT_12,
		Sum(a.BASE_EXEC_AMT_TOT) Over () BASE_EXEC_AMT_TOT,
		Sum(a.BASE_PLAN_AMT_TOT) Over () BASE_PLAN_AMT_TOT,
		...
		100 * a.PLAN_AMT_TOT / NullIf(Sum(a.BASE_PLAN_AMT_TOT) Over (),0) RAT_TOT_PLAN,
		RowNum RNN
	From
		(
			Select
				...
				Sum( Case When a.MNG_CODE = '매출액' Then b.PLAN_AMT Else Null End ) / :BASE_AMT BASE_PLAN_AMT_TOT,
...
Select
	...
	a.EXEC_AMT_11 C_11,
	a.EXEC_AMT_12 C_12,
	a.PLAN_AMT_TOT C_TOT1,
	a.EXEC_AMT_TOT C_TOT2,
	a.PROGRESS_TOT C_TOT3
From	Base_Table a
...
Select
	...
	a.RAT_11 C_11,
	a.RAT_12 C_12,
	a.RAT_TOT_PLAN C_TOT1,
	a.RAT_TOT C_TOT2,
	100 * a.RAT_TOT / NullIf(a.RAT_TOT_PLAN,0) C_TOT3
From	Base_Table a
...
Select
	4 MAIN_ORDER,
	'영업외손익(%)' NAME,
	100 * Sum(a.EXEC_AMT_01) / NullIf(Sum(a.BASE_EXEC_AMT_01),0) C_01,
	100 * Sum(a.EXEC_AMT_02) / NullIf(Sum(a.BASE_EXEC_AMT_02),0) C_02,
	100 * Sum(a.EXEC_AMT_03) / NullIf(Sum(a.BASE_EXEC_AMT_03),0) C_03,
	100 * Sum(a.EXEC_AMT_04) / NullIf(Sum(a.BASE_EXEC_AMT_04),0) C_04,
	100 * Sum(a.EXEC_AMT_05) / NullIf(Sum(a.BASE_EXEC_AMT_05),0) C_05,
	100 * Sum(a.EXEC_AMT_06) / NullIf(Sum(a.BASE_EXEC_AMT_06),0) C_06,
	100 * Sum(a.EXEC_AMT_07) / NullIf(Sum(a.BASE_EXEC_AMT_07),0) C_07,
	100 * Sum(a.EXEC_AMT_08) / NullIf(Sum(a.BASE_EXEC_AMT_08),0) C_08,
	100 * Sum(a.EXEC_AMT_09) / NullIf(Sum(a.BASE_EXEC_AMT_09),0) C_09,
	100 * Sum(a.EXEC_AMT_10) / NullIf(Sum(a.BASE_EXEC_AMT_10),0) C_10,
	100 * Sum(a.EXEC_AMT_11) / NullIf(Sum(a.BASE_EXEC_AMT_11),0) C_11,
	100 * Sum(a.EXEC_AMT_12) / NullIf(Sum(a.BASE_EXEC_AMT_12),0) C_12,
	100 * Sum(a.PLAN_AMT_TOT) / NullIf(Sum(a.BASE_PLAN_AMT_TOT),0) C_TOT1,
	100 * Sum(a.EXEC_AMT_TOT) / NullIf(Sum(a.BASE_EXEC_AMT_TOT),0) C_TOT2,
	100 * (100 * Sum(a.EXEC_AMT_TOT) / NullIf(Sum(a.BASE_EXEC_AMT_TOT),0)) / NullIf((100 * Sum(a.EXEC_AMT_TOT) / NullIf(Sum(a.BASE_PLAN_AMT_TOT),0)),0) C_TOT3
From	Base_Table a
