...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLMASumTarCodeR";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 원가집적대상코드</td>
...
<C> Name=원가집적코드	ID=SUM_TAR_CODE			Align=Left	 Width=100   	Show='true'
</C>
<C> Name=원가집적코드명 ID=SUM_TAR_NAME			Align=Left	 Width=200   	Show='true'
</C>
											">
							...
							<tr>
								<td width="50%">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="15" height="20"><img src="../images/bullet1.gif"></td>
											<td class="font_green_bold"> 원가집적대상 부서/현장</td>
											<td align="right" width="*">
												&nbsp;
											</td>
										</tr>
										...
										<tr>
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE=" 
<C> Name='원가집적코드' ID=SUM_TAR_CODE Align=Center HeadAlign=Center  Width=120 Sort=true edit=none Show=False
</C>
<FC> Name='부서코드'	ID=DEPT_CODE Align=Left HeadAlign=Center  Width=120 Sort=true edit=none BgColor='#E0F4FF'
</FC>
<FC> Name='부서명'		ID=DEPT_NAME Align=Left HeadAlign=Center  Width=250 edit=none	BgColor='#E0F4FF'
</FC>
														">
