											...
											<td>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="150" class="font_green_bold">배부금액목록</td>
														...
														<td width="*" height="100%">
															<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" height="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
																...
																<PARAM NAME="Format" VALUE=" 
																	<C> Name=계정코드	ID=ACC_CODE Width=80 Edit=none
																	</C> 
																	<C> Name=계정명	ID=ACC_NAME Width=240 Edit=none
																	</C> 
																	<G> Name='배부기준' ID=G1
																		<C> Name=배부기준 		ID=DVD_NAME Width=90 Edit=none
																		</C> 
																		<C> Name=기준금액 		ID=DVD_RAT_POSITION Width=110 Edit=none
																		</C> 
																		<C> Name=기준총액 		ID=DVD_RAT_BASE Width=110 Edit=none
																		</C> 
																		<C> Name='배부비율%' 		ID=DVD_RATIO Width=60 Edit=none
																		</C> 
																	</G>
																	<C> Name=배부금액	ID=DVD_AMT Width=110 Edit=none SumText=@sum SumBgColor=#FFCCCC
																	</C>
																	<C> Name=배부대상총액	ID=SUM_AMT Width=110 Edit=none SumText=@sum SumBgColor=#FFCCCC
																	</C>
																	">
										...
										<tr>
											<td>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="15" height="20"><img src="../images/bullet1.gif"></td>
														<td width="300" class="font_green_bold">배부대상 금액 전표 목록</td>
														<td align="right" width="*">
														...
														<td width="*" height="100%">
															<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__6"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" height="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
																...
																<PARAM NAME="Format" VALUE=" 
																	...
																	<C> Name=집적대상 		ID=SUM_TAR_NAME Width=120 Edit=none
																	</C> 
																	<C> Name='부서/현장' 		ID=DEPT_NAME Width=160 Edit=none
																	</C> 
																	...
																	<C> Name=적용금액	ID=APPL_AMT Width=90 Edit=none SumText=@sum SumBgColor=#FFCCCC
																	</C>
																	<C> Name='적요' 		ID=SUMMARY Width=240 Edit=none
																	</C> 
																	">
