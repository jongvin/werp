...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 	a.ITEM_TAG , \n";
			strSql += " 	a.MNG_CODE , \n";
			strSql += " 	To_Char(a.FUNC_NO) FUNC_NO , \n";
		...
		else if (strAct.equals("ITEM_NO"))
		{
			...
			strSql  = " Select SQ_T_ITEM_NO.NextVal ITEM_NO From Dual  \n";
		...
		else if (strAct.equals("APPLY_SEQ"))
		{
			...
			strSql  = " Select SQ_T_MA_APPLY_SEQ.NextVal APPLY_SEQ From Dual  \n";
		...
		else if (strAct.equals("SUB01"))
		{
			...
			strSql += " 	a.REMARKS, \n";
			strSql += " 	b.ACC_NAME \n";
			strSql += " From	T_PL_MA_ITEM_ACC_CODE a, \n";
			strSql += " 		T_ACC_CODE b \n";
			strSql += " Where	a.ITEM_NO =  ?  \n";
			...
			lrArgData.addColumn("1ITEM_NO", CITData.NUMBER);
			lrArgData.addRow();
			lrArgData.setValue("1ITEM_NO", strITEM_NO);
			try
			{
				lrReturnData = CITDatabase.selectQuery(strSql, lrArgData);
