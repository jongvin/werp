...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 			sum(c_y_exec_bg)  c_y_exec_bg,      \n";
			...
			strSql += " 		 		 decode(nvl(c_y_exec_bg,0),0, 0, round(c_y_exec_bg/100000000,0)) c_y_exec_bg, \n";
			strSql += " 				 decode(nvl(c_y_plan_bg,0),0, 0, round((nvl(c_y_exec_bg,0)/nvl(c_y_plan_bg,0))*100,1)) c_plan_rate19, \n";
			strSql += " 				 decode(nvl(b_y_exec_bg,0), 0, 0, round((nvl(c_y_exec_bg,0)/nvl(b_y_exec_bg,0))*100,1)) b_rate19 \n";
			strSql += " 		  from  \n";
			strSql += " 				  \n";
			...
			strSql += " 				 		 sum(exec_amt) c_y_exec_bg \n";
			strSql += " 				  from  t_pl_comp_plan_exec \n";
			strSql += " 				  where comp_code =  ?  \n";
			...
			strSql += " 		  decode(a1.c_y_exec_bg, 0, 0, round((b1.c_y_exec_bg/a1.c_y_exec_bg)*100,1)) c_y_exec_bg, \n";
