...
function btnquery_prt_onclick()
{
	...
	//dsCOPY.NameString(dsCOPY.RowPosition,"BUNGI") = vBungi;
	dsCOPY.NameString(dsCOPY.RowPosition,"MON1") = vMon1;
	dsCOPY.NameString(dsCOPY.RowPosition,"MON2") = vMon2;
	dsCOPY.NameString(dsCOPY.RowPosition,"MON3") = vMon3;
	//dsCOPY.NameString(dsCOPY.RowPosition,"") = vDeptCode;
	...
	strTemp += "&&P_MON1__" + vMon1;
	strTemp += "&&P_MON2__" + vMon2;
	strTemp += "&&P_MON3__" + vMon3;
