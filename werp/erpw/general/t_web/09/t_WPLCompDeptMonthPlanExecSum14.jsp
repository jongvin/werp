...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLCompDeptMonthPlanExecSum14";
	String strPageName = "t_WPLCompDeptMonthPlanExecSum14";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 주요부문별실적</td>
								...
								<td width="100%" height="100%">
									...
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<C> Name=당년실적 ID=c_y_exec_amt Width=75 
											</C>
											<C> Name=증감 ID=bc_y_dif_exec_amt Width=75 
											</C> 
											<G>name='당년 월별 주요 부문별 실적' ID=C1 
												<C> Name=1월 ID=exec_amt01 Width=75 
												</C> 
												<C> Name=2월  ID=exec_amt02 Width=75
												</C>
												<C> Name=3월 ID=exec_amt03 Width=75 
												</C>
												<C> Name=4월 ID=exec_amt04 Width=75 
												</C> 
												<C> Name=5월  ID=exec_amt05 Width=75
												</C>
												<C> Name=6월 ID=exec_amt06 Width=75 
												</C>
												<C> Name=상반기 ID=exec_amt121 Width=75 
												</C> 
												<C> Name=7월 ID=exec_amt07 Width=75 
												</C> 
												<C> Name=8월  ID=exec_amt08 Width=75
												</C>
												<C> Name=9월 ID=exec_amt09 Width=75 
												</C> 
												<C> Name=10월 ID=exec_amt10 Width=75 
												</C> 
												<C> Name=11월  ID=exec_amt11 Width=75
												</C>
												<C> Name=12월 ID=exec_amt12 Width=75 
												</C>
												<C> Name=하반기 ID=exec_amt122 Width=75 
												</C>  
											</G>
