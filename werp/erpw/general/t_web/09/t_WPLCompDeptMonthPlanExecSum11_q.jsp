...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 	''||ROUND(NVL(b.CUR_EXEC_AMT, 0)) C_Y_EXEC_AMT,  \n";
			strSql += " 	''||ROUND(NVL(b.CUR_EXEC_AMT, 0)-NVL(b.PRE_EXEC_AMT, 0)) BC_Y_DIF_EXEC_AMT,  \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT01, 0)) EXEC_AMT01, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT02, 0)) EXEC_AMT02, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT03, 0)) EXEC_AMT03, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT04, 0)) EXEC_AMT04, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT05, 0)) EXEC_AMT05, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT06, 0)) EXEC_AMT06, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT121, 0)) EXEC_AMT121, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT07, 0)) EXEC_AMT07, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT08, 0)) EXEC_AMT08, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT09, 0)) EXEC_AMT09, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT10, 0)) EXEC_AMT10, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT11, 0)) EXEC_AMT11, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT12, 0)) EXEC_AMT12, \n";
			strSql += " 	''||ROUND(NVL(b.EXEC_AMT122, 0)) EXEC_AMT122 \n";
			strSql += "  FROM  \n";
			strSql += "  	(  \n";
			strSql += "  		SELECT  \n";
			strSql += "  			  ?    COMP_CODE,  \n";
			...
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID = (  ?   - 0)  THEN b.EXEC_AMT ELSE 0 END )/1000000 CUR_EXEC_AMT, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '01' THEN b.EXEC_AMT END )/1000000 EXEC_AMT01, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '02' THEN b.EXEC_AMT END )/1000000 EXEC_AMT02, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '03' THEN b.EXEC_AMT END )/1000000 EXEC_AMT03, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '04' THEN b.EXEC_AMT END )/1000000 EXEC_AMT04, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '05' THEN b.EXEC_AMT END )/1000000 EXEC_AMT05, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '06' THEN b.EXEC_AMT END )/1000000 EXEC_AMT06, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) BETWEEN '01' AND '06' THEN b.EXEC_AMT END )/1000000 EXEC_AMT121, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '07' THEN b.EXEC_AMT END )/1000000 EXEC_AMT07, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '08' THEN b.EXEC_AMT END )/1000000 EXEC_AMT08, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '09' THEN b.EXEC_AMT END )/1000000 EXEC_AMT09, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '10' THEN b.EXEC_AMT END )/1000000 EXEC_AMT10, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '11' THEN b.EXEC_AMT END )/1000000 EXEC_AMT11, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) = '12' THEN b.EXEC_AMT END )/1000000 EXEC_AMT12, \n";
			strSql += " 			SUM( CASE WHEN b.CLSE_ACC_ID =  ?  AND SUBSTR(b.WORK_YM, 5,6) BETWEEN '07' AND '12' THEN b.EXEC_AMT END )/1000000 EXEC_AMT122 \n";
			strSql += "  		FROM \n";
			...
			strSql += " 				--b.DEPT_CODE,  \n";
			strSql += " 				c.SUB_SEQ, \n";
			strSql += " 				DECODE( NVL(b.PRE_EXEC_AMT, 0),	0, 0, NVL(c.PRE_EXEC_AMT, 0)/NVL(b.PRE_EXEC_AMT, 0) ) B_Y_EXEC_AMT,  \n";
			strSql += " 				DECODE( NVL(b.CUR_EXEC_AMT, 0),	0, 0, NVL(c.CUR_EXEC_AMT, 0)/NVL(b.CUR_EXEC_AMT, 0) ) C_Y_EXEC_AMT,  \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT01, 0),	0, 0, NVL(c.EXEC_AMT01, 0) /NVL(b.EXEC_AMT01, 0) ) EXEC_AMT01, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT02, 0),	0, 0, NVL(c.EXEC_AMT02, 0) /NVL(b.EXEC_AMT02, 0) ) EXEC_AMT02, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT03, 0),	0, 0, NVL(c.EXEC_AMT03, 0) /NVL(b.EXEC_AMT03, 0) ) EXEC_AMT03, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT04, 0),	0, 0, NVL(c.EXEC_AMT04, 0) /NVL(b.EXEC_AMT04, 0) ) EXEC_AMT04, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT05, 0),	0, 0, NVL(c.EXEC_AMT05, 0) /NVL(b.EXEC_AMT05, 0) ) EXEC_AMT05, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT06, 0),	0, 0, NVL(c.EXEC_AMT06, 0) /NVL(b.EXEC_AMT06, 0) ) EXEC_AMT06, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT121, 0),	0, 0, NVL(c.EXEC_AMT121,0) /NVL(b.EXEC_AMT121,0) ) EXEC_AMT121, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT07, 0),	0, 0, NVL(c.EXEC_AMT07, 0) /NVL(b.EXEC_AMT07, 0) ) EXEC_AMT07, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT08, 0),	0, 0, NVL(c.EXEC_AMT08, 0) /NVL(b.EXEC_AMT08, 0) ) EXEC_AMT08, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT09, 0),	0, 0, NVL(c.EXEC_AMT09, 0) /NVL(b.EXEC_AMT09, 0) ) EXEC_AMT09, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT10, 0),	0, 0, NVL(c.EXEC_AMT10, 0) /NVL(b.EXEC_AMT10, 0) ) EXEC_AMT10, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT11, 0),	0, 0, NVL(c.EXEC_AMT11, 0) /NVL(b.EXEC_AMT11, 0) ) EXEC_AMT11, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT12, 0),	0, 0, NVL(c.EXEC_AMT12, 0) /NVL(b.EXEC_AMT12, 0) ) EXEC_AMT12, \n";
			strSql += " 				DECODE( NVL(b.EXEC_AMT122, 0),	0, 0, NVL(c.EXEC_AMT122,0) /NVL(b.EXEC_AMT122,0) ) EXEC_AMT122 \n";
			strSql += " 		FROM  \n";
			strSql += " 		( \n";
			strSql += " 			SELECT  \n";
			strSql += " 				b.COMP_CODE ,  \n";
