...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 		From	T_PL_COMP_DEPT_PLAN_EXEC b \n";
			...
			lrArgData.addColumn("24COMP_CODE", CITData.VARCHAR2);
			lrArgData.addColumn("25CLSE_ACC_ID", CITData.VARCHAR2);
			lrArgData.addColumn("26DEPT_CODE", CITData.VARCHAR2);
			lrArgData.addRow();
			...
			lrArgData.setValue("24COMP_CODE", strCOMP_CODE);
			lrArgData.setValue("25CLSE_ACC_ID", strCLSE_ACC_ID);
			lrArgData.setValue("26DEPT_CODE", strDEPT_NAME);
		...
		else if (strAct.equals("COPY"))
		{
			...
			strSql  = " Select 'XXXXXXXXXX' COMP_CODE,'XXXXXXXXXX' CLSE_ACC_ID,'XXXXXXXXXXXXXXXXXXXX' DEPT_CODE,0 QUARTER_YEAR From Dual where 1=0\n";
		...
		else if (strAct.equals("CLOSE"))
		{
			...
			strSql  = " Select F_T_FL_Is_Close_Dept_F( ? , ? , ? , ? ) FORE_CONFIRM_TAG \n";
			strSql += " from dual ";
