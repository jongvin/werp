...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLCompDeptMonthPlanExecSum01";
	String strPageName = "t_WPLCompDeptMonthPlanExecSum01";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 주요부문별매출.매출이익</td>
								...
								<td width="100%" height="100%">
									...
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<X>name={'당년'} ID=MON
												<G>name='1~9월' ID=C1 
													<C> Name=전년 ID=b_y_exec_amt19 Width=75 
													</C> 
													<C> Name=계획  ID=c_y_plan_amt19 Width=75
													</C>
													<C> Name=실적 ID=c_y_exec_amt19 Width=75 
													</C> 
												...
												<G>name='10월' ID=C2 
													...
													<C> Name=예상  ID=forecast_amt10 Width=75
													</C>
												</G>
												<G>name='11월' ID=C3
													<C> Name=계획 ID=plan_amt11 Width=75 
													</C> 
													<C> Name=예상  ID=forecast_amt11 Width=75
													</C>
												</G>
												<G>name='12월' ID=C4
													<C> Name=계획 ID=plan_amt12 Width=75 
													</C> 
													<C> Name=예상  ID=forecast_amt12 Width=75
													</C>
												</G>
												<G>name='년 간' ID=C5 
													<C> Name=계획 ID=c_y_plan_amt Width=75 
													</C> 
													<C> Name=예상  ID=c_y_forecast_amt Width=75
													</C>
													<C> Name=계획비  ID=c_plan_rate Width=75
													</C>
													<C> Name=전년비  ID=b_rate Width=75
													</C>
												</G>
											</X>
											<X>name='내년' ID=C6
												<C> Name=계획  ID=n_y_plan_amt Width=75
												</C>
												<C> Name=전년비 ID=n_rate Width=75
												</C>
											</X>
											">
									</OBJECT>
