...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLCompDeptMonthPlanExecSum12";
	String strPageName = "t_WPLCompDeptMonthPlanExecSum12";
//저장 액션
...
<html>
	<head>
		...
		<!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__1); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__2"> <!--CONVPAGE_TAIL 지우지마세요//-->
		<object id=dsCOPY classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
		</object>
		<!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__2); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__3"> <!--CONVPAGE_TAIL 지우지마세요//-->
		<object id="trans"  classid="clsid:0A2233AD-E771-11D2-973D-00104B15E56F" >
	      <param name="KeyValue" value="<%=strUpdateKeyValue%>">
		  <param name="Action"    value="<%=strFileName%>_tr.jsp">
		</object>
		<!--CONVPAGE_HEAD 지우지마세요//--></comment> <script> __WS__(__NSID__3); </script> <!--CONVPAGE_TAIL 지우지마세요//-->
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 손익계산서 계획</td>
								...
								<td width="100%" height="100%">
									...
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<C> Name=전년실적 ID=b_y_exec_amt Align=Right Width=75 
											</C>
											<C> Name=당년계획 ID=c_y_plan_amt Align=Right Width=75 
											</C>
											<C> Name=증감 ID=bc_y_dif_plan_amt Align=Right Width=75 
											</C> 
											<G>name='당년 월별 매출/손익 계획' ID=C1 
												<C> Name=1월 ID=plan_amt01 Align=Right Width=75 
												</C> 
												<C> Name=2월  ID=plan_amt02 Align=Right Width=75
												</C>
												<C> Name=3월 ID=plan_amt03 Align=Right Width=75 
												</C>
												<C> Name=4월 ID=plan_amt04 Align=Right Width=75 
												</C> 
												<C> Name=5월  ID=plan_amt05 Align=Right Width=75
												</C>
												<C> Name=6월 ID=plan_amt06 Align=Right Width=75 
												</C>
												<C> Name=상반기 ID=plan_amt121 Align=Right Width=75 
												</C> 
												<C> Name=7월 ID=plan_amt07 Align=Right Width=75 
												</C> 
												<C> Name=8월  ID=plan_amt08 Align=Right Width=75
												</C>
												<C> Name=9월 ID=plan_amt09 Align=Right Width=75 
												</C> 
												<C> Name=10월 ID=plan_amt10 Align=Right Width=75 
												</C> 
												<C> Name=11월  ID=plan_amt11 Align=Right Width=75
												</C>
												<C> Name=12월 ID=plan_amt12 Align=Right Width=75 
												</C>
												<C> Name=하반기 ID=plan_amt122 Align=Right Width=75 
												</C>  
											</G>
