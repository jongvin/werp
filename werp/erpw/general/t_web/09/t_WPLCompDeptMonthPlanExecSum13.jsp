...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLCompDeptMonthPlanExecSum13";
	String strPageName = "t_WPLCompDeptMonthPlanExecSum13";
//저장 액션
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 주요부문별계획</td>
								...
								<td width="100%" height="100%">
									...
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=현장 ID=dept_name Align=Center Width=150  suppress=1
											</C>
											<C> Name=구분 ID=biz_plan_item_name Align=Center Width=100 
											</C>
											<C> Name=전년실적 ID=b_y_exec_amt Width=75 
											</C>
											<C> Name=당년계획 ID=c_y_plan_amt Width=75 
											</C>
											<C> Name=증감 ID=bc_y_dif_plan_amt Width=75 
											</C> 
											<G>name='당년 월별 주요 부문별 계획' ID=C1 
												<C> Name=1월 ID=plan_amt01 Width=75 
												</C> 
												<C> Name=2월  ID=plan_amt02 Width=75
												</C>
												<C> Name=3월 ID=plan_amt03 Width=75 
												</C>
												<C> Name=4월 ID=plan_amt04 Width=75 
												</C> 
												<C> Name=5월  ID=plan_amt05 Width=75
												</C>
												<C> Name=6월 ID=plan_amt06 Width=75 
												</C>
												<C> Name=상반기 ID=plan_amt121 Width=75 
												</C> 
												<C> Name=7월 ID=plan_amt07 Width=75 
												</C> 
												<C> Name=8월  ID=plan_amt08 Width=75
												</C>
												<C> Name=9월 ID=plan_amt09 Width=75 
												</C> 
												<C> Name=10월 ID=plan_amt10 Width=75 
												</C> 
												<C> Name=11월  ID=plan_amt11 Width=75
												</C>
												<C> Name=12월 ID=plan_amt12 Width=75 
												</C>
												<C> Name=하반기 ID=plan_amt122 Width=75 
												</C>  
											</G>
