...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 			     decode(nvl(c_y_plan_amt,0),0, 0, round(c_y_plan_amt/1000000,0)) - decode(nvl(b_y_exec_amt,0),0, 0, round(b_y_exec_amt/1000000,0)) bc_y_dif_plan_amt, \n";
			...
			strSql += " 				 decode(nvl(plan_amt01,0), 0, 0, round(plan_amt01/1000000,0)) + decode(nvl(plan_amt02,0), 0, 0, round(plan_amt02/1000000,0)) + \n";
			strSql += " 				 decode(nvl(plan_amt03,0), 0, 0, round(plan_amt03/1000000,0)) + decode(nvl(plan_amt04,0), 0, 0, round(plan_amt04/1000000,0)) + \n";
			strSql += " 				 decode(nvl(plan_amt05,0), 0, 0, round(plan_amt05/1000000,0)) + decode(nvl(plan_amt06,0), 0, 0, round(plan_amt06/1000000,0)) plan_amt121, \n";
			...
			strSql += " 				 decode(nvl(plan_amt07,0), 0, 0, round(plan_amt07/1000000,0)) + decode(nvl(plan_amt08,0), 0, 0, round(plan_amt08/1000000,0)) +  \n";
			strSql += " 				 decode(nvl(plan_amt09,0), 0, 0, round(plan_amt09/1000000,0)) + decode(nvl(plan_amt10,0), 0, 0, round(plan_amt10/1000000,0)) + \n";
			strSql += " 				 decode(nvl(plan_amt11,0), 0, 0, round(plan_amt11/1000000,0)) + decode(nvl(plan_amt12,0), 0, 0, round(plan_amt12/1000000,0)) plan_amt122 \n";
			strSql += " 		  from  \n";
			...
			strSql += " 						   sum(plan_amt) b_y_exec_amt \n";
			...
			strSql += " 		   decode(a1.c_y_plan_amt, 0, 0, round((b1.c_y_plan_amt/a1.c_y_plan_amt)*100, 2)) c_y_plan_amt, \n";
			strSql += " 		   decode(a1.bc_y_dif_plan_amt, 0, 0, round((b1.bc_y_dif_plan_amt/a1.bc_y_dif_plan_amt)*100, 2)) bc_y_dif_plan_amt, \n";
			strSql += " 		   decode(a1.plan_amt01, 0, 0, round((b1.plan_amt01/a1.plan_amt01)*100, 2)) plan_amt01, \n";
			strSql += " 		   decode(a1.plan_amt02, 0, 0, round((b1.plan_amt02/a1.plan_amt02)*100, 2)) plan_amt02, \n";
			strSql += " 		   decode(a1.plan_amt03, 0, 0, round((b1.plan_amt03/a1.plan_amt03)*100, 2)) plan_amt03, \n";
			strSql += " 		   decode(a1.plan_amt04, 0, 0, round((b1.plan_amt04/a1.plan_amt04)*100, 2)) plan_amt04, \n";
			strSql += " 		   decode(a1.plan_amt05, 0, 0, round((b1.plan_amt05/a1.plan_amt05)*100, 2)) plan_amt05, \n";
			strSql += " 		   decode(a1.plan_amt06, 0, 0, round((b1.plan_amt06/a1.plan_amt06)*100, 2)) plan_amt06, \n";
			strSql += " 		   decode(a1.plan_amt121, 0, 0, round((b1.plan_amt121/a1.plan_amt121)*100, 2)) plan_amt121, \n";
			strSql += " 		   decode(a1.plan_amt07, 0, 0, round((b1.plan_amt07/a1.plan_amt07)*100, 2)) plan_amt07, \n";
			strSql += " 		   decode(a1.plan_amt08, 0, 0, round((b1.plan_amt08/a1.plan_amt08)*100, 2)) plan_amt08, \n";
			strSql += " 		   decode(a1.plan_amt09, 0, 0, round((b1.plan_amt09/a1.plan_amt09)*100, 2)) plan_amt09, \n";
			strSql += " 		   decode(a1.plan_amt10, 0, 0, round((b1.plan_amt10/a1.plan_amt10)*100, 2)) plan_amt10, \n";
			strSql += " 		   decode(a1.plan_amt11, 0, 0, round((b1.plan_amt11/a1.plan_amt11)*100, 2)) plan_amt11, \n";
			strSql += " 		   decode(a1.plan_amt12, 0, 0, round((b1.plan_amt12/a1.plan_amt12)*100, 2)) plan_amt12, \n";
			strSql += " 		   decode(a1.plan_amt122, 0, 0, round((b1.plan_amt122/a1.plan_amt122)*100, 2)) plan_amt122 \n";
			strSql += " 	from \n";
			strSql += " 		(	    \n";
