...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WPLDeptPlanAllR(현장별경영계획계획수립)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLDeptPlanAllR";
//저장 액션
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 현장별경영계획계획수립내역</td>
														<td align="right" width="*">
															<input id="btnGetConsInfo" type="button" class="img_btn10_1" value="시공계획에서가져오기"  onclick="btnGetConsInfo_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															<input id="btnRemoveAll" type="button" class="img_btn12_1" value="경영계획계획삭제(전체)"  onclick="btnRemoveAll()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
														</td>
													</tr>
												</table>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE="
														<FC> Name=현장코드 ID=DEPT_CODE Width=90 suppress=1
														</FC>
														<FC> Name=현장명 ID=DEPT_NAME Width=150 suppress=1
														</FC>
														<FC> Name=항목명 ID=LEVELED_NAME Width=90 suppress=2
														</FC>
