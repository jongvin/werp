								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 손익계산서실적</td>
								...
								<td width="100%" height="100%">
									...
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__9"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											<C> Name=구분 ID=biz_plan_item_name Align=Left Width=100 
											</C>
											<C> Name=전년실적 ID=b_y_exec_amt Align=Right Width=75 
											</C>
											<C> Name=당년실적 ID=c_y_exec_amt Align=Right Width=75 
											</C>
											<C> Name=증감 ID=bc_y_dif_exec_amt Align=Right Width=75 
											</C> 
											<G>name='당년 월별 매출/손익 실적' ID=C1 
												<C> Name=1월 ID=exec_amt01 Align=Right Width=75 
												</C> 
												<C> Name=2월  ID=exec_amt02 Align=Right Width=75
												</C>
												<C> Name=3월 ID=exec_amt03 Align=Right Width=75 
												</C>
												<C> Name=4월 ID=exec_amt04 Align=Right Width=75 
												</C> 
												<C> Name=5월  ID=exec_amt05 Align=Right Width=75
												</C>
												<C> Name=6월 ID=exec_amt06 Align=Right Width=75 
												</C>
												<C> Name=상반기 ID=exec_amt121 Align=Right Width=75 
												</C> 
												<C> Name=7월 ID=exec_amt07 Align=Right Width=75 
												</C> 
												<C> Name=8월  ID=exec_amt08 Align=Right Width=75
												</C>
												<C> Name=9월 ID=exec_amt09 Align=Right Width=75 
												</C> 
												<C> Name=10월 ID=exec_amt10 Align=Right Width=75 
												</C> 
												<C> Name=11월  ID=exec_amt11 Align=Right Width=75
												</C>
												<C> Name=12월 ID=exec_amt12 Align=Right Width=75 
												</C>
												<C> Name=하반기 ID=exec_amt122 Align=Right Width=75 
												</C>  
											</G>
