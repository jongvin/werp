		...
		if(!CITCommon.isNull(strAct) && strAct.equals("COPY"))
		{
			...
			try
			{
				for	(int i = 0;	i <	rows.length; i++)
				{
					...
					lrArgData.setValue("BUNGI", rows[i].getString(dsCOPY.indexOfColumn("BUNGI")));
