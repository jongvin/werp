...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLCompDeptMonthPlanExecSum08";
	String strPageName = "t_WPLCompDeptMonthPlanExecSum08";
//저장 액션
								...
								<td width="100%" class="td_green">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="15"><img src="../images/bullet3.gif"></td>
											<td width="45" class=font_green_bold>분기</td>
											<td width="52">
												<select id=cboBUNGI width=30>
													<option value=1>1분기
													<option value=2>2분기
													<option value=3>3분기
													<option value=4>4분기
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 분기전망</td>
								...
								<td width="100%" height="100%">
									...
									<OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE=" 
											...
											<G>name='월' ID=C1 
												<C> Name=전년 ID=b_y_exec_bg Width=75 
												</C> 
												<C> Name=계획  ID=c_y_plan_bg Width=75
												</C>
												<C> Name=전망 ID=c_y_forecast_bg Width=75 
												</C> 
												<C> Name=계획비  ID=c_plan_rate19 Width=75
												</C>
												<C> Name=전년비  ID=b_rate19 Width=75
												</C>
											</G>
											<G>name='월' ID=C2 
												<C> Name=전년 ID=b_y_exec_bg2 Width=75 
												</C> 
												<C> Name=계획  ID=c_y_plan_bg2 Width=75
												</C>
												<C> Name=전망 ID=c_y_forecast_bg2 Width=75 
												</C> 
												<C> Name=계획비  ID=c_plan_rate192 Width=75
												</C>
												<C> Name=전년비  ID=b_rate192 Width=75
												</C>
											</G>
											<G>name='월' ID=C3 
												<C> Name=전년 ID=b_y_exec_bg3 Width=75 
												</C> 
												<C> Name=계획  ID=c_y_plan_bg3 Width=75
												</C>
												<C> Name=전망 ID=c_y_forecast_bg3 Width=75 
												</C> 
												<C> Name=계획비  ID=c_plan_rate193 Width=75
												</C>
												<C> Name=전년비  ID=b_rate193 Width=75
												</C>
											</G>
											">
									</OBJECT>
