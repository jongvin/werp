...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WSlipAllSumRegister.jsp(관리손익집계 및 배부)
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WSlipAllSumRegister";
//저장 액션
							...
							<tr valign="middle"> 
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<td width="100%">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="80" class=font_green_bold>기간</td>
														<td width="52">
														...
														<td width="52">
															<input id="txtBUDG_YYYY_MM_TO" type="text" notNull  DATATYPE="DATEYM" style="width:60px">
														</td>
										...
										<tr> 
											<td width="100%" align="Center">
												<input id="btnSum" type="button" class="img_btn4_1" value="기간집계" onclick="btnSum_onClick()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
											</td>
										</tr>
									</table>
									<!-- 조건 테이블 종료 //-->
