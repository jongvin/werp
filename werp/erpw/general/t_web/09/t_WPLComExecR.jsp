...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLComExecR";
//저장 액션
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 경영계획실적집계내역</td>
														<td align="right" width="*">
															...
															<input id="btnRemoveAll" type="button" class="img_btn12_1" value="경영계획실적삭제(월)"  onclick="btnRemoveAll()" onmouseover="this.style.color=MOUSE_OVER;" onmouseout="this.style.color=MOUSE_OUT;">
															&nbsp;&nbsp;
