...
/**************************************************************************/
	...
	try
	{
		...
		if (strAct.equals("MAIN"))
		{
			...
			strSql += " 		   a.p_no, \n";
			strSql += " 	       a.biz_plan_item_no, \n";
			strSql += " 		   '영업외 수지' biz_plan_item_name, \n";
			strSql += " 	       a.exec_amt01- b.exec_amt01 exec_amt01,     \n";
			strSql += " 	       a.plan_amt01-b.plan_amt01 plan_amt01,      \n";
			strSql += " 		   a.forecast_amt01-b.forecast_amt01 forecast_amt01, \n";
			strSql += " 		   a.exec_amt02-b.exec_amt02 exec_amt02,     \n";
			strSql += " 		   a.plan_amt02-b.plan_amt02 plan_amt02,      \n";
			strSql += " 		   a.forecast_amt02-b.forecast_amt02 forecast_amt02, \n";
			strSql += " 		   a.exec_amt03-b.exec_amt03 exec_amt03,     \n";
			strSql += " 		   a.plan_amt03-b.plan_amt03 plan_amt03,      \n";
			strSql += " 		   a.forecast_amt03-b.forecast_amt03 forecast_amt03, \n";
			strSql += " 		   a.exec_amt04-b.exec_amt04 exec_amt04,     \n";
			strSql += " 		   a.plan_amt04-b.plan_amt04 plan_amt04,      \n";
			strSql += " 		   a.forecast_amt04-b.forecast_amt04 forecast_amt04, \n";
			strSql += " 		   a.exec_amt05-b.exec_amt05 exec_amt05,     \n";
			strSql += " 		   a.plan_amt05-b.plan_amt05 plan_amt05,      \n";
			strSql += " 		   a.forecast_amt05- b.forecast_amt05 forecast_amt05, \n";
			strSql += " 		   a.exec_amt06-b.exec_amt06 exec_amt06,     \n";
			strSql += " 		   a.plan_amt06-b.plan_amt06 plan_amt06,      \n";
			strSql += " 		   a.forecast_amt06- b.forecast_amt06 forecast_amt06, \n";
			strSql += " 		   a.exec_amt07-b.exec_amt07 exec_amt07,     \n";
			strSql += " 		   a.plan_amt07-b.plan_amt07 plan_amt07,      \n";
			strSql += " 		   a.forecast_amt07- b.forecast_amt07 forecast_amt07, \n";
			strSql += " 		   a.exec_amt08-b.exec_amt08 exec_amt08,     \n";
			strSql += " 		   a.plan_amt08-b.plan_amt08 plan_amt08,      \n";
			strSql += " 		   a.forecast_amt08- b.forecast_amt08 forecast_amt08, \n";
			strSql += " 		   a.exec_amt09-b.exec_amt09 exec_amt09,     \n";
			strSql += " 		   a.plan_amt09-b.plan_amt09 plan_amt09,      \n";
			strSql += " 		   a.forecast_amt09-b.forecast_amt09 forecast_amt09, \n";
			strSql += " 		   a.exec_amt10-b.exec_amt10 exec_amt10,     \n";
			strSql += " 		   a.plan_amt10-b.plan_amt10 plan_amt10,      \n";
			strSql += " 		   a.forecast_amt10-b.forecast_amt10 forecast_amt10, \n";
			strSql += " 		   a.exec_amt11-b.exec_amt11 exec_amt11,      \n";
			strSql += " 		   a.plan_amt11-b.plan_amt11 plan_amt11,      \n";
			strSql += " 		   a.forecast_amt11- b.forecast_amt11 forecast_amt11,  \n";
			strSql += " 		   a.exec_amt12-b.exec_amt12 exec_amt12,      \n";
			strSql += " 		   a.plan_amt12-b.plan_amt12 plan_amt12,      \n";
			strSql += " 		   a.forecast_amt12- b.forecast_amt12  forecast_amt12	  \n";
			strSql += " 	from  \n";
			strSql += " 	    ( \n";
			...
			strSql += " 			  ) b \n";
			strSql += " 		where a.biz_plan_item_no = b.biz_plan_item_no(+) \n";
			strSql += " 		and	  a.biz_plan_item_no =5 \n";
			strSql += " 		)	a, \n";
			strSql += " 		( \n";
			strSql += " 		select  '12' div, \n";
			strSql += " 				a.p_no, \n";
			...
			strSql += " 			  ) b \n";
			strSql += " 		where a.biz_plan_item_no = b.biz_plan_item_no(+) \n";
			strSql += " 		and	  a.biz_plan_item_no =8 \n";
			strSql += " 		)	b \n";
			strSql += " 	where a.div = b.div \n";
			strSql += " 	order by 1 \n";
			strSql += " 	) \n";
			strSql += " 	 \n";
			strSql += " 		 \n";
