...
/**************************************************************************/
	...
	CITData lrReturnData4 = null;
	CITData lrReturnData5 = null;
	CITData lrReturnData6 = null;
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLPlItemR";
//저장 액션
	...
	try
	{
		...
		try
		{
			...
			strSql = 
				...
				"Where	a.CODE_GROUP_ID = 'PL_ITEM_KIND'"+"\n"+
				"Order By"+"\n"+
				"	a.SEQ"+"\n";
		...
		try
		{
			...
			strSql = 
				...
				"	a.FUNC_TITLE NAME"+"\n"+
				"From	T_PL_COMP_PLN_FUNCTIONS a"+"\n"+
				"Order By"+"\n"+
				"	a.FUNC_TITLE"+"\n";
		...
		try
		{
			...
			strSql = 
				...
				"	a.FUNC_TITLE NAME"+"\n"+
				"From	T_PL_COMP_EXE_FUNCTIONS a"+"\n"+
				"Order By"+"\n"+
				"	a.FUNC_TITLE"+"\n";
		...
		try
		{
			...
			strSql = 
				...
				"	a.FUNC_TITLE NAME"+"\n"+
				"From	T_PL_COMP_FORE_FUNCTIONS a"+"\n"+
				"Order By"+"\n"+
				"	a.FUNC_TITLE"+"\n";
		...
		try
		{
			...
			strSql = 
				...
				"	a.FUNC_TITLE NAME"+"\n"+
				"From	T_PL_COMP_PLN_FUNCTIONS_B a"+"\n"+
				"Order By"+"\n"+
				"	a.FUNC_TITLE"+"\n";
			lrReturnData4 = CITDatabase.selectQuery(strSql, lrArgData);
		}
		catch (Exception ex)
		{
			throw new Exception("SYS-100001:페이지 초기화 오류 -> " + ex.getMessage());
		...
		try
		{
			...
			strSql = 
				...
				"	a.FUNC_TITLE NAME"+"\n"+
				"From	T_PL_COMP_EXE_FUNCTIONS_B a"+"\n"+
				"Order By"+"\n"+
				"	a.FUNC_TITLE"+"\n";
			lrReturnData5 = CITDatabase.selectQuery(strSql, lrArgData);
		}
		catch (Exception ex)
		{
			throw new Exception("SYS-100001:페이지 초기화 오류 -> " + ex.getMessage());
		...
		try
		{
			...
			strSql = 
				...
				"	a.FUNC_TITLE NAME"+"\n"+
				"From	T_PL_COMP_FORE_FUNCTIONS_B a"+"\n"+
				"Order By"+"\n"+
				"	a.FUNC_TITLE"+"\n";
			lrReturnData6 = CITDatabase.selectQuery(strSql, lrArgData);
		}
		catch (Exception ex)
		{
			throw new Exception("SYS-100001:페이지 초기화 오류 -> " + ex.getMessage());
...
%>
				arITEM_KIND.push(new F_CodeName("<%=sCode%>","<%=sName%>"));
<%
			}
%>			
...
%>			
			arCODE4 = new Array();
<%
			for(int i = 0 ; i < lrReturnData4.getRowsCount(); ++i)
			{
				String		sCode = lrReturnData4.toString(i, "CODE");
				String		sName = lrReturnData4.toString(i, "NAME");
%>
				arCODE4.push(new F_CodeName("<%=sCode%>","<%=sName%>"));
<%
			}
%>			
			arCODE5 = new Array();
<%
			for(int i = 0 ; i < lrReturnData5.getRowsCount(); ++i)
			{
				String		sCode = lrReturnData5.toString(i, "CODE");
				String		sName = lrReturnData5.toString(i, "NAME");
%>
				arCODE5.push(new F_CodeName("<%=sCode%>","<%=sName%>"));
<%
			}
%>			
			arCODE6 = new Array();
<%
			for(int i = 0 ; i < lrReturnData6.getRowsCount(); ++i)
			{
				String		sCode = lrReturnData6.toString(i, "CODE");
				String		sName = lrReturnData6.toString(i, "NAME");
%>
				arCODE6.push(new F_CodeName("<%=sCode%>","<%=sName%>"));
<%
			}
%>			
		...
		<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__5"> <!--CONVPAGE_TAIL 지우지마세요//--><object id=dsBIZ_PLAN_ITEM_NO classid=CLSID:3267EA0D-B5D8-11D2-A4F9-00608CEBEE49>
											...
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td class="font_green_bold"> 경영계획항목</td>
											...
											<td width="100%" height="100%">
												<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__12"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridSUB01 WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
													...
													<PARAM NAME="Format" VALUE=" 
														...
														<FC> Name=집계방법 ID=SUM_MTHD_TAG EditStyle=Combo Data='2:계정집계,3:상계추적' Align=Center Width=80
														</FC> 
