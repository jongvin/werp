...
<%
/**************************************************************************/
/* 1. 프 로 그 램 id : t_WPLInvestCodeR.jsp(투자코드등록)
/* 2. 유형(시나리오) : 
/* 3. 기  능  정  의 : 프로그램 설명 
...
//디자인 외 부분은 여기만 손대자!!!!!
//파일명	
	String strFileName = "./t_WPLInvestCodeR";
//저장 액션
	...
	try
	{
 		...
 		try
		{
			...
			strSql += "Where	a.CODE_GROUP_ID = 'INV_TAG' \n";
			strSql += "And	a.USE_TAG = 'T' \n";
			strSql += "Order by	a.SEQ \n";

			lrReturnData = CITDatabase.selectQuery(strSql, lrArgData);

			strCODE = CITCommon.toGauceComboString(lrReturnData, "CODE", "NAME");
		}
		catch (Exception ex)
		{
								...
								<td width="100%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td class="font_green_bold"> 투자코드목록</td>
								...
								<td width="100%" height="100%">
									<!--CONVPAGE_HEAD 지우지마세요//--> <comment id="__NSID__3"> <!--CONVPAGE_TAIL 지우지마세요//--><OBJECT id=gridMAIN WIDTH="100%" HEIGHT="100%" classid=clsid:1F57AEAD-DB12-11D2-A4F9-00608CEBEE49 VIEWASTEXT>
										...
										<PARAM NAME="Format" VALUE="
											<C> Name=투자코드 ID=KIND_CODE Align=Left Width=100
											</C>
											<C> Name=투자구분 ID=INV_TAG EditStyle=Combo	Data='<%=strCODE%>' Align=Center  Width=120
											</C>
											<C> Name=투자코드명 ID=KIND_NAME Align=Left  Width=350
											</C>
											">
