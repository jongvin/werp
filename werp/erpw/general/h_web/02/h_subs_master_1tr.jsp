...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("h_subs_master_1tr"); gpstatement.gp_dataset = dSet;
   	...
   	int idx_pay_tag = dSet.indexOfColumn("pay_tag");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
      ...
      gpstatement.bindColumn(14, idx_prize_dongho);
      gpstatement.bindColumn(15, idx_subs_amt);
      gpstatement.bindColumn(16, idx_bank_head_code);
      gpstatement.bindColumn(17, idx_bank_head_name);
      gpstatement.bindColumn(18, idx_refund_deposit_no);
      gpstatement.bindColumn(19, idx_remark);
      gpstatement.bindColumn(20, idx_pay_tag);
      gpstatement.bindColumn(21, idx_preparation_order);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "update h_subs_master set " + 
                            ...
                            "remark=?,  " + 
                            "pay_tag=?,  " + 
                            "preparation_order=?  where dept_code=? and sell_code=? and subs_no=?";  
      stmt = conn.prepareStatement(sSql); 
      gpstatement.gp_stmt = stmt;
      gpstatement.bindColumn(1, idx_dept_code);
      gpstatement.bindColumn(2, idx_sell_code);
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(23, idx_sell_code);
      gpstatement.bindColumn(24, idx_subs_no);
      stmt.executeUpdate();
      stmt.close();
