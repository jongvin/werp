<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("dongho",GauceDataColumn.TB_STRING,14));
    ...
    String query = "        select " + arg_no_seq + " seq," + 
     ...
     "               c.long_name," + 
     "               a.sell_code, " + 
     "               to_char(a.subs_no,'9999999999999') dongho, " + 
     "               to_char(a.pyong,'999999') pyong, " + 
     "               a.cust_code," + 
     "               b.cust_name, " + 
     "               to_char(a.subs_date,'yyyy.mm.dd') contract_date," + 
     "               ''  sms_yn, " + 
     "               b.cell_phone, " + 
     "               ''  email_yn, " + 
     "               b.e_mail" + 
