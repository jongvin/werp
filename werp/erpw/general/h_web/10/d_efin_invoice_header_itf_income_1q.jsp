<%@ page session="true"	  contentType="text/html;charset=EUC_KR" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("batch_date",GauceDataColumn.TB_STRING,18));
	  ...
	  dSet.addDataColumn(new GauceDataColumn("interface_flag",GauceDataColumn.TB_STRING,1));
     ...
     "        WHERE TO_CHAR(A.invoice_group_id) IN (SELECT DISTINCT work_no FROM H_SALE_INCOME "+
	  "                                                                                                                                             where dept_code = '"+arg_dept_code +"'"+
	   "																																																	and sell_code = '"+arg_sell_code  +"'"+ 
		"																																																	 and  not( degree_seq  < '99'" +
	  "																																                                                    AND receipt_code  = '23') "+
	  "																																																		and not (  degree_seq  < '99'" +
	  "																																 and  degree_seq >= '70' "+
     "                                                                                                AND receipt_code  in ('1B','70') )) "+
