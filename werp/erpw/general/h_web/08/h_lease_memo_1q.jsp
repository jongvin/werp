<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("cont_seq",GauceDataColumn.TB_DECIMAL,18,0));
	  dSet.addDataColumn(new GauceDataColumn("cont_num",GauceDataColumn.TB_STRING,18));
     ...
     dSet.addDataColumn(new GauceDataColumn("key_3",GauceDataColumn.TB_STRING,18));
    ...
    String query = "SELECT A.DEPT_CODE," + 
     ...
     "		 NVL(A.CONT_SEQ, 0)  CONT_SEQ," + 
	  "       a.dept_code||'-'||to_char(a.cont_date,'yyyymm')||'-'||to_char(a.cont_seq,'00') cont_num,	 "+
     ...
     "       A.DEPT_CODE   KEY_1," + 
     "		 A.SELL_CODE   KEY_2," + 
     "		 TO_CHAR(A.CONT_DATE,'YYYY.MM.DD')   KEY_3," + 
     "		 NVL(A.CONT_SEQ, 0) KEY_4," + 
