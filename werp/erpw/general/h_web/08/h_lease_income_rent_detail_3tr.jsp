<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("h_lease_income_rent_detail_3tr");
   ...
   int  rowCnt = dSet.getDataRowCnt();
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
		String sSql = " INSERT INTO H_LEASE_RENT_INCOME ( dept_code," + 
                    "sell_code," + 
                    "cont_date," + 
                    "cont_seq," + 
                    "degree_code," + 
      ...
      gpstatement.bindColumn(10, idx_rent_supply);
      gpstatement.bindColumn(11, idx_rent_vat);
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(23, idx_cont_date);
      gpstatement.bindColumn(24, idx_cont_seq);
