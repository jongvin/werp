...
String arg_dept_code = req.getParameter("arg_dept_code");
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("apply_date",GauceDataColumn.TB_STRING,18));
	  dSet.addDataColumn(new GauceDataColumn("apply_date_edit",GauceDataColumn.TB_STRING,7));
    ...
    String query = "select d.dept_code," + 
     ...
     "		 d.cont_seq," + 
     "		 d.chg_seq," + 
     "		 to_char(d.apply_date,'yyyy.mm.dd') apply_date," + 
	  "		 to_char(d.apply_date,'yyyy.mm') apply_date_edit," +
     "		 d.rent_amt," + 
     "		 d.rent_vat" + 
     "  from h_lease_rent_detail d" + 
