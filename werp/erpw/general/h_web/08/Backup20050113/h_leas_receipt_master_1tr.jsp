<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("h_leas_receipt_master_1tr");
     gpstatement.gp_dataset = dSet;
   	...
   	int idx_lease_real_name = dSet.indexOfColumn("lease_real_name");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
      ...
      gpstatement.bindColumn(32, idx_lease_supply);
      gpstatement.bindColumn(33, idx_lease_vat);
      gpstatement.bindColumn(34, idx_lease_s_date);
      gpstatement.bindColumn(35, idx_lease_e_date);
      gpstatement.bindColumn(36, idx_lease_real_name);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "update h_sale_master set " + 
                            ...
                            "lease_s_date=?,  " + 
                            "lease_e_date=?,  " + 
                            "lease_real_name=?  where dept_code=? " +
	                         "            and sell_code=? " +
                            "            and dongho=?" +
                            "            and seq=?";    
      stmt = conn.prepareStatement(sSql); 
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(39, idx_dongho);
      gpstatement.bindColumn(40, idx_seq);
      stmt.executeUpdate();
      stmt.close();
