...
include file ="../../../comm_function/conn_procedure_tr_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
      ...
      stmt = conn.prepareCall("{call Y_SP_H_LEAS_RAISE_GRNTEE_BATCH(?,?,?,?,?,?,?,?,?,?)}");
	  ...
	  stmt.setString(7,arg_guarantee_amt);
	  stmt.setString(8,arg_raise_amt);
	  stmt.setString(9,arg_raise_cont_date);
