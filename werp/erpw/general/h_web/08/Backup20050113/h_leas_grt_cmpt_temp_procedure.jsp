...
include file ="../../../comm_function/conn_procedure_tr_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
      ...
      stmt = conn.prepareCall("{call y_sp_h_leas_grt_cmpt_temp(?,?,?,?,?,?,?,?,?,?,?)}");
      ...
      stmt.setString(8,arg_input_amt);
      stmt.setString(9,arg_input_class);
      stmt.setString(10,arg_input_deposit);
      stmt.setString(11,arg_user);
%><%@ 
