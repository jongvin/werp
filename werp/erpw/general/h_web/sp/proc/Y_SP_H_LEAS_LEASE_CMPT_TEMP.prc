CREATE OR REPLACE PROCEDURE y_sp_h_leas_lease_cmpt_temp(as_spec_unq_num IN NUMBER,
...
-- 공통 변수
   ...
   C_MAX_DEGREE        H_LEAS_LEASE_AGREE.DEGREE_CODE%TYPE;         -- 마지막약정차수(잔금,인상분 포함)
...
END y_sp_h_leas_lease_cmpt_temp;
/
