...
CURSOR DETAIL_CUR IS
      ...
      SELECT a.dongho,
         ...
         AND b.receipt_code  IN ('11','12','15','18','19','1A','23') 
                                 --11(CMS/FBS입금)  12(계좌입금)   15(청약선수금대체) 18(매출할인)?, 
                                 --19(예수금대체)   1A(카드수수료) 23(착오입금환출)
		 GROUP BY a.dongho,
             a.seq,
		       a.contract_code,
		       b.receipt_date,
...
-- User Define Error
   ...
   C_ACNTNO_PRE        VARCHAR2(50);                  --분양미수금 
   C_ACNTNO_DUE        VARCHAR2(50);                  --분양선수금
   C_ACNTNO_ACC        VARCHAR2(50)  DEFAULT '111131';--보통예금(원화)
   C_ACNTNO_DIS        VARCHAR2(50)  DEFAULT '411117';--매출할인(분양수익)     -할인료
   C_ACNTNO_DEL        VARCHAR2(50)  DEFAULT '461112';--이자수익(연체료) 
   
   C_SOURCE            VARCHAR2(50)  DEFAULT '분양';
   C_CATEGORY          VARCHAR2(50)  DEFAULT '수입금';
