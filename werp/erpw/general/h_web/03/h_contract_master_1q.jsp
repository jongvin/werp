...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
	 ...
	 dSet.addDataColumn(new GauceDataColumn("contract_number",GauceDataColumn.TB_STRING,6));
    ...
    "                       e.cell_phone, "+
     ...
     "                   and a.cust_code   = e.cust_code (+) " +
	  "                   and a.cust_code_co   = f.cust_code (+) " +
