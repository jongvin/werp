...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("h_contract_name_chg_1tr"); gpstatement.gp_dataset = dSet;
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
		String sSql = " INSERT INTO H_SALE_MASTER ( dept_code," + 
                    ...
                    "moveinto_fr_date," +
                    "moveinto_to_date,   " +
                    "remark, cont_zip_code, cont_addr1, cont_addr2)      ";
      ...
      gpstatement.bindColumn(33, idx_remark);
		gpstatement.bindColumn(34, idx_cont_zip_code);
		gpstatement.bindColumn(35, idx_cont_addr1);
		gpstatement.bindColumn(36, idx_cont_addr2);
      stmt.executeUpdate();
      stmt.close();
