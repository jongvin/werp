...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
	  ...
	  gpstatement.bindColumn(34, idx_lease_supply);
	  gpstatement.bindColumn(35, idx_lease_vat);
	  gpstatement.bindColumn(36, idx_lease_s_date);
	  gpstatement.bindColumn(37, idx_lease_e_date);
      stmt.executeUpdate();
      stmt.close();
