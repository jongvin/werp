...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("h_contract_master_pre_1tr"); gpstatement.gp_dataset = dSet;
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      ...
      gpstatement.bindColumn(2, idx_pre_cont_tag);
	  gpstatement.bindColumn(3, idx_pre_cont_date);
	  gpstatement.bindColumn(4, idx_pre_cont_amt);
	  gpstatement.bindColumn(5, idx_pre_cont_memo);
