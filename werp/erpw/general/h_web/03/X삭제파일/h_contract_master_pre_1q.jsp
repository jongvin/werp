...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("pre_cont_tag",GauceDataColumn.TB_STRING,1));
     dSet.addDataColumn(new GauceDataColumn("pre_cont_date",GauceDataColumn.TB_STRING,20));
	 dSet.addDataColumn(new GauceDataColumn("pre_cont_amt",GauceDataColumn.TB_DECIMAL,18,0));
	 dSet.addDataColumn(new GauceDataColumn("pre_cont_memo",GauceDataColumn.TB_STRING,100));
	 dSet.addDataColumn(new GauceDataColumn("subs_prize",GauceDataColumn.TB_STRING,1));
    String query = "  SELECT a.DEPT_CODE,   " + 
     ...
     "                       a.CLASS,   " + 
     "                       a.OPTION_CODE,   " + 
     "                       pre.CUST_CODE CUST_CODE ,   " + 
     "                       a.UNION_CODE,   " + 
     "                       a.UNION_ID,   " + 
     "                       a.CONTRACT_CODE,   " + 
     "                       decode(a.CONTRACT_YN, 'Y', 'T', 'N', 'F') CONTRACT_YN,   " + 
	 ...
	 "                       pre.pre_cont_tag  pre_cont_tag, "+
     "                       to_char(pre.pre_cont_date,'YYYY.MM.DD') pre_cont_date," +
	 "                       pre.pre_cont_amt pre_cont_amt, "+
	 "                       pre.pre_cont_memo  pre_cont_memo, "+
	 "                       decode(subs.prize_date,  null, 'F', 'T') subs_prize "+
	 ...
	 "									 zz.pre_cont_amt, " +
	 "									 zz.pre_cont_memo " +
	 "							 from h_sale_master zz, " +
	 "                                   (select max(dongho) dongho, max(seq)seq "+
	 "								         from h_sale_master "+
	 "									  where dept_code = " + "'" + arg_dept_code + "'" +
	 "										 and sell_code = " + "'" + arg_sell_code + "'" +
	 "										 and chg_div = '00' "+
	 "									 group by dept_code,sell_code,dongho)z "+
	 "							where zz.chg_div = '00' " +
	 "							   and zz.DEPT_CODE =  " + "'" + arg_dept_code + "'" +
     "                             and zz.SELL_CODE = " + "'" + arg_sell_code + "'" + 
	 "                             and z.dongho = zz.dongho "+
	 "							   and z.seq    = zz.seq) pre," +
	 "                      h_subs_master subs "+
     "                WHERE a.dongho = subs.prize_dongho(+) "+
	 "					 and subs.dept_code(+) =" + "'" + arg_dept_code + "'" +
	 "					 and subs.sell_code(+) = " + "'" + arg_sell_code + "'" +
     ...
     "                   and pre.cust_code   = e.cust_code (+) " +
     "                   and a.dongho = b.dongho" + 
     "              	    and a.seq = b.seq " + 
	 "                   and a.dongho = pre.dongho" + 
