...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("prize_tag",GauceDataColumn.TB_STRING,1));
    ...
    String query = "  SELECT a.DEPT_CODE,   " + 
     ...
     "                       a.CLASS,   " + 
     "                       a.OPTION_CODE,   " + 
     "                       decode(f.CUST_CODE, null, '', 'Y') prize_tag,   " + 
     "                       decode(a.CUST_CODE, null, f.cust_code, a.cust_code) cust_code,   " + 
     "                       a.UNION_CODE,   " + 
     "                       a.UNION_ID,   " + 
     "                       a.CONTRACT_CODE,   " + 
     "                       a.CONTRACT_YN,   " + 
     ...
     "                       c.class_name, " +
     "                       d.option_name, " +
     "                       decode(a.CUST_CODE, null, g.cust_name, e.cust_name) cust_name, " +
     "                       e.cust_div, " +
