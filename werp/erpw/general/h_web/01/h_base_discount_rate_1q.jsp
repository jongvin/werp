...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
    ...
    String query = "  SELECT  h_base_discount_rate.dept_code ," + 
     "          h_base_discount_rate.sell_code ," + 
     "          h_base_discount_rate.rate_kind ," + 
     "          to_char(h_base_discount_rate.s_date,'yyyymmdd') s_date ," + 
     "          to_char(h_base_discount_rate.e_date,'yyyymmdd') e_date," + 
     "          h_base_discount_rate.rate ," + 
     "          h_base_discount_rate.cutoff_std ," + 
     "          h_base_discount_rate.cutoff_unit,   " + 
     "          h_base_discount_rate.rate_kind old_rate_kind," + 
     "          to_char(h_base_discount_rate.s_date,'yyyymmdd')  old_s_date " + 
     "       FROM h_base_discount_rate    " + 
     "       WHERE ( h_base_discount_rate.dept_code = '" + arg_dept_code + "') and   "  + 
     "             ( h_base_discount_rate.sell_code = '" + arg_sell_code + "')   " + 
     "            order by  h_base_discount_rate.rate_kind,h_base_discount_rate.s_date   ";
%><%@ 
