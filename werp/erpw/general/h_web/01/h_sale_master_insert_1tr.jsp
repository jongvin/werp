...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("h_sale_master_insert_1tr"); gpstatement.gp_dataset = dSet;
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
      ...
      gpstatement.bindColumn(31, idx_remark);
		gpstatement.bindColumn(32, idx_deposit_no);
		gpstatement.bindColumn(33, idx_v_account_no);
      stmt.executeUpdate();
      stmt.close();
