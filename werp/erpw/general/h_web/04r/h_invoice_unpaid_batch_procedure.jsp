...
include file ="../../../comm_function/conn_procedure_tr_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
      ...
      stmt = conn.prepareCall("{call Y_Sp_H_Invoice_unpaid_Batch (?,?,?,?,?,?,?,?,?)}");
      ...
      stmt.setString(5,arg_agree_to);
		stmt.setString(6,arg_dongho_fr);
      stmt.setString(7,arg_dongho_to);
		stmt.setString(8,arg_pyong_fr);
      stmt.setString(9,arg_pyong_to);
