...
"    WHERE work_no_subs IS NULL"   +
"      AND a.dept_code = ar_intf.work_dept_code"   +
"      AND a.sell_code = ar_intf.work_sell_code"   +
"      AND a.subs_date BETWEEN ar_intf.cat_from_dt AND ar_intf.cat_to_dt"   +
" ORDER BY a.subs_no;"  ;
