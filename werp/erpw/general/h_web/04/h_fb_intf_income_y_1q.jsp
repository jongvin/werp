<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
    ...
    String query = "SELECT A.FB_SEQ, " + 
     ...
     "       A.DEPOSIT_NO, " + 
     "       A.V_ACCOUNT_NO, " + 
     "       A.EX_COL1 res_ex_col1, " + 
     "       A.EX_COL2 res_ex_col2, " + 
     "       A.EX_COL3 res_ex_col3, " + 
     "       A.EX_COL4 res_ex_col4, " + 
     "       to_char(A.EX_DT1, 'yyyy.mm.dd') res_ex_dt1, " + 
     "       to_char(A.EX_DT2, 'yyyy.mm.dd') res_ex_dt2," + 
	  "       'F' chk, a.work_seq "+
