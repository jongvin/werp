...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("h_income_detail_2tr"); gpstatement.gp_dataset = dSet;
	...
	int idx_loan_yn = dSet.indexOfColumn("loan_yn");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
	  ...
	  gpstatement.bindColumn(15, idx_loan_yn);
	  gpstatement.bindColumn(16, idx_loan_date);
	  gpstatement.bindColumn(17, idx_loan_interest_tag);
	  gpstatement.bindColumn(18, idx_loan_bank_code);
	  gpstatement.bindColumn(19, idx_loan_rdm_yn);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(24, idx_key_degree_code);
      stmt.executeUpdate();
      stmt.close();
