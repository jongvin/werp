<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("self_not_attain",GauceDataColumn.TB_STRING,400));
     dSet.addDataColumn(new GauceDataColumn("self_support_req",GauceDataColumn.TB_STRING,400));
