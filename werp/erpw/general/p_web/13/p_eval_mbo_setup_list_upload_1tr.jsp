...
String dir = (String) session.getAttribute("dir");
      GauceDataSet dSet = req.getGauceDataSet("p_eval_mbo_setup_list_upload_1tr"); 
  ...
  for(int i=0; i< rowCnt; i++){
      ...
      String sSql = "update p_eval_mbo_setup_list set " + 
                            ...
                            "url=?  where eval_code=? and eval_year=? and self_evaluator=? ";  
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(5, idx_self_evaluator);
      stmt.executeUpdate();
      stmt.close();
