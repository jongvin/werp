...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 // 다음 문장은 수정 하시요 (파라메터 갯수만큼 (없으면 //로 막으세요)--r
     ...
     String arg_comp_code  = arg_comp_code1.replace('^','%') ;  // ^를 %로 바꿈. url에서는 %를 값으로 넘겨줄수 없슴으로  
 ...
 //---------------------------------------------------------- 
    ...
    String query = "  SELECT  view_dept_code.dept_code ," + 
     ...
     "     FROM view_dept_code  " + 
     "     WHERE  view_dept_code.comp_code like '" + arg_comp_code + "' " +  
     "       and (( view_dept_code.long_name like '" + arg_dept_name + "' ) " +  
     "          or  ( view_dept_code.dept_code like '" + arg_dept_code + "' ))      " + 
     "         order by   view_dept_code.dept_code     ";
%><%@ 
