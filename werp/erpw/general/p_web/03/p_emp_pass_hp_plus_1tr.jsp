<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 include file ="../../../comm_function/conn_mssql_portal_tr.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("p_emp_pass_hp_plus_1tr");
   ...
   /* ds_1(oracle)에서 합격이면   ds_hp(mssql)에서 이력서를 수정 불가능하도록 close_tag를 'Y'(으)로 셋팅 */ 
   /* ds_1(oracle)에서 불합격이면 ds_hp(mssql)에서 이력서를 수정 가능하도록   close_tag를 'N'(으)로 셋팅 */ 
