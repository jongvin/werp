<%@ page session="true" contentType="text/html;charset=EUC_KR" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
    ...
    String query = "   select decode(to_char(a.join_date,'mm'),'01','01월','02','02월','03','03월',        " +
		...
		"	 			   " + arg_div + " " + 
		"		    group by to_char(a.join_date,'mm'), a.grade_code, b.grade_name               " +
		"		    order by to_char(a.join_date,'mm'), a.grade_code " ;
