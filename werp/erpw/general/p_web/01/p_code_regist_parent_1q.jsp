<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("code_currname",GauceDataColumn.TB_STRING,40));
     dSet.addDataColumn(new GauceDataColumn("table_name",GauceDataColumn.TB_STRING,60));
     dSet.addDataColumn(new GauceDataColumn("code_pk_no",GauceDataColumn.TB_DECIMAL,18,0));
    ...
    String query = "  SELECT p_code_regist.code_name," + 
     "             p_code_regist.code_currname," + 
     ...
     "	 FROM p_code_regist                  " +
     "	WHERE p_code_regist.use_yn = 'Y'            " +
     "   ORDER BY p_code_regist.code_name ASC,       " + 
     "            p_code_regist.code_currname ASC         ";
