<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("p_pers_cer_issue_1tr");
     gpstatement.gp_dataset = dSet;
   	...
   	int idx_print_date = dSet.indexOfColumn("print_date");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
		String sSql = " INSERT INTO p_pers_certificate ( emp_no," + 
                    ...
                    "requestor_name," + 
                    "approve_div," + 
                    "approve_yn, req_date, write_date, print_date )      ";
      ...
      gpstatement.bindColumn(21, idx_print_date);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "update p_pers_certificate set " + 
                            ...
                            "req_date=?, " +
                            "write_date=?, " +
                            "print_date=? where emp_no=? and spec_no_seq=? ";  
      stmt = conn.prepareStatement(sSql); 
      gpstatement.gp_stmt = stmt;
      gpstatement.bindColumn(1, idx_emp_no);
      gpstatement.bindColumn(2, idx_spec_no_seq);
