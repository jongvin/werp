<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("p_edu_receipt_1tr");
     gpstatement.gp_dataset = dSet;
   	...
   	int idx_edu_name = dSet.indexOfColumn("out_edu_name");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
      ...
      gpstatement.bindColumn(19, idx_receipt_tag);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      gpstatement.bindColumn(20, idx_emp_no);
      gpstatement.bindColumn(21, idx_edu_code);
      gpstatement.bindColumn(22, idx_edu_year);
      gpstatement.bindColumn(23, idx_edu_degree);
      gpstatement.bindColumn(24, idx_spec_no_seq);
      stmt.executeUpdate();
      stmt.close();
