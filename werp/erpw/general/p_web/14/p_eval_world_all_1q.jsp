<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
    ...
    String query = "  SELECT  a.eval_code ," + 
     ...
     "			 decode(a.sec_present_yn, 'Y', 'T', 'F') common_ok, " +
     "			 leader.leader_ok  ,  " +
     "			 'F' ok_tag " +
     ...
     "				   and b.eval_degree    = '" + arg_eval_degree + "' " ;
	  ...
	  query += "	)	leader 			";
     query += " where a.self_dept_code  = b.dept_code  (+) " ;
     query += "   and a.self_grade_code = c.grade_code (+) " ;
     query += "   and a.self_evaluator  = m.resident_no (+) " ;
     query += "   and a.fir_dept_code   = f_b.dept_code (+) " ;
     query += "   and a.fir_grade_code  = f_c.grade_code(+) " ;
     query += "   and a.fir_evaluator   = f_m.resident_no(+)" ; 
     query += "   and a.sec_dept_code   = s_b.dept_code (+) " ;
     query += "   and a.sec_grade_code  = s_c.grade_code(+) " ;
     query += "   and a.sec_evaluator   = s_m.resident_no(+) " ; 
     query += "   and a.self_evaluator  = leader.self_evaluator (+) " ;
     query += "   and a.eval_code       = '02' " ;
     query += "   and a.eval_degree     = '" + arg_eval_degree + "' " ;
