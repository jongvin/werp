<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
    ...
    String query = "        select  a.comp_code,        									" +
     ...
     "      			 where a.apply_order_date <= '" + arg_last_date + "'          " +
     "						 and a.confirm_tag = '1'												" +
     "      		  ) a,                                                            " +
     "				p_pers_master b,																	" +
     "     		  	p_code_order c,                                                   " +
     "     		  	z_code_chg_dept_title d,                                          " +
     "     		  	z_code_chg_dept_content e,                                        " +
     "     		  	z_code_dept dept,                                                 " +
     "     		  	p_code_grade grade,                                               " +
     "     		  	z_code_comp  comp                                                 " +
     "       where (a.rk_1 = 1                                                      " +
     ...
     "     	   and d.degree     = e.degree                                          " +
     "     	   and d.dept_seq_key = e.dept_seq_key                                  " +
     "     	   and a.grade_code = '" + arg_grade_code + "'                          " +
     "     	   and d.degree = " + arg_degree + "                              	   " +
     "     	   and d.level_code like '" + arg_level_code + "'                       " +
     "     	   and e.dept_code  like '" + arg_dept_code + "'                        " +
     "     	     )                                                                  " +
     "     	   and not (                                                            " +
     "     	       c.service_div =  '3'                                             " +
