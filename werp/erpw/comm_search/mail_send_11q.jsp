<%@ page session="true" contentType="text/html;charset=euc-kr"  import="java.text.*,java.util.*,javax.mail.*,javax.mail.internet.*,java.lang.*,javax.activation.*,java.io.*,com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*"%>
