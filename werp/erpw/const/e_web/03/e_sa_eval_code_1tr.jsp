...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("e_sa_eval_code_1tr");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
      ...
      gpstatement.bindColumn(3, idx_part);
      gpstatement.bindColumn(4, idx_item);
      gpstatement.bindColumn(5, idx_or_item);
      gpstatement.bindColumn(6, idx_or_point);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      gpstatement.bindColumn(7, idx_opinion_type);
      gpstatement.bindColumn(8, idx_key_item);
      gpstatement.bindColumn(9, idx_key_seq);
      stmt.executeUpdate();
      stmt.close();
