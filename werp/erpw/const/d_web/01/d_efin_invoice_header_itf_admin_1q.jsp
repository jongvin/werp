<%@ page session="true" contentType="text/html;charset=EUC_KR"  import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 // 다음 문장은 수정 하시요 (파라메터 갯수만큼 (없으면 //로 막으세요)--r
     ...
     arg_user_id = arg_user_id.toLowerCase();
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("complete_name",GauceDataColumn.TB_STRING,30));
    String query = "  SELECT a.invoice_group_id,   " + 
     ...
     "         CASE WHEN a.complete_flag = '1' THEN '결재중' WHEN a.complete_flag = '9' THEN '완료' WHEN a.complete_flag = '3' THEN '반송' ELSE '' END complete_name " + 
     ...
     "   ORDER BY a.approval_num, a.created_dept_name,a.batch_date desc,a.invoice_group_id " + 
     "                 ";
