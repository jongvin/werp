<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_1",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_2",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_3",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_4",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_5",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_6",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_7",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_8",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_9",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_10",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("approval_yymm_date_11",GauceDataColumn.TB_STRING,18));
    String query = "  SELECT a.invoice_group_id,   " + 
     ...
     "         'F' chk, " + 
     "         b.invoice_amount,  " + 
     "         to_char(a.approval_date_1,'yy.mm.dd') approval_yymm_date_1,   " + 
     "         to_char(a.approval_date_2,'yy.mm.dd') approval_yymm_date_2,   " + 
     "         to_char(a.approval_date_3,'yy.mm.dd') approval_yymm_date_3,   " + 
     "         to_char(a.approval_date_4,'yy.mm.dd') approval_yymm_date_4,   " + 
     "         to_char(a.approval_date_5,'yy.mm.dd') approval_yymm_date_5,   " + 
     "         to_char(a.approval_date_6,'yy.mm.dd') approval_yymm_date_6,   " + 
     "         to_char(a.approval_date_7,'yy.mm.dd') approval_yymm_date_7,   " + 
     "         to_char(a.approval_date_8,'yy.mm.dd') approval_yymm_date_8,   " + 
     "         to_char(a.approval_date_9,'yy.mm.dd') approval_yymm_date_9,   " + 
     "         to_char(a.approval_date_10,'yy.mm.dd') approval_yymm_date_10,   " + 
     "         to_char(a.approval_date_11,'yy.mm.dd') approval_yymm_date_11   " + 
     "    FROM efin_invoice_header_itf   a," + 
     "         efin_invoice_header_itf_v   b" + 
     "   WHERE a.invoice_group_id =  b.invoice_group_id " + 
     "      and ((a.approval_id_1 = '" + arg_user_id + "' " + 
     "           and  a.approval_status_1 = '" + arg_result + "') " + 
     "      or (a.approval_id_2 = '" + arg_user_id + "' " + 
     "           and  a.approval_status_2 = '" + arg_result + "') " + 
     "      or (a.approval_id_3 = '" + arg_user_id + "' " + 
     "           and  a.approval_status_3 = '" + arg_result + "') " + 
     "      or (a.approval_id_4 = '" + arg_user_id + "' " + 
     "           and  a.approval_status_4 = '" + arg_result + "') " + 
     "      or (a.approval_id_5 = '" + arg_user_id + "' " + 
     "           and  a.approval_status_5 = '" + arg_result + "') " + 
     "      or (a.approval_id_6 = '" + arg_user_id + "' " + 
     "           and  a.approval_status_6 = '" + arg_result + "') " + 
     "      or (a.approval_id_7 = '" + arg_user_id + "' " + 
     "           and  a.approval_status_7 = '" + arg_result + "') " + 
     "      or (a.approval_id_8 = '" + arg_user_id + "' " + 
     "           and  a.approval_status_8 = '" + arg_result + "') " + 
     "      or (a.approval_id_9 = '" + arg_user_id + "' " + 
     "           and  a.approval_status_9 = '" + arg_result + "')) " + 
     "     and a.batch_date >= '" + arg_from_date + "' " + 
     "     and a.batch_date <= '" + arg_to_date + "' " + 
     "   ORDER BY  a.created_dept_name,a.batch_date,a.invoice_group_id " + 
     "                 ";
