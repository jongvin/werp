<%@ page import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("chg_class",GauceDataColumn.TB_STRING,4));
     dSet.addDataColumn(new GauceDataColumn("chg_date",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("user_code",GauceDataColumn.TB_STRING,18));
     dSet.addDataColumn(new GauceDataColumn("gubun",GauceDataColumn.TB_STRING,18));
    ...
    String query = "  SELECT  a.sbcr_name ," + 
                   "          a.sbcr_unq_num ," + 
                   ...
                   "          a.input_name , a.region_code,a.chg_class," +
                   ...
                   "      AND to_char(a.chg_date,'YYYY.MM.DD') >= " + "'" + arg_from_date + "'" +
                   "      AND to_char(a.chg_date,'YYYY.MM.DD') <= " + "'" + arg_to_date + "'" +
                   "      AND a.chg_class = '2' " +
                   "      ANd a.sbcr_code is not null " +
