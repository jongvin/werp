...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
    ...
    String query = "  SELECT s_order_parent.dept_code,   " + 
     ...
     "         s_estimate_parent.est_amt,   " + 
     "         s_estimate_parent.ctrl_amt,   " + 
     "         s_estimate_parent.emat_amt,   " + 
     "         s_estimate_parent.elab_amt,   " + 
     "         s_estimate_parent.eexp_amt,   " + 
     "         s_estimate_parent.cmat_amt,   " + 
     "         s_estimate_parent.clab_amt,   " + 
     "         s_estimate_parent.cexp_amt  " + 
     ...
     "         ( s_estimate_parent.sbcr_code = '" + arg_sbcr_code + "' ) AND  " + 
