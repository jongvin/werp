...
String dir = (String) session.getAttribute("dir");
     GauceDataSet dSet = req.getGauceDataSet("s_const_add_file_1tr");
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      ...
      gpstatement.gp_stmt = stmt;
      int aa;
//      	  gpstatement.gp_stmt.setMaxFieldSize(3000);
//      	  aa = gpstatement.gp_stmt.getMaxFieldSize();
//      	  GauceVariable g1 = new GauceVariable(15,3,3,'R',3000);
//      	  aa = g1.getStrLength();

//      try {
//           gpstatement.gp_stmt.setMaxFieldSize(30000);
//       } catch(java.sql.SQLException e){
//         System.out.println(e);
//      } 
//      if (true) {
//			throw new Exception(aa + "true");
//		}   
      gpstatement.bindColumn(1, idx_con_add_doc_id);
      gpstatement.bindColumn(2, idx_dept_code);
      gpstatement.bindColumn(3, idx_cst_doc_no);
...
//      stmt.setString(16,rows.getString(idx_bonsa_sign_val));
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      gpstatement.bindColumn(24, idx_con_add_doc_id);
      stmt.executeUpdate();
      stmt.close();
