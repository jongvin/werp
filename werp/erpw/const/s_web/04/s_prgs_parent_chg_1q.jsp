...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
    ...
    String query = "  SELECT  s_prgs_parent.dept_code ," + 
     ...
     "          s_chg_cn_parent.seq no_seq," + 
     "          s_chg_cn_parent.llevel ," + 
     "          s_chg_cn_parent.sum_code ," + 
     "          s_chg_cn_parent.parent_sum_code ," + 
     "          s_chg_cn_parent.detail_yn ," + 
     "          s_chg_cn_parent.name ," + 
     "          s_chg_cn_parent.direct_class     FROM s_chg_cn_parent ," + 
     "          s_prgs_parent     " + 
     "         WHERE ( s_prgs_parent.dept_code = s_chg_cn_parent.dept_code ) and " + 
     "               ( s_prgs_parent.order_number = s_chg_cn_parent.order_number ) and  " + 
     "               ( s_prgs_parent.spec_no_seq = s_chg_cn_parent.spec_no_seq ) and " + 
