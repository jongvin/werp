<%@ page import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("m_output_slip_detail_find_1tr");
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      ...
      gpstatement.bindColumn(5, idx_vat_amt);
      gpstatement.bindColumn(6, idx_vat_unq_num);
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      gpstatement.bindColumn(7, idx_dept_code);
      gpstatement.bindColumn(8, idx_yymmdd);
      gpstatement.bindColumn(9, idx_seq);
      gpstatement.bindColumn(10, idx_output_unq_num);
      stmt.executeUpdate();
      stmt.close();
   }
     }
