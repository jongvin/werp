...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("m_approval_detail_find_1tr"); gpstatement.gp_dataset = dSet;
   	...
   	int idx_noinput_qty = dSet.indexOfColumn("noinput_qty");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
      ...
      gpstatement.bindColumn(20, idx_noinput_qty);
      stmt.executeUpdate();
      stmt.close();
