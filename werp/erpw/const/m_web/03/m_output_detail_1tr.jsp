...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
		String sSql = " INSERT INTO M_OUTPUT_DETAIL ( dept_code," + 
                    ...
                    "est_unq_num," + 
                    "input_unq_num," + 
                    "approval_unq_num,tmat_unq_num ,vat_unq_num,vat_amt,remark)      ";
      ...
      gpstatement.bindColumn(25, idx_remark);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "update m_output_detail set " + 
                            ...
                            "est_unq_num=?,  " + 
                            "input_unq_num=?,  " + 
                            "approval_unq_num=?,tmat_unq_num=?,vat_unq_num=?,vat_amt=? ,remark=? where dept_code=? " + 
                            " and yymmdd=?  " + 
                            " and seq=?  " + 
                            " and output_unq_num=?  " ;  
      stmt = conn.prepareStatement(sSql); 
...
/* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(27, idx_yymmdd);
      gpstatement.bindColumn(28, idx_seq);
      gpstatement.bindColumn(29, idx_output_unq_num);
      stmt.executeUpdate();
      stmt.close();
