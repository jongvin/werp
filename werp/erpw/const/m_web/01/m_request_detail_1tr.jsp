...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("m_request_detail_1tr"); 
	...
	int idx_pre_chg_cnt = dSet.indexOfColumn("pre_chg_cnt");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
		String sSql = " INSERT INTO M_REQUEST_DETAIL ( dept_code," + 
                    ...
                    "spec_no_seq," + 
                    "spec_unq_num," + 
                    "nappr_qty ,remark1,bud_qty,bud_price,bud_amt,pre_request_qty,pre_chg_cnt )      ";
	  ...
	  gpstatement.bindColumn(27, idx_pre_chg_cnt);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "update m_request_detail set " + 
                            ...
                            "spec_no_seq=?,  " + 
                            "spec_unq_num=?,  " + 
                            "nappr_qty=?, remark1=?,bud_qty=?,bud_price=?,bud_amt=?,pre_request_qty=?,pre_chg_cnt=?  where dept_code=? " +
                            " and requestseq=? " +
                            " and chg_cnt=? " +
                            " and request_unq_num=? ";  
      stmt = conn.prepareStatement(sSql); 
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(29, idx_requestseq);
      gpstatement.bindColumn(30, idx_chg_cnt);
      gpstatement.bindColumn(31, idx_request_unq_num);
      stmt.executeUpdate();
      stmt.close();
