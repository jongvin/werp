...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("m_request_1tr"); gpstatement.gp_dataset = dSet;
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
		String sSql = " INSERT INTO M_REQUEST ( dept_code," + 
                    ...
                    "proj_content," + 
                    "head_content," +
                    "approve_class, order_class, owner,check_method )      ";
      ...
      gpstatement.bindColumn(11, idx_owner);
      gpstatement.bindColumn(12, idx_check_method);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "update m_request set " + 
                            ...
                            "proj_content=?,  " + 
                            "head_content=?,  " +
                            "approve_class=? , order_class=?, owner=?,check_method=? where dept_code=? " +
                            " and requestseq=? " +
                            " and chg_cnt=?";  
      stmt = conn.prepareStatement(sSql); 
      gpstatement.gp_stmt = stmt;
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(14, idx_requestseq);
      gpstatement.bindColumn(15, idx_chg_cnt);
      stmt.executeUpdate();
      stmt.close();
