...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("kindtag",GauceDataColumn.TB_STRING,1));
     dSet.addDataColumn(new GauceDataColumn("mtrgrand",GauceDataColumn.TB_STRING,10));
     dSet.addDataColumn(new GauceDataColumn("mtrmiddle",GauceDataColumn.TB_STRING,10));
