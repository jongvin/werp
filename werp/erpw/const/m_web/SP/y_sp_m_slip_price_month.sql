/* ============================================================================= */
/* 함수명 : y_sp_m_slip_price_month(CJ개발)                                      */
/* 기  능 : 자재관리-지급임차료전표 발행                                         */
/* ----------------------------------------------------------------------------- */
...
/* 작성일 : 2006.04.12                                                           */
/* ============================================================================= */
CREATE OR REPLACE PROCEDURE y_sp_m_slip_price_month (as_dept_code    IN   VARCHAR2,
																	  as_date         IN   DATE,
...
SELECT a.amt,nvl(a.amt * 0.1,0),a.month,to_char(a.month,'YYYY.MM') || '월 손료',nvl(a.amt * 1.1,0),0,0,d.ditag,
		 c.businessman_number,c.sbcr_name,c.rep_name1,c.kind_bussinesstype,c.kinditem,c.zip_number1,c.address1,c.tel_number1,c.chrg_name1,c.chrg_email,a.basic_date
 ...
 WHERE a.dept_code = d.dept_code
   ...
   AND a.dept_code = 'A0101'
	AND trunc(a.month,'MM')= '2006.06.01'
;
