...
SELECT a.amt,a.yyyymmdd,a.cont,a.work_process
...
-- 전표내역을 만들기 위한 커서
		OPEN	DETAIL_CUR;
		LOOP
			FETCH DETAIL_CUR INTO V_AMT,V_YYMMDD,V_CONT,V_TAG;
			EXIT WHEN DETAIL_CUR%NOTFOUND;
	
			IF V_TAG = '2' THEN
				C_ACNT_CODE := '420010100';
				C_CR_CODE   := '112080100';
			ELSE 
