...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("f_receive_amt_1tr"); gpstatement.gp_dataset = dSet;
   	...
   	int idx_input_tag = dSet.indexOfColumn("input_tag");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
		String sSql = " INSERT INTO F_RECEIVE_AMT ( dept_code," + 
                    ...
                    "bank_amt," + 
                    "etc_amt," + 
                    "rqst_detail, input_tag, invoice_num, invoice_num1 )      ";
      ...
      gpstatement.bindColumn(10, idx_input_tag);
      gpstatement.bindColumn(11, idx_invoice_num);
      gpstatement.bindColumn(12, idx_invoice_num1);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "update f_receive_amt set " + 
                            ...
                            "bank_amt=?,  " + 
                            "etc_amt=?,  " + 
                            "rqst_detail=?, input_tag=?, invoice_num=?, invoice_num1=?  where dept_code=? " +
                            " and receive_date=?  " + 
                            " and seq=?  ";  
      stmt = conn.prepareStatement(sSql); 
      gpstatement.gp_stmt = stmt;
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(14, idx_key_receive_date);
