...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("delay_rate",GauceDataColumn.TB_DECIMAL,18,4));
     dSet.addDataColumn(new GauceDataColumn("reserve_rate",GauceDataColumn.TB_DECIMAL,18,0));
     dSet.addDataColumn(new GauceDataColumn("cont_rate",GauceDataColumn.TB_DECIMAL,18,0));
    ...
    String query = "  SELECT a.DEPT_CODE,   " + 
     ...
     "         nvl(a.CHANGE_SUM_AMT,0) CHANGE_SUM_AMT,  " + 
