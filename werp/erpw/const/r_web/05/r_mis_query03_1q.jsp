...
//---------------------------------------------------------- 
    ...
    String query = "select a.id," + 
     ...
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'01',nvl(a.collection_plan_amt,0),0),0)) comp_01," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'02',nvl(a.collection_plan_amt,0),0),0)) comp_02," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'03',nvl(a.collection_plan_amt,0),0),0)) comp_03," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'04',nvl(a.collection_plan_amt,0),0),0)) comp_04," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'05',nvl(a.collection_plan_amt,0),0),0)) comp_05," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'06',nvl(a.collection_plan_amt,0),0),0)) comp_06," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'07',nvl(a.collection_plan_amt,0),0),0)) comp_07," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'08',nvl(a.collection_plan_amt,0),0),0)) comp_08," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'09',nvl(a.collection_plan_amt,0),0),0)) comp_09," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'10',nvl(a.collection_plan_amt,0),0),0)) comp_10," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'11',nvl(a.collection_plan_amt,0),0),0)) comp_11," + 
     " 			sum(nvl(decode(to_char(a.plan_date,'MM'),'12',nvl(a.collection_plan_amt,0),0),0)) comp_12," + 
     " 			sum(nvl(a.collection_plan_amt,0)) comp_tot," + 
     " 			sum(nvl(a.collection_plan_amt,0)) + AVG(nvl(c.amt,0)) tot_tot" + 
     " 	from r_contract_collection_plan a," + 
     " 		  z_code_dept b," + 
     " 		  ( select sum(nvl(a.supply_amt,0)) amt" + 
     ...
     " 	where to_char(a.plan_date,'YYYY') = " + "'" + arg_year + "'" + 
     "      and b.dept_code = a.dept_code (+)" + 
     "      and b.chg_const_start_date is not null" + 
     "      and to_char(b.chg_const_start_date,'YYYY') <= " + "'" + arg_year + "'" + 
     ...
     " 			'수금실적' name, " + 
     " 			AVG(nvl(c.amt,0))   ly_tot," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'01',nvl(a.supply_amt,0),0),0)) comp_01," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'02',nvl(a.supply_amt,0),0),0)) comp_02," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'03',nvl(a.supply_amt,0),0),0)) comp_03," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'04',nvl(a.supply_amt,0),0),0)) comp_04," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'05',nvl(a.supply_amt,0),0),0)) comp_05," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'06',nvl(a.supply_amt,0),0),0)) comp_06," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'07',nvl(a.supply_amt,0),0),0)) comp_07," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'08',nvl(a.supply_amt,0),0),0)) comp_08," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'09',nvl(a.supply_amt,0),0),0)) comp_09," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'10',nvl(a.supply_amt,0),0),0)) comp_10," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'11',nvl(a.supply_amt,0),0),0)) comp_11," + 
     " 			sum(nvl(decode(to_char(a.received_date,'MM'),'12',nvl(a.supply_amt,0),0),0)) comp_12," + 
     " 			sum(nvl(a.supply_amt,0)) comp_tot," + 
     " 			sum(nvl(a.supply_amt,0)) + AVG(nvl(c.amt,0)) tot_tot" + 
     " 	from r_contract_time_collection a," + 
     " 		  z_code_dept b," + 
     " 		  ( select sum(nvl(a.supply_amt,0)) amt" + 
     "             from r_contract_time_collection a," + 
