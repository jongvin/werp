...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
    ...
    String query = " select  max(a.dept_code) dept_code,  " + 
     ...
     "					0 ly_tot, " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'01',nvl(a.change_sum_amt,0),0),0)) comp_01,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'02',nvl(a.change_sum_amt,0),0),0)) comp_02,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'03',nvl(a.change_sum_amt,0),0),0)) comp_03,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'04',nvl(a.change_sum_amt,0),0),0)) comp_04,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'05',nvl(a.change_sum_amt,0),0),0)) comp_05,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'06',nvl(a.change_sum_amt,0),0),0)) comp_06,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'07',nvl(a.change_sum_amt,0),0),0)) comp_07,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'08',nvl(a.change_sum_amt,0),0),0)) comp_08,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'09',nvl(a.change_sum_amt,0),0),0)) comp_09,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'10',nvl(a.change_sum_amt,0),0),0)) comp_10,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'11',nvl(a.change_sum_amt,0),0),0)) comp_11,  " + 
     "					sum(nvl(decode(to_char(a.cont_date,'MM'),'12',nvl(a.change_sum_amt,0),0),0)) comp_12,  " + 
     "					sum(nvl(a.change_sum_amt,0)) comp_tot  " + 
     "			 from r_contract_register   a," + 
     "					z_code_dept c,  " + 
     "               c_spec_class_parent d, " +
	  "               c_spec_class_child e " +
     ...
     "		  select a.dept_code," + 
     "					c.long_name," + 
     "					nvl(a.change_sum_amt - b.change_sum_amt,0) ly_tot, " + 
     "					0 comp_01,  " + 
     "					0 comp_02,  " + 
     "					0 comp_03,  " + 
     "					0 comp_04,  " + 
     ...
     "					sum(nvl(a.change_sum_amt,0)) ly_tot, " + 
     "					0 comp_01,  " + 
     "					0 comp_02,  " + 
     "					0 comp_03,  " + 
     "					0 comp_04,  " + 
