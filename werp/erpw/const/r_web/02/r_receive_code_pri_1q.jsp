vm<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@ 
...
// 다음 문장은 수정 하시요 (파라메터 갯수만큼 (없으면 //로 막으세요)--r
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("siteexplan_date",GauceDataColumn.TB_STRING,18));
     ...
     dSet.addDataColumn(new GauceDataColumn("regist_date",GauceDataColumn.TB_STRING,18));
     ...
     dSet.addDataColumn(new GauceDataColumn("res_end_date",GauceDataColumn.TB_STRING,18));
     ...
     dSet.addDataColumn(new GauceDataColumn("imp_supplier",GauceDataColumn.TB_STRING,30));
	  dSet.addDataColumn(new GauceDataColumn("input_name",GauceDataColumn.TB_STRING,30));
     dSet.addDataColumn(new GauceDataColumn("const_etc_remark",GauceDataColumn.TB_STRING,500));
     dSet.addDataColumn(new GauceDataColumn("business_remark",GauceDataColumn.TB_STRING,2000));
     ...
     "             a.PARENT_DEPT_CODE," + 
     "             a.APPROVE_CLASS, " + 
     "             to_char(a.SITEEXPLAN_DATE,'YYYY.MM.DD') SITEEXPLAN_DATE, " + 
     "             a.SITEEXPLAN_PLACE, " + 
     "             a.SITEEXPLAN_COND, " + 
     "             a.SITEEXPLAN_TAG, " + 
     "             a.SITEEXPLAN_NAME, " + 
     ...
     "             a.REGIST_TAG, " + 
     "             a.TENDER_NO, " + 
     "             to_char(a.TENDER_DATE,'YYYY.MMDD') TENDER_DATE, " + 
     "             a.TENDER_PLACE, " + 
     "             a.TENDER_COND, " + 
     ...
     "             to_char(a.RES_END_DATE,'YYYY.MM.DD') RES_END_DATE, " + 
