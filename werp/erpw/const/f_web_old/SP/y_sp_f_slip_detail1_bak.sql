/* ============================================================================= */
/* 함수명 : y_sp_f_slip_detail1                                                  */
/* 기  능 : 자동전표생성디테일(부가세없고거래처있는거).                          */
/* ----------------------------------------------------------------------------- */
/* 인  수 : 현장코드               ==> as_dept_code (string)                     */
/*        : 시작일                 ==> adt_from_date(date)                       */
/*        : 종료일                 ==> adt_to_date(date)                         */
/*        : 전표일                 ==> adt_slip_date(date)                       */
/*        : 거래처코드             ==> arg_cust_code(string)                     */
...
/* 작성일 : 2003.08.14                                                           */
/* ============================================================================= */
CREATE OR REPLACE PROCEDURE y_sp_f_slip_detail1(as_dept_code    IN   VARCHAR2,
                                        		   adt_from_yymm   IN   DATE,
															   adt_to_yymm     IN   DATE,
															   adt_slip_date   IN   DATE,
																arg_cust_code   IN   VARCHAR2,
...
BEGIN
   BEGIN
		...
		INSERT INTO erpc.AM_WORK_DETAIL  
		VALUES ( adt_slip_date,arg_seq,C_SEQ,C_SEQ,as_dept_code,as_class,'1',as_dept_code,'510',   
				 C_ACNT_CODE,C_ACNT_CODE,0,0,0,C_TOT,0,C_TOT,'현장전도급청구분','현장전도급청구분',   
				 '1',arg_cust_code,'',null,null,null,null,null,null,null,null,null,null,null,null,null,null,   
					 null,null,0,0,0,0,0,0,0,0,0,NULL,NULL,NULL,null,null,null,   
					 0,0,null,null,0,null,sysdate,null,sysdate )  ;
