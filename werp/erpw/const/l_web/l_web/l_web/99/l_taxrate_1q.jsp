...
//     String in_emp_nm = req.getParameter("in_emp_nm");
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("civil_taxrate",GauceDataColumn.TB_DECIMAL,18,2));
     dSet.addDataColumn(new GauceDataColumn("deduction_taxrate",GauceDataColumn.TB_DECIMAL,18,2));
     dSet.addDataColumn(new GauceDataColumn("comp_text",GauceDataColumn.TB_STRING,100));
     dSet.addDataColumn(new GauceDataColumn("insurance_taxrate",GauceDataColumn.TB_DECIMAL,18,2));
