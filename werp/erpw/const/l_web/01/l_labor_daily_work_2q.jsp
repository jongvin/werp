...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
    ...
    String query = "  SELECT a.DEPT_CODE,   " + 
     ...
     "    and a.work_date = 	(select to_char(max(work_date),'yyyymmdd') select_1 " +
     "    from l_labor_dailywork where dept_code = '"+arg_dept+"' " +
     "  and to_char(work_date,'yyyy.mm.dd') < '"+arg_date+"' )   " +
