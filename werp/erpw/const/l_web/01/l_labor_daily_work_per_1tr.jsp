...
include file ="../../../comm_function/conn_tr_pool.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("l_labor_daily_work_1tr"); gpstatement.gp_dataset = dSet;
   	...
   	int idx_work_date_1 = dSet.indexOfColumn("work_date_1");
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      ...
      gpstatement.bindColumn(15, idx_civil_register_number);
      gpstatement.bindColumn(16, idx_work_date_1);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      gpstatement.bindColumn(1, idx_dept_code);
      gpstatement.bindColumn(2, idx_civil_register_number);
      gpstatement.bindColumn(3, idx_work_date_1);
      stmt.executeUpdate();
      stmt.close();
    }
     }
