<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 include file ="../../../comm_function/conn_tr.jsp"%><%
     GauceDataSet dSet = req.getGauceDataSet("g_mis_result_1tr");
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
		String sSql = " INSERT INTO G_MIS_RESULT ( work_year," + 
                    "unq_key," + 
                    "no_seq," + 
                    "desc1," + 
                    "plan_1," + 
      ...
      gpstatement.bindColumn(5, idx_plan_1);
      gpstatement.bindColumn(6, idx_plan_2);
      gpstatement.bindColumn(7, idx_plan_3);
      gpstatement.bindColumn(8, idx_plan_4);
      gpstatement.bindColumn(9, idx_plan_5);
      gpstatement.bindColumn(10, idx_plan_6);
      gpstatement.bindColumn(11, idx_plan_7);
      gpstatement.bindColumn(12, idx_plan_8);
      gpstatement.bindColumn(13, idx_plan_9);
      gpstatement.bindColumn(14, idx_plan_10);
      gpstatement.bindColumn(15, idx_plan_11);
      gpstatement.bindColumn(16, idx_plan_12);
      gpstatement.bindColumn(17, idx_result_1);
      gpstatement.bindColumn(18, idx_result_2);
      gpstatement.bindColumn(19, idx_result_3);
      gpstatement.bindColumn(20, idx_result_4);
      gpstatement.bindColumn(21, idx_result_5);
      gpstatement.bindColumn(22, idx_result_6);
      gpstatement.bindColumn(23, idx_result_7);
      gpstatement.bindColumn(24, idx_result_8);
      gpstatement.bindColumn(25, idx_result_9);
      gpstatement.bindColumn(26, idx_result_10);
      gpstatement.bindColumn(27, idx_result_11);
      gpstatement.bindColumn(28, idx_result_12);
      gpstatement.bindColumn(29, idx_calc_yn);
      stmt.executeUpdate();
      stmt.close();
 
   }else if(rows.getJobType() ==  GauceDataRow.TB_JOB_UPDATE){
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "update g_mis_result set " + 
                            "work_year=?,  " + 
                            "unq_key=?,  " + 
                            "no_seq=?,  " + 
                            "desc1=?,  " + 
 ...
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      gpstatement.bindColumn(30, idx_work_year);
      gpstatement.bindColumn(31, idx_unq_key);
      stmt.executeUpdate();
      stmt.close();
   }else if(rows.getJobType() ==  GauceDataRow.TB_JOB_DELETE){
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "delete from g_mis_result where work_year=? and unq_key=? "; 
      stmt = conn.prepareStatement(sSql); 
      gpstatement.gp_stmt = stmt;
 /* 다음 문장은 반드시 수정하시요(변수갯수 만큼) */ 
      gpstatement.bindColumn(1, idx_work_year);
