<%@ page session="true" contentType="text/html;charset=EUC_KR" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
    ...
    String query = "  " + 
                   ...
                   " from ( " + 
                   "     SELECT '1' type, trunc(a.receive_date,'mm') mm,nvl(a.have_grade,'00') gubun, nvl(b.detail_name,' ') detail_name,  count(nvl(a.have_grade,1)) cnt " + 
                   ...
                   "        group by trunc(a.receive_date,'mm'),nvl(a.have_grade,'00'),nvl(b.detail_name,' ')                                                 " + 
                   "     union all                                                                                                                   " + 
                   "     SELECT '2' type, trunc(a.receive_date,'mm') ,nvl(a.exam_type,'00') gubun,nvl(b.detail_name,' '), count(nvl(a.exam_type,1))           " + 
                   "        from r1_proj a, r1_code_etc_detail b                                                                                     " + 
                   "        where b.class_tag (+)= '09'                                                                                                 " + 
                   "          and a.exam_type = b.etc_code (+)                                                                                       " + 
                   "          and a.receive_date >= '" + arg_work_year + "'                                                                                     " + 
                   "          and a.receive_date < add_months('" + arg_work_year + "',12)     " + 
                   "        group by trunc(a.receive_date,'mm'),nvl(a.exam_type,'00'),nvl(b.detail_name,' ')                                                  " + 
                   "       ) a,                                                                                                                      " + 
                   "    (                                                                                                                            " + 
                   ...
                   "   where a.mm = b.mm " + 
                   "   order by a.type,a.gubun,a.detail_name,a.mm   ";
