<%@ page session="true"	  contentType="text/html; charset=EUC_KR" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
    ...
    String query = "" + 
     ...
     "  FROM (" + 
     "SELECT  distinct DECODE(f.sido, '서울', '1', '경기', '2', '제주', '8', NULL, '9', '3') || NVL(f.sido, '기타') || f.gugun  sort_tag, " + 
	  "        a.subs_no, "+
     "        NVL(f.sido, '기타')  sido,  " + 
     "        NVL(f.gugun, '기타') gugun,  " + 
     "        DECODE(a.sell_code, '03', 1, 0) lease_cnt,    " + 
     "        DECODE(a.sell_code, '01', 0, 1) sale_cnt,    " + 
	  "        DECODE(a.sell_code, '02', 0, 1) union_cnt,    " + 
     "        DECODE(SUBSTR(b.cust_code,7,1), '1', 1, 0) male_cnt,  " + 
     "        DECODE(SUBSTR(b.cust_code,7,1), '1', 0, 1) female_cnt,  " + 
