...
/* 작성일 : 2005.06.27                                                           */
/* ============================================================================= */
CREATE OR REPLACE PROCEDURE sp_g_mis_forecast_est(ad_work_yymm  IN  DATE) IS
-------------------------------------------------------------
-- 변수선언
-------------------------------------------------------------
-- 공통 변수
...
BEGIN
  BEGIN
		...
		INSERT INTO g_mis_forecast_est(work_yymm,
									         proj_bus_type,
									         proj_prog_type,
									         proj_unq_key,proj_name)
