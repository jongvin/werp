...
/* 작성일 : 2001.08.22                                                           */
/* ============================================================================= */
CREATE OR REPLACE PROCEDURE y_sp_y_chgdegree_cmpt(as_dept_code    IN   VARCHAR2,
                                                  ai_chg_no_seq   IN   INTEGER,
                                                  an_spec_no_seq  IN   NUMBER,
