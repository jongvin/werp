/* ============================================================================= */
/* 함수명 : sp_y_subesmt_seq_creation                                            */
/* 기  능 : 집계구조의순번을 TEMP에저장한다.                                     */
/* 작성자 : 김동우                                                               */
/* 작성일 : 2001.10.31                                                           */
/* ============================================================================= */
CREATE OR REPLACE PROCEDURE sp_y_subesmt_seq_creation(as_receive_code    IN   VARCHAR2,
                                                ai_no            IN   INTEGER,
...
-- User Define Error 
   ...
   V_PARENT_SUM_CODE   Y_ESMT_SUB_SUMMARY.PARENT_SUM_CODE%TYPE;
   V_SEQ               Y_ESMT_SUB_SUMMARY.SEQ%TYPE;
   V_INVEST_CLASS      Y_ESMT_SUB_SUMMARY.INVEST_CLASS%TYPE;
   V_DETAIL_YN         Y_ESMT_SUB_SUMMARY.DETAIL_YN%TYPE;
   C_SA_CODE           Y_ESMT_SUB_SUMMARY.SUM_CODE%TYPE;
   C_KA_CODE           Y_ESMT_SUB_SUMMARY.SUM_CODE%TYPE;
   C_INVEST_CLASS      Y_ESMT_SUB_SUMMARY.INVEST_CLASS%TYPE;
   C_DETAIL_YN         Y_ESMT_SUB_SUMMARY.DETAIL_YN%TYPE;
   C_PARENT_SUM_CODE   Y_ESMT_SUB_SUMMARY.PARENT_SUM_CODE%TYPE;    -- 상위코드
   C_SEQ               Y_ESMT_SUB_SUMMARY.SEQ%TYPE; 
