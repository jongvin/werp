...
/* 작성일 : 2001.09.11                                                           */
/* ============================================================================= */
CREATE OR REPLACE PROCEDURE sp_y_projmng_spec_copy(as_proj_code    IN   VARCHAR2,
...
-- 현장관리비편성기준을 현장별 현장관리비로 복사한다. 
   ...
   IF C_CNT < 1 THEN
      INSERT INTO y_projmng_request  
           VALUES ( as_proj_code,sysdate,'1',null,'N',null,sysdate,as_user )  ;
   END IF;
 ...
 BEGIN
	...
	LOOP
      ...
      IF C_CNT < 1 THEN
	      INSERT INTO y_projmng_amt_wbs  
   	        VALUES ( as_proj_code,V_WBS_CODE,'',V_NAME,V_NOTE,
 ...
 BEGIN
	...
	LOOP
      ...
      IF C_CNT < 1 THEN
         INSERT INTO y_projmng_amt  
              VALUES ( as_proj_code,V_WBS_CODE,V_RES_CLASS_CODE,V_DETAIL_CODE,0,
