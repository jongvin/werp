...
/* 작성일 : 2001.08.14                                                           */
/* ============================================================================= */
CREATE OR REPLACE PROCEDURE sp_y_budget_spec_copy(as_proj_code    IN   VARCHAR2,
                                                  ai_no           IN   INTEGER,
...
-- 해당차수의 변경실행내역과 변경실행집계구조의 자료를 삭제한다. 
   ...
   DELETE FROM Y_BUDGET_SUMMARY
         WHERE ( proj_code  = as_proj_code );

-- 최종실행집계구조를 해당차수의 변경실행집계구조로 복사한다. 
   INSERT INTO Y_BUDGET_SUMMARY  
        SELECT a.proj_code,a.sum_code,a.direct_class,
               a.mng_code,a.wbs_code,a.seq,a.llevel,a.parent_sum_code,
               a.invest_class,a.detail_yn,a.name,a.ssize,a.unit,
               NVL(a.cnt_qty,0),   
               NVL(a.cnt_amt,0),   
               NVL(a.cnt_mat_amt,0),   
               NVL(a.cnt_lab_amt,0),   
...
-- 최종실행내역를 해당차수의 변경실행내역으로 복사한다. 
   INSERT INTO Y_BUDGET_DETAIL  
        SELECT a.proj_code,a.sum_code,a.spec_unq_num,a.detail_code,a.res_class,
               a.seq,a.mng_code,a.wbs_code,a.mat_code,a.add_yn,
