...
/* 작성일 : 2001.09.04                                                           */
/* ============================================================================= */
CREATE OR REPLACE PROCEDURE sp_y_subest_esmt_tot_cmpt(as_receive_code    IN   VARCHAR2,
                                                        ai_no           IN   INTEGER,
...
-- User Define Error 
   V_SUM_CODE          Y_ESMT_SUB_SUMMARY.SUM_CODE%TYPE;
   ...
   C_CTRL_AMT          Y_ESMT_SUBEST_DETAIL.CTRL_AMT%TYPE;           -- 조정금액
   C_CTRL_MAT_AMT      Y_ESMT_SUBEST_DETAIL.CTRL_MAT_AMT%TYPE;       -- 조정자재비
   C_CTRL_LAB_AMT      Y_ESMT_SUBEST_DETAIL.CTRL_LAB_AMT%TYPE;       -- 조정노무비
   C_CTRL_EXP_AMT      Y_ESMT_SUBEST_DETAIL.CTRL_EXP_AMT%TYPE;       -- 조정경비
   C_LEVEL             NUMBER(20,5);  -- 
   C_CNT               NUMBER(20,5);  -- 
	...
	LOOP
      ...
      SELECT NVL(SUM(AMT),0),NVL(SUM(MAT_AMT),0),NVL(SUM(LAB_AMT),0),
        ...
        INTO C_AMT,C_MAT_AMT,C_LAB_AMT,C_EXP_AMT,
             C_CTRL_AMT,C_CTRL_MAT_AMT,C_CTRL_LAB_AMT,C_CTRL_EXP_AMT
