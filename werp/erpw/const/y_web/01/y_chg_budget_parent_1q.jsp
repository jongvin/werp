...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
    ...
    String query = "  SELECT  y_chg_budget_parent.dept_code ," + 
     ...
     "          (select count(y_chg_budget_detail.dept_code)  " + 
     ...
     "                  AND  y_chg_budget_parent.spec_no_seq = y_chg_budget_detail.spec_no_seq " + 
     "                  AND  y_chg_budget_parent.dept_code = " + "'" + arg_dept_code + "'" + "  " + 
     "                  and  y_chg_budget_parent.chg_no_seq = " + arg_chg_no_seq + "  " + 
     "                  and  y_chg_budget_parent.invest_class = 'Y') cnt " + 
     "    FROM y_chg_budget_parent ,y_wbs_code  " + 
     "    WHERE ( y_chg_budget_parent.wbs_code = y_wbs_code.wbs_code (+))  and  " +  
