<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 include file ="../../../comm_function/conn_tr_pool.jsp"%><%
	...
	if(rows.getJobType() == GauceDataRow.TB_JOB_INSERT){
      ...
      gpstatement.bindColumn(7, idx_price);
      ...
      gpstatement.bindColumn(15, idx_exp_price);
      gpstatement.bindColumn(16, idx_exp_amt);
      gpstatement.bindColumn(17, idx_remark);
      gpstatement.bindColumn(18, idx_mat_code);
      gpstatement.bindColumn(19, idx_res_class);
      gpstatement.bindColumn(20, idx_dept_code);
      gpstatement.bindColumn(21, idx_part_class);
      gpstatement.bindColumn(22, idx_name_key);
      stmt.executeUpdate();
      stmt.close();
 ...
 /* 다음 문장은 반드시 수정하시요 (where 아래의 변수 갯수만큼 */ 
      String sSql = "update y_budget_detail_excel_temp set " + 
                            "name_key=REPLACE(SUBSTR(part_class,1,1) || TRIM(NAME) || TRIM(SSIZE) || TRIM(UNIT),' ','')  where dept_code=? and part_class =? ";  
      stmt = conn.prepareStatement(sSql); 
      gpstatement.gp_stmt = stmt;
