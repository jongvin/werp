<%@ page session="true" import="com.gauce.*,com.gauce.io.*,com.gauce.common.*,com.gauce.log.*,com.gauce.db.*,java.sql.*"%><%@
 ...
 //---------------------------------------------------------- 
     ...
     dSet.addDataColumn(new GauceDataColumn("BEFORE_RESULT_MAP",GauceDataColumn.TB_STRING,2000));
     dSet.addDataColumn(new GauceDataColumn("AFTER_RESULT_MAP",GauceDataColumn.TB_STRING,2000));
     ...
     dSet.addDataColumn(new GauceDataColumn("IMPROVE_MERIT",GauceDataColumn.TB_STRING,2000));
     dSet.addDataColumn(new GauceDataColumn("IMPROVE_WEAK",GauceDataColumn.TB_STRING,2000));
     dSet.addDataColumn(new GauceDataColumn("IMPROVE_ALERT",GauceDataColumn.TB_STRING,2000));
     dSet.addDataColumn(new GauceDataColumn("IMPROVE_RESULT_MERIT",GauceDataColumn.TB_STRING,2000));
     dSet.addDataColumn(new GauceDataColumn("IMPROVE_RESULT_ALERT",GauceDataColumn.TB_STRING,2000));
     dSet.addDataColumn(new GauceDataColumn("CHARGE_OPINION",GauceDataColumn.TB_STRING,2000));
     dSet.addDataColumn(new GauceDataColumn("PART_OPINION",GauceDataColumn.TB_STRING,2000));
	...
	String query =" SELECT																			" +
                      ...
                      "DEPT_CODE,  " + 
							 "(SELECT LONG_NAME FROM Z_CODE_DEPT WHERE DEPT_CODE = v_tech_proposal_plan_detail.dept_code ) LONG_NAME , " +
                      "SEQ_NUM,  " + 
                      "WBS_CODE,  " + 
                      ...
                      "BEFORE_MAP, " + 
                      "AFTER_MAP, " + 
                      "DECODE(BEFORE_RESULT_MAP,NULL,BEFORE_MAP,BEFORE_RESULT_MAP)BEFORE_RESULT_MAP, " + 
                      "DECODE(AFTER_RESULT_MAP,NULL,AFTER_MAP,AFTER_RESULT_MAP) AFTER_RESULT_MAP, " + 
                      ...
                      "IMPROVE_WEAK, " + 
                      "IMPROVE_ALERT, " + 
                      "DECODE(IMPROVE_RESULT_MERIT,NULL,IMPROVE_MERIT,IMPROVE_RESULT_MERIT) IMPROVE_RESULT_MERIT, " + 
                      "IMPROVE_RESULT_ALERT, " + 
                      "CHARGE_OPINION, " + 
                      "PART_OPINION , " + 
                      "DECODE(BEFORE_MAT_AMT_RESULT,-1,BEFORE_MAT_AMT,BEFORE_MAT_AMT_RESULT)BEFORE_MAT_AMT_RESULT, " + 
                      "DECODE(AFTER_MAT_AMT_RESULT,-1,AFTER_MAT_AMT,AFTER_MAT_AMT_RESULT)AFTER_MAT_AMT_RESULT ," + 
                      "DECODE(BEFORE_LABOR_AMT_RESULT,-1,BEFORE_LABOR_AMT,BEFORE_LABOR_AMT_RESULT)BEFORE_LABOR_AMT_RESULT, " + 
                      "DECODE(AFTER_LABOR_AMT_RESULT,-1,AFTER_LABOR_AMT,AFTER_LABOR_AMT_RESULT)AFTER_LABOR_AMT_RESULT, " + 
                      "DECODE(BEFORE_EQUIP_AMT_RESULT,-1,BEFORE_EQUIP_AMT,BEFORE_EQUIP_AMT_RESULT)BEFORE_EQUIP_AMT_RESULT ," + 
                      "DECODE(AFTER_EQUIP_AMT_RESULT,-1,AFTER_EQUIP_AMT,AFTER_EQUIP_AMT_RESULT)AFTER_EQUIP_AMT_RESULT ," + 
                      "DECODE(BEFORE_ETC_AMT_RESULT,-1,BEFORE_ETC_AMT,BEFORE_ETC_AMT_RESULT) BEFORE_ETC_AMT_RESULT," + 
                      "DECODE(AFTER_ETC_AMT_RESULT,-1,AFTER_ETC_AMT,AFTER_ETC_AMT_RESULT)AFTER_ETC_AMT_RESULT ," + 
