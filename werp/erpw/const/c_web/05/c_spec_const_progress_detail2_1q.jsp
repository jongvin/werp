 ...
 //---------------------------------------------------------- 
    ...
    String query = "  SELECT b.dept_code,   " + 
     ...
     "			NVL(b.LS_COST_AMT,0)  LS_COST_AMT," + 
	  ...
	  "	 decode( (NVL(b.RESULT_AMT, 0) + NVL(b.LS_RESULT_AMT, 0)), 0, 0 ,(NVL(b.COST_AMT,0) + NVL(b.LS_COST_AMT, 0)) / (NVL(b.RESULT_AMT, 0) + NVL(b.LS_RESULT_AMT, 0)) * 100)  TOT_COST_RATE,  " +
     "   decode( NVL(result_amt,0),0,0, NVL(b.COST_AMT,0) / result_amt * 100) COST_RATE,  " +
     "   decode( NVL(LS_RESULT_AMT,0),0,0, NVL(b.LS_COST_AMT,0) / LS_RESULT_AMT * 100) LS_COST_RATE, " +
