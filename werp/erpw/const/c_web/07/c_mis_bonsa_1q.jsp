...
//     "          to_char(a.chg_const_end_date,'yyyy.mm.dd')  chg_const_end_date , " + 
     ...
     "       (select dept_code,max(chg_seq) chg_seq, max(chg_no_seq) chg_no_seq from c_chg_progress group by dept_code) d, " + 
