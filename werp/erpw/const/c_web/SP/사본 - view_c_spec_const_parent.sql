CREATE VIEW view_c_spec_const_parent
  ...
  AS SELECT c_spec_const_parent.yymm, c_spec_class_parent.sum_code, 
        ...
        c_spec_const_parent.ls_cost_exp_amt, y_budget_parent.cnt_amt, 
        y_budget_parent.cnt_mat_amt, y_budget_parent.cnt_lab_amt, 
        y_budget_parent.cnt_exp_amt, y_budget_parent.amt, 
        y_budget_parent.mat_amt, y_budget_parent.lab_amt, 
        y_budget_parent.exp_amt, y_budget_parent.equ_amt, 
