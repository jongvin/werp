...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 ...
 //---------------------------------------------------------- 
    ...
    String query = "    SELECT    c_spec_class_parent.name name," + 
     ...
     "			              SUM(DECODE(to_char(view_c_spec_const_parent.yymm,'yyyy.mm.dd'),'" + arg_year + ".12.01'" + " ,NVL(view_c_spec_const_parent.pre_result_amt,0),0))  pre_result_amt   " + 
     ...
     "        GROUP BY  c_spec_class_parent.name        ";
%><%@ 
