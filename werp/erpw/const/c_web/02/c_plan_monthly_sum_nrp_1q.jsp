...
include file="../../../comm_function/conn_q_pool.jsp"%><%
 // 다음 문장은 수정 하시요 (파라메터 갯수만큼 (없으면 //로 막으세요)//
    ...
    String query =" SELECT   m.new_tag, m.receive_tag, m.pq_tag,"+
...
"      AND d.YEAR = '"+arg_year+"'"   +
" GROUP BY m.new_tag, m.receive_tag, m.pq_tag, d.line_no, line_desc, line_desc2"   +
" ORDER BY m.new_tag, m.receive_tag, m.pq_tag, d.line_no"  ;
%><%@ 
