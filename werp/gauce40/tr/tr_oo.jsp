...
<gdml>
  ...
  <dataset name="GROUP" fragment="50">
    <dh>
      <def name="deptno" type="int" size="5"/>
      <def name="dname" type="string" size="30"/>
      <def name="loc" type="string" size="30"/>
    </dh><c:forEach var="group" items="${GroupList}">
    <dr>
      <dd><c:out value="${group.deptno}"/></dd>
      <dd><c:out value="${group.dname}"/></dd>
      <dd><c:out value="${group.loc}"/></dd>
    </dr></c:forEach>
  </dataset>
</gdml>