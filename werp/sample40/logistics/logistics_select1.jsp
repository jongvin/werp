...
<sql:query var="user" dataSource="${GauceDB$sampledb}">    
    SELECT gubun, ToSite, FromSite, SC, Category, January, Feburary, March, April, May, June, July, August, September, October, November, December FROM T_HM3001 WHERE YYYY = '<c:out value="${param.year}"/>' order by ToSite asc, Category asc
</sql:query>
<gdml>
